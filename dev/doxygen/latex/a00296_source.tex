\hypertarget{a00296_source}{}\doxysection{fefactory.\+hh}
\label{a00296_source}\index{fefactory.hh@{fefactory.hh}}
...
\DoxyCodeLine{11 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00227}{ikarus/finiteelements/febase.hh}}>}}
...
\DoxyCodeLine{22 \textcolor{keyword}{struct }\mbox{\hyperlink{a01267}{FEFactory}}}
\DoxyCodeLine{23 \{}
\DoxyCodeLine{24   \textcolor{keyword}{using }\mbox{\hyperlink{a01267_ae4167551b40097429f804066c4973256}{Skills}} = SK;}
\DoxyCodeLine{25 }
...
\DoxyCodeLine{37   \mbox{\hyperlink{a01267_aacbb6c8ee45484144edb78306da79456}{FEFactory}}(\textcolor{keyword}{const} BH\& basisHandler, \textcolor{keyword}{const} SK2\& sk)}
\DoxyCodeLine{38       : basisHandler\_\{\&basisHandler\},}
\DoxyCodeLine{39         skills\_\{sk\} \{\}}
\DoxyCodeLine{40 }
\DoxyCodeLine{41   \textcolor{keyword}{auto} \mbox{\hyperlink{a01267_aa324bf69fc6e9d878cdaf1b2a8667196}{operator()}}() \{}
...
\DoxyCodeLine{47           \textcolor{keyword}{typename} \mbox{\hyperlink{a01259}{PreFE<BH, useFlat, useEigenRef>::template}} \mbox{\hyperlink{a01255}{FE<std::decay\_t<Args>::template}} Skill...> fe(}
...
\DoxyCodeLine{68 \textcolor{keyword}{auto} \mbox{\hyperlink{a00351_a59639a9a20f036a4f1c0794f65595662}{makeFE}}(\textcolor{keyword}{const} BH\& basisHandler, \textcolor{keyword}{const} SK\& sk) \{}
\DoxyCodeLine{69   \mbox{\hyperlink{a01267}{FEFactory<BH, SK, useFlat, useEigenRef>}} factory(basisHandler, sk);}
\DoxyCodeLine{70 }
...
\DoxyCodeLine{85 \textcolor{keyword}{auto} \mbox{\hyperlink{a00351_aa80712fed165a22f02670f195488fe5f}{makeFEWithUnTouchedBasis}}(\textcolor{keyword}{const} BH\& basisHandler, SK\&\& sk) \{}
\DoxyCodeLine{86   \mbox{\hyperlink{a01267}{FEFactory<BH, SK, false, useEigenRef>}} factory(basisHandler, std::forward<SK>(sk));}
\DoxyCodeLine{87 }
