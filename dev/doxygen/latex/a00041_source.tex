\hypertarget{a00041_source}{}\doxysection{functionsanitychecks.\+hh}
\label{a00041_source}\index{functionsanitychecks.hh@{functionsanitychecks.hh}}
...
\DoxyCodeLine{10 \textcolor{preprocessor}{\#include "{}\mbox{\hyperlink{a00026}{findlinesegment.hh}}"{}}}
\DoxyCodeLine{11 }
...
\DoxyCodeLine{28   \textcolor{keywordtype}{double} drawResultAndReturnSlope(std::string\&\& functionName, \textcolor{keyword}{const} std::function<\textcolor{keywordtype}{double}(\textcolor{keywordtype}{double})>\& ftfunc, \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00137_a65b25c4ffa5a9d9f808da12703e79cb2}{draw}},}
