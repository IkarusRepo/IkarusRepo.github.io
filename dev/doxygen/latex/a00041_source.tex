...
\DoxyCodeLine{28   \textcolor{keywordtype}{double} drawResultAndReturnSlope(std::string\&\& functionName, \textcolor{keyword}{const} std::function<\textcolor{keywordtype}{double}(\textcolor{keywordtype}{double})>\& ftfunc, \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00242_a65b25c4ffa5a9d9f808da12703e79cb2}{draw}},}
\DoxyCodeLine{29                                   \textcolor{keywordtype}{int} slopeOfReference);}
\DoxyCodeLine{30 \} \textcolor{comment}{// namespace Impl}}
\DoxyCodeLine{34 \textcolor{comment}{}\textcolor{keyword}{struct }\mbox{\hyperlink{a01609}{CheckFlags}}}
\DoxyCodeLine{35 \{}
\DoxyCodeLine{36   \textcolor{keywordtype}{bool} \mbox{\hyperlink{a01609_a08fa473dcdfbdb5dcf759546ea2da3b8}{draw}}                        = \textcolor{keyword}{true};}
\DoxyCodeLine{37   \textcolor{keywordtype}{bool} \mbox{\hyperlink{a01609_ac9946207ee221c94e843ea7c048a16a3}{writeSlopeStatementIfFailed}} = \textcolor{keyword}{true};}
\DoxyCodeLine{38   \textcolor{keywordtype}{double} \mbox{\hyperlink{a01609_a6c1e702608ca901f9f7efca524560b25}{tolerance}}                 = 1e-\/2;}
\DoxyCodeLine{39 \};}
\DoxyCodeLine{40 }
...
\DoxyCodeLine{54 \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00332_gacb9e813539bfd84df99ad097cabc9de9}{checkGradient}}(}
\DoxyCodeLine{55     NonlinearOperator\& nonLinOp, \mbox{\hyperlink{a01609}{CheckFlags}} checkFlags = \mbox{\hyperlink{a01609}{CheckFlags}}(),}
...
\DoxyCodeLine{115 \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00332_ga553465359c199ef676945832587d2869}{checkJacobian}}(}
\DoxyCodeLine{116     NonlinearOperator\& nonLinOp, \mbox{\hyperlink{a01609}{CheckFlags}} checkFlags = \mbox{\hyperlink{a01609}{CheckFlags}}(),}
...
\DoxyCodeLine{134     \textcolor{keyword}{auto} value = (nonLinOp.value() -\/ e -\/ t * jacofv).\mbox{\hyperlink{a00332_ga0ffc0c74dbd9aeee3e53b199a21b828c}{norm}}();}
...
\DoxyCodeLine{168 \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00332_ga5d1a87964a3d6b6ddc994532e93b6798}{checkHessian}}(}
\DoxyCodeLine{169     NonlinearOperator\& nonLinOp, \mbox{\hyperlink{a01609}{CheckFlags}} checkFlags = \mbox{\hyperlink{a01609}{CheckFlags}}(),}
