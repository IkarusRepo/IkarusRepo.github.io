\hypertarget{a00391}{}\doxysection{Ikarus\+::utils Namespace Reference}
\label{a00391}\index{Ikarus::utils@{Ikarus::utils}}
\doxysubsection*{Classes}
\begin{DoxyCompactItemize}
\item 
struct \mbox{\hyperlink{a01799}{Check\+Flags}}
\begin{DoxyCompactList}\small\item\em Struct to hold flags for function checks. \end{DoxyCompactList}\item 
struct \mbox{\hyperlink{a01743}{Solver\+Default}}
\begin{DoxyCompactList}\small\item\em Default functor for solving operations. \end{DoxyCompactList}\item 
struct \mbox{\hyperlink{a01747}{Update\+Default}}
...
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{a00372_ga6e36d8f5163f232e3142ecbd0575e8b4}{make\+Unique\+And\+Sort}} (std\+::ranges\+::random\+\_\+access\+\_\+range auto \&r)
...
{\footnotesize template$<$typename T $>$ }\\auto \mbox{\hyperlink{a00372_ga0ccbb016e46741bd00c69436dc11e2d0}{append\+Unique}} (std\+::ranges\+::random\+\_\+access\+\_\+range auto \&r, T \&\&v)
\begin{DoxyCompactList}\small\item\em Appends a value to the range if it is not already present. \end{DoxyCompactList}\item 
{\footnotesize template$<$class C $>$ }\\void \mbox{\hyperlink{a00372_ga2b7954c72a2393ab7494fa0b66d828cd}{print\+Content}} (C \&\&c, std\+::ostream \&os=std\+::cout)
...
{\footnotesize template$<$class C $>$ }\\auto \mbox{\hyperlink{a00372_ga7f597d87c8f2bcbf4afc65ebc929b680}{transform\+Value\+Range\+To\+Pointer\+Range}} (C \&cont)
\begin{DoxyCompactList}\small\item\em Transforms a value range to a pointer range. \end{DoxyCompactList}\item 
{\footnotesize template$<$class C $>$ }\\auto \mbox{\hyperlink{a00372_ga83bd9e4f59f0aa9fadd797efefa751d9}{transform\+Pointer\+Range\+To\+Reference\+Range}} (C \&cont)
\begin{DoxyCompactList}\small\item\em Transforms a pointer range to a reference range. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename Tuple , typename Predicate $>$ }\\constexpr size\+\_\+t \mbox{\hyperlink{a00372_gaf75511e781bb89056badd33413222010}{find\+\_\+if}} (Tuple \&\&tuple, Predicate pred)
...
{\footnotesize template$<$typename Tuple , typename Predicate $>$ }\\bool \mbox{\hyperlink{a00372_ga33284bcf99d7d3870e0aff06f6651aa2}{none\+\_\+of}} (Tuple \&\&tuple, Predicate pred)
...
{\footnotesize template$<$typename Tuple , typename Predicate $>$ }\\bool \mbox{\hyperlink{a00372_gab6d955a70ec9215ae9a8f3841582ab49}{any\+\_\+of}} (Tuple \&\&tuple, Predicate pred)
...
{\footnotesize template$<$typename Tuple , typename Predicate $>$ }\\auto \mbox{\hyperlink{a00372_gad9f30d486a3d9151d534ec1b0fad5341}{filter}} (Tuple \&\&tuple, Predicate pred)
\begin{DoxyCompactList}\small\item\em Filters the elements of a tuple based on a given predicate. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename... Types$>$ }\\constexpr auto \mbox{\hyperlink{a00372_ga12de8f77a63ef488a87a5aa8536146ee}{unique}} (std\+::tuple$<$ Types... $>$ \&\&tuple)
\begin{DoxyCompactList}\small\item\em Creates a tuple with unique types from the given tuple. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename Tuple , typename Predicate $>$ }\\constexpr size\+\_\+t \mbox{\hyperlink{a00372_gae9a7254f583151ee431db537c9980865}{count\+\_\+if}} (Tuple \&\&tuple, Predicate pred)
...
{\footnotesize template$<$template$<$ auto... $>$ class Type, typename Tuple $>$ }\\constexpr int \mbox{\hyperlink{a00372_ga62d8ab565d41e49db75f0641bcdf0740}{find\+Type\+Specialization}} ()
...
{\footnotesize template$<$template$<$ auto... $>$ class Type, typename Tuple $>$ }\\auto \mbox{\hyperlink{a00372_ga05a5ccea0f87d41fc69956f55a2c1dbd}{get\+Specialization}} (Tuple \&\&tuple)
...
{\footnotesize template$<$template$<$ auto... $>$ class Type, typename Tuple $>$ }\\constexpr bool \mbox{\hyperlink{a00372_gaec2a5de0482441ef1e1c68fb7ff8a0bc}{has\+Type\+Specialization}} ()
\begin{DoxyCompactList}\small\item\em Checks if a tuple has a specialization of a template type. \end{DoxyCompactList}\item 
{\footnotesize template$<$template$<$ auto... $>$ class Type, typename Tuple $>$ }\\constexpr bool \mbox{\hyperlink{a00372_gadf919f3a9b0c1d50134f9d041a3ce9f7}{count\+Type\+Specialization}} ()
...
{\footnotesize template$<$int N, class Tuple $>$ }\\constexpr auto \mbox{\hyperlink{a00372_ga32de94604b9d1a7423134f33f49d613f}{make\+Tuple\+Subset}} (Tuple \&\&t)
...
{\footnotesize template$<$class Tuple , std\+::size\+\_\+t... I$>$ }\\constexpr auto \mbox{\hyperlink{a00372_gaef801f15c9f18ae16e4241a497c33e96}{make\+Tuple\+From\+Tuple\+Indices}} (Tuple \&\&t)
\begin{DoxyCompactList}\small\item\em Creates a new tuple using indices from the original tuple. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename... Types$>$ }\\auto \mbox{\hyperlink{a00391_a4c617d2458cc6d792f5ba3e6c64a0c7f}{make\+Nested\+Tuple\+Flat}} (std\+::tuple$<$ Types... $>$)
\begin{DoxyCompactList}\small\item\em Creates a flattened nested tuple. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename Tuple $>$ }\\auto \mbox{\hyperlink{a00391_a162c64656f5917b717a6b44ebf4c9ebf}{make\+Nested\+Tuple\+Flat\+And\+Store\+References}} (Tuple \&\&tup)
...
requires traits\+::\+Pointer$<$T$>$}\\auto \& \mbox{\hyperlink{a00391_aa156028e47fc302b02a7e70dea888034}{return\+Reference\+Or\+Nullopt\+If\+Object\+Is\+Null\+Ptr}} (T v)
...
std\+::tuple$<$ Dune\+::\+Functions\+::\+Polynomial$<$ double $>$, decltype(Eigen\+::seq(0, 0))$>$ \mbox{\hyperlink{a00370_ga16e7d5f51cc42190c090e727495c1609}{find\+Line\+Segment}} (const Eigen\+::\+Vector\+Xd \&x, const Eigen\+::\+Vector\+Xd \&y, int segment\+Size)
\begin{DoxyCompactList}\small\item\em Find a linear segment in a set of data points. \end{DoxyCompactList}\item 
{\footnotesize template$<$int size, typename LV $>$ }\\void \mbox{\hyperlink{a00370_gae9098182120929a0d21cff1c38f5ca84}{obtain\+Lagrange\+Global\+Node\+Positions}} (const LV \&local\+View, std\+::vector$<$ \mbox{\hyperlink{a01751}{Dune\+::\+Field\+Vector}}$<$ double, size $>$ $>$ \&lagrange\+Node\+Global\+Coords)
...
{\footnotesize template$<$int size, typename Basis $>$ }\\auto \mbox{\hyperlink{a00370_gaa19ed04a701aaa500f7c486addae2d2e}{global\+Index\+From\+Global\+Position}} (const Basis \&basis, const \mbox{\hyperlink{a01751}{Dune\+::\+Field\+Vector}}$<$ double, size $>$ \&pos)
...
{\footnotesize template$<$typename \mbox{\hyperlink{a01327}{FE}} $>$ }\\auto \mbox{\hyperlink{a00370_ga30df35336d19b00bc5db2a0b52ce650e}{reference\+Element\+Sub\+Entity\+Positions}} (\mbox{\hyperlink{a01327}{FE}} \&fe, int codim)
...
{\footnotesize template$<$typename \mbox{\hyperlink{a01327}{FE}} $>$ }\\auto \mbox{\hyperlink{a00370_ga8c05dce8a66fc4efbe31674b87d18298}{reference\+Element\+Vertex\+Positions}} (\mbox{\hyperlink{a01327}{FE}} \&fe)
...
{\footnotesize template$<$typename Nonlinear\+Operator , typename Update\+Type  = typename Nonlinear\+Operator\+::template Parameter\+Value$<$0$>$$>$ }\\bool \mbox{\hyperlink{a00370_ga5d1a87964a3d6b6ddc994532e93b6798}{check\+Hessian}} (Nonlinear\+Operator \&non\+Lin\+Op, \mbox{\hyperlink{a01799}{Check\+Flags}} check\+Flags=\mbox{\hyperlink{a01799}{Check\+Flags}}(), std\+::function$<$ void(typename Nonlinear\+Operator\+::template Parameter\+Value$<$ 0 $>$ \&, const Update\+Type \&)$>$ p\+\_\+update\+Function=\mbox{[}$\,$\mbox{]}(typename Nonlinear\+Operator\+::template Parameter\+Value$<$ 0 $>$ \&a, const Update\+Type \&b) \{ a+=b;\})
\begin{DoxyCompactList}\small\item\em Checks the Hessian of a nonlinear operator. \end{DoxyCompactList}\item 
std\+::tuple$<$ Dune\+::\+Functions\+::\+Polynomial$<$ double $>$, double $>$ \mbox{\hyperlink{a00370_ga0d3a38551806e4de3ff44f311847ba51}{polyfit}} (const Eigen\+::\+Ref$<$ const Eigen\+::\+Vector\+Xd $>$ \&x, const Eigen\+::\+Ref$<$ const Eigen\+::\+Vector\+Xd $>$ \&y, int deg)
...
{\footnotesize template$<$class T , class Tree\+Path , class Power\+Func , class Leaf\+Func $>$ }\\void \mbox{\hyperlink{a00391_a63742d75d099b93da7ddf6e78a3c1f56}{for\+Each\+Leaf\+Or\+Power\+Leaf\+Node}} (T \&\&tree, Tree\+Path \&\&tree\+Path, Power\+Func \&\&power\+Func, Leaf\+Func \&\&leaf\+Func)
...
requires (std\+::convertible\+\_\+to$<$F, std\+::function$<$bool(int, \mbox{\hyperlink{a01751}{Dune\+::\+Field\+Vector}}$<$double, size$>$ \&\&)$>$$>$)}\\void \mbox{\hyperlink{a00391_a9bfdb235951b98b7a214704baf9c6f95}{for\+Each\+Lagrange\+Node\+Position}} (const LV \&local\+View, F \&\&f)
...
\begin{DoxyCompactItemize}
\item 
{\footnotesize template$<$template$<$ auto... $>$ class Type, typename Tuple $>$ }\\static constexpr bool \mbox{\hyperlink{a00372_ga62ee166e690831f40395df076e9cdddb}{count\+Type\+Specialization\+\_\+v}} = \mbox{\hyperlink{a00372_gadf919f3a9b0c1d50134f9d041a3ce9f7}{count\+Type\+Specialization}}$<$Type, Tuple$>$()
...
\mbox{\Hypertarget{a00391_a9bfdb235951b98b7a214704baf9c6f95}\label{a00391_a9bfdb235951b98b7a214704baf9c6f95}} 
...
requires (std\+::convertible\+\_\+to$<$F, std\+::function$<$bool(int, \mbox{\hyperlink{a01751}{Dune\+::\+Field\+Vector}}$<$double, size$>$ \&\&)$>$$>$)\\
...
\mbox{\hyperlink{a00395}{Dune}} book page 314 for details 
\end{DoxySeeAlso}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{a00391_a9bfdb235951b98b7a214704baf9c6f95_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{a00391_a63742d75d099b93da7ddf6e78a3c1f56}\label{a00391_a63742d75d099b93da7ddf6e78a3c1f56}} 
...
\begin{center}
\leavevmode
\includegraphics[width=217pt]{a00391_a63742d75d099b93da7ddf6e78a3c1f56_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{a00391_a4c617d2458cc6d792f5ba3e6c64a0c7f}\label{a00391_a4c617d2458cc6d792f5ba3e6c64a0c7f}} 
...
\end{DoxyReturn}
\mbox{\Hypertarget{a00391_a162c64656f5917b717a6b44ebf4c9ebf}\label{a00391_a162c64656f5917b717a6b44ebf4c9ebf}} 
...
\end{DoxyReturn}
This function creates a flattened nested tuple and stores references. \mbox{\Hypertarget{a00391_aa156028e47fc302b02a7e70dea888034}\label{a00391_aa156028e47fc302b02a7e70dea888034}} 
