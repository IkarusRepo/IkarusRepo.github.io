...
\DoxyCodeLine{23 }
\DoxyCodeLine{24 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00295}{Ikarus}} \{}
\DoxyCodeLine{25 }
\DoxyCodeLine{32   \textcolor{keyword}{class }\mbox{\hyperlink{a01490}{IkarusInstance}} \{}
\DoxyCodeLine{33   \textcolor{keyword}{public}:}
\DoxyCodeLine{39     \textcolor{keyword}{static} \mbox{\hyperlink{a01490}{IkarusInstance}}\& \mbox{\hyperlink{a01490_a76a31b1d9f5b1fba7180451b1edddf0a}{getInstance}}() \{}
\DoxyCodeLine{40       \textcolor{keyword}{static} \mbox{\hyperlink{a01490}{IkarusInstance}} instance;}
\DoxyCodeLine{41       \textcolor{keywordflow}{return} instance;}
\DoxyCodeLine{42     \}}
\DoxyCodeLine{43 }
\DoxyCodeLine{49     \textcolor{keywordtype}{void} \mbox{\hyperlink{a01490_a833f9b23184e3d0f5b06f5b7b85d9233}{enableFileLogger}}(std::string\&\& filename = \textcolor{stringliteral}{"{}"{}}) \{}
...
\DoxyCodeLine{65     \textcolor{keyword}{friend} \textcolor{keywordtype}{void} \mbox{\hyperlink{a01490_a4865c52ed9d7e9c0f00e8bd5295ee853}{init}}(\textcolor{keywordtype}{int} argc, \textcolor{keywordtype}{char}** argv, \textcolor{keywordtype}{bool} \mbox{\hyperlink{a01490_a833f9b23184e3d0f5b06f5b7b85d9233}{enableFileLogger}});}
\DoxyCodeLine{66     \mbox{\hyperlink{a01490}{IkarusInstance}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{67     std::string executableName;}
\DoxyCodeLine{68 }
\DoxyCodeLine{69   \textcolor{keyword}{public}:}
\DoxyCodeLine{70     \mbox{\hyperlink{a01490_a5310bd753ef99eb8cd3814f93b6fc345}{IkarusInstance}}(\mbox{\hyperlink{a01490}{IkarusInstance}} \textcolor{keyword}{const}\&) = \textcolor{keyword}{delete};}
\DoxyCodeLine{71     \textcolor{keywordtype}{void} \mbox{\hyperlink{a01490_a77f7470b50ebee705f221d80b689f6f5}{operator=}}(\mbox{\hyperlink{a01490}{IkarusInstance}} \textcolor{keyword}{const}\&) = \textcolor{keyword}{delete};}
\DoxyCodeLine{72   \};}
\DoxyCodeLine{73 }
\DoxyCodeLine{81   \textcolor{keywordtype}{void} \textcolor{keyword}{inline} \mbox{\hyperlink{a00295_ac8243891c1b961e50a066140ab79a142}{init}}(\textcolor{keywordtype}{int} argc, \textcolor{keywordtype}{char}** argv, \textcolor{keywordtype}{bool} enableFileLogger = \textcolor{keyword}{true}) \{}
\DoxyCodeLine{82     Dune::MPIHelper::instance(argc, argv);}
\DoxyCodeLine{83     \textcolor{keyword}{auto}\& instance          = \mbox{\hyperlink{a01490_a76a31b1d9f5b1fba7180451b1edddf0a}{IkarusInstance::getInstance}}();}
