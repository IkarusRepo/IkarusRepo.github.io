...
\DoxyCodeLine{16 }
\DoxyCodeLine{17 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00266}{ikarus/assembler/dirichletbcenforcement.hh}}>}}
...
\DoxyCodeLine{21 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a02827}{ikarus/utils/basis.hh}}>}}
\DoxyCodeLine{22 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00068}{ikarus/utils/traits.hh}}>}}
\DoxyCodeLine{23 }
\DoxyCodeLine{24 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00389}{Ikarus::Python}} \{}
\DoxyCodeLine{25 }
...
\DoxyCodeLine{46 \textcolor{keyword}{struct }\mbox{\hyperlink{a01639}{SparseMatrixWrapper}}}
\DoxyCodeLine{47 \{}
\DoxyCodeLine{48   \mbox{\hyperlink{a01639_adea8b485a2a498cb28c69debdb841f21}{SparseMatrixWrapper}}(Eigen::SparseMatrix<T>\& matrix)}
\DoxyCodeLine{49       : \mbox{\hyperlink{a01639_a32da660f4237007b18c282ea7bb38b8b}{matrixRef}}(matrix) \{\}}
\DoxyCodeLine{50   std::reference\_wrapper<Eigen::SparseMatrix<T>> \mbox{\hyperlink{a01639_a32da660f4237007b18c282ea7bb38b8b}{matrixRef}};}
\DoxyCodeLine{51 \};}
\DoxyCodeLine{52 }
\DoxyCodeLine{53 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T>}
\DoxyCodeLine{54 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00389_a09b4a81e2d6d0619406854f6dc3fc8f7}{registerSparseMatrixWrapper}}(pybind11::handle scope) \{}
...
\DoxyCodeLine{57       scope, \textcolor{stringliteral}{"{}SparseMatrixWrapper"{}}, Dune::Python::GenerateTypeName(Dune::className<\mbox{\hyperlink{a01639}{SparseMatrixWrapper<T>}}>()),}
\DoxyCodeLine{58       includes);}
\DoxyCodeLine{59   \textcolor{keywordflow}{if} (isNotRegistered) \{}
\DoxyCodeLine{60     lv.def(\mbox{\hyperlink{a00375_ac8243891c1b961e50a066140ab79a142}{pybind11::init}}<Eigen::SparseMatrix<T>\&>())}
\DoxyCodeLine{61         .def(\textcolor{stringliteral}{"{}\_\_setitem\_\_"{}}, [](\mbox{\hyperlink{a01639}{SparseMatrixWrapper<T>}}\& self, std::array<int, 2> index,}
\DoxyCodeLine{62                                \textcolor{keywordtype}{double} val) \{ self.\mbox{\hyperlink{a01639_a32da660f4237007b18c282ea7bb38b8b}{matrixRef}}.get().coeffRef(index[0], index[1]) = val; \})}
\DoxyCodeLine{63         .def(\textcolor{stringliteral}{"{}\_\_getitem\_\_"{}}, [](\mbox{\hyperlink{a01639}{SparseMatrixWrapper<T>}}\& self, std::array<int, 2> index) \{}
\DoxyCodeLine{64           \textcolor{keywordflow}{return} self.\mbox{\hyperlink{a01639_a32da660f4237007b18c282ea7bb38b8b}{matrixRef}}.get().coeffRef(index[0], index[1]);}
\DoxyCodeLine{65         \});}
\DoxyCodeLine{66   \}}
\DoxyCodeLine{67 \}}
\DoxyCodeLine{68 }
\DoxyCodeLine{69 \textcolor{keyword}{template} <\textcolor{keyword}{class }\mbox{\hyperlink{a01239}{AssemblerManipulator}}, \textcolor{keyword}{class}... options>}
\DoxyCodeLine{70 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00389_aad35f78683b64303a28d3b8b4f83aa37}{registerAssemblerManipulator}}(pybind11::handle scope, pybind11::class\_<AssemblerManipulator, options...> cls) \{}
\DoxyCodeLine{71   \textcolor{keyword}{using }pybind11::operator\textcolor{stringliteral}{"{}"{}}\_a;}
\DoxyCodeLine{72 }
\DoxyCodeLine{73   \mbox{\hyperlink{a00367_ga87d3c6e620be5df59ba6923751caae86}{registerFlatAssembler}}(scope, cls);}
...
\DoxyCodeLine{77 }
\DoxyCodeLine{78   cls.def(\mbox{\hyperlink{a00375_ac8243891c1b961e50a066140ab79a142}{pybind11::init}}([](\textcolor{keyword}{const} UnderlyingAssembler\& as) \{ \textcolor{keywordflow}{return} \textcolor{keyword}{new} \mbox{\hyperlink{a01239}{AssemblerManipulator}}(as); \}));}
\DoxyCodeLine{79 }
\DoxyCodeLine{80   \textcolor{keyword}{using }NewArgs = std::tuple<}
\DoxyCodeLine{81       \mbox{\hyperlink{a01643}{ScalarWrapper<std::reference\_wrapper<typename AssemblerManipulator::ScalarType>}}>,}
...
\DoxyCodeLine{84                          \mbox{\hyperlink{a01639}{SparseMatrixWrapper<double>}}, Eigen::Ref<Eigen::MatrixXd>>>;}
...
\DoxyCodeLine{95                           \textcolor{keyword}{using }Traits            = \mbox{\hyperlink{a01895}{Ikarus::traits::FunctionTraits<F>}};}
...
\DoxyCodeLine{103                               \textcolor{keyword}{typename} \mbox{\hyperlink{a01907}{Ikarus::traits::ChangeArgTypeAtPos<F, lastIndex, NewArg>::NewFunctionType}};}
\DoxyCodeLine{104 }
\DoxyCodeLine{105                           cls.def(name.c\_str(), [\&](\mbox{\hyperlink{a01239}{AssemblerManipulator}}\& self, FMod f) \{}
