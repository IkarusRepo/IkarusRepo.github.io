...
\DoxyCodeLine{28 \textcolor{keyword}{concept }\mbox{\hyperlink{a01960}{Pointer}} = std::is\_pointer\_v<T> || std::is\_same\_v<T, std::nullptr\_t>;}
\DoxyCodeLine{29 }
...
\DoxyCodeLine{85 \textcolor{keyword}{struct }\mbox{\hyperlink{a01872}{hasType}} : std::false\_type}
\DoxyCodeLine{86 \{}
\DoxyCodeLine{87 \};}
\DoxyCodeLine{88 }
...
\DoxyCodeLine{91 \textcolor{keyword}{struct }\mbox{\hyperlink{a01872}{hasType}}<T, \mbox{\hyperlink{a00383}{std}}::tuple<>> : std::false\_type}
\DoxyCodeLine{92 \{}
\DoxyCodeLine{93 \};}
\DoxyCodeLine{94 }
...
\DoxyCodeLine{133 \textcolor{keyword}{struct }\mbox{\hyperlink{a01876}{isSharedPtr}} : std::false\_type}
\DoxyCodeLine{134 \{}
\DoxyCodeLine{135 \};}
\DoxyCodeLine{136 }
...
\DoxyCodeLine{139 \textcolor{keyword}{struct }\mbox{\hyperlink{a01876}{isSharedPtr<std::shared\_ptr<T>}}> : std::true\_type}
\DoxyCodeLine{140 \{}
\DoxyCodeLine{141 \};}
\DoxyCodeLine{142 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{143 }
\DoxyCodeLine{144 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T>}
\DoxyCodeLine{145 \textcolor{keyword}{class }\mbox{\hyperlink{a01880}{remove\_pointer}}}
\DoxyCodeLine{146 \{}
...
\DoxyCodeLine{152   \textcolor{keyword}{using }\mbox{\hyperlink{a01880_aeb039b36424f998cbf10801e5609eb8c}{type}} = \textcolor{keyword}{typename} \textcolor{keyword}{decltype}(test(0))\mbox{\hyperlink{a01880_aeb039b36424f998cbf10801e5609eb8c}{::type}};}
\DoxyCodeLine{153 \};}
\DoxyCodeLine{154 }
\DoxyCodeLine{155 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T>}
\DoxyCodeLine{156 \textcolor{keyword}{using }\mbox{\hyperlink{a00407_a472256748675b3006507836bd8034a0e}{remove\_pointer\_t}} = \textcolor{keyword}{typename} \mbox{\hyperlink{a01880_aeb039b36424f998cbf10801e5609eb8c}{remove\_pointer<T>::type}};}
\DoxyCodeLine{157 }
...
\DoxyCodeLine{259 \textcolor{keyword}{struct }\mbox{\hyperlink{a01900}{Index}};}
\DoxyCodeLine{260 \textcolor{preprocessor}{\#ifndef DOXYGEN}}
\DoxyCodeLine{261 \textcolor{keyword}{template} <\textcolor{keyword}{class} T>}
\DoxyCodeLine{262 \textcolor{keyword}{struct }\mbox{\hyperlink{a01900}{Index}}<T, \mbox{\hyperlink{a00383}{std}}::tuple<>>}
\DoxyCodeLine{263 \{}
...
\DoxyCodeLine{268 \textcolor{keyword}{struct }\mbox{\hyperlink{a01900}{Index}}<T, \mbox{\hyperlink{a00383}{std}}::tuple<T, Types...>>}
\DoxyCodeLine{269 \{}
...
\DoxyCodeLine{298 \textcolor{keyword}{struct }\mbox{\hyperlink{a01904}{Rebind}};}
\DoxyCodeLine{299 }
...
\DoxyCodeLine{305 \textcolor{keyword}{struct }\mbox{\hyperlink{a01904}{Rebind}}<Container<OldType, Args...>, NewType>}
\DoxyCodeLine{306 \{}
...
\DoxyCodeLine{314 \textcolor{keyword}{struct }\mbox{\hyperlink{a01904}{Rebind}}<Container<OldType, N>, NewType>}
\DoxyCodeLine{315 \{}
...
\DoxyCodeLine{331 \textcolor{keyword}{struct }\mbox{\hyperlink{a01908}{FunctionTraits}};}
\DoxyCodeLine{332 }
...
\DoxyCodeLine{338 \textcolor{keyword}{struct }\mbox{\hyperlink{a01908}{FunctionTraits}}<R (*)(Args...)>}
\DoxyCodeLine{339 \{}
...
\DoxyCodeLine{352 \textcolor{keyword}{struct }\mbox{\hyperlink{a01908}{FunctionTraits}}<R (C::*)(Args...) const>}
\DoxyCodeLine{353 \{}
...
\DoxyCodeLine{394 \textcolor{keyword}{struct }\mbox{\hyperlink{a01912}{ReplaceTypeAtPos}};}
\DoxyCodeLine{395 }
...
\DoxyCodeLine{398 \textcolor{keyword}{struct }\mbox{\hyperlink{a01912}{ReplaceTypeAtPos}}<\mbox{\hyperlink{a00383}{std}}::tuple<Args...>, Pos, NewType>}
\DoxyCodeLine{399 \{}
...
\DoxyCodeLine{417 \textcolor{keyword}{using }\mbox{\hyperlink{a00407_ac903f76dfaaaf40abfe1c532850db3d1}{ReplaceTypeAtPos\_t}} = \textcolor{keyword}{typename} \mbox{\hyperlink{a01912}{ReplaceTypeAtPos<Tuple, Pos, NewType>::type}};}
\DoxyCodeLine{418 }
\DoxyCodeLine{425 \textcolor{keyword}{template} <\textcolor{keyword}{typename} R, \textcolor{keyword}{typename} Tuple>}
\DoxyCodeLine{426 \textcolor{keyword}{struct }\mbox{\hyperlink{a01916}{TupleToFunctionType}};}
\DoxyCodeLine{427 }
...
\DoxyCodeLine{430 \textcolor{keyword}{struct }\mbox{\hyperlink{a01916}{TupleToFunctionType}}<R, \mbox{\hyperlink{a00383}{std}}::tuple<Args...>>}
\DoxyCodeLine{431 \{}
...
\DoxyCodeLine{443 \textcolor{keyword}{using }\mbox{\hyperlink{a00407_a6b604914727df9d1b05be9a64c56898c}{TupleToFunctionType\_t}} = \textcolor{keyword}{typename} \mbox{\hyperlink{a01916}{TupleToFunctionType<R, Tuple>::type}};}
\DoxyCodeLine{444 }
...
\DoxyCodeLine{453 \textcolor{keyword}{struct }\mbox{\hyperlink{a01920}{ChangeArgTypeAtPos}};}
\DoxyCodeLine{454 }
...
\DoxyCodeLine{457 \textcolor{keyword}{struct }\mbox{\hyperlink{a01920}{ChangeArgTypeAtPos}}<\mbox{\hyperlink{a00383}{std}}::function<R(Args...)>, Pos, NewType>}
\DoxyCodeLine{458 \{}
\DoxyCodeLine{459   \textcolor{keyword}{using }OriginalFunction = std::function<R(Args...)>;}
\DoxyCodeLine{460   \textcolor{keyword}{using }Traits           = \mbox{\hyperlink{a01908}{FunctionTraits<OriginalFunction>}};}
