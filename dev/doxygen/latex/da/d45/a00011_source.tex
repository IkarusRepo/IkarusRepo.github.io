...
\DoxyCodeLine{114   \textcolor{keyword}{auto} \mbox{\hyperlink{a00298_ac00abda505aa8ccc73ce59afd165ce49}{parameter}}(Args\&\&... args) \{}
...
\DoxyCodeLine{126   \textcolor{keyword}{auto} \mbox{\hyperlink{a00298_ab787b670f0d338c870988f417cf85f76}{functions}}(Args\&\&... args) \{}
...
\DoxyCodeLine{140   \textcolor{keyword}{auto} \mbox{\hyperlink{a00298_ac4a51a33b91a6e959c61fb4a71cef19c}{initResults}}(\textcolor{keyword}{const} Impl::Functions<DerivativeArgs...>\& derivativesFunctions,}
...
\DoxyCodeLine{154   \textcolor{keyword}{class }\mbox{\hyperlink{a01513}{NonLinearOperator}} \{}
\DoxyCodeLine{155   \textcolor{keyword}{public}:}
\DoxyCodeLine{156     \mbox{\hyperlink{a01513_a2308f86b14266d7b7049b0a12cf20cdc}{NonLinearOperator}}([[maybe\_unused]] \textcolor{keyword}{const} TypeListOne\& derivativesFunctions,}
...
\DoxyCodeLine{174         = std::tuple<\mbox{\hyperlink{a00296_ga0ba1bf25ee478b1b1d9e96c1dcd831a0}{Ikarus::traits::ReturnType}}<DerivativeArgs, ParameterArgs\&...>...>;  }
...
\DoxyCodeLine{197 }
\DoxyCodeLine{204     \textcolor{keyword}{explicit} \mbox{\hyperlink{a01513_a2308f86b14266d7b7049b0a12cf20cdc}{NonLinearOperator}}(\textcolor{keyword}{const} Impl::Functions<DerivativeArgs...>\& derivativesFunctions,}
...
\DoxyCodeLine{208           derivativesEvaluated\_(\mbox{\hyperlink{a00298_ac4a51a33b91a6e959c61fb4a71cef19c}{initResults}}(derivativesFunctions, parameterI)) \{\}}
\DoxyCodeLine{209 }
...
\DoxyCodeLine{310       \textcolor{keywordflow}{return} \mbox{\hyperlink{a01513}{Ikarus::NonLinearOperator}}(\mbox{\hyperlink{a00298_ab787b670f0d338c870988f417cf85f76}{functions}}(std::get<Derivatives>(derivatives\_)...),}
...
\DoxyCodeLine{316         std::is\_reference\_v<\mbox{\hyperlink{a00296_ga0ba1bf25ee478b1b1d9e96c1dcd831a0}{Ikarus::traits::ReturnType}}<DerivativeArgs, ParameterArgs\&...>>,}
\DoxyCodeLine{317         std::reference\_wrapper<std::remove\_reference\_t<\mbox{\hyperlink{a00296_ga0ba1bf25ee478b1b1d9e96c1dcd831a0}{Ikarus::traits::ReturnType}}<DerivativeArgs, ParameterArgs\&...>>>,}
\DoxyCodeLine{318         std::remove\_cvref\_t<\mbox{\hyperlink{a00296_ga0ba1bf25ee478b1b1d9e96c1dcd831a0}{Ikarus::traits::ReturnType}}<DerivativeArgs, ParameterArgs\&...>>>...>;}
