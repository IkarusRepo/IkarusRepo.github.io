\hypertarget{a02512_source}{}\doxysection{utils/dirichletvalues.hh}
\label{a02512_source}\index{dirichletvalues.hh@{dirichletvalues.hh}}
...
\DoxyCodeLine{27 }
\DoxyCodeLine{28 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00345}{Dune}} \{}
\DoxyCodeLine{29 \textcolor{keyword}{template} <\textcolor{keyword}{class} K, \textcolor{keywordtype}{int} N>}
\DoxyCodeLine{30 \textcolor{keyword}{class }\mbox{\hyperlink{a01520}{FieldVector}};}
\DoxyCodeLine{31 \}}
\DoxyCodeLine{32 }
...
\DoxyCodeLine{46 \textcolor{keyword}{class }\mbox{\hyperlink{a01524}{DirichletValues}}}
\DoxyCodeLine{47 \{}
\DoxyCodeLine{48 \textcolor{keyword}{public}:}
\DoxyCodeLine{49   \textcolor{keyword}{using }\mbox{\hyperlink{a01524_a2e6f1ef4a810a7269303f54a6f74539f}{Basis}}                         = std::remove\_cvref\_t<B>;}
\DoxyCodeLine{50   \textcolor{keyword}{using }\mbox{\hyperlink{a01524_aa71c2b94b37f2b4e83f9f1e059e6fe4c}{FlagsType}}                     = FC;}
\DoxyCodeLine{51   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01524_a79e90730d4ac67efb5e38590c0429df5}{worldDimension}} = Basis::GridView::dimensionworld;}
\DoxyCodeLine{52   \textcolor{keyword}{using }\mbox{\hyperlink{a01524_a3db820fbcd2b7edf58ce3b21b261f621}{BackendType}}                   = \textcolor{keyword}{decltype}(Dune::Functions::istlVectorBackend(std::declval<FlagsType\&>()));}
\DoxyCodeLine{53   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01524_aeb81ceb2617369a584dd12f4574ab1dc}{DirichletValues}}(\textcolor{keyword}{const} B\& \mbox{\hyperlink{a01524_ae783c95d2e4b55d9d37f4c141b1d719b}{basis}})}
\DoxyCodeLine{54       : basis\_\{\mbox{\hyperlink{a01524_ae783c95d2e4b55d9d37f4c141b1d719b}{basis}}\},}
...
\DoxyCodeLine{70   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01524_a57486778cd8e2e42be337b5d1ff0d564}{fixBoundaryDOFs}}(F\&\& f) \{}
\DoxyCodeLine{71     \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (\mbox{\hyperlink{a01671}{Concepts::IsFunctorWithArgs<F, BackendType, typename Basis::MultiIndex>}}) \{}
...
\DoxyCodeLine{74     \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (\mbox{\hyperlink{a01671}{Concepts::IsFunctorWithArgs<F, BackendType, int, typename Basis::LocalView>}}) \{}
...
\DoxyCodeLine{77     \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (\mbox{\hyperlink{a01671}{Concepts::IsFunctorWithArgs}}<F, \mbox{\hyperlink{a01524_a3db820fbcd2b7edf58ce3b21b261f621}{BackendType}}, int, \textcolor{keyword}{typename} Basis::LocalView,}
...
\DoxyCodeLine{95   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01524_a956ce2cdc09731f001821c7b59d49e85}{fixDOFs}}(F\&\& f) \{}
\DoxyCodeLine{96     f(basis\_, dirichletFlagsBackend\_);}
\DoxyCodeLine{97   \}}
\DoxyCodeLine{98 }
\DoxyCodeLine{104   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01524_a3ccd03313f8c6837b077e14ac9f50d16}{fixIthDOF}}(\textcolor{keyword}{typename} Basis::MultiIndex i) \{ dirichletFlagsBackend\_[i] = \textcolor{keyword}{true}; \}}
\DoxyCodeLine{105 }
\DoxyCodeLine{106   \textcolor{comment}{/* \(\backslash\)brief Returns the local basis object */}}
\DoxyCodeLine{107   \textcolor{keyword}{const} \textcolor{keyword}{auto}\& \mbox{\hyperlink{a01524_ae783c95d2e4b55d9d37f4c141b1d719b}{basis}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} basis\_; \}}
\DoxyCodeLine{108 }
...
\DoxyCodeLine{112   [[nodiscard]] \textcolor{keywordtype}{bool} \mbox{\hyperlink{a01524_a1b1fccdb71619c0a49aa24977682d43a}{isConstrained}}(\textcolor{keyword}{const} MultiIndex\& multiIndex) \textcolor{keyword}{const} \{}
...
\DoxyCodeLine{117   [[nodiscard]] \textcolor{keywordtype}{bool} \mbox{\hyperlink{a01524_a7c30706789441e0dce7a7c3f80cb6d2e}{isConstrained}}(std::size\_t i)\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} dirichletFlags\_[i]; \}}
\DoxyCodeLine{118 }
\DoxyCodeLine{119   \textcolor{comment}{/* \(\backslash\)brief Returns how many degrees of freedoms are fixed */}}
\DoxyCodeLine{120   \textcolor{keyword}{auto} \mbox{\hyperlink{a01524_aeb299b04b2777be56012b32a3b2e6a9c}{fixedDOFsize}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} std::ranges::count(dirichletFlags\_, \textcolor{keyword}{true}); \}}
\DoxyCodeLine{121 }
\DoxyCodeLine{122   \textcolor{comment}{/* \(\backslash\)brief Returns how many degrees of freedom there are */}}
\DoxyCodeLine{123   \textcolor{keyword}{auto} \mbox{\hyperlink{a01524_a010fa7b0721c137eb61221493e52dc92}{size}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} dirichletFlags\_.size(); \}}
\DoxyCodeLine{124 }
\DoxyCodeLine{125   \textcolor{comment}{/* \(\backslash\)brief Returns the underlying dof flag container */}}
\DoxyCodeLine{126   \textcolor{keyword}{auto}\& \mbox{\hyperlink{a01524_af8495b65eac223b7b6c64f07b31cc814}{container}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} dirichletFlags\_; \}}
\DoxyCodeLine{127 }
\DoxyCodeLine{137   \textcolor{keyword}{template} <\textcolor{keyword}{typename} F>}
\DoxyCodeLine{138   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01524_abc3413114cb9272944e1b44606c6a0a1}{storeInhomogeneousBoundaryCondition}}(F\&\& f) \{}
...
\DoxyCodeLine{145   \}}
\DoxyCodeLine{146 }
\DoxyCodeLine{156   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01524_ac3950f8821f8e8c1f2a8b8f8a7e86875}{evaluateInhomogeneousBoundaryCondition}}(Eigen::VectorXd\& xIh, \textcolor{keyword}{const} \textcolor{keywordtype}{double}\& lambda) \{}
...
\DoxyCodeLine{166   \}}
\DoxyCodeLine{167 }
\DoxyCodeLine{177   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01524_a5d7fdc80dfd3ebdcb58f0770844f71da}{evaluateInhomogeneousBoundaryConditionDerivative}}(Eigen::VectorXd\& xIh, \textcolor{keyword}{const} \textcolor{keywordtype}{double}\& lambda) \{}
...
\DoxyCodeLine{191   \mbox{\hyperlink{a01524_a2e6f1ef4a810a7269303f54a6f74539f}{Basis}} basis\_;}
\DoxyCodeLine{192   \mbox{\hyperlink{a01524_aa71c2b94b37f2b4e83f9f1e059e6fe4c}{FlagsType}} dirichletFlags\_;}
\DoxyCodeLine{193   \mbox{\hyperlink{a01524_a3db820fbcd2b7edf58ce3b21b261f621}{BackendType}} dirichletFlagsBackend\_;}
...
\DoxyCodeLine{197         \textcolor{keyword}{const} \mbox{\hyperlink{a01520}{Dune::FieldVector<double, worldDimension>}}\&, \textcolor{keyword}{const} \textcolor{keywordtype}{double}\&)>;}
