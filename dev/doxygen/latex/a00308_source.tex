\hypertarget{a00308_source}{}\doxysection{resultfunction.\+hh}
\label{a00308_source}\index{resultfunction.hh@{resultfunction.hh}}
...
\DoxyCodeLine{33     \textcolor{keywordtype}{double} operator()(\textcolor{keyword}{const} R\& resultArray, \textcolor{keyword}{const} \mbox{\hyperlink{a01784}{Dune::FieldVector<double, dim>}}\& pos, \textcolor{keyword}{const} FiniteElement\& fe,}
...
\DoxyCodeLine{62 \textcolor{keyword}{class} \mbox{\hyperlink{a01616}{ResultFunction}} : \textcolor{keyword}{public} Dune::VTKFunction<typename AS::GridView>}
\DoxyCodeLine{63 \{}
\DoxyCodeLine{64 \textcolor{keyword}{public}:}
\DoxyCodeLine{65   \textcolor{keyword}{using }\mbox{\hyperlink{a01616_ab7712895c055876ce68b119ee5be512b}{Assembler}}         = AS;}
\DoxyCodeLine{66   \textcolor{keyword}{using }\mbox{\hyperlink{a01616_ae02316521c3591dee26cf26d3cc1aafe}{GridView}}          = \textcolor{keyword}{typename} Assembler::GridView;}
\DoxyCodeLine{67   \textcolor{keyword}{using }\mbox{\hyperlink{a01616_a04e04c52ed60c19be684faa4767ed795}{FERequirementType}} = \textcolor{keyword}{typename} Assembler::FERequirement;}
\DoxyCodeLine{68   \textcolor{keyword}{using }\mbox{\hyperlink{a01616_a593fc23022f4622064a1659c0805a44f}{FEContainer}}       = \textcolor{keyword}{typename} Assembler::FEContainer;}
\DoxyCodeLine{69   \textcolor{keyword}{using }\mbox{\hyperlink{a01616_a8c19ba544b970530a3d2421eef882c72}{FiniteElement}}     = \textcolor{keyword}{typename} std::remove\_cvref\_t<FEContainer>::value\_type;}
\DoxyCodeLine{70 }
\DoxyCodeLine{71   \textcolor{keyword}{using }\mbox{\hyperlink{a01616_a916f6362e75f7b8f9f8e9b5acd7fb3ae}{ctype}}                  = \textcolor{keyword}{typename} GridView::ctype;}
\DoxyCodeLine{72   \textcolor{keyword}{constexpr} \textcolor{keyword}{static} \textcolor{keywordtype}{int} griddim = GridView::dimension;}
\DoxyCodeLine{73   \textcolor{keyword}{using }\mbox{\hyperlink{a01616_a6da0b532274ad8ed0c79e7012fbf81fd}{Entity}}                 = \textcolor{keyword}{typename} GridView::template Codim<0>::Entity;}
\DoxyCodeLine{74 }
\DoxyCodeLine{85   \textcolor{keywordtype}{double} \mbox{\hyperlink{a01616_add24f14249cce07c37dd92e3f81cf50c}{evaluate}}(\textcolor{keywordtype}{int} comp, \textcolor{keyword}{const} \mbox{\hyperlink{a01616_a6da0b532274ad8ed0c79e7012fbf81fd}{Entity}}\& e, \textcolor{keyword}{const} \mbox{\hyperlink{a01784}{Dune::FieldVector<ctype, griddim>}}\& local)\textcolor{keyword}{ const override }\{}
...
\DoxyCodeLine{88   \}}
\DoxyCodeLine{89 }
\DoxyCodeLine{97   [[nodiscard]] \textcolor{keywordtype}{int} \mbox{\hyperlink{a01616_a29d17ce2c3a99be49e322d527b42748a}{ncomps}}()\textcolor{keyword}{ const override }\{}
\DoxyCodeLine{98     \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (std::is\_same\_v<UserFunction, Impl::DefaultUserFunction>) \{}
\DoxyCodeLine{99       \mbox{\hyperlink{a01784}{Dune::FieldVector<ctype, griddim>}} val(0.0);}
...
\DoxyCodeLine{104   \}}
\DoxyCodeLine{105 }
\DoxyCodeLine{113   [[nodiscard]] \textcolor{keyword}{constexpr} std::string \mbox{\hyperlink{a01616_aaefbf5aea92c097023ed3d628a25f2cf}{name}}()\textcolor{keyword}{ const override }\{}
...
\DoxyCodeLine{118   \}}
\DoxyCodeLine{119 }
\DoxyCodeLine{128   Dune::VTK::Precision \mbox{\hyperlink{a01616_aa2ce1b66145ac6962be8189061f42d45}{precision}}()\textcolor{keyword}{ const override }\{ \textcolor{keywordflow}{return} prec\_; \}}
\DoxyCodeLine{129 }
\DoxyCodeLine{140   \textcolor{keyword}{template} <\textcolor{keyword}{typename} UF = UserFunction>}
\DoxyCodeLine{141   \mbox{\hyperlink{a01616_aa37e3d1ee3abfa48ae5bfd300a01c09b}{ResultFunction}}(std::shared\_ptr<Assembler> assembler, Dune::VTK::Precision prec = Dune::VTK::Precision::float64,}
...
\DoxyCodeLine{148   \textcolor{keywordtype}{double} evaluateComponent(\textcolor{keywordtype}{int} eleID, \textcolor{keyword}{const} \mbox{\hyperlink{a01784}{Dune::FieldVector<ctype, griddim>}}\& local, \textcolor{keywordtype}{int} comp)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{180 \textcolor{keyword}{auto} \mbox{\hyperlink{a00384_aba0432efad1cef6c956ccf108829682c}{makeResultFunction}}(std::shared\_ptr<AS> assembler, Dune::VTK::Precision prec = Dune::VTK::Precision::float64,}
...
\DoxyCodeLine{197 \textcolor{keyword}{auto} \mbox{\hyperlink{a00384_aba0432efad1cef6c956ccf108829682c}{makeResultFunction}}(std::shared\_ptr<AS> assembler, UserFunction\&\& userFunction) \{}
...
\DoxyCodeLine{219 \textcolor{keyword}{auto} \mbox{\hyperlink{a00384_ad8472943b9877db27039331c847154f1}{makeResultVtkFunction}}(std::shared\_ptr<AS> assembler, UserFunction\&\& userFunction = \{\}) \{}
