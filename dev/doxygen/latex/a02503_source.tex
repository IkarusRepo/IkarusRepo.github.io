\hypertarget{a02503_source}{}\doxysection{python/dirichletvalues/dirichletvalues.hh}
\label{a02503_source}\index{dirichletvalues.hh@{dirichletvalues.hh}}
...
\DoxyCodeLine{51 }
\DoxyCodeLine{52   \textcolor{keyword}{using }\mbox{\hyperlink{a01466}{Basis}}        = \textcolor{keyword}{typename} \mbox{\hyperlink{a01502_a90174bec95fb08a186f29d1d98e350dc}{DirichletValues::Basis}};}
\DoxyCodeLine{53   \textcolor{keyword}{using }BackendType  = \textcolor{keyword}{typename} \mbox{\hyperlink{a01502_a4b708d1ae34c1f28389273f209ea79f7}{DirichletValues::BackendType}};}
\DoxyCodeLine{54   \textcolor{keyword}{using }FlagsType    = \textcolor{keyword}{typename} \mbox{\hyperlink{a01502_a824bc5693b4b784c8ec9c65aad07da92}{DirichletValues::FlagsType}};}
...
\DoxyCodeLine{66 }
\DoxyCodeLine{67   cls.def(\mbox{\hyperlink{a00325_ac8243891c1b961e50a066140ab79a142}{pybind11::init}}([](\textcolor{keyword}{const} \mbox{\hyperlink{a01466}{Basis}}\& \mbox{\hyperlink{a00345_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}) \{ \textcolor{keywordflow}{return} \textcolor{keyword}{new} \mbox{\hyperlink{a01502}{DirichletValues}}(\mbox{\hyperlink{a00345_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}); \}), pybind11::keep\_alive<1, 2>());}
\DoxyCodeLine{68 }
...
\DoxyCodeLine{71           [](\mbox{\hyperlink{a01502}{DirichletValues}}\& self, \textcolor{keyword}{const} std::function<\textcolor{keywordtype}{void}(Eigen::Ref<Eigen::VectorX<bool>>, \textcolor{keywordtype}{int})>\& f) \{}
...
\DoxyCodeLine{75             \};}
\DoxyCodeLine{76             self.\mbox{\hyperlink{a01502_a7de80e6ad56431b46750ddbc2580c45e}{fixBoundaryDOFs}}(lambda);}
\DoxyCodeLine{77           \});}
\DoxyCodeLine{78 }
\DoxyCodeLine{79   cls.def(\textcolor{stringliteral}{"{}fixBoundaryDOFsUsingLocalView"{}},}
\DoxyCodeLine{80           [](\mbox{\hyperlink{a01502}{DirichletValues}}\& self,}
...
\DoxyCodeLine{89             \};}
\DoxyCodeLine{90             self.\mbox{\hyperlink{a01502_a7de80e6ad56431b46750ddbc2580c45e}{fixBoundaryDOFs}}(lambda);}
\DoxyCodeLine{91           \});}
\DoxyCodeLine{92 }
\DoxyCodeLine{93   cls.def(}
\DoxyCodeLine{94       \textcolor{stringliteral}{"{}fixBoundaryDOFsUsingLocalViewAndIntersection"{}},}
\DoxyCodeLine{95       [](\mbox{\hyperlink{a01502}{DirichletValues}}\& self,}
...
\DoxyCodeLine{104         \};}
\DoxyCodeLine{105         self.\mbox{\hyperlink{a01502_a7de80e6ad56431b46750ddbc2580c45e}{fixBoundaryDOFs}}(lambda);}
\DoxyCodeLine{106       \});}
\DoxyCodeLine{107 }
\DoxyCodeLine{108   cls.def(\textcolor{stringliteral}{"{}fixDOFs"{}},}
\DoxyCodeLine{109           [](\mbox{\hyperlink{a01502}{DirichletValues}}\& self, \textcolor{keyword}{const} std::function<\textcolor{keywordtype}{void}(Eigen::Ref<Eigen::VectorX<bool>>, \textcolor{keyword}{const} \mbox{\hyperlink{a01466}{Basis}}\&)>\& f) \{}
\DoxyCodeLine{110             self.\mbox{\hyperlink{a01502_a7de80e6ad56431b46750ddbc2580c45e}{fixBoundaryDOFs}}(f);}
\DoxyCodeLine{111           \});}
\DoxyCodeLine{112 \}}
\DoxyCodeLine{113 }
