...
\DoxyCodeLine{32 Eigen::Tensor<typename Derived::Scalar, rank> \mbox{\hyperlink{a00392_ga5cfd9d098384fb067d897b3c0499b447}{tensorView}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01831}{Eigen::EigenBase<Derived>}}\& matrix,}
...
\DoxyCodeLine{37 \}}
\DoxyCodeLine{38 }
\DoxyCodeLine{47 \textcolor{keyword}{auto} \mbox{\hyperlink{a00392_gab2cea9ac847cc3635812467c9d96ceb4}{dyadic}}(\textcolor{keyword}{const} \textcolor{keyword}{auto}\& A\_ij, \textcolor{keyword}{const} \textcolor{keyword}{auto}\& B\_kl) \{}
...
\DoxyCodeLine{61 \textcolor{keyword}{auto} \mbox{\hyperlink{a00392_gab2cea9ac847cc3635812467c9d96ceb4}{dyadic}}(\textcolor{keyword}{const} Eigen::Vector<ST, size>\& a, \textcolor{keyword}{const} Eigen::Vector<ST, size>\& b) \{}
...
\DoxyCodeLine{73 \textcolor{keyword}{auto} \mbox{\hyperlink{a00392_ga1c9618ef351cd986d4f64fde7f52e860}{symmetricIdentityFourthOrder}}() \{}
...
\DoxyCodeLine{95 \textcolor{keyword}{auto} \mbox{\hyperlink{a00392_ga2368a572348c410fd7e7deb6c6e3964a}{symmetricFourthOrder}}(\textcolor{keyword}{const} \textcolor{keyword}{auto}\& A, \textcolor{keyword}{const} \textcolor{keyword}{auto}\& B) \{}
...
\DoxyCodeLine{114 \textcolor{keyword}{auto} \mbox{\hyperlink{a00392_gadb08b6f9cc40847b70286dc314a23000}{identityFourthOrder}}() \{}
...
\DoxyCodeLine{135 \textcolor{keyword}{auto} \mbox{\hyperlink{a00392_ga8fa2b440586483c1ee0f9b90b9081da2}{fourthOrderIKJL}}(\textcolor{keyword}{const} Eigen::MatrixBase<AType>\& A, \textcolor{keyword}{const} Eigen::MatrixBase<BType>\& B) \{}
...
\DoxyCodeLine{158 \textcolor{keyword}{auto} \mbox{\hyperlink{a00392_gaea03dbfcd8f85ef7af004c7e09244aa9}{symTwoSlots}}(\textcolor{keyword}{const} Eigen::TensorFixedSize<ScalarType, Eigen::Sizes<dim, dim, dim, dim>>\& t,}
...
\DoxyCodeLine{164 \}}
\DoxyCodeLine{165 }
\DoxyCodeLine{179 \textcolor{keyword}{constexpr} Eigen::Index \mbox{\hyperlink{a00392_ga4304655095296ce9283e012587817a51}{toVoigt}}(Eigen::Index i, Eigen::Index j) \textcolor{keyword}{noexcept} \{}
...
\DoxyCodeLine{207 Eigen::Matrix<ScalarType, 6, 6> \mbox{\hyperlink{a00392_ga4304655095296ce9283e012587817a51}{toVoigt}}(\textcolor{keyword}{const} Eigen::TensorFixedSize<ScalarType, Eigen::Sizes<3, 3, 3, 3>>\& ft) \{}
...
\DoxyCodeLine{213           mat(\mbox{\hyperlink{a00392_ga4304655095296ce9283e012587817a51}{toVoigt}}(i, j), \mbox{\hyperlink{a00392_ga4304655095296ce9283e012587817a51}{toVoigt}}(k, l)) = ft(i, j, k, l);}
...
\DoxyCodeLine{238 \textcolor{keyword}{auto} \mbox{\hyperlink{a00392_ga4304655095296ce9283e012587817a51}{toVoigt}}(\textcolor{keyword}{const} Eigen::Matrix<ST, size, size, Options, maxSize, maxSize>\& E, \textcolor{keywordtype}{bool} isStrain = \textcolor{keyword}{true}) \{}
...
\DoxyCodeLine{283          ((maxSize == 1 or maxSize == 3 or maxSize == 6) and size == \mbox{\hyperlink{a00412}{Eigen}}::Dynamic))}
\DoxyCodeLine{284 auto \mbox{\hyperlink{a00392_gadc8e9e9f3838d0392a5fcf1e11374ee9}{fromVoigt}}(const \mbox{\hyperlink{a00412}{Eigen}}::Matrix<ST, size, 1, Options, maxSize, 1>\& EVoigt, \textcolor{keywordtype}{bool} isStrain = true) \{}
...
\DoxyCodeLine{290       isFixedSized ? (-\/1 + \mbox{\hyperlink{a00396_ae55d4d0c3478ab3ecf54ce905ddf223b}{ct\_sqrt}}(1 + 8 * size)) / 2 : (-\/1 + \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{int}\textcolor{keyword}{>}(std::sqrt(1 + 8 * inputSize))) / 2;}
\DoxyCodeLine{291 }
...
\DoxyCodeLine{314 \}}
\DoxyCodeLine{315 }
\DoxyCodeLine{329 \textcolor{keyword}{constexpr} std::array<size\_t, 2> \mbox{\hyperlink{a00392_gadc8e9e9f3838d0392a5fcf1e11374ee9}{fromVoigt}}(\textcolor{keywordtype}{size\_t} i) \{}
...
\DoxyCodeLine{356 \textcolor{keyword}{auto} \mbox{\hyperlink{a00392_gadc8e9e9f3838d0392a5fcf1e11374ee9}{fromVoigt}}(\textcolor{keyword}{const} Eigen::Matrix<ScalarType, 6, 6>\& CVoigt) \{}
...
\DoxyCodeLine{361       \textcolor{keyword}{auto} firstIndices                                                       = \mbox{\hyperlink{a00392_gadc8e9e9f3838d0392a5fcf1e11374ee9}{fromVoigt}}(i);}
\DoxyCodeLine{362       \textcolor{keyword}{auto} secondIndices                                                      = \mbox{\hyperlink{a00392_gadc8e9e9f3838d0392a5fcf1e11374ee9}{fromVoigt}}(j);}
...
\DoxyCodeLine{380 Eigen::Matrix3d \mbox{\hyperlink{a00396_a7a5b9f5e83f6918ca1726fb4316c3b86}{calcTransformationMatrix2D}}(\textcolor{keyword}{const} Geometry\& geometry) \{}
...
\DoxyCodeLine{413 Eigen::Matrix<double, 6, 6> \mbox{\hyperlink{a00396_a95234ab8588ced83708c6e5a30e2368e}{calcTransformationMatrix3D}}(\textcolor{keyword}{const} Geometry\& geometry) \{}
