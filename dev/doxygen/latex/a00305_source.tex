\hypertarget{a00305_source}{}\doxysection{autodifffe.\+hh}
\label{a00305_source}\index{autodifffe.hh@{autodifffe.hh}}
...
\DoxyCodeLine{27 \textcolor{keyword}{class }\mbox{\hyperlink{a01351}{AutoDiffFE}} : \textcolor{keyword}{public} FEImpl}
\DoxyCodeLine{28 \{}
\DoxyCodeLine{29 \textcolor{keyword}{public}:}
\DoxyCodeLine{30   \textcolor{keyword}{using }\mbox{\hyperlink{a01351_ac6509944238101aef666b1614df1d443}{RealFE}}       = FEImpl;                        }
\DoxyCodeLine{31   \textcolor{keyword}{using }\mbox{\hyperlink{a01351_ace1636b5cd13f380d0865682480e81b2}{BasisHandler}} = \textcolor{keyword}{typename} RealFE::BasisHandler; }
\DoxyCodeLine{32   \textcolor{keyword}{using }\mbox{\hyperlink{a01351_a4e63c92eb684ddda330b4cd3cb5b769e}{Traits}}       = \textcolor{keyword}{typename} RealFE::Traits;       }
\DoxyCodeLine{33   \textcolor{keyword}{using }\mbox{\hyperlink{a01351_ae985fb2fdb86d514700c4d57f03e97d5}{LocalView}}    = \textcolor{keyword}{typename} Traits::LocalView;    }
\DoxyCodeLine{34   \textcolor{keyword}{using }\mbox{\hyperlink{a01351_af1d3fa6b651ee728bd39a33c3c3da250}{Element}}      = \textcolor{keyword}{typename} Traits::Element;      }
\DoxyCodeLine{35   \textcolor{keyword}{using }\mbox{\hyperlink{a01351_afa810836d72e1475c93b3b5a7122b540}{Requirement}}  = \textcolor{keyword}{typename} RealFE::Requirement;  }
...
\DoxyCodeLine{48   \textcolor{keyword}{friend} \textcolor{keywordtype}{void} \mbox{\hyperlink{a01351_ab362ff410a785df25fea3442f897932e}{calculateMatrix}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01351}{AutoDiffFE}}\& self, \textcolor{keyword}{const} \mbox{\hyperlink{a01351_afa810836d72e1475c93b3b5a7122b540}{Requirement}}\& par, \textcolor{keyword}{const} \mbox{\hyperlink{a00396_a390d5311179ec61d163a29c943b3d1a0}{MatrixAffordance}}\& affordance,}
\DoxyCodeLine{49                               \textcolor{keyword}{typename} Traits::template MatrixType<> h) \{}
\DoxyCodeLine{50     self.\mbox{\hyperlink{a01351_ab362ff410a785df25fea3442f897932e}{calculateMatrix}}(par, affordance, h);}
\DoxyCodeLine{51   \}}
\DoxyCodeLine{52 }
\DoxyCodeLine{61   \textcolor{keyword}{friend} \textcolor{keywordtype}{void} \mbox{\hyperlink{a01351_a66f3c9c144a7eccbe60b1b9e494b5cd5}{calculateVector}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01351}{AutoDiffFE}}\& self, \textcolor{keyword}{const} \mbox{\hyperlink{a01351_afa810836d72e1475c93b3b5a7122b540}{Requirement}}\& par, \mbox{\hyperlink{a00396_aab9e3e38507d1db7602bc750718c302a}{VectorAffordance}} affordance,}
\DoxyCodeLine{62                               \textcolor{keyword}{typename} Traits::template VectorType<double> g) \{}
\DoxyCodeLine{63     self.\mbox{\hyperlink{a01351_a66f3c9c144a7eccbe60b1b9e494b5cd5}{calculateVector}}(par, affordance, g);}
\DoxyCodeLine{64   \}}
\DoxyCodeLine{65 }
\DoxyCodeLine{76   \textcolor{keyword}{friend} \textcolor{keywordtype}{void} \mbox{\hyperlink{a01351_ab515dd8db1ec299afff0c7884d1d7103}{calculateLocalSystem}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01351}{AutoDiffFE}}\& self, \textcolor{keyword}{const} \mbox{\hyperlink{a01351_afa810836d72e1475c93b3b5a7122b540}{Requirement}}\& par, \textcolor{keyword}{const} \mbox{\hyperlink{a00396_a390d5311179ec61d163a29c943b3d1a0}{MatrixAffordance}}\& affordanceM,}
\DoxyCodeLine{77                                    \mbox{\hyperlink{a00396_aab9e3e38507d1db7602bc750718c302a}{VectorAffordance}} affordanceV, \textcolor{keyword}{typename} Traits::template MatrixType<> h,}
\DoxyCodeLine{78                                    \textcolor{keyword}{typename} Traits::template VectorType<> g) \{}
\DoxyCodeLine{79     self.\mbox{\hyperlink{a01351_ab515dd8db1ec299afff0c7884d1d7103}{calculateLocalSystem}}(par, affordanceM, affordanceV, h, g);}
\DoxyCodeLine{80   \}}
\DoxyCodeLine{81 }
\DoxyCodeLine{90   \textcolor{keyword}{friend} \textcolor{keyword}{auto} \mbox{\hyperlink{a01351_a7c880870399ba4c1e4d62fafef04fda3}{calculateScalar}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01351}{AutoDiffFE}}\& self, \textcolor{keyword}{const} \mbox{\hyperlink{a01351_afa810836d72e1475c93b3b5a7122b540}{Requirement}}\& par, \mbox{\hyperlink{a00396_af6f894084edd9109762b86222995ef2a}{ScalarAffordance}} affordance) \{}
\DoxyCodeLine{91     \textcolor{keywordflow}{return} self.\mbox{\hyperlink{a01351_a7c880870399ba4c1e4d62fafef04fda3}{calculateScalar}}(par, affordance);}
\DoxyCodeLine{92   \}}
\DoxyCodeLine{93 }
\DoxyCodeLine{99   \textcolor{keyword}{const} \mbox{\hyperlink{a01351_ac6509944238101aef666b1614df1d443}{RealFE}}\& \mbox{\hyperlink{a01351_a8bd5af319955bc66a08c074858df2303}{realFE}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} *\textcolor{keyword}{this}; \}}
\DoxyCodeLine{100 }
\DoxyCodeLine{108   \textcolor{keyword}{template} <\textcolor{keyword}{typename}... Args>}
\DoxyCodeLine{109   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01351_a26248faa29dc3165140f3647f94c5d4a}{AutoDiffFE}}(Args\&\&... args)}
\DoxyCodeLine{110       : \mbox{\hyperlink{a01351_ac6509944238101aef666b1614df1d443}{RealFE}}\{\mbox{\hyperlink{a00395}{std}}::forward<Args>(args)...\} \{\}}
\DoxyCodeLine{111 }
\DoxyCodeLine{112 \textcolor{keyword}{private}:}
\DoxyCodeLine{113   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01351_ab362ff410a785df25fea3442f897932e}{calculateMatrix}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01351_afa810836d72e1475c93b3b5a7122b540}{Requirement}}\& req, \textcolor{keyword}{const} \mbox{\hyperlink{a00396_a390d5311179ec61d163a29c943b3d1a0}{MatrixAffordance}}\& affordance,}
...
\DoxyCodeLine{125                                    req, \mbox{\hyperlink{a00396_a2597fb8b5ba646668b01bcc4e5f75818}{vectorAffordance}}(affordance),}
...
\DoxyCodeLine{138         Mixin::template calculateVectorImpl<autodiff::dual>(req, \mbox{\hyperlink{a00396_a2597fb8b5ba646668b01bcc4e5f75818}{vectorAffordance}}(affordance), gref, x);}
...
\DoxyCodeLine{144                                .\textcolor{keyword}{template} calculateScalarImpl<autodiff::dual2nd>(req, \mbox{\hyperlink{a00396_a9f58a3849d4736e5cc314f6f995fe9e7}{scalarAffordance}}(affordance), v);}
\DoxyCodeLine{145                          \}) \{}
...
\DoxyCodeLine{152         \textcolor{keywordflow}{return} Mixin::template calculateScalarImpl<autodiff::dual2nd>(req, \mbox{\hyperlink{a00396_a9f58a3849d4736e5cc314f6f995fe9e7}{scalarAffordance}}(affordance), x);}
\DoxyCodeLine{153       \};}
...
\DoxyCodeLine{159   \}}
\DoxyCodeLine{160 }
\DoxyCodeLine{161   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01351_a66f3c9c144a7eccbe60b1b9e494b5cd5}{calculateVector}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01351_afa810836d72e1475c93b3b5a7122b540}{Requirement}}\& req, \mbox{\hyperlink{a00396_aab9e3e38507d1db7602bc750718c302a}{VectorAffordance}} affordance,}
...
\DoxyCodeLine{173                                .\textcolor{keyword}{template} calculateScalarImpl<autodiff::dual>(req, \mbox{\hyperlink{a00396_a9f58a3849d4736e5cc314f6f995fe9e7}{scalarAffordance}}(affordance),}
...
\DoxyCodeLine{182         \textcolor{keywordflow}{return} Mixin::template calculateScalarImpl<autodiff::dual>(req, \mbox{\hyperlink{a00396_a9f58a3849d4736e5cc314f6f995fe9e7}{scalarAffordance}}(affordance), x);}
\DoxyCodeLine{183       \};}
...
\DoxyCodeLine{189   \}}
\DoxyCodeLine{190 }
\DoxyCodeLine{191   [[nodiscard]] \textcolor{keywordtype}{double} \mbox{\hyperlink{a01351_a7c880870399ba4c1e4d62fafef04fda3}{calculateScalar}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01351_afa810836d72e1475c93b3b5a7122b540}{Requirement}}\& par, \mbox{\hyperlink{a00396_af6f894084edd9109762b86222995ef2a}{ScalarAffordance}} affordance)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{204   \}}
\DoxyCodeLine{205 }
\DoxyCodeLine{206   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01351_ab515dd8db1ec299afff0c7884d1d7103}{calculateLocalSystem}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01351_afa810836d72e1475c93b3b5a7122b540}{Requirement}}\& req, \textcolor{keyword}{const} \mbox{\hyperlink{a00396_a390d5311179ec61d163a29c943b3d1a0}{MatrixAffordance}}\& affordanceM, \mbox{\hyperlink{a00396_aab9e3e38507d1db7602bc750718c302a}{VectorAffordance}} affordanceV,}
...
\DoxyCodeLine{208     assert(\mbox{\hyperlink{a00396_a9f58a3849d4736e5cc314f6f995fe9e7}{scalarAffordance}}(affordanceM) == \mbox{\hyperlink{a00396_a9f58a3849d4736e5cc314f6f995fe9e7}{scalarAffordance}}(affordanceV));}
\DoxyCodeLine{209     Eigen::VectorXdual2nd dx(this-\/>localView().size());}
\DoxyCodeLine{210     dx.setZero();}
\DoxyCodeLine{211     \textcolor{keyword}{auto} f = [\&](\textcolor{keyword}{auto}\& x) \{ \textcolor{keywordflow}{return} Mixin::calculateScalarImpl(req, \mbox{\hyperlink{a00396_a9f58a3849d4736e5cc314f6f995fe9e7}{scalarAffordance}}(affordanceV), x); \};}
