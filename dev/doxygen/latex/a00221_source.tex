\hypertarget{a00221_source}{}\doxysection{membranestrains.\+hh}
\label{a00221_source}\index{membranestrains.hh@{membranestrains.hh}}
...
\DoxyCodeLine{31   \textcolor{keyword}{auto} \mbox{\hyperlink{a01328_acfe8c5424970d44c34005e13e851494a}{value}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01364}{Dune::FieldVector<double, 2>}}\& gpPos, \textcolor{keyword}{const} Geometry\& geo, \textcolor{keyword}{const} \textcolor{keyword}{auto}\& uFunction) \textcolor{keyword}{const}}
...
\DoxyCodeLine{65   \textcolor{keyword}{auto} \mbox{\hyperlink{a01328_a1c17239105e26dfdc369583624d8a200}{derivative}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01364}{Dune::FieldVector<double, 2>}}\& gpPos, \textcolor{keyword}{const} Eigen::Matrix<ScalarType, 2, 3>\& jcur,}
...
\DoxyCodeLine{96   \textcolor{keyword}{auto} \mbox{\hyperlink{a01328_a95cb97998e73fcf05fb7d9df0249b2e9}{secondDerivative}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01364}{Dune::FieldVector<double, 2>}}\& gpPos, \textcolor{keyword}{const} \textcolor{keyword}{auto}\& dNAtGp, \textcolor{keyword}{const} Geometry\& geo,}
