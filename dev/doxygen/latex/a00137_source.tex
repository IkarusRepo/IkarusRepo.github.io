...
\DoxyCodeLine{26 }
\DoxyCodeLine{30 \textcolor{keyword}{struct }\mbox{\hyperlink{a01412}{EnhancedAssumedStrainsPre}}}
\DoxyCodeLine{31 \{}
\DoxyCodeLine{32   \textcolor{keywordtype}{int} \mbox{\hyperlink{a01412_a4c30fabbf2fb4739dabcf7caa3855936}{numberOfParameters}}\{\};}
\DoxyCodeLine{33 }
\DoxyCodeLine{34   \textcolor{keyword}{template} <\textcolor{keyword}{typename} PreFE, \textcolor{keyword}{typename} FE>}
\DoxyCodeLine{35   \textcolor{keyword}{using }\mbox{\hyperlink{a01408}{Skill}} = \mbox{\hyperlink{a01408}{EnhancedAssumedStrains<PreFE, FE>}};}
\DoxyCodeLine{36 \};}
\DoxyCodeLine{37 }
\DoxyCodeLine{48 \textcolor{keyword}{template} <\textcolor{keyword}{typename} PreFE, \textcolor{keyword}{typename} FE>}
\DoxyCodeLine{49 \textcolor{keyword}{class }\mbox{\hyperlink{a01408}{EnhancedAssumedStrains}}}
\DoxyCodeLine{50 \{}
...
\DoxyCodeLine{55   \textcolor{keyword}{using }\mbox{\hyperlink{a01408_a5e8657da9cafc0eb0744abc6d78f40ee}{LocalView}} = \textcolor{keyword}{typename} \mbox{\hyperlink{a01372_a06bdad066f621e46875af45a22677a3c}{Traits::LocalView}};}
\DoxyCodeLine{56   \textcolor{keyword}{using }\mbox{\hyperlink{a01408_af9a84ff5a51d180ed10a0eaae73d59d4}{Geometry}}  = \textcolor{keyword}{typename} \mbox{\hyperlink{a01372_a0b7be1104fba2d190e3fed46f291a851}{Traits::Geometry}};}
\DoxyCodeLine{57   \textcolor{keyword}{using }\mbox{\hyperlink{a01408_a3ffd06f997ccccf1b5d2625372760279}{GridView}}  = \textcolor{keyword}{typename} \mbox{\hyperlink{a01372_a3ec0294824df467074f5070cb58f5a91}{Traits::GridView}};}
\DoxyCodeLine{58   \textcolor{keyword}{using }\mbox{\hyperlink{a01412}{Pre}}       = \mbox{\hyperlink{a01412}{EnhancedAssumedStrainsPre}};}
\DoxyCodeLine{59 }
\DoxyCodeLine{60   \textcolor{keyword}{using }\mbox{\hyperlink{a01408_ac0240f5e442600ad657fb9b9f4cbb219}{SupportedResultTypes}} = std::tuple<decltype(makeRT<ResultTypes::linearStress>())>;}
\DoxyCodeLine{61 }
\DoxyCodeLine{66   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01408_a75462594650477236751a2251883597b}{EnhancedAssumedStrains}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01412}{Pre}}\& pre) \{ this-\/>\mbox{\hyperlink{a01408_adda3bf7e9e3e6a6bdadab56e5d69a878}{setEASType}}(pre.\mbox{\hyperlink{a01412_a4c30fabbf2fb4739dabcf7caa3855936}{numberOfParameters}}); \}}
\DoxyCodeLine{67 }
\DoxyCodeLine{73   \textcolor{keywordtype}{bool} \mbox{\hyperlink{a01408_abe6a790acb94dbb3061bbbe64f73b751}{isDisplacementBased}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} easVariant\_.isDisplacmentBased(); \}}
\DoxyCodeLine{74 }
\DoxyCodeLine{80   \textcolor{keyword}{const} \textcolor{keyword}{auto}\& \mbox{\hyperlink{a01408_a7b28d4252e1edb4f0e1fb8ac524098ed}{easVariant}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} easVariant\_; \}}
\DoxyCodeLine{81 }
\DoxyCodeLine{87   \textcolor{keyword}{auto} \mbox{\hyperlink{a01408_adde36207d3eb902dd9a6f7075e991649}{numberOfEASParameters}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} easVariant\_.numberOfEASParameters(); \}}
\DoxyCodeLine{88 }
...
\DoxyCodeLine{104   \textcolor{keyword}{auto} \mbox{\hyperlink{a01408_afddcb054816acf30dd2f0543a67dc96c}{calculateAtImpl}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01344}{Requirement}}\& req, \textcolor{keyword}{const} \mbox{\hyperlink{a01692}{Dune::FieldVector<double, Traits::mydim>}}\& local,}
\DoxyCodeLine{105                        Dune::PriorityTag<2>)\textcolor{keyword}{ const }\{}
\DoxyCodeLine{106     \textcolor{keywordflow}{if} (\mbox{\hyperlink{a01408_abe6a790acb94dbb3061bbbe64f73b751}{isDisplacementBased}}())}
...
\DoxyCodeLine{113       \textcolor{keyword}{using }RTWrapper = \mbox{\hyperlink{a01368}{ResultWrapper<RT<typename Traits::ctype, Traits::mydim, Traits::worlddim>}}, \mbox{\hyperlink{a00363_acfb09bb7db104db62d3d1d2dc3e009b2a57dea6f5039281b7fee517fc43bf3110}{ResultShape::Vector}}>;}
...
\DoxyCodeLine{120         \textcolor{keyword}{const} \textcolor{keyword}{auto} disp  = \mbox{\hyperlink{a00358_ga545d74839895f4576a3b8c97d72abefd}{Dune::viewAsFlatEigenVector}}(ufunc.coefficientsRef());}
...
\DoxyCodeLine{131   \}}
\DoxyCodeLine{132 }
\DoxyCodeLine{138   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01408_adda3bf7e9e3e6a6bdadab56e5d69a878}{setEASType}}(\textcolor{keywordtype}{int} \mbox{\hyperlink{a01408_adde36207d3eb902dd9a6f7075e991649}{numberOfEASParameters}}) \{}
\DoxyCodeLine{139     \textcolor{keywordflow}{if} (\mbox{\hyperlink{a01408_adde36207d3eb902dd9a6f7075e991649}{numberOfEASParameters}} != 0)}
\DoxyCodeLine{140       \mbox{\hyperlink{a01408_a9847b385310a9f6745eb58e4f965d409}{easApplicabilityCheck}}();}
\DoxyCodeLine{141     easVariant\_.setEASType(\mbox{\hyperlink{a01408_adde36207d3eb902dd9a6f7075e991649}{numberOfEASParameters}});}
\DoxyCodeLine{142   \}}
\DoxyCodeLine{143 }
\DoxyCodeLine{144 \textcolor{keyword}{protected}:}
\DoxyCodeLine{145   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01408_ab76f2762671562a653fb346e9d4fbe3e}{bindImpl}}() \{}
...
\DoxyCodeLine{152   \textcolor{keyword}{inline} \textcolor{keywordtype}{void} \mbox{\hyperlink{a01408_a9847b385310a9f6745eb58e4f965d409}{easApplicabilityCheck}}()\textcolor{keyword}{ const }\{}
\DoxyCodeLine{153     \textcolor{keyword}{const} \textcolor{keyword}{auto}\& numberOfNodes = underlying().numberOfNodes();}
\DoxyCodeLine{154     assert(not(not((numberOfNodes == 4 and \mbox{\hyperlink{a01372_ae15b8efa9f66a3caee81d99dd5c648de}{Traits::mydim}} == 2) or (numberOfNodes == 8 and \mbox{\hyperlink{a01372_ae15b8efa9f66a3caee81d99dd5c648de}{Traits::mydim}} == 3)) and}
\DoxyCodeLine{155                (not \mbox{\hyperlink{a01408_abe6a790acb94dbb3061bbbe64f73b751}{isDisplacementBased}}())) \&\&}
...
\DoxyCodeLine{160   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01408_a41688f59fef9934faee1209a9c7d46b7}{calculateMatrixImpl}}(}
\DoxyCodeLine{161       \textcolor{keyword}{const} \mbox{\hyperlink{a01344}{Requirement}}\& par, \textcolor{keyword}{const} \mbox{\hyperlink{a00363_a390d5311179ec61d163a29c943b3d1a0}{MatrixAffordance}}\& affordance, \textcolor{keyword}{typename} Traits::template MatrixType<> K,}
...
\DoxyCodeLine{164     \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00381}{Dune}};}
\DoxyCodeLine{165     \mbox{\hyperlink{a01408_a9847b385310a9f6745eb58e4f965d409}{easApplicabilityCheck}}();}
\DoxyCodeLine{166     \textcolor{keywordflow}{if} (\mbox{\hyperlink{a01408_abe6a790acb94dbb3061bbbe64f73b751}{isDisplacementBased}}())}
...
\DoxyCodeLine{187   \textcolor{keyword}{inline} ScalarType \mbox{\hyperlink{a01408_ae18c38ea736547657bf0dc6a93414d31}{calculateScalarImpl}}(}
\DoxyCodeLine{188       \textcolor{keyword}{const} \mbox{\hyperlink{a01344}{Requirement}}\& par, \mbox{\hyperlink{a00363_af6f894084edd9109762b86222995ef2a}{ScalarAffordance}} affordance,}
...
\DoxyCodeLine{190     \mbox{\hyperlink{a01408_a9847b385310a9f6745eb58e4f965d409}{easApplicabilityCheck}}();}
\DoxyCodeLine{191     \textcolor{keywordflow}{if} (\mbox{\hyperlink{a01408_abe6a790acb94dbb3061bbbe64f73b751}{isDisplacementBased}}())}
...
\DoxyCodeLine{198   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01408_a9febb77b55a78ae825f8627d2ad1e8c7}{calculateVectorImpl}}(}
\DoxyCodeLine{199       \textcolor{keyword}{const} \mbox{\hyperlink{a01344}{Requirement}}\& par, \mbox{\hyperlink{a00363_aab9e3e38507d1db7602bc750718c302a}{VectorAffordance}} affordance, \textcolor{keyword}{typename} Traits::template VectorType<ScalarType> force,}
...
\DoxyCodeLine{201     \mbox{\hyperlink{a01408_a9847b385310a9f6745eb58e4f965d409}{easApplicabilityCheck}}();}
\DoxyCodeLine{202     \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00381}{Dune}};}
...
\DoxyCodeLine{217       \}();}
\DoxyCodeLine{218       \textcolor{keyword}{const} \textcolor{keyword}{auto} disp  = \mbox{\hyperlink{a00358_ga545d74839895f4576a3b8c97d72abefd}{Dune::viewAsFlatEigenVector}}(uFunction.coefficientsRef());}
...
\DoxyCodeLine{230           force.template segment<Traits::worlddim>(\mbox{\hyperlink{a01372_a5d611e1d48285bac5c5ebd6fda9c7cc7}{Traits::worlddim}} * i) += bopI.transpose() * stresses * intElement;}
\DoxyCodeLine{231         \}}
\DoxyCodeLine{232       \}}
\DoxyCodeLine{233     \};}
...
\DoxyCodeLine{242   \textcolor{keyword}{const} \textcolor{keyword}{auto}\& underlying()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} \textcolor{keyword}{static\_cast<}\textcolor{keyword}{const }\mbox{\hyperlink{a01312}{FE}}\&\textcolor{keyword}{>}(*this); \}}
...
\DoxyCodeLine{250     \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00381}{Dune}};}
...
\DoxyCodeLine{265         \textcolor{keyword}{const} \textcolor{keywordtype}{size\_t} I = \mbox{\hyperlink{a01372_a5d611e1d48285bac5c5ebd6fda9c7cc7}{Traits::worlddim}} * i;}
...
\DoxyCodeLine{271 \};}
\DoxyCodeLine{272 }
\DoxyCodeLine{278 \textcolor{keyword}{auto} \mbox{\hyperlink{a00363_a95d330fd032b3ed38354e893a814d33a}{eas}}(\textcolor{keywordtype}{int} numberOfEASParameters = 0) \{}
\DoxyCodeLine{279   \mbox{\hyperlink{a01412}{EnhancedAssumedStrainsPre}} pre(numberOfEASParameters);}
\DoxyCodeLine{280 }
