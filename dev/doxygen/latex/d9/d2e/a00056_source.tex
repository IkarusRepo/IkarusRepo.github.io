...
\DoxyCodeLine{23   \textcolor{keyword}{concept }\mbox{\hyperlink{a01606}{Pointer}} = std::is\_pointer\_v<T> || std::is\_same\_v<T, std::nullptr\_t>;}
\DoxyCodeLine{24 }
...
\DoxyCodeLine{74   \textcolor{keyword}{struct }\mbox{\hyperlink{a01542}{hasType}} : std::false\_type \{\};}
\DoxyCodeLine{75 }
...
\DoxyCodeLine{78   \textcolor{keyword}{struct }\mbox{\hyperlink{a01542}{hasType}}<T, std::tuple<>> : std::false\_type \{\};}
\DoxyCodeLine{79 }
...
\DoxyCodeLine{185   \textcolor{keyword}{struct }\mbox{\hyperlink{a01562}{Index}};}
\DoxyCodeLine{186 \textcolor{preprocessor}{\#ifndef DOXYGEN}}
\DoxyCodeLine{187   \textcolor{keyword}{template} <\textcolor{keyword}{class} T>}
\DoxyCodeLine{188   \textcolor{keyword}{struct }\mbox{\hyperlink{a01562}{Index}}<T, std::tuple<>> \{}
...
\DoxyCodeLine{193   \textcolor{keyword}{struct }\mbox{\hyperlink{a01562}{Index}}<T, std::tuple<T, Types...>> \{}
...
\DoxyCodeLine{221   \textcolor{keyword}{struct }\mbox{\hyperlink{a01566}{Rebind}};}
\DoxyCodeLine{222 }
...
\DoxyCodeLine{228   \textcolor{keyword}{struct }\mbox{\hyperlink{a01566}{Rebind}}<Container<OldType, Args...>, NewType> \{}
...
\DoxyCodeLine{236   \textcolor{keyword}{struct }\mbox{\hyperlink{a01566}{Rebind}}<Container<OldType, N>, NewType> \{}
...
\DoxyCodeLine{252   \textcolor{keyword}{struct }\mbox{\hyperlink{a01570}{FunctionTraits}};}
\DoxyCodeLine{253 }
...
\DoxyCodeLine{259   \textcolor{keyword}{struct }\mbox{\hyperlink{a01570}{FunctionTraits}}<R (*)(Args...)> \{}
...
\DoxyCodeLine{270   \textcolor{keyword}{struct }\mbox{\hyperlink{a01570}{FunctionTraits}}<R (C::*)(Args...) const> \{}
