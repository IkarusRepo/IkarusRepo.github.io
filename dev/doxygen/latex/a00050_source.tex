...
\DoxyCodeLine{10 \textcolor{preprocessor}{\#include "{}\mbox{\hyperlink{a00038}{concepts.hh}}"{}}}
\DoxyCodeLine{11 \textcolor{preprocessor}{\#include "{}\mbox{\hyperlink{a00023}{traits.hh}}"{}}}
\DoxyCodeLine{12 }
...
\DoxyCodeLine{181 \textcolor{keyword}{requires}(\mbox{\hyperlink{a01643}{Ikarus::Concepts::AddAssignAble}}<Type, \textcolor{keyword}{decltype}(b.template segment<Type::correctionSize>(0))> and}
...
\DoxyCodeLine{201 \textcolor{keyword}{requires}(\mbox{\hyperlink{a01643}{Ikarus::Concepts::AddAssignAble}}<Type, \textcolor{keyword}{decltype}(b.template segment<Type::correctionSize>(0))> and}
...
\DoxyCodeLine{241 \textcolor{keyword}{requires}(\mbox{\hyperlink{a01643}{Ikarus::Concepts::AddAssignAble}}<ManifoldPoint, \textcolor{keyword}{decltype}(b.template segment<ManifoldPoint::valueSize>(0))> and}
...
\DoxyCodeLine{421 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00320_ga40c08050aff1e3e49e58c7823ecbcc77}{printForMaple}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01464}{Eigen::EigenBase<Derived>}}\& A) \{}
...
\DoxyCodeLine{427     \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00334}{Eigen}};}
...
\DoxyCodeLine{581   \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (!Concepts::EigenVector6<Derived> and \mbox{\hyperlink{a01649}{Concepts::EigenVector<Derived>}}) \{}
