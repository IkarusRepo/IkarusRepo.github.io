\hypertarget{a00263_source}{}\doxysection{materialhelpers.\+hh}
\label{a00263_source}\index{materialhelpers.hh@{materialhelpers.hh}}
...
\DoxyCodeLine{20 }
\DoxyCodeLine{21 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00407}{Ikarus::Materials}} \{}
\DoxyCodeLine{25 \textcolor{keyword}{struct }\mbox{\hyperlink{a01587}{MatrixIndexPair}}}
\DoxyCodeLine{26 \{}
\DoxyCodeLine{27   Eigen::Index \mbox{\hyperlink{a01587_aea06e613d6a158b8e197a5f79ef7f197}{row}}; }
\DoxyCodeLine{28   Eigen::Index \mbox{\hyperlink{a01587_a05834d6b2ab9428e4ecc645234ef9d34}{col}}; }
\DoxyCodeLine{29 \};}
...
\DoxyCodeLine{89     \textcolor{keywordflow}{return} \mbox{\hyperlink{a00392_gadc8e9e9f3838d0392a5fcf1e11374ee9}{fromVoigt}}(E.derived(), \textcolor{keyword}{true});}
...
\DoxyCodeLine{150 \textcolor{keyword}{inline} \mbox{\hyperlink{a00396_acfb09bb7db104db62d3d1d2dc3e009b2a57dea6f5039281b7fee517fc43bf3110}{Vector}} deviatoricStretches(\textcolor{keyword}{const} Vector\& lambda) \{}
...
\DoxyCodeLine{165 \textcolor{keyword}{inline} \mbox{\hyperlink{a00396_acfb09bb7db104db62d3d1d2dc3e009b2a57dea6f5039281b7fee517fc43bf3110}{Vector}} invariants(\textcolor{keyword}{const} Vector\& lambda) \{}
