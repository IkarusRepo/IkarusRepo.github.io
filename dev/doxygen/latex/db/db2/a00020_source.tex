...
\DoxyCodeLine{22 }
\DoxyCodeLine{23 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00317}{Eigen}} \{}
\DoxyCodeLine{24   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Derived>}
\DoxyCodeLine{25   \textcolor{keyword}{struct }\mbox{\hyperlink{a01454}{EigenBase}};}
\DoxyCodeLine{26 \}}
\DoxyCodeLine{27 }
\DoxyCodeLine{28 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00310}{Ikarus}} \{}
...
\DoxyCodeLine{33   \textcolor{keyword}{auto} \mbox{\hyperlink{a00310_ac2c6469be19ce4ef2e630bfa1c5a5e24}{transpose}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01454}{Eigen::EigenBase<Derived>}}\& A);}
...
\DoxyCodeLine{45     \textcolor{keyword}{concept }\mbox{\hyperlink{a01611}{FlatInterLeavedBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{69     \textcolor{keyword}{concept }\mbox{\hyperlink{a01612}{LagrangeNode}} = Impl::LagrangeNodeHelper<Dune::Functions::LagrangeNode, Node>::value;}
\DoxyCodeLine{70 }
\DoxyCodeLine{78     \textcolor{keyword}{template} <\textcolor{keyword}{typename} Node, \textcolor{keywordtype}{int} order>}
\DoxyCodeLine{79     \textcolor{keyword}{concept }\mbox{\hyperlink{a01613}{LagrangeNodeOfOrder}} = Impl::LagrangeNodeHelperOfOrder<Dune::Functions::LagrangeNode, Node, order>::value;}
\DoxyCodeLine{80 }
\DoxyCodeLine{89     \textcolor{keyword}{template} <\textcolor{keyword}{typename} Basis>}
\DoxyCodeLine{90     \textcolor{keyword}{concept }\mbox{\hyperlink{a01614}{FlatLexicographicBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{103     \textcolor{keyword}{concept }\mbox{\hyperlink{a01615}{FlatIndexBasis}} = \mbox{\hyperlink{a01614}{FlatLexicographicBasis<Basis>}} or \mbox{\hyperlink{a01611}{FlatInterLeavedBasis<Basis>}};}
\DoxyCodeLine{104 }
\DoxyCodeLine{113     \textcolor{keyword}{template} <\textcolor{keyword}{typename} Basis>}
\DoxyCodeLine{114     \textcolor{keyword}{concept }\mbox{\hyperlink{a01616}{BlockedInterLeavedBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{127     \textcolor{keyword}{concept }\mbox{\hyperlink{a01617}{BlockedLexicographicBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{138     \textcolor{keyword}{concept }\mbox{\hyperlink{a01618}{DuneLocalBasis}} = \textcolor{keyword}{requires}(DuneLocalBasisImpl\& duneLocalBasis) \{}
...
\DoxyCodeLine{163     \textcolor{keyword}{concept }\mbox{\hyperlink{a01619}{BlockedIndexBasis}} = \mbox{\hyperlink{a01617}{BlockedLexicographicBasis<Basis>}} or \mbox{\hyperlink{a01616}{BlockedInterLeavedBasis<Basis>}};}
\DoxyCodeLine{164 }
\DoxyCodeLine{173     \textcolor{keyword}{template} <\textcolor{keyword}{typename} Basis>}
\DoxyCodeLine{174     \textcolor{keyword}{concept }\mbox{\hyperlink{a01620}{PowerBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{186     \textcolor{keyword}{concept }\mbox{\hyperlink{a01621}{PathFollowingStrategy}} = \textcolor{keyword}{requires}(PathFollowingImpl pft, NonLinearOperator nop, SubsidiaryArgs args) \{}
...
\DoxyCodeLine{190     \};}
\DoxyCodeLine{191 }
\DoxyCodeLine{200     \textcolor{keyword}{template} <\textcolor{keyword}{typename} AdaptiveStepSizing, \textcolor{keyword}{typename} \mbox{\hyperlink{a01422}{NonLinearSolverInformation}}, \textcolor{keyword}{typename} \mbox{\hyperlink{a01190}{SubsidiaryArgs}},}
\DoxyCodeLine{201               \textcolor{keyword}{typename} \mbox{\hyperlink{a01534}{NonLinearOperator}}>}
\DoxyCodeLine{202     \textcolor{keyword}{concept }\mbox{\hyperlink{a01622}{AdaptiveStepSizingStrategy}} = \textcolor{keyword}{requires}(AdaptiveStepSizing adaptiveSS, NonLinearSolverInformation info,}
...
\DoxyCodeLine{218     \textcolor{keyword}{concept }\mbox{\hyperlink{a01623}{LinearSolverCheck}} = \textcolor{keyword}{requires}(\mbox{\hyperlink{a00310_ae747d502e8f67af4c5412d8a6febeb4c}{LinearSolver}}\& linearSolver, MatrixType\& Ax, VectorType\& vec) \{}
...
\DoxyCodeLine{232     \textcolor{keyword}{concept }\mbox{\hyperlink{a01624}{NonLinearSolverCheckForPathFollowing}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{247     \textcolor{keyword}{concept }\mbox{\hyperlink{a01625}{MultiplyAble}} = \textcolor{keyword}{requires}(L x, R y) \{}
\DoxyCodeLine{248       x* y;}
\DoxyCodeLine{249     \};}
\DoxyCodeLine{250 }
\DoxyCodeLine{258     \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{259     \textcolor{keyword}{concept }\mbox{\hyperlink{a01626}{AddAble}} = \textcolor{keyword}{requires}(L x, R y) \{}
\DoxyCodeLine{260       x + y;}
\DoxyCodeLine{261     \};}
\DoxyCodeLine{262 }
\DoxyCodeLine{270     \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{271     \textcolor{keyword}{concept }\mbox{\hyperlink{a01627}{SubstractAble}} = \textcolor{keyword}{requires}(L x, R y) \{}
\DoxyCodeLine{272       x -\/ y;}
\DoxyCodeLine{273     \};}
\DoxyCodeLine{274 }
\DoxyCodeLine{283     \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{284     \textcolor{keyword}{concept }\mbox{\hyperlink{a01628}{MultiplyAssignAble}} = \textcolor{keyword}{requires}(L x, R y) \{}
\DoxyCodeLine{285       x *= y;}
\DoxyCodeLine{286     \};}
\DoxyCodeLine{287 }
\DoxyCodeLine{296     \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{297     \textcolor{keyword}{concept }\mbox{\hyperlink{a01629}{DivideAssignAble}} = \textcolor{keyword}{requires}(L x, R y) \{}
\DoxyCodeLine{298       x /= y;}
\DoxyCodeLine{299     \};}
\DoxyCodeLine{300 }
\DoxyCodeLine{309     \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{310     \textcolor{keyword}{concept }\mbox{\hyperlink{a01630}{AddAssignAble}} = \textcolor{keyword}{requires}(L x, R y) \{}
\DoxyCodeLine{311       x += y;}
\DoxyCodeLine{312     \};}
\DoxyCodeLine{313 }
\DoxyCodeLine{322     \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{323     \textcolor{keyword}{concept }\mbox{\hyperlink{a01631}{SubstractAssignAble}} = \textcolor{keyword}{requires}(L x, R y) \{}
\DoxyCodeLine{324       x -\/= y;}
\DoxyCodeLine{325     \};}
\DoxyCodeLine{326 }
\DoxyCodeLine{334     \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{335     \textcolor{keyword}{concept }\mbox{\hyperlink{a01632}{DivideAble}} = \textcolor{keyword}{requires}(L x, R y) \{}
\DoxyCodeLine{336       x / y;}
\DoxyCodeLine{337     \};}
\DoxyCodeLine{338 }
\DoxyCodeLine{345     \textcolor{keyword}{template} <\textcolor{keyword}{typename} L>}
\DoxyCodeLine{346     \textcolor{keyword}{concept }\mbox{\hyperlink{a01633}{NegateAble}} = \textcolor{keyword}{requires}(L x) \{}
\DoxyCodeLine{347       -\/x;}
\DoxyCodeLine{348     \};}
\DoxyCodeLine{349 }
\DoxyCodeLine{356     \textcolor{keyword}{template} <\textcolor{keyword}{typename} L>}
\DoxyCodeLine{357     \textcolor{keyword}{concept }\mbox{\hyperlink{a01634}{TransposeAble}} = \textcolor{keyword}{requires}(L x) \{}
\DoxyCodeLine{358       \mbox{\hyperlink{a00310_ac2c6469be19ce4ef2e630bfa1c5a5e24}{transpose}}(x);}
\DoxyCodeLine{359     \};}
\DoxyCodeLine{360 }
\DoxyCodeLine{368     \textcolor{keyword}{template} <\textcolor{keyword}{typename} Op, \textcolor{keyword}{typename}... Args>}
\DoxyCodeLine{369     \textcolor{keyword}{concept }\mbox{\hyperlink{a01635}{IsFunctorWithArgs}} = \textcolor{keyword}{requires}(Op op, Args... args) \{}
\DoxyCodeLine{370       op(args...);}
\DoxyCodeLine{371     \};}
\DoxyCodeLine{372 }
\DoxyCodeLine{380     \textcolor{keyword}{template} <\textcolor{keyword}{typename} V>}
\DoxyCodeLine{381     \textcolor{keyword}{concept }\mbox{\hyperlink{a01636}{EigenVector}} = \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{bool}\textcolor{keyword}{>}(V::IsVectorAtCompileTime);}
\DoxyCodeLine{382 }
...
\DoxyCodeLine{472 \textcolor{comment}{}    \textcolor{keyword}{template} <\textcolor{keyword}{template} <\textcolor{keyword}{typename}...> \textcolor{keyword}{class }MaterialToCheck, \textcolor{keyword}{typename} \mbox{\hyperlink{a00298_gga05ac785124262c1e323d2f937d520a1bad92a8333dd3ccb895cc65f7455b71206}{Material}}>}
\DoxyCodeLine{473     \textcolor{keyword}{concept }\mbox{\hyperlink{a01637}{IsMaterial}} = Impl::isMaterial<MaterialToCheck, Material>();}
\DoxyCodeLine{474 }
