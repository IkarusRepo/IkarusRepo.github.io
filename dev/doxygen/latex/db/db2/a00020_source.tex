...
\DoxyCodeLine{25   \textcolor{keyword}{struct }\mbox{\hyperlink{a01418}{EigenBase}};}
\DoxyCodeLine{26 \}}
\DoxyCodeLine{27 }
...
\DoxyCodeLine{33   \textcolor{keyword}{auto} \mbox{\hyperlink{a00295_ac2c6469be19ce4ef2e630bfa1c5a5e24}{transpose}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01418}{Eigen::EigenBase<Derived>}}\& A);}
...
\DoxyCodeLine{45     \textcolor{keyword}{concept }\mbox{\hyperlink{a01575}{FlatInterLeavedBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{69     \textcolor{keyword}{concept }\mbox{\hyperlink{a01576}{LagrangeNode}} = Impl::LagrangeNodeHelper<Dune::Functions::LagrangeNode, Node>::value;}
\DoxyCodeLine{70 }
\DoxyCodeLine{78     \textcolor{keyword}{template} <\textcolor{keyword}{typename} Node, \textcolor{keywordtype}{int} order>}
\DoxyCodeLine{79     \textcolor{keyword}{concept }\mbox{\hyperlink{a01577}{LagrangeNodeOfOrder}} = Impl::LagrangeNodeHelperOfOrder<Dune::Functions::LagrangeNode, Node, order>::value;}
\DoxyCodeLine{80 }
\DoxyCodeLine{89     \textcolor{keyword}{template} <\textcolor{keyword}{typename} Basis>}
\DoxyCodeLine{90     \textcolor{keyword}{concept }\mbox{\hyperlink{a01578}{FlatLexicographicBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{103     \textcolor{keyword}{concept }\mbox{\hyperlink{a01579}{FlatIndexBasis}} = \mbox{\hyperlink{a01578}{FlatLexicographicBasis<Basis>}} or \mbox{\hyperlink{a01575}{FlatInterLeavedBasis<Basis>}};}
\DoxyCodeLine{104 }
\DoxyCodeLine{113     \textcolor{keyword}{template} <\textcolor{keyword}{typename} Basis>}
\DoxyCodeLine{114     \textcolor{keyword}{concept }\mbox{\hyperlink{a01580}{BlockedInterLeavedBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{127     \textcolor{keyword}{concept }\mbox{\hyperlink{a01581}{BlockedLexicographicBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{138     \textcolor{keyword}{concept }\mbox{\hyperlink{a01582}{DuneLocalBasis}} = \textcolor{keyword}{requires}(DuneLocalBasisImpl\& duneLocalBasis) \{}
...
\DoxyCodeLine{163     \textcolor{keyword}{concept }\mbox{\hyperlink{a01583}{BlockedIndexBasis}} = \mbox{\hyperlink{a01581}{BlockedLexicographicBasis<Basis>}} or \mbox{\hyperlink{a01580}{BlockedInterLeavedBasis<Basis>}};}
\DoxyCodeLine{164 }
\DoxyCodeLine{173     \textcolor{keyword}{template} <\textcolor{keyword}{typename} Basis>}
\DoxyCodeLine{174     \textcolor{keyword}{concept }\mbox{\hyperlink{a01584}{PowerBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{186     \textcolor{keyword}{concept }\mbox{\hyperlink{a01585}{PathFollowingStrategy}} = \textcolor{keyword}{requires}(PathFollowingImpl pft, NonLinearOperator nop, SubsidiaryArgs args) \{}
...
\DoxyCodeLine{190     \};}
\DoxyCodeLine{191 }
\DoxyCodeLine{200     \textcolor{keyword}{template} <\textcolor{keyword}{typename} AdaptiveStepSizing, \textcolor{keyword}{typename} \mbox{\hyperlink{a01386}{NonLinearSolverInformation}}, \textcolor{keyword}{typename} \mbox{\hyperlink{a01174}{SubsidiaryArgs}},}
\DoxyCodeLine{201               \textcolor{keyword}{typename} \mbox{\hyperlink{a01498}{NonLinearOperator}}>}
\DoxyCodeLine{202     \textcolor{keyword}{concept }\mbox{\hyperlink{a01586}{AdaptiveStepSizingStrategy}} = \textcolor{keyword}{requires}(AdaptiveStepSizing adaptiveSS, NonLinearSolverInformation info,}
...
\DoxyCodeLine{218     \textcolor{keyword}{concept }\mbox{\hyperlink{a01587}{LinearSolverCheck}} = \textcolor{keyword}{requires}(\mbox{\hyperlink{a00295_ae747d502e8f67af4c5412d8a6febeb4c}{LinearSolver}}\& linearSolver, MatrixType\& Ax, VectorType\& vec) \{}
...
\DoxyCodeLine{232     \textcolor{keyword}{concept }\mbox{\hyperlink{a01588}{NonLinearSolverCheckForPathFollowing}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{247     \textcolor{keyword}{concept }\mbox{\hyperlink{a01589}{MultiplyAble}} = \textcolor{keyword}{requires}(L x, R y) \{}
\DoxyCodeLine{248       x* y;}
\DoxyCodeLine{249     \};}
\DoxyCodeLine{250 }
\DoxyCodeLine{258     \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{259     \textcolor{keyword}{concept }\mbox{\hyperlink{a01590}{AddAble}} = \textcolor{keyword}{requires}(L x, R y) \{}
\DoxyCodeLine{260       x + y;}
\DoxyCodeLine{261     \};}
\DoxyCodeLine{262 }
\DoxyCodeLine{270     \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{271     \textcolor{keyword}{concept }\mbox{\hyperlink{a01591}{SubstractAble}} = \textcolor{keyword}{requires}(L x, R y) \{}
\DoxyCodeLine{272       x -\/ y;}
\DoxyCodeLine{273     \};}
\DoxyCodeLine{274 }
\DoxyCodeLine{283     \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{284     \textcolor{keyword}{concept }\mbox{\hyperlink{a01592}{MultiplyAssignAble}} = \textcolor{keyword}{requires}(L x, R y) \{}
\DoxyCodeLine{285       x *= y;}
\DoxyCodeLine{286     \};}
\DoxyCodeLine{287 }
\DoxyCodeLine{296     \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{297     \textcolor{keyword}{concept }\mbox{\hyperlink{a01593}{DivideAssignAble}} = \textcolor{keyword}{requires}(L x, R y) \{}
\DoxyCodeLine{298       x /= y;}
\DoxyCodeLine{299     \};}
\DoxyCodeLine{300 }
\DoxyCodeLine{309     \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{310     \textcolor{keyword}{concept }\mbox{\hyperlink{a01594}{AddAssignAble}} = \textcolor{keyword}{requires}(L x, R y) \{}
\DoxyCodeLine{311       x += y;}
\DoxyCodeLine{312     \};}
\DoxyCodeLine{313 }
\DoxyCodeLine{322     \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{323     \textcolor{keyword}{concept }\mbox{\hyperlink{a01595}{SubstractAssignAble}} = \textcolor{keyword}{requires}(L x, R y) \{}
\DoxyCodeLine{324       x -\/= y;}
\DoxyCodeLine{325     \};}
\DoxyCodeLine{326 }
\DoxyCodeLine{334     \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{335     \textcolor{keyword}{concept }\mbox{\hyperlink{a01596}{DivideAble}} = \textcolor{keyword}{requires}(L x, R y) \{}
\DoxyCodeLine{336       x / y;}
\DoxyCodeLine{337     \};}
\DoxyCodeLine{338 }
\DoxyCodeLine{345     \textcolor{keyword}{template} <\textcolor{keyword}{typename} L>}
\DoxyCodeLine{346     \textcolor{keyword}{concept }\mbox{\hyperlink{a01597}{NegateAble}} = \textcolor{keyword}{requires}(L x) \{}
\DoxyCodeLine{347       -\/x;}
\DoxyCodeLine{348     \};}
\DoxyCodeLine{349 }
\DoxyCodeLine{356     \textcolor{keyword}{template} <\textcolor{keyword}{typename} L>}
\DoxyCodeLine{357     \textcolor{keyword}{concept }\mbox{\hyperlink{a01598}{TransposeAble}} = \textcolor{keyword}{requires}(L x) \{}
...
\DoxyCodeLine{369     \textcolor{keyword}{concept }\mbox{\hyperlink{a01599}{IsFunctorWithArgs}} = \textcolor{keyword}{requires}(Op op, Args... args) \{}
\DoxyCodeLine{370       op(args...);}
\DoxyCodeLine{371     \};}
\DoxyCodeLine{372 }
\DoxyCodeLine{380     \textcolor{keyword}{template} <\textcolor{keyword}{typename} V>}
\DoxyCodeLine{381     \textcolor{keyword}{concept }\mbox{\hyperlink{a01600}{EigenVector}} = \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{bool}\textcolor{keyword}{>}(V::IsVectorAtCompileTime);}
\DoxyCodeLine{382 }
...
\DoxyCodeLine{473     \textcolor{keyword}{concept }\mbox{\hyperlink{a01601}{IsMaterial}} = Impl::isMaterial<MaterialToCheck, Material>();}
\DoxyCodeLine{474 }
