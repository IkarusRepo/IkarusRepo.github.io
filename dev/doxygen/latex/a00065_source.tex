\hypertarget{a00065_source}{}\doxysection{nonlinearoperator.\+hh}
\label{a00065_source}\index{nonlinearoperator.hh@{nonlinearoperator.hh}}
...
\DoxyCodeLine{155 \textcolor{keyword}{class }\mbox{\hyperlink{a01768}{NonLinearOperator}}}
\DoxyCodeLine{156 \{}
\DoxyCodeLine{157 \textcolor{keyword}{public}:}
\DoxyCodeLine{158   \mbox{\hyperlink{a01768_a2308f86b14266d7b7049b0a12cf20cdc}{NonLinearOperator}}([[maybe\_unused]] \textcolor{keyword}{const} TypeListOne\& derivativesFunctions,}
...
\DoxyCodeLine{212   explicit \mbox{\hyperlink{a01768_a2308f86b14266d7b7049b0a12cf20cdc}{NonLinearOperator}}(const Impl::Functions<DerivativeArgs...>\& derivativesFunctions,}
...
\DoxyCodeLine{225   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01768_a2308f86b14266d7b7049b0a12cf20cdc}{NonLinearOperator}}(\textcolor{keyword}{const} Funcs\& derivativesFunctions, \textcolor{keyword}{const} Impl::Parameter<ParameterArgs...>\& parameterI)}
...
\DoxyCodeLine{356     \mbox{\hyperlink{a01768}{Ikarus::NonLinearOperator}}<Impl::Functions<std::tuple\_element\_t<Derivatives, \textcolor{keyword}{decltype}(derivatives\_)>...>,}
...
\DoxyCodeLine{383     -\/> \mbox{\hyperlink{a01768}{NonLinearOperator}}<Impl::Functions<DerivativeArgs...>, Impl::Parameter<ParameterArgs...>>;}
