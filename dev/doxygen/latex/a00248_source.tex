\hypertarget{a00248_source}{}\doxysection{feresulttypes.\+hh}
\label{a00248_source}\index{feresulttypes.hh@{feresulttypes.hh}}
...
\DoxyCodeLine{11 }
\DoxyCodeLine{18 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00360}{Ikarus}} \{}
...
\DoxyCodeLine{26       \textcolor{keywordflow}{return} \mbox{\hyperlink{a00356_ga4304655095296ce9283e012587817a51}{toVoigt}}(mat.derived(), strainlike);}
\DoxyCodeLine{27     \}}
\DoxyCodeLine{28   \};}
\DoxyCodeLine{29 }
...
\DoxyCodeLine{48       \textcolor{keywordflow}{return} \mbox{\hyperlink{a00356_ga106e11a950fe2545890e811d2e9545fd}{fromVoigt}}(vec.derived(), strainlike);}
\DoxyCodeLine{49     \}}
\DoxyCodeLine{50   \};}
\DoxyCodeLine{51 }
...
\DoxyCodeLine{121 }
\DoxyCodeLine{124 }
\DoxyCodeLine{125   \mbox{\hyperlink{a00366_a60454300a3ee8c6fdd19a7a62dce2202}{REGISTER\_SIMPLE\_SYMMETRIC\_RESULTTYPE}}(linearStress, worldDim, worldDim, \textcolor{keyword}{false});}
\DoxyCodeLine{126   \mbox{\hyperlink{a00366_a60454300a3ee8c6fdd19a7a62dce2202}{REGISTER\_SIMPLE\_SYMMETRIC\_RESULTTYPE}}(PK2Stress, worldDim, worldDim, \textcolor{keyword}{false});}
\DoxyCodeLine{127   \mbox{\hyperlink{a00366_a60454300a3ee8c6fdd19a7a62dce2202}{REGISTER\_SIMPLE\_SYMMETRIC\_RESULTTYPE}}(cauchyStress, worldDim, worldDim, \textcolor{keyword}{false});}
\DoxyCodeLine{128 }
\DoxyCodeLine{129   \mbox{\hyperlink{a00366_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(director, worldDim, 1);}
\DoxyCodeLine{130   \mbox{\hyperlink{a00366_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(magnetization, worldDim, 1);}
\DoxyCodeLine{131   \mbox{\hyperlink{a00366_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(gradientNormOfMagnetization, 1, 1);}
\DoxyCodeLine{132   \mbox{\hyperlink{a00366_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(vectorPotential, worldDim, 1);}
\DoxyCodeLine{133   \mbox{\hyperlink{a00366_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(divergenceOfVectorPotential, 1, 1);}
\DoxyCodeLine{134 }
\DoxyCodeLine{135   \mbox{\hyperlink{a00366_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(BField, worldDim, 1);}
\DoxyCodeLine{136   \mbox{\hyperlink{a00366_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(HField, worldDim, 1);}
\DoxyCodeLine{137 }
\DoxyCodeLine{138   \mbox{\hyperlink{a00366_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(customType, Eigen::Dynamic, Eigen::Dynamic);}
\DoxyCodeLine{139 \} \textcolor{comment}{// namespace ResultTypes}}
\DoxyCodeLine{140 }
\DoxyCodeLine{141 \textcolor{keyword}{enum class} \mbox{\hyperlink{a00360_acfb09bb7db104db62d3d1d2dc3e009b2}{ResultShape}}}
\DoxyCodeLine{142 \{}
\DoxyCodeLine{143   \mbox{\hyperlink{a00360_acfb09bb7db104db62d3d1d2dc3e009b2a57dea6f5039281b7fee517fc43bf3110}{Vector}},}
\DoxyCodeLine{144   \mbox{\hyperlink{a00360_acfb09bb7db104db62d3d1d2dc3e009b2af53df0293e169f562bc1d9a20e1d2589}{Matrix}}}
\DoxyCodeLine{145 \};}
\DoxyCodeLine{146 }
\DoxyCodeLine{153 \textcolor{keyword}{template} <\textcolor{keyword}{typename} RT, ResultShape storedResultShape = ResultShape::Vector>}
\DoxyCodeLine{154 \textcolor{keyword}{struct }\mbox{\hyperlink{a01365}{ResultWrapper}} : RT}
\DoxyCodeLine{155 \{}
...
\DoxyCodeLine{160   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{bool} storedValueIsVector       = storedResultShape == \mbox{\hyperlink{a00360_acfb09bb7db104db62d3d1d2dc3e009b2a57dea6f5039281b7fee517fc43bf3110}{ResultShape::Vector}};}
\DoxyCodeLine{161 }
\DoxyCodeLine{162 \textcolor{keyword}{public}:}
\DoxyCodeLine{163   \textcolor{keyword}{using }\mbox{\hyperlink{a01365_ad2e94e390a1a328d7abd8006f29dbbd2}{VecType}} = std::invoke\_result\_t<\textcolor{keyword}{decltype}(\&RT::Vectorizer::template transform<ResultTypeValueType>),}
\DoxyCodeLine{164                                        \textcolor{keyword}{const} ResultTypeValueType\&>;}
\DoxyCodeLine{165   \textcolor{keyword}{using }\mbox{\hyperlink{a01365_a3be8a4f7e4b67bc2bb90a826c1ed7c85}{MatType}} =}
...
\DoxyCodeLine{167                            \textcolor{keyword}{const} \mbox{\hyperlink{a01365_ad2e94e390a1a328d7abd8006f29dbbd2}{VecType}}\&, \textcolor{keywordtype}{int}, \textcolor{keywordtype}{int}>;}
\DoxyCodeLine{168   \textcolor{keyword}{using }\mbox{\hyperlink{a01365_a1baf31b4a8525d6b81860c8f0a0b6a84}{StoredType}} = std::conditional\_t<storedValueIsVector, VecType, MatType>;}
\DoxyCodeLine{169   \textcolor{keyword}{using }\mbox{\hyperlink{a01365_aef0efc55342d144366f8eddbc6fe00f9}{ResultType}} = RT;}
\DoxyCodeLine{170 }
\DoxyCodeLine{175   \textcolor{keyword}{auto} \mbox{\hyperlink{a01365_ae1be56ef0981f28e1dfa4f77453251d3}{asVec}}()\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{180   \}}
\DoxyCodeLine{181 }
\DoxyCodeLine{188   \textcolor{keyword}{auto} \mbox{\hyperlink{a01365_ae5c30a9c8da8fe6bb01b1cee0fc43155}{asMat}}(Eigen::Index rows = rowsAtCompileTime, Eigen::Index cols = colsAtCompileTime)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{201   \}}
\DoxyCodeLine{202   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01365_a826dcccf70e97474b01126970e2839ac}{ResultWrapper}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{203   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01365_a623510c28007eb075ed7719de10562b2}{ResultWrapper}}(\mbox{\hyperlink{a01365_a1baf31b4a8525d6b81860c8f0a0b6a84}{StoredType}}\&\& value) \{ this-\/>value\_ = std::move(value); \}}
\DoxyCodeLine{204   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01365_ae3ec0250a8cce10dae2b6eacec3ffe11}{ResultWrapper}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01365_a1baf31b4a8525d6b81860c8f0a0b6a84}{StoredType}}\& value) \{ this-\/>value\_ = value; \}}
\DoxyCodeLine{205   \mbox{\hyperlink{a01365}{ResultWrapper}}\& \mbox{\hyperlink{a01365_adbc957bfc9a97390ce57d778dd7c91a1}{operator=}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01365_a1baf31b4a8525d6b81860c8f0a0b6a84}{StoredType}}\& value) \{}
\DoxyCodeLine{206     this-\/>value\_ = value;}
\DoxyCodeLine{207     \textcolor{keywordflow}{return} *\textcolor{keyword}{this};}
\DoxyCodeLine{208   \}}
\DoxyCodeLine{209   \mbox{\hyperlink{a01365}{ResultWrapper}}\& \mbox{\hyperlink{a01365_a6a1deb7c814879d79eaa5fe467666b2f}{operator=}}(\mbox{\hyperlink{a01365_a1baf31b4a8525d6b81860c8f0a0b6a84}{StoredType}}\&\& value) \{}
...
\DoxyCodeLine{215   \mbox{\hyperlink{a01365_a1baf31b4a8525d6b81860c8f0a0b6a84}{StoredType}} value\_\{\};}
\DoxyCodeLine{216 \};}
\DoxyCodeLine{217 }
...
\DoxyCodeLine{229 \textcolor{keyword}{auto} \mbox{\hyperlink{a00360_a38629395c2d43ba44328b01ce0c0daf3}{makeRT}}() \{}
...
\DoxyCodeLine{239 \textcolor{keyword}{auto} \mbox{\hyperlink{a00360_aef80b6b5b45dcfbea4f722f51a84f53f}{toString}}() \{}
\DoxyCodeLine{240   \textcolor{keywordflow}{return} \mbox{\hyperlink{a00360_aef80b6b5b45dcfbea4f722f51a84f53f}{toString}}(Impl::DummyRT<RT>\{\});}
\DoxyCodeLine{241 \}}
\DoxyCodeLine{242 }
...
\DoxyCodeLine{249 \textcolor{keyword}{constexpr} \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00360_aae9d6a05f2ca4f54c0524404e27e7ed1}{isSameResultType}} = std::is\_same\_v<Impl::DummyRT<RT1>, Impl::DummyRT<RT2>>;}
\DoxyCodeLine{250 }
