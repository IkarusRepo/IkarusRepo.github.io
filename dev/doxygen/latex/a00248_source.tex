...
\DoxyCodeLine{13 }
\DoxyCodeLine{14 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00254}{ikarus/finiteelements/ferequirements.hh}}>}}
...
\DoxyCodeLine{27 \textcolor{keyword}{class }\mbox{\hyperlink{a01224}{AutoDiffFE}} : \textcolor{keyword}{public} FEImpl}
\DoxyCodeLine{28 \{}
\DoxyCodeLine{29 \textcolor{keyword}{public}:}
\DoxyCodeLine{30   \textcolor{keyword}{using }\mbox{\hyperlink{a01224_ac6509944238101aef666b1614df1d443}{RealFE}}            = FEImpl;                             }
\DoxyCodeLine{31   \textcolor{keyword}{using }\mbox{\hyperlink{a01224_ace1636b5cd13f380d0865682480e81b2}{BasisHandler}}      = \textcolor{keyword}{typename} RealFE::BasisHandler;      }
\DoxyCodeLine{32   \textcolor{keyword}{using }\mbox{\hyperlink{a01224_acb52d8adef8b40aabec280ecd1db60f6}{Base}}              = \textcolor{keyword}{typename} RealFE::Base;              }
\DoxyCodeLine{33   \textcolor{keyword}{using }\mbox{\hyperlink{a01224_a25b17a1ebebcf86b4994f735ae7b5281}{Traits}}            = \textcolor{keyword}{typename} Base::Traits;              }
\DoxyCodeLine{34   \textcolor{keyword}{using }\mbox{\hyperlink{a01224_ae985fb2fdb86d514700c4d57f03e97d5}{LocalView}}         = \textcolor{keyword}{typename} Traits::LocalView;         }
\DoxyCodeLine{35   \textcolor{keyword}{using }\mbox{\hyperlink{a01224_af1d3fa6b651ee728bd39a33c3c3da250}{Element}}           = \textcolor{keyword}{typename} Traits::Element;           }
\DoxyCodeLine{36   \textcolor{keyword}{using }\mbox{\hyperlink{a01224_a4d0caa6dbe1dea19b8a265e7074cc45f}{FERequirementType}} = \textcolor{keyword}{typename} Traits::FERequirementType; }
\DoxyCodeLine{37 }
\DoxyCodeLine{44   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01224_a374cdfcdf85fcaba0114571ee4ef95d0}{calculateMatrix}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01224_a4d0caa6dbe1dea19b8a265e7074cc45f}{FERequirementType}}\& req, \textcolor{keyword}{typename} Traits::template MatrixType<> h)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{78   \}}
\DoxyCodeLine{79 }
\DoxyCodeLine{86   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01224_ae2d3a5600747957c5dfb84455c1e1648}{calculateVector}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01224_a4d0caa6dbe1dea19b8a265e7074cc45f}{FERequirementType}}\& req, \textcolor{keyword}{typename} Traits::template VectorType<> g)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{108   \}}
\DoxyCodeLine{109 }
\DoxyCodeLine{117   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01224_a26b7180649b487ae56f5c31e53276cd4}{calculateLocalSystem}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01224_a4d0caa6dbe1dea19b8a265e7074cc45f}{FERequirementType}}\& req, \textcolor{keyword}{typename} Traits::template MatrixType<> h,}
...
\DoxyCodeLine{123   \}}
\DoxyCodeLine{124 }
\DoxyCodeLine{131   [[nodiscard]] \textcolor{keywordtype}{double} \mbox{\hyperlink{a01224_a4092c3249a569470e2d9dfbd0af72749}{calculateScalar}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01224_a4d0caa6dbe1dea19b8a265e7074cc45f}{FERequirementType}}\& par)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{143   \}}
\DoxyCodeLine{144 }
\DoxyCodeLine{150   \textcolor{keyword}{const} \mbox{\hyperlink{a01224_ac6509944238101aef666b1614df1d443}{RealFE}}\& \mbox{\hyperlink{a01224_a8bd5af319955bc66a08c074858df2303}{realFE}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} *\textcolor{keyword}{this}; \}}
\DoxyCodeLine{151 }
\DoxyCodeLine{159   \textcolor{keyword}{template} <\textcolor{keyword}{typename}... Args>}
\DoxyCodeLine{160   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01224_a26248faa29dc3165140f3647f94c5d4a}{AutoDiffFE}}(Args\&\&... args)}
\DoxyCodeLine{161       : \mbox{\hyperlink{a01224_ac6509944238101aef666b1614df1d443}{RealFE}}\{std::forward<Args>(args)...\} \{\}}
\DoxyCodeLine{162 \};}
