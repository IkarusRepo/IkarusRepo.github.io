\hypertarget{a00155_source}{}\doxysection{resultfunction.\+hh}
\label{a00155_source}\index{resultfunction.hh@{resultfunction.hh}}
...
\DoxyCodeLine{87       \mbox{\hyperlink{a01764}{Dune::FieldVector<ctype, griddim>}} val(0.0);}
...
\DoxyCodeLine{134   \textcolor{keywordtype}{double} evaluateComponent(\textcolor{keywordtype}{int} eleID, \textcolor{keyword}{const} \mbox{\hyperlink{a01764}{Dune::FieldVector<ctype, griddim>}}\& local, \textcolor{keywordtype}{int} comp)\textcolor{keyword}{ const }\{}
