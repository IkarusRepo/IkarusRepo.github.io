\hypertarget{a02508_source}{}\doxysection{python/dirichletvalues/dirichletvalues.hh}
...
\DoxyCodeLine{24 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00322}{Ikarus::Python}} \{}
\DoxyCodeLine{25 }
\DoxyCodeLine{48   \textcolor{keyword}{template} <\textcolor{keyword}{class }DirichletValues, \textcolor{keyword}{class}... options>}
\DoxyCodeLine{49   \textcolor{keywordtype}{void} \mbox{\hyperlink{a00305_ga39b6df6adfe4858b13ac71f5830f29f6}{registerDirichletValues}}(pybind11::handle scope, pybind11::class\_<DirichletValues, options...> cls) \{}
\DoxyCodeLine{50     \textcolor{keyword}{using }pybind11::operator\textcolor{stringliteral}{"{}"{}}\_a;}
\DoxyCodeLine{51 }
\DoxyCodeLine{52     \textcolor{keyword}{using }\mbox{\hyperlink{a01453}{Basis}}        = \textcolor{keyword}{typename} \mbox{\hyperlink{a01489_a90174bec95fb08a186f29d1d98e350dc}{DirichletValues::Basis}};}
\DoxyCodeLine{53     \textcolor{keyword}{using }BackendType  = \textcolor{keyword}{typename} \mbox{\hyperlink{a01489_a4b708d1ae34c1f28389273f209ea79f7}{DirichletValues::BackendType}};}
\DoxyCodeLine{54     \textcolor{keyword}{using }FlagsType    = \textcolor{keyword}{typename} \mbox{\hyperlink{a01489_a824bc5693b4b784c8ec9c65aad07da92}{DirichletValues::FlagsType}};}
...
\DoxyCodeLine{66 }
\DoxyCodeLine{67     cls.def(\mbox{\hyperlink{a00313_ac8243891c1b961e50a066140ab79a142}{pybind11::init}}([](\textcolor{keyword}{const} \mbox{\hyperlink{a01453}{Basis}}\& \mbox{\hyperlink{a00332_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}) \{ \textcolor{keywordflow}{return} \textcolor{keyword}{new} \mbox{\hyperlink{a01489}{DirichletValues}}(\mbox{\hyperlink{a00332_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}); \}),}
...
\DoxyCodeLine{72             [](\mbox{\hyperlink{a01489}{DirichletValues}}\& self, \textcolor{keyword}{const} std::function<\textcolor{keywordtype}{void}(Eigen::Ref<Eigen::VectorX<bool>>, \textcolor{keywordtype}{int})>\& f) \{}
...
\DoxyCodeLine{76               \};}
\DoxyCodeLine{77               self.\mbox{\hyperlink{a01489_a7de80e6ad56431b46750ddbc2580c45e}{fixBoundaryDOFs}}(lambda);}
\DoxyCodeLine{78             \});}
\DoxyCodeLine{79 }
\DoxyCodeLine{80     cls.def(\textcolor{stringliteral}{"{}fixBoundaryDOFsUsingLocalView"{}},}
\DoxyCodeLine{81             [](\mbox{\hyperlink{a01489}{DirichletValues}}\& self,}
...
\DoxyCodeLine{90               \};}
\DoxyCodeLine{91               self.\mbox{\hyperlink{a01489_a7de80e6ad56431b46750ddbc2580c45e}{fixBoundaryDOFs}}(lambda);}
\DoxyCodeLine{92             \});}
\DoxyCodeLine{93 }
\DoxyCodeLine{94     cls.def(\textcolor{stringliteral}{"{}fixBoundaryDOFsUsingLocalViewAndIntersection"{}},}
\DoxyCodeLine{95             [](\mbox{\hyperlink{a01489}{DirichletValues}}\& self,}
...
\DoxyCodeLine{105               \};}
\DoxyCodeLine{106               self.\mbox{\hyperlink{a01489_a7de80e6ad56431b46750ddbc2580c45e}{fixBoundaryDOFs}}(lambda);}
\DoxyCodeLine{107             \});}
\DoxyCodeLine{108 }
\DoxyCodeLine{109     cls.def(\textcolor{stringliteral}{"{}fixDOFs"{}},}
\DoxyCodeLine{110             [](\mbox{\hyperlink{a01489}{DirichletValues}}\& self, \textcolor{keyword}{const} std::function<\textcolor{keywordtype}{void}(Eigen::Ref<Eigen::VectorX<bool>>, \textcolor{keyword}{const} \mbox{\hyperlink{a01453}{Basis}}\&)>\& f) \{}
\DoxyCodeLine{111               self.\mbox{\hyperlink{a01489_a7de80e6ad56431b46750ddbc2580c45e}{fixBoundaryDOFs}}(f);}
\DoxyCodeLine{112             \});}
\DoxyCodeLine{113   \}}
\DoxyCodeLine{114 }
