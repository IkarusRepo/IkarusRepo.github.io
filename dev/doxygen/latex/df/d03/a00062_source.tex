...
\DoxyCodeLine{35   \textcolor{keyword}{auto} \mbox{\hyperlink{a00305_gaa33adfa2e95d7040a816bb2da81d275d}{orthonormalizeMatrixColumns}}(\textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& A) \{}
...
\DoxyCodeLine{57   \textcolor{keyword}{auto} \mbox{\hyperlink{a00305_ga545d74839895f4576a3b8c97d72abefd}{viewAsFlatEigenVector}}(Dune::BlockVector<ValueType>\& blockedVector) \{}
...
\DoxyCodeLine{72   \textcolor{keyword}{auto} \mbox{\hyperlink{a00305_ga545d74839895f4576a3b8c97d72abefd}{viewAsFlatEigenVector}}(\textcolor{keyword}{const} Dune::BlockVector<ValueType>\& blockedVector) \{}
...
\DoxyCodeLine{88   \textcolor{keyword}{auto} \mbox{\hyperlink{a00305_gaf9d7cf401f9f03ce1aae728c646ce178}{viewAsEigenMatrixAsDynFixed}}(Dune::BlockVector<ValueType>\& blockedVector) \{}
...
\DoxyCodeLine{104   \textcolor{keyword}{auto} \mbox{\hyperlink{a00305_gaf9d7cf401f9f03ce1aae728c646ce178}{viewAsEigenMatrixAsDynFixed}}(\textcolor{keyword}{const} Dune::BlockVector<ValueType>\& blockedVector) \{}
...
\DoxyCodeLine{121   \textcolor{keyword}{auto} \mbox{\hyperlink{a00305_gac25618d0e7c4aece653662d2541b61ec}{viewAsEigenMatrixFixedDyn}}(Dune::BlockVector<ValueType>\& blockedVector) \{}
...
\DoxyCodeLine{136   \textcolor{keyword}{auto} \mbox{\hyperlink{a00305_gac25618d0e7c4aece653662d2541b61ec}{viewAsEigenMatrixFixedDyn}}(\textcolor{keyword}{const} Dune::BlockVector<ValueType>\& blockedVector) \{}
...
\DoxyCodeLine{151   \textcolor{keywordtype}{size\_t} \mbox{\hyperlink{a00305_ga609664964681787f2f736f772b82a01e}{correctionSize}}(\textcolor{keyword}{const} Dune::BlockVector<Type>\& a) \textcolor{keyword}{requires} \textcolor{keyword}{requires} \{}
\DoxyCodeLine{152     \mbox{\hyperlink{a00305_ga609664964681787f2f736f772b82a01e}{Type::correctionSize}};}
\DoxyCodeLine{153   \}}
\DoxyCodeLine{154   \{ \textcolor{keywordflow}{return} a.size() * \mbox{\hyperlink{a00305_ga609664964681787f2f736f772b82a01e}{Type::correctionSize}}; \}}
\DoxyCodeLine{155 }
\DoxyCodeLine{163   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Type>}
\DoxyCodeLine{164   \textcolor{keywordtype}{size\_t} \mbox{\hyperlink{a00305_gac1df27a0dfa864327029cdb906a1840c}{valueSize}}(\textcolor{keyword}{const} Dune::BlockVector<Type>\& a) \textcolor{keyword}{requires} \textcolor{keyword}{requires} \{}
\DoxyCodeLine{165     \mbox{\hyperlink{a00305_gac1df27a0dfa864327029cdb906a1840c}{Type::valueSize}};}
\DoxyCodeLine{166   \}}
\DoxyCodeLine{167   \{ \textcolor{keywordflow}{return} a.size() * \mbox{\hyperlink{a00305_gac1df27a0dfa864327029cdb906a1840c}{Type::valueSize}}; \}}
\DoxyCodeLine{168 }
\DoxyCodeLine{178   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Type, \textcolor{keyword}{typename} Derived>}
\DoxyCodeLine{179   Dune::BlockVector<Type>\& \mbox{\hyperlink{a00305_gace6bdf5ec8a965423e5a13c20c91dd89}{operator+=}}(Dune::BlockVector<Type>\& a, \textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& b) \textcolor{keyword}{requires}(}
\DoxyCodeLine{180       \mbox{\hyperlink{a01630}{Ikarus::Concepts::AddAssignAble}}<Type, \textcolor{keyword}{decltype}(b.template segment<Type::correctionSize>(0))>and \textcolor{keyword}{requires}() \{}
\DoxyCodeLine{181         \mbox{\hyperlink{a00305_ga609664964681787f2f736f772b82a01e}{Type::correctionSize}};}
\DoxyCodeLine{182       \}) \{}
\DoxyCodeLine{183     assert(\mbox{\hyperlink{a00305_ga609664964681787f2f736f772b82a01e}{correctionSize}}(a) == \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{size\_t}\textcolor{keyword}{>}(b.size()) \&\& \textcolor{stringliteral}{"{} The passed vector has wrong size"{}});}
\DoxyCodeLine{184     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} i = 0U; i < a.size(); ++i)}
\DoxyCodeLine{185       a[i] += b.template segment<Type::correctionSize>(i * \mbox{\hyperlink{a00305_ga609664964681787f2f736f772b82a01e}{Type::correctionSize}});}
...
\DoxyCodeLine{199   Dune::BlockVector<Type>\& \mbox{\hyperlink{a00305_ga09e1060b2b3a53a77bb0da6345d844b1}{operator-\/=}}(Dune::BlockVector<Type>\& a, \textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& b) \textcolor{keyword}{requires}(}
\DoxyCodeLine{200       \mbox{\hyperlink{a01630}{Ikarus::Concepts::AddAssignAble}}<Type, \textcolor{keyword}{decltype}(b.template segment<Type::correctionSize>(0))>and \textcolor{keyword}{requires}() \{}
\DoxyCodeLine{201         \mbox{\hyperlink{a00305_ga609664964681787f2f736f772b82a01e}{Type::correctionSize}};}
\DoxyCodeLine{202       \}) \{}
...
\DoxyCodeLine{216   Dune::TupleVector<Types...>\& \mbox{\hyperlink{a00305_gace6bdf5ec8a965423e5a13c20c91dd89}{operator+=}}(Dune::TupleVector<Types...>\& a, \textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& b) \{}
...
\DoxyCodeLine{220       \textcolor{keyword}{const} \textcolor{keywordtype}{size\_t} size = \mbox{\hyperlink{a00305_ga609664964681787f2f736f772b82a01e}{correctionSize}}(a[i]);}
...
\DoxyCodeLine{239   \mbox{\hyperlink{a00305_gad6bf040c4e1fadbf243d4c1c9d2855b2}{addInEmbedding}}(Dune::BlockVector<ManifoldPoint>\& a, \textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& b) \textcolor{keyword}{requires}(}
\DoxyCodeLine{240       \mbox{\hyperlink{a01630}{Ikarus::Concepts::AddAssignAble}}<ManifoldPoint,}
\DoxyCodeLine{241                                       \textcolor{keyword}{decltype}(b.template segment<ManifoldPoint::valueSize>(0))>and \textcolor{keyword}{requires}() \{}
\DoxyCodeLine{242         \mbox{\hyperlink{a00305_gac1df27a0dfa864327029cdb906a1840c}{ManifoldPoint::valueSize}};}
\DoxyCodeLine{243       \}) \{}
\DoxyCodeLine{244     assert(\mbox{\hyperlink{a00305_gac1df27a0dfa864327029cdb906a1840c}{valueSize}}(a) == \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{size\_t}\textcolor{keyword}{>}(b.size()) \&\& \textcolor{stringliteral}{"{} The passed vector has wrong size"{}});}
\DoxyCodeLine{245     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} i = 0U; i < a.size(); ++i)}
\DoxyCodeLine{246       a[i].\mbox{\hyperlink{a00305_gad6bf040c4e1fadbf243d4c1c9d2855b2}{addInEmbedding}}(b.template segment<ManifoldPoint::valueSize>(i * \mbox{\hyperlink{a00305_gac1df27a0dfa864327029cdb906a1840c}{ManifoldPoint::valueSize}}));}
...
\DoxyCodeLine{258   \textcolor{keyword}{requires}(!std::floating\_point<Derived>) \textcolor{keyword}{auto} \mbox{\hyperlink{a00305_ga0ffc0c74dbd9aeee3e53b199a21b828c}{norm}}(\textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& v) \{ \textcolor{keywordflow}{return} v.norm(); \}}
\DoxyCodeLine{259 }
\DoxyCodeLine{266   \textcolor{keyword}{auto} \mbox{\hyperlink{a00305_ga0ffc0c74dbd9aeee3e53b199a21b828c}{norm}}(\textcolor{keyword}{const} std::floating\_point \textcolor{keyword}{auto}\& v) \{ \textcolor{keywordflow}{return} std::abs(v); \}}
\DoxyCodeLine{267 }
\DoxyCodeLine{277   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Scalar, \textcolor{keywordtype}{int} size>}
\DoxyCodeLine{278   \textcolor{keyword}{auto} \mbox{\hyperlink{a00305_gacbc60e06e8e43a9bc14660189eb1baa1}{operator*}}(\textcolor{keyword}{const} Eigen::DiagonalMatrix<Scalar, size>\& a, \textcolor{keyword}{const} Eigen::DiagonalMatrix<Scalar, size>\& b) \{}
...
\DoxyCodeLine{292   \textcolor{keyword}{auto} \mbox{\hyperlink{a00305_gace6bdf5ec8a965423e5a13c20c91dd89}{operator+=}}(Eigen::DiagonalMatrix<Scalar, size>\& a, \textcolor{keyword}{const} Eigen::DiagonalMatrix<Scalar, size>\& b) \{}
...
\DoxyCodeLine{308   \textcolor{keyword}{auto} \mbox{\hyperlink{a00305_ga098b554b29619e0cea837f3daa6e0e30}{operator+}}(\textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& a, \textcolor{keyword}{const} Eigen::DiagonalMatrix<Scalar, size>\& b) \{}
...
\DoxyCodeLine{325   \textcolor{keyword}{auto} \mbox{\hyperlink{a00305_ga098b554b29619e0cea837f3daa6e0e30}{operator+}}(\textcolor{keyword}{const} Eigen::DiagonalMatrix<Scalar, size>\& a, \textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& b) \{}
...
\DoxyCodeLine{338   \textcolor{keyword}{auto} \mbox{\hyperlink{a00305_ga9ab6437d6235e378a6171bfffd4bf1cc}{operator-\/}}(\textcolor{keyword}{const} Eigen::DiagonalMatrix<Scalar, size>\& a) \{}
...
\DoxyCodeLine{352   \textcolor{keyword}{auto} \mbox{\hyperlink{a00305_ga098b554b29619e0cea837f3daa6e0e30}{operator+}}(\textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& a, \textcolor{keyword}{const} Eigen::DiagonalWrapper<Derived2>\& b) \{}
...
\DoxyCodeLine{368   \textcolor{keyword}{auto} \mbox{\hyperlink{a00305_ga098b554b29619e0cea837f3daa6e0e30}{operator+}}(\textcolor{keyword}{const} Eigen::DiagonalWrapper<Derived>\& a, \textcolor{keyword}{const} Eigen::MatrixBase<Derived2>\& b) \{}
...
\DoxyCodeLine{382   std::ostream\& \mbox{\hyperlink{a00305_gac2cdcc3047e59b91a4874a1355503cd5}{operator<<}}(std::ostream\& os, \textcolor{keyword}{const} Eigen::DiagonalMatrix<Scalar, size>\& a) \{}
...
\DoxyCodeLine{395   Derived \mbox{\hyperlink{a00305_gabd35ea7f69bcc71ee90ea421a1c48167}{sym}}(\textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& A) \{}
...
\DoxyCodeLine{407   Derived \mbox{\hyperlink{a00305_ga1496a9776a583f8b09c4244a68453394}{skew}}(\textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& A) \{}
...
\DoxyCodeLine{418   \textcolor{keywordtype}{void} \mbox{\hyperlink{a00305_ga40c08050aff1e3e49e58c7823ecbcc77}{printForMaple}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01454}{Eigen::EigenBase<Derived>}}\& A) \{}
...
\DoxyCodeLine{424       \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00317}{Eigen}};}
...
\DoxyCodeLine{441   \textcolor{keyword}{auto} \mbox{\hyperlink{a00305_ga821ecf80e4a83241318d825f49cd79e4}{createRandomVector}}(\textcolor{keyword}{typename} FieldVectorT::value\_type lower = -\/1, \textcolor{keyword}{typename} FieldVectorT::value\_type upper = 1) \{}
...
\DoxyCodeLine{459   Eigen::Matrix<ScalarType, 3, 3> \mbox{\hyperlink{a00305_ga1496a9776a583f8b09c4244a68453394}{skew}}(\textcolor{keyword}{const} Eigen::Vector<ScalarType, 3>\& a) \{}
...
\DoxyCodeLine{480   \textcolor{keyword}{constexpr} \textcolor{keyword}{auto} \mbox{\hyperlink{a00305_ga8bdeefaffd49685e7dcd89f34af51d76}{voigtNotationContainer}} = std::get<dim -\/ 1>(Impl::voigtIndices);}
\DoxyCodeLine{481 }
...
\DoxyCodeLine{495   \textcolor{keyword}{auto} \mbox{\hyperlink{a00305_ga19d425a4fbc72c2ef7a97d71de9329a4}{staticCondensation}}(\textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& E,}
...
\DoxyCodeLine{523   \textcolor{keyword}{auto} \mbox{\hyperlink{a00305_ga2f675229501979101656ec4dee7764d5}{removeCol}}(\textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& E, \textcolor{keyword}{const} std::array<size\_t, sizeOfRemovedCols>\& indices) \{}
...
\DoxyCodeLine{549   \textcolor{keyword}{auto} \mbox{\hyperlink{a00305_ga378c5569b7b899586e7c8006fb776351}{toVoigtAndMaybeReduce}}(\textcolor{keyword}{const} Eigen::Matrix<ST, 3, 3>\& E, [[maybe\_unused]] \textcolor{keyword}{const} MaterialImpl\& material,}
...
\DoxyCodeLine{552       \textcolor{keywordflow}{return} \mbox{\hyperlink{a00306_ga4304655095296ce9283e012587817a51}{toVoigt}}(E, isStrain);}
\DoxyCodeLine{553     \textcolor{keywordflow}{else} \{}
\DoxyCodeLine{554       \textcolor{keyword}{auto} ev = \mbox{\hyperlink{a00306_ga4304655095296ce9283e012587817a51}{toVoigt}}(E, isStrain);}
...
\DoxyCodeLine{556 }
\DoxyCodeLine{557       \textcolor{keyword}{auto} evRed = \mbox{\hyperlink{a00305_ga2f675229501979101656ec4dee7764d5}{removeCol}}(ev, MaterialImpl::fixedVoigtIndices);}
...
\DoxyCodeLine{577   \textcolor{keyword}{decltype}(\textcolor{keyword}{auto}) \mbox{\hyperlink{a00305_ga30500f2c49b7d1997c7eb7b6ee90ad75}{enlargeIfReduced}}(\textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& E) \{}
\DoxyCodeLine{578     \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (!Concepts::EigenVector6<Derived> and \mbox{\hyperlink{a01636}{Concepts::EigenVector<Derived>}}) \{}
\DoxyCodeLine{579       \textcolor{keyword}{static\_assert}(\mbox{\hyperlink{a01298_a9c276dd6faf7062d02dde5c01644fd10}{Material::isReduced}}, \textcolor{stringliteral}{"{}You should only end up here, if your material is reduced"{}});}
\DoxyCodeLine{580 }
...
\DoxyCodeLine{591       \textcolor{keyword}{static\_assert}(\mbox{\hyperlink{a01298_a9c276dd6faf7062d02dde5c01644fd10}{Material::isReduced}}, \textcolor{stringliteral}{"{}You should only end up here, if your material is reduced"{}});}
\DoxyCodeLine{592 }
