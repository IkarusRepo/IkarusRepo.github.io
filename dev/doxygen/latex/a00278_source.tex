...
\DoxyCodeLine{16 }
\DoxyCodeLine{17 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00369}{Ikarus::ResultEvaluators}} \{}
\DoxyCodeLine{18 }
\DoxyCodeLine{25 \textcolor{keyword}{struct }\mbox{\hyperlink{a01537}{VonMises}}}
\DoxyCodeLine{26 \{}
\DoxyCodeLine{34   \textcolor{keyword}{template} <\textcolor{keyword}{typename} R>}
\DoxyCodeLine{35   \textcolor{keywordtype}{double} \mbox{\hyperlink{a01537_a041bead382beb38c3d0f128d729e9e5d}{operator()}}(\textcolor{keyword}{const} R\& resultArray, [[maybe\_unused]] \textcolor{keyword}{const} \textcolor{keywordtype}{int} comp)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{50   \}}
\DoxyCodeLine{51 }
\DoxyCodeLine{56   \textcolor{keyword}{static} std::string \mbox{\hyperlink{a01537_a60952d65a227074bcb68af8ed78d4129}{name}}() \{ \textcolor{keywordflow}{return} \textcolor{stringliteral}{"{}VonMises"{}}; \}}
\DoxyCodeLine{57 }
\DoxyCodeLine{62   \textcolor{keyword}{static} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01537_acdfd2226b12f3819350f4ea231e337bf}{ncomps}}() \{ \textcolor{keywordflow}{return} 1; \}}
\DoxyCodeLine{63 \};}
\DoxyCodeLine{64 }
...
\DoxyCodeLine{74 \textcolor{keyword}{struct} \mbox{\hyperlink{a01541}{PrincipalStress}}}
\DoxyCodeLine{75 \{}
\DoxyCodeLine{82   \textcolor{keywordtype}{double} \mbox{\hyperlink{a01541_a5b1a1b6fc619e80943b5b54912371cef}{operator()}}(\textcolor{keyword}{const} \textcolor{keyword}{auto}\& resultArray, \textcolor{keyword}{const} \textcolor{keywordtype}{int} comp)\textcolor{keyword}{ const }\{}
\DoxyCodeLine{83     \textcolor{keyword}{auto} mat = \mbox{\hyperlink{a00356_ga106e11a950fe2545890e811d2e9545fd}{fromVoigt}}(resultArray, \textcolor{keyword}{false});}
...
\DoxyCodeLine{86   \}}
\DoxyCodeLine{87 }
\DoxyCodeLine{92   \textcolor{keyword}{static} std::string \mbox{\hyperlink{a01541_aab635f940c3d1785f4bafe281b575500}{name}}() \{ \textcolor{keywordflow}{return} \textcolor{stringliteral}{"{}PrincipalStress"{}}; \}}
\DoxyCodeLine{93 }
\DoxyCodeLine{98   \textcolor{keyword}{static} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01541_abc08f088b44639b38ce5fb4b7b3ce7c6}{ncomps}}() \{ \textcolor{keywordflow}{return} dim; \}}
\DoxyCodeLine{99 \};}
\DoxyCodeLine{100 }
