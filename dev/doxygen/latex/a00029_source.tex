\hypertarget{a00029_source}{}\doxysection{functionsanitychecks.\+hh}
\label{a00029_source}\index{functionsanitychecks.hh@{functionsanitychecks.hh}}
...
\DoxyCodeLine{10 \textcolor{preprocessor}{\#include "{}\mbox{\hyperlink{a00062}{findlinesegment.hh}}"{}}}
\DoxyCodeLine{11 }
...
\DoxyCodeLine{28   \textcolor{keywordtype}{double} drawResultAndReturnSlope(std::string\&\& functionName, \textcolor{keyword}{const} std::function<\textcolor{keywordtype}{double}(\textcolor{keywordtype}{double})>\& ftfunc, \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00176_a65b25c4ffa5a9d9f808da12703e79cb2}{draw}},}
\DoxyCodeLine{29                                   \textcolor{keywordtype}{int} slopeOfReference);}
\DoxyCodeLine{30 \} \textcolor{comment}{// namespace Impl}}
\DoxyCodeLine{34 \textcolor{comment}{}\textcolor{keyword}{struct }\mbox{\hyperlink{a01532}{CheckFlags}}}
\DoxyCodeLine{35 \{}
\DoxyCodeLine{36   \textcolor{keywordtype}{bool} \mbox{\hyperlink{a01532_a08fa473dcdfbdb5dcf759546ea2da3b8}{draw}}                        = \textcolor{keyword}{true};}
\DoxyCodeLine{37   \textcolor{keywordtype}{bool} \mbox{\hyperlink{a01532_ac9946207ee221c94e843ea7c048a16a3}{writeSlopeStatementIfFailed}} = \textcolor{keyword}{true};}
\DoxyCodeLine{38   \textcolor{keywordtype}{double} \mbox{\hyperlink{a01532_a6c1e702608ca901f9f7efca524560b25}{tolerance}}                 = 1e-\/2;}
\DoxyCodeLine{39 \};}
\DoxyCodeLine{40 }
...
\DoxyCodeLine{55     NonlinearOperator\& nonLinOp, \mbox{\hyperlink{a01532}{CheckFlags}} checkFlags = \mbox{\hyperlink{a01532}{CheckFlags}}(),}
...
\DoxyCodeLine{116     NonlinearOperator\& nonLinOp, \mbox{\hyperlink{a01532}{CheckFlags}} checkFlags = \mbox{\hyperlink{a01532}{CheckFlags}}(),}
...
\DoxyCodeLine{169     NonlinearOperator\& nonLinOp, \mbox{\hyperlink{a01532}{CheckFlags}} checkFlags = \mbox{\hyperlink{a01532}{CheckFlags}}(),}
