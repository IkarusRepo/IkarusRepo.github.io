\hypertarget{a02864_source}{}\doxysection{python/ikarus/materials/materials.hh}
\label{a02864_source}\index{materials.hh@{materials.hh}}
...
\DoxyCodeLine{11 }
\DoxyCodeLine{12 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a02861}{ikarus/finiteelements/mechanics/materials.hh}}>}}
\DoxyCodeLine{13 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00242}{ikarus/finiteelements/mechanics/materials/tags.hh}}>}}
\DoxyCodeLine{14 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00218}{ikarus/python/finiteelements/material.hh}}>}}
\DoxyCodeLine{15 }
\DoxyCodeLine{16 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00372_ga2c5ed0e112e5ea2865689ad21282c5e6}{addMaterialsSubModule}}(pybind11::module\& m) \{}
\DoxyCodeLine{17   \textcolor{keyword}{namespace }py = pybind11;}
\DoxyCodeLine{18   \textcolor{keyword}{using namespace }pybind11::literals;}
\DoxyCodeLine{19   \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00384}{Ikarus}};}
\DoxyCodeLine{20   \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00396}{Eigen}};}
\DoxyCodeLine{21 }
...
\DoxyCodeLine{23 }
\DoxyCodeLine{24   \mbox{\hyperlink{a00350_a4f679b27b8832c36acea41eab8e0d0bc}{ENUM\_BINDINGS\_WITH\_MODULE}}(\mbox{\hyperlink{a00373_gacef1e451de1a99845c59d7391064fb8f}{StrainTags}}, materials);}
\DoxyCodeLine{25   \mbox{\hyperlink{a00350_a4f679b27b8832c36acea41eab8e0d0bc}{ENUM\_BINDINGS\_WITH\_MODULE}}(\mbox{\hyperlink{a00373_ga70b4ce43c53cc5e949d49919f437501e}{StressTags}}, materials);}
\DoxyCodeLine{26   \mbox{\hyperlink{a00350_a4f679b27b8832c36acea41eab8e0d0bc}{ENUM\_BINDINGS\_WITH\_MODULE}}(\mbox{\hyperlink{a00373_ga05ac785124262c1e323d2f937d520a1b}{TangentModuliTags}}, materials);}
\DoxyCodeLine{27 }
\DoxyCodeLine{28   pybind11::class\_<LinearElasticity> linElastic(materials, \textcolor{stringliteral}{"{}LinearElasticity"{}});}
\DoxyCodeLine{29   Ikarus::Python::registerLinearElasticity(materials, linElastic);}
\DoxyCodeLine{30 }
\DoxyCodeLine{31   pybind11::class\_<StVenantKirchhoff> svk(materials, \textcolor{stringliteral}{"{}StVenantKirchhoff"{}});}
\DoxyCodeLine{32   Ikarus::Python::registerStVenantKirchhoff(materials, svk);}
\DoxyCodeLine{33 }
\DoxyCodeLine{34   pybind11::class\_<NeoHooke> nh(materials, \textcolor{stringliteral}{"{}NeoHooke"{}});}
...
\DoxyCodeLine{49       [](\mbox{\hyperlink{a00373_gacef1e451de1a99845c59d7391064fb8f}{StrainTags}} from, \mbox{\hyperlink{a00373_gacef1e451de1a99845c59d7391064fb8f}{StrainTags}} to, Eigen::MatrixXd E) -\/> Eigen::MatrixXd \{}
\DoxyCodeLine{50         \textcolor{keyword}{auto} callTransformStrain =}
\DoxyCodeLine{51             []<\mbox{\hyperlink{a00373_gacef1e451de1a99845c59d7391064fb8f}{StrainTags}} from\_, \mbox{\hyperlink{a00373_gacef1e451de1a99845c59d7391064fb8f}{StrainTags}} to\_>(\textcolor{keyword}{const} Eigen::MatrixXd\& eRaw) -\/> Eigen::MatrixXd \{}
...
\DoxyCodeLine{76             \textcolor{keywordflow}{case} \mbox{\hyperlink{a00373_ggacef1e451de1a99845c59d7391064fb8fa0eb1f1f7a6a355c2f4260b74c21d80f3}{Ikarus::StrainTags::displacementGradient}}:}
...
\DoxyCodeLine{79             \textcolor{keywordflow}{case} \mbox{\hyperlink{a00373_ggacef1e451de1a99845c59d7391064fb8faea40a9960a7a89c4f366beeab85d07d2}{Ikarus::StrainTags::rightCauchyGreenTensor}}:}
...
\DoxyCodeLine{90             \textcolor{keywordflow}{case} \mbox{\hyperlink{a00373_ggacef1e451de1a99845c59d7391064fb8fa0eb1f1f7a6a355c2f4260b74c21d80f3}{Ikarus::StrainTags::displacementGradient}}:}
...
\DoxyCodeLine{93             \textcolor{keywordflow}{case} \mbox{\hyperlink{a00373_ggacef1e451de1a99845c59d7391064fb8faea40a9960a7a89c4f366beeab85d07d2}{Ikarus::StrainTags::rightCauchyGreenTensor}}:}
...
\DoxyCodeLine{104             \textcolor{keywordflow}{case} \mbox{\hyperlink{a00373_ggacef1e451de1a99845c59d7391064fb8fa0eb1f1f7a6a355c2f4260b74c21d80f3}{Ikarus::StrainTags::displacementGradient}}:}
...
\DoxyCodeLine{107             \textcolor{keywordflow}{case} \mbox{\hyperlink{a00373_ggacef1e451de1a99845c59d7391064fb8fa61fc106262d2e2049866894bb4f862a5}{Ikarus::StrainTags::deformationGradient}}:}
