\hypertarget{a00215_source}{}\doxysection{traction.\+hh}
\label{a00215_source}\index{traction.hh@{traction.hh}}
...
\DoxyCodeLine{9 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00023}{ikarus/utils/defaultfunctions.hh}}>}}
\DoxyCodeLine{10 }
...
\DoxyCodeLine{98         \textcolor{keyword}{const} \mbox{\hyperlink{a01370}{Dune::FieldVector<double, myDim>}}\& quadPos = intersection.geometryInInside().global(curQuad.position());}
\DoxyCodeLine{99 }
...
\DoxyCodeLine{120     \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00331}{Dune}};}
...
\DoxyCodeLine{133         \textcolor{keyword}{const} \mbox{\hyperlink{a01370}{Dune::FieldVector<double, myDim>}}\& quadPos = intersection.geometryInInside().global(curQuad.position());}
...
\DoxyCodeLine{153   std::function<Eigen::Vector<double, worldDim>(\textcolor{keyword}{const} \mbox{\hyperlink{a01370}{Dune::FieldVector<double, worldDim>}}\&, \textcolor{keyword}{const} \textcolor{keywordtype}{double}\&)>}
