...
\DoxyCodeLine{20 \textcolor{keyword}{class }\mbox{\hyperlink{a01364}{FieldVector}};}
...
\DoxyCodeLine{24 }
\DoxyCodeLine{35 \textcolor{keyword}{struct }\mbox{\hyperlink{a01368}{VonMises}}}
\DoxyCodeLine{36 \{}
...
\DoxyCodeLine{38   \textcolor{keywordtype}{double} \mbox{\hyperlink{a01368_a1cf7d88462db0aba4e49e6c635269c46}{operator()}}(\textcolor{keyword}{const} ElementType\& fe, \textcolor{keyword}{const} \mbox{\hyperlink{a01252}{ResultRequirements<FERequirements>}}\& req,}
\DoxyCodeLine{39                     \textcolor{keyword}{const} \mbox{\hyperlink{a01364}{Dune::FieldVector<ScalarType, size>}}\& pos, [[maybe\_unused]] \textcolor{keywordtype}{int} comp) \textcolor{keyword}{const}}
...
\DoxyCodeLine{52   \}}
\DoxyCodeLine{53 }
\DoxyCodeLine{58   \textcolor{keyword}{static} std::string \mbox{\hyperlink{a01368_a60952d65a227074bcb68af8ed78d4129}{name}}() \{ \textcolor{keywordflow}{return} \textcolor{stringliteral}{"{}VonMises"{}}; \}}
\DoxyCodeLine{59 }
\DoxyCodeLine{64   \textcolor{keyword}{static} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01368_acdfd2226b12f3819350f4ea231e337bf}{ncomps}}() \{ \textcolor{keywordflow}{return} 1; \}}
\DoxyCodeLine{65 \};}
\DoxyCodeLine{66 }
\DoxyCodeLine{78 \textcolor{keyword}{struct }\mbox{\hyperlink{a01372}{PrincipalStress}}}
\DoxyCodeLine{79 \{}
...
\DoxyCodeLine{81   \textcolor{keywordtype}{double} \mbox{\hyperlink{a01372_a30ccc009cdf990e107cb807f769bbc5b}{operator()}}(\textcolor{keyword}{const} ElementType\& fe, \textcolor{keyword}{const} \mbox{\hyperlink{a01252}{ResultRequirements<FERequirements>}}\& req,}
\DoxyCodeLine{82                     \textcolor{keyword}{const} \mbox{\hyperlink{a01364}{Dune::FieldVector<ScalarType, size>}}\& pos, \textcolor{keywordtype}{int} comp) \textcolor{keyword}{const}}
...
\DoxyCodeLine{98   \}}
\DoxyCodeLine{99 }
\DoxyCodeLine{104   \textcolor{keyword}{static} std::string \mbox{\hyperlink{a01372_a3bf1a9009747f7fe1e645192bcf6350d}{name}}() \{ \textcolor{keywordflow}{return} \textcolor{stringliteral}{"{}PrincipalStress"{}}; \}}
\DoxyCodeLine{105 }
\DoxyCodeLine{110   \textcolor{keyword}{static} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01372_a5f3b81a2fcecace3ee76bff9acee54d3}{ncomps}}() \{ \textcolor{keywordflow}{return} 2; \}}
\DoxyCodeLine{111 \};}
\DoxyCodeLine{112 }
