\hypertarget{a00206_source}{}\doxysection{flatassembler.\+hh}
\label{a00206_source}\index{flatassembler.hh@{flatassembler.hh}}
...
\DoxyCodeLine{16 }
\DoxyCodeLine{17 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00176}{ikarus/assembler/dirichletbcenforcement.hh}}>}}
\DoxyCodeLine{18 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00323}{ikarus/finiteelements/ferequirements.hh}}>}}
\DoxyCodeLine{19 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a03006}{ikarus/utils/basis.hh}}>}}
\DoxyCodeLine{20 }
...
\DoxyCodeLine{41 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00388_ga87d3c6e620be5df59ba6923751caae86}{registerFlatAssembler}}(pybind11::handle scope, pybind11::class\_<Assembler, options...> cls) \{}
...
\DoxyCodeLine{49 }
\DoxyCodeLine{50   cls.def(\mbox{\hyperlink{a00396_ac8243891c1b961e50a066140ab79a142}{pybind11::init}}([](\textcolor{keyword}{const} pybind11::list\& fes, \textcolor{keyword}{const} DirichletValuesType\& \mbox{\hyperlink{a00426_a453691a9a22118c4736e30240481a281}{dirichletValues}}) \{}
...
\DoxyCodeLine{55             \textcolor{keywordflow}{return} \textcolor{keyword}{new} Assembler(std::move(fesV), \mbox{\hyperlink{a00426_a453691a9a22118c4736e30240481a281}{dirichletValues}});}
\DoxyCodeLine{56           \}),}
...
\DoxyCodeLine{64       [](Assembler\& self, \textcolor{keyword}{const} FERequirementType\& req, \mbox{\hyperlink{a00396_a390d5311179ec61d163a29c943b3d1a0}{Ikarus::MatrixAffordance}} affordance,}
\DoxyCodeLine{65          \mbox{\hyperlink{a00396_a9f83fad9f4c149f249165a13f2370eec}{Ikarus::DBCOption}} dbcOption) -\/> std::remove\_cvref\_t<\textcolor{keyword}{decltype}(self.matrix(req, affordance))> \{}
...
\DoxyCodeLine{76       [](Assembler\& self, \mbox{\hyperlink{a00396_a9f83fad9f4c149f249165a13f2370eec}{Ikarus::DBCOption}} dbcOption) -\/> std::remove\_cvref\_t<\textcolor{keyword}{decltype}(self.matrix(dbcOption))> \{}
...
\DoxyCodeLine{83       [](Assembler\& self, \textcolor{keyword}{const} FERequirementType\& req, \mbox{\hyperlink{a00396_aab9e3e38507d1db7602bc750718c302a}{Ikarus::VectorAffordance}} affordance,}
\DoxyCodeLine{84          \mbox{\hyperlink{a00396_a9f83fad9f4c149f249165a13f2370eec}{Ikarus::DBCOption}} dbcOption) \{ \textcolor{keywordflow}{return} self.vector(req, affordance, dbcOption); \},}
...
\DoxyCodeLine{90       \textcolor{stringliteral}{"{}vector"{}}, [](Assembler\& self, \mbox{\hyperlink{a00396_a9f83fad9f4c149f249165a13f2370eec}{Ikarus::DBCOption}} dbcOption) \{ \textcolor{keywordflow}{return} self.vector(dbcOption); \},}
...
\DoxyCodeLine{95       [](Assembler\& self, \textcolor{keyword}{const} FERequirementType\& req, \mbox{\hyperlink{a00396_af6f894084edd9109762b86222995ef2a}{Ikarus::ScalarAffordance}} affordance) \{}
...
\DoxyCodeLine{108                      \mbox{\hyperlink{a00396_a9f83fad9f4c149f249165a13f2370eec}{DBCOption}} dbcOption = \mbox{\hyperlink{a00396_a9f83fad9f4c149f249165a13f2370eecabbd47109890259c0127154db1af26c75}{DBCOption::Full}}) \{ \textcolor{keywordflow}{return} self.bind(req, affordance, dbcOption); \});}
...
\DoxyCodeLine{111   cls.def(\textcolor{stringliteral}{"{}bind"{}}, [](Assembler\& self, \textcolor{keyword}{const} \mbox{\hyperlink{a00396_a9f83fad9f4c149f249165a13f2370eec}{DBCOption}} dbcOption) \{ \textcolor{keywordflow}{return} self.bind(dbcOption); \});}
...
\DoxyCodeLine{131 }
\DoxyCodeLine{132 \mbox{\hyperlink{a00206_adda74d8564a01c0a9851a4379308a8b2}{MAKE\_ASSEMBLER\_REGISTERY\_FUNCTION}}(\mbox{\hyperlink{a01303}{SparseFlatAssembler}});}
\DoxyCodeLine{133 \mbox{\hyperlink{a00206_adda74d8564a01c0a9851a4379308a8b2}{MAKE\_ASSEMBLER\_REGISTERY\_FUNCTION}}(\mbox{\hyperlink{a01307}{DenseFlatAssembler}});}
\DoxyCodeLine{134 }
