\hypertarget{a00257_source}{}\doxysection{membranestrains.\+hh}
\label{a00257_source}\index{membranestrains.hh@{membranestrains.hh}}
...
\DoxyCodeLine{16 }
\DoxyCodeLine{17 \textcolor{keyword}{struct }\mbox{\hyperlink{a01409}{DefaultMembraneStrain}}}
\DoxyCodeLine{18 \{}
\DoxyCodeLine{30   \textcolor{keyword}{template} <\textcolor{keyword}{typename} GEO>}
\DoxyCodeLine{31   \textcolor{keyword}{static} \textcolor{keyword}{auto} \mbox{\hyperlink{a01409_a7c65ab77e1e42865fc4d0b04a5cb288a}{value}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01573}{Dune::FieldVector<double, 2>}}\& gpPos, \textcolor{keyword}{const} GEO\& geo,}
...
\DoxyCodeLine{36     \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00354}{Dune}};}
...
\DoxyCodeLine{65   \textcolor{keyword}{static} \textcolor{keyword}{auto} \mbox{\hyperlink{a01409_a0e9910984eae86b868f317f0a26a132e}{derivative}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01573}{Dune::FieldVector<double, 2>}}\& gpPos, \textcolor{keyword}{const} Eigen::Matrix<ST, 2, 3>\& jcur,}
...
\DoxyCodeLine{96   \textcolor{keyword}{static} \textcolor{keyword}{auto} \mbox{\hyperlink{a01409_a28a06b4e89e7e526e8b09b020d6adfcf}{secondDerivative}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01573}{Dune::FieldVector<double, 2>}}\& gpPos, \textcolor{keyword}{const} \textcolor{keyword}{auto}\& dNAtGp, \textcolor{keyword}{const} GEO\& geo,}
