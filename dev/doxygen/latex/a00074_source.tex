...
\DoxyCodeLine{13 }
\DoxyCodeLine{14 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00362}{std}} \{}
...
\DoxyCodeLine{20 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00384}{Ikarus::traits}} \{}
\DoxyCodeLine{21 }
\DoxyCodeLine{27 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T>}
\DoxyCodeLine{28 \textcolor{keyword}{concept }\mbox{\hyperlink{a01885}{Pointer}} = std::is\_pointer\_v<T> || std::is\_same\_v<T, std::nullptr\_t>;}
\DoxyCodeLine{29 }
...
\DoxyCodeLine{42 \textcolor{keyword}{struct }is\_tuple<\mbox{\hyperlink{a00362}{std}}::tuple<T...>> : std::true\_type}
\DoxyCodeLine{43 \{}
\DoxyCodeLine{44 \};}
\DoxyCodeLine{45 }
...
\DoxyCodeLine{55 \textcolor{keyword}{consteval} \textcolor{keywordtype}{int} \mbox{\hyperlink{a00361_ga45ac3fa7e384aa760181de7a1377dc14}{countType}}() \{}
...
\DoxyCodeLine{74 \textcolor{keyword}{using }\mbox{\hyperlink{a00361_ga0ba1bf25ee478b1b1d9e96c1dcd831a0}{ReturnType}} = std::invoke\_result\_t<Fun, Args...>;}
\DoxyCodeLine{75 }
\DoxyCodeLine{84 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T, \textcolor{keyword}{typename} Tuple>}
\DoxyCodeLine{85 \textcolor{keyword}{struct }\mbox{\hyperlink{a01800}{hasType}} : std::false\_type}
\DoxyCodeLine{86 \{}
\DoxyCodeLine{87 \};}
\DoxyCodeLine{88 }
...
\DoxyCodeLine{91 \textcolor{keyword}{struct }\mbox{\hyperlink{a01800}{hasType}}<T, \mbox{\hyperlink{a00362}{std}}::tuple<>> : std::false\_type}
\DoxyCodeLine{92 \{}
\DoxyCodeLine{93 \};}
\DoxyCodeLine{94 }
...
\DoxyCodeLine{108 \textcolor{keyword}{struct }hasType<T, \mbox{\hyperlink{a00362}{std}}::tuple<U, Ts...>> : hasType<T, std::tuple<Ts...>>}
\DoxyCodeLine{109 \{}
\DoxyCodeLine{110 \};}
\DoxyCodeLine{111 }
\DoxyCodeLine{112 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T, \textcolor{keyword}{typename}... Ts>}
\DoxyCodeLine{113 \textcolor{keyword}{struct }hasType<T, \mbox{\hyperlink{a00362}{std}}::tuple<T, Ts...>> : std::true\_type}
\DoxyCodeLine{114 \{}
\DoxyCodeLine{115 \};}
...
\DoxyCodeLine{133 \textcolor{keyword}{struct }\mbox{\hyperlink{a01804}{isSharedPtr}} : std::false\_type}
\DoxyCodeLine{134 \{}
\DoxyCodeLine{135 \};}
\DoxyCodeLine{136 }
...
\DoxyCodeLine{139 \textcolor{keyword}{struct }\mbox{\hyperlink{a01804}{isSharedPtr<std::shared\_ptr<T>}}> : std::true\_type}
\DoxyCodeLine{140 \{}
\DoxyCodeLine{141 \};}
\DoxyCodeLine{142 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{143 }
\DoxyCodeLine{144 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T>}
\DoxyCodeLine{145 \textcolor{keyword}{class }\mbox{\hyperlink{a01808}{remove\_pointer}}}
\DoxyCodeLine{146 \{}
...
\DoxyCodeLine{152   \textcolor{keyword}{using }\mbox{\hyperlink{a01808_aeb039b36424f998cbf10801e5609eb8c}{type}} = \textcolor{keyword}{typename} \textcolor{keyword}{decltype}(test(0))\mbox{\hyperlink{a01808_aeb039b36424f998cbf10801e5609eb8c}{::type}};}
\DoxyCodeLine{153 \};}
\DoxyCodeLine{154 }
\DoxyCodeLine{155 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T>}
\DoxyCodeLine{156 \textcolor{keyword}{using }\mbox{\hyperlink{a00384_a472256748675b3006507836bd8034a0e}{remove\_pointer\_t}} = \textcolor{keyword}{typename} \mbox{\hyperlink{a01808_aeb039b36424f998cbf10801e5609eb8c}{remove\_pointer<T>::type}};}
\DoxyCodeLine{157 }
...
\DoxyCodeLine{259 \textcolor{keyword}{struct }\mbox{\hyperlink{a01828}{Index}};}
\DoxyCodeLine{260 \textcolor{preprocessor}{\#ifndef DOXYGEN}}
\DoxyCodeLine{261 \textcolor{keyword}{template} <\textcolor{keyword}{class} T>}
\DoxyCodeLine{262 \textcolor{keyword}{struct }\mbox{\hyperlink{a01828}{Index}}<T, \mbox{\hyperlink{a00362}{std}}::tuple<>>}
\DoxyCodeLine{263 \{}
...
\DoxyCodeLine{268 \textcolor{keyword}{struct }\mbox{\hyperlink{a01828}{Index}}<T, \mbox{\hyperlink{a00362}{std}}::tuple<T, Types...>>}
\DoxyCodeLine{269 \{}
...
\DoxyCodeLine{274 \textcolor{keyword}{struct }Index<T, \mbox{\hyperlink{a00362}{std}}::tuple<U, Types...>>}
\DoxyCodeLine{275 \{}
...
\DoxyCodeLine{298 \textcolor{keyword}{struct }\mbox{\hyperlink{a01832}{Rebind}};}
\DoxyCodeLine{299 }
...
\DoxyCodeLine{305 \textcolor{keyword}{struct }\mbox{\hyperlink{a01832}{Rebind}}<Container<OldType, Args...>, NewType>}
\DoxyCodeLine{306 \{}
...
\DoxyCodeLine{314 \textcolor{keyword}{struct }\mbox{\hyperlink{a01832}{Rebind}}<Container<OldType, N>, NewType>}
\DoxyCodeLine{315 \{}
...
\DoxyCodeLine{331 \textcolor{keyword}{struct }\mbox{\hyperlink{a01836}{FunctionTraits}};}
\DoxyCodeLine{332 }
...
\DoxyCodeLine{338 \textcolor{keyword}{struct }\mbox{\hyperlink{a01836}{FunctionTraits}}<R (*)(Args...)>}
\DoxyCodeLine{339 \{}
...
\DoxyCodeLine{352 \textcolor{keyword}{struct }\mbox{\hyperlink{a01836}{FunctionTraits}}<R (C::*)(Args...) const>}
\DoxyCodeLine{353 \{}
...
\DoxyCodeLine{381 \textcolor{keyword}{struct }FunctionTraits<T, \mbox{\hyperlink{a00381}{Dune}}::void\_t<decltype(\&T::operator())>> : \textcolor{keyword}{public} FunctionTraits<decltype(\&T::operator())>}
\DoxyCodeLine{382 \{}
\DoxyCodeLine{383 \};}
...
\DoxyCodeLine{394 \textcolor{keyword}{struct }\mbox{\hyperlink{a01840}{ReplaceTypeAtPos}};}
\DoxyCodeLine{395 }
...
\DoxyCodeLine{398 \textcolor{keyword}{struct }\mbox{\hyperlink{a01840}{ReplaceTypeAtPos}}<\mbox{\hyperlink{a00362}{std}}::tuple<Args...>, Pos, NewType>}
\DoxyCodeLine{399 \{}
...
\DoxyCodeLine{417 \textcolor{keyword}{using }\mbox{\hyperlink{a00384_ac903f76dfaaaf40abfe1c532850db3d1}{ReplaceTypeAtPos\_t}} = \textcolor{keyword}{typename} \mbox{\hyperlink{a01840}{ReplaceTypeAtPos<Tuple, Pos, NewType>::type}};}
\DoxyCodeLine{418 }
\DoxyCodeLine{425 \textcolor{keyword}{template} <\textcolor{keyword}{typename} R, \textcolor{keyword}{typename} Tuple>}
\DoxyCodeLine{426 \textcolor{keyword}{struct }\mbox{\hyperlink{a01844}{TupleToFunctionType}};}
\DoxyCodeLine{427 }
...
\DoxyCodeLine{430 \textcolor{keyword}{struct }\mbox{\hyperlink{a01844}{TupleToFunctionType}}<R, \mbox{\hyperlink{a00362}{std}}::tuple<Args...>>}
\DoxyCodeLine{431 \{}
...
\DoxyCodeLine{443 \textcolor{keyword}{using }\mbox{\hyperlink{a00384_a6b604914727df9d1b05be9a64c56898c}{TupleToFunctionType\_t}} = \textcolor{keyword}{typename} \mbox{\hyperlink{a01844}{TupleToFunctionType<R, Tuple>::type}};}
\DoxyCodeLine{444 }
...
\DoxyCodeLine{453 \textcolor{keyword}{struct }\mbox{\hyperlink{a01848}{ChangeArgTypeAtPos}};}
\DoxyCodeLine{454 }
...
\DoxyCodeLine{457 \textcolor{keyword}{struct }\mbox{\hyperlink{a01848}{ChangeArgTypeAtPos}}<\mbox{\hyperlink{a00362}{std}}::function<R(Args...)>, Pos, NewType>}
\DoxyCodeLine{458 \{}
\DoxyCodeLine{459   \textcolor{keyword}{using }OriginalFunction = std::function<R(Args...)>;}
\DoxyCodeLine{460   \textcolor{keyword}{using }Traits           = \mbox{\hyperlink{a01836}{FunctionTraits<OriginalFunction>}};}
\DoxyCodeLine{461   \textcolor{keyword}{using }NewArgsTuple     = \mbox{\hyperlink{a00384_ac903f76dfaaaf40abfe1c532850db3d1}{ReplaceTypeAtPos\_t<typename Traits::ArgsTuple, Pos, NewType>}};}
\DoxyCodeLine{462   \textcolor{keyword}{using }NewFunctionType  = \mbox{\hyperlink{a00384_a6b604914727df9d1b05be9a64c56898c}{TupleToFunctionType\_t<R, NewArgsTuple>}};}
\DoxyCodeLine{463 \};}
