\hypertarget{a00176_source}{}\doxysection{fehelper.\+hh}
\label{a00176_source}\index{fehelper.hh@{fehelper.hh}}
...
\DoxyCodeLine{10 }
\DoxyCodeLine{11 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00313}{Ikarus::FEHelper}} \{}
\DoxyCodeLine{24   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Traits, \textcolor{keyword}{typename} ScalarType>}
\DoxyCodeLine{25   \textcolor{keyword}{auto} \mbox{\hyperlink{a00313_a2c8d65eb2c1b14e022a42dbccf0b5cb1}{localSolutionBlockVector}}(\textcolor{keyword}{const} \textcolor{keyword}{typename} Traits::FERequirementType::SolutionVectorTypeRaw\& x,}
