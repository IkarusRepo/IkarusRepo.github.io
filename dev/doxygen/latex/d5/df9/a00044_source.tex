...
\DoxyCodeLine{17 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00320}{Ikarus::utils}} \{}
\DoxyCodeLine{18 }
\DoxyCodeLine{28   \textcolor{keywordtype}{void} \mbox{\hyperlink{a00307_ga6e36d8f5163f232e3142ecbd0575e8b4}{makeUniqueAndSort}}(std::ranges::random\_access\_range \textcolor{keyword}{auto}\& r) \{}
\DoxyCodeLine{29     sort(r.begin(), r.end());}
\DoxyCodeLine{30     r.erase(\mbox{\hyperlink{a00307_ga12de8f77a63ef488a87a5aa8536146ee}{std::unique}}(r.begin(), r.end()), r.end());}
\DoxyCodeLine{31   \}}
\DoxyCodeLine{32 }
\DoxyCodeLine{43   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Value>}
\DoxyCodeLine{44   \textcolor{keyword}{auto} \mbox{\hyperlink{a00307_ga8f6d2c90383de63c518cefeaccee76f8}{appendUnique}}(std::ranges::random\_access\_range \textcolor{keyword}{auto}\& r, Value\&\& v) \{}
...
\DoxyCodeLine{63   \textcolor{keywordtype}{void} \mbox{\hyperlink{a00307_ga11bb80da2430170954d6b7519f9498a6}{printContent}}(Container\&\& c, std::ostream\& os = std::cout) \{}
...
\DoxyCodeLine{76   \textcolor{keyword}{auto} \mbox{\hyperlink{a00307_ga5f3a9e195a06ac4419ccb479f8819d62}{transformValueRangeToPointerRange}}(Container\& cont) \{}
...
\DoxyCodeLine{91   \textcolor{keyword}{auto} \mbox{\hyperlink{a00307_gaabfee41eeb4843cb2fa37b5f381e9fef}{transformPointerRangeToReferenceRange}}(Container\& cont) \{}
...
\DoxyCodeLine{99   \textcolor{keyword}{auto} \mbox{\hyperlink{a00320_a4c617d2458cc6d792f5ba3e6c64a0c7f}{makeNestedTupleFlat}}(std::tuple<Types...> tup);}
...
\DoxyCodeLine{129           \textcolor{keywordflow}{return} std::tuple\_cat(\mbox{\hyperlink{a00320_a4c617d2458cc6d792f5ba3e6c64a0c7f}{makeNestedTupleFlat}}(T()), makeNestedTupleFlatImpl<Types...>());}
...
\DoxyCodeLine{134           \textcolor{keywordflow}{return} \mbox{\hyperlink{a00320_a4c617d2458cc6d792f5ba3e6c64a0c7f}{makeNestedTupleFlat}}(T());}
...
\DoxyCodeLine{215   \textcolor{keyword}{constexpr} \textcolor{keywordtype}{size\_t} \mbox{\hyperlink{a00307_gaf75511e781bb89056badd33413222010}{find\_if}}(Tuple\&\& tuple, Predicate pred) \{}
...
\DoxyCodeLine{243   \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00307_ga33284bcf99d7d3870e0aff06f6651aa2}{none\_of}}(Tuple\&\& tuple, Predicate pred) \{}
\DoxyCodeLine{244     \textcolor{keywordflow}{return} \mbox{\hyperlink{a00307_gaf75511e781bb89056badd33413222010}{find\_if}}(tuple, pred) == std::tuple\_size<std::decay\_t<Tuple>>::value;}
\DoxyCodeLine{245   \}}
\DoxyCodeLine{246 }
\DoxyCodeLine{259   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Tuple, \textcolor{keyword}{typename} Predicate>}
\DoxyCodeLine{260   \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00307_gab6d955a70ec9215ae9a8f3841582ab49}{any\_of}}(Tuple\&\& tuple, Predicate pred) \{}
\DoxyCodeLine{261     \textcolor{keywordflow}{return} !\mbox{\hyperlink{a00307_ga33284bcf99d7d3870e0aff06f6651aa2}{none\_of}}(tuple, pred);}
\DoxyCodeLine{262   \}}
\DoxyCodeLine{263 }
\DoxyCodeLine{278   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Tuple, \textcolor{keyword}{typename} Predicate>}
\DoxyCodeLine{279   \textcolor{keyword}{auto} \mbox{\hyperlink{a00307_gad9f30d486a3d9151d534ec1b0fad5341}{filter}}(Tuple\&\& tuple, Predicate pred) \{}
...
\DoxyCodeLine{299   \textcolor{keyword}{constexpr} \textcolor{keyword}{auto} \mbox{\hyperlink{a00307_ga12de8f77a63ef488a87a5aa8536146ee}{unique}}([[maybe\_unused]] std::tuple<Types...>\&\& tuple) \{}
...
\DoxyCodeLine{317   \textcolor{keyword}{constexpr} \textcolor{keywordtype}{size\_t} \mbox{\hyperlink{a00307_gae9a7254f583151ee431db537c9980865}{count\_if}}(Tuple\&\& tuple, Predicate pred) \{}
...
\DoxyCodeLine{338   \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a00307_ga62d8ab565d41e49db75f0641bcdf0740}{findTypeSpecialization}}() \{}
\DoxyCodeLine{339     \textcolor{keywordflow}{return} \mbox{\hyperlink{a00307_gaf75511e781bb89056badd33413222010}{find\_if}}(std::remove\_cvref\_t<Tuple>(), []<\textcolor{keyword}{typename} T>(T\&\&) \{}
...
\DoxyCodeLine{357   \textcolor{keyword}{auto} \mbox{\hyperlink{a00307_ga05a5ccea0f87d41fc69956f55a2c1dbd}{getSpecialization}}(Tuple\&\& tuple) \{}
...
\DoxyCodeLine{378   \textcolor{keyword}{constexpr} \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00307_gaec2a5de0482441ef1e1c68fb7ff8a0bc}{hasTypeSpecialization}}() \{}
\DoxyCodeLine{379     \textcolor{keywordflow}{return} (}
\DoxyCodeLine{380         \mbox{\hyperlink{a00307_gaf75511e781bb89056badd33413222010}{find\_if}}(std::remove\_cvref\_t<Tuple>(),}
...
\DoxyCodeLine{397   \textcolor{keyword}{constexpr} \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00307_gadf919f3a9b0c1d50134f9d041a3ce9f7}{countTypeSpecialization}}() \{}
\DoxyCodeLine{398     \textcolor{keywordflow}{return} \mbox{\hyperlink{a00307_gae9a7254f583151ee431db537c9980865}{count\_if}}(}
...
\DoxyCodeLine{414   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00307_ga62ee166e690831f40395df076e9cdddb}{countTypeSpecialization\_v}} = countTypeSpecialization<Type, Tuple>();}
\DoxyCodeLine{415 }
\DoxyCodeLine{428   \textcolor{keyword}{template} <\textcolor{keywordtype}{int} N, \textcolor{keyword}{class} Tuple>}
\DoxyCodeLine{429   \textcolor{keyword}{constexpr} \textcolor{keyword}{auto} \mbox{\hyperlink{a00307_ga32de94604b9d1a7423134f33f49d613f}{makeTupleSubset}}(Tuple\&\& t) \{}
...
\DoxyCodeLine{450   \textcolor{keyword}{constexpr} \textcolor{keyword}{auto} \mbox{\hyperlink{a00307_gaef801f15c9f18ae16e4241a497c33e96}{makeTupleFromTupleIndices}}(Tuple\&\& t) \{}
...
\DoxyCodeLine{462   \textcolor{keyword}{auto} \mbox{\hyperlink{a00320_a4c617d2458cc6d792f5ba3e6c64a0c7f}{makeNestedTupleFlat}}(std::tuple<Types...>) \{}
...
\DoxyCodeLine{476   \textcolor{keyword}{auto} \mbox{\hyperlink{a00320_a162c64656f5917b717a6b44ebf4c9ebf}{makeNestedTupleFlatAndStoreReferences}}(Tuple\&\& tup) \{}
...
\DoxyCodeLine{493   \textcolor{keyword}{requires} \mbox{\hyperlink{a01638}{traits::Pointer<T>}}}
\DoxyCodeLine{494   \textcolor{keyword}{auto}\& \mbox{\hyperlink{a00320_aa156028e47fc302b02a7e70dea888034}{returnReferenceOrNulloptIfObjectIsNullPtr}}(T v) \{}
