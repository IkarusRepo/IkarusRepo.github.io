\hypertarget{a02413_source}{}\doxysection{finiteelements/mechanics/kirchhoffloveshell.hh}
\label{a02413_source}\index{kirchhoffloveshell.hh@{kirchhoffloveshell.hh}}
\mbox{\hyperlink{a02413}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{64   \textcolor{keyword}{class }\mbox{\hyperlink{a01258}{KirchhoffLoveShell}} : \textcolor{keyword}{public} \mbox{\hyperlink{a01194}{PowerBasisFE}}<typename Basis\_::FlatBasis> \{}
\DoxyCodeLine{65   \textcolor{keyword}{public}:}
\DoxyCodeLine{66     \textcolor{keyword}{using }\mbox{\hyperlink{a01258_aff08f23fc6273613460eb026e8600b55}{Basis}}                   = Basis\_;}
\DoxyCodeLine{67     \textcolor{keyword}{using }\mbox{\hyperlink{a01258_a01bddbf8b0a84653e765e254592cbe1c}{FlatBasis}}               = \textcolor{keyword}{typename} \mbox{\hyperlink{a01414_ab9e57abdb5f4abeb030f6122df75849e}{Basis::FlatBasis}};}
...
\DoxyCodeLine{69     \textcolor{keyword}{using }\mbox{\hyperlink{a01258_ada03913c70f89a6feab860e6871b1a58}{FERequirementType}}       = FERequirements\_;}
\DoxyCodeLine{70     \textcolor{keyword}{using }\mbox{\hyperlink{a01226}{ResultRequirementsType}}  = \mbox{\hyperlink{a01226}{ResultRequirements<FERequirementType>}};}
\DoxyCodeLine{71     \textcolor{keyword}{using }\mbox{\hyperlink{a01258_a1c7174db95cf392d498ed6a79e54004a}{LocalView}}               = \textcolor{keyword}{typename} FlatBasis::LocalView;}
\DoxyCodeLine{72     \textcolor{keyword}{using }\mbox{\hyperlink{a01258_a665a7d8755b3ca37133a8fdfecbb5e53}{Element}}                 = \textcolor{keyword}{typename} LocalView::Element;}
\DoxyCodeLine{73     \textcolor{keyword}{using }\mbox{\hyperlink{a01258_a53ff5e7dfc6018836c490d40160fa901}{Geometry}}                = \textcolor{keyword}{typename} Element::Geometry;}
\DoxyCodeLine{74     \textcolor{keyword}{using }\mbox{\hyperlink{a01258_ab0f57da5f1f7d65ae88278f4ee6e8870}{GridView}}                = \textcolor{keyword}{typename} FlatBasis::GridView;}
\DoxyCodeLine{75     \textcolor{keyword}{using }\mbox{\hyperlink{a01294}{Traits}}                  = \mbox{\hyperlink{a01294}{TraitsFromLocalView<LocalView, useEigenRef>}};}
\DoxyCodeLine{76     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01258_a22273fa4834535f534e9dfab377aec83}{myDim}}    = \mbox{\hyperlink{a01294_ab29f61e7d71697962fe41642d683f9f5}{Traits::mydim}};}
\DoxyCodeLine{77     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01258_a72ab40a0cd36ae7aed708f82780c20b0}{worlddim}} = \mbox{\hyperlink{a01294_a47ccda97cc8e04f87be6d2c3a165ba98}{Traits::worlddim}};}
\DoxyCodeLine{78 }
...
\DoxyCodeLine{96     \mbox{\hyperlink{a01258_ae749b820da13eb29aafad5f0b704ea39}{KirchhoffLoveShell}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01258_aff08f23fc6273613460eb026e8600b55}{Basis}}\& globalBasis, \textcolor{keyword}{const} \textcolor{keyword}{typename} LocalView::Element\& element, \textcolor{keywordtype}{double} emod, \textcolor{keywordtype}{double} nu,}
...
\DoxyCodeLine{100         : \mbox{\hyperlink{a01258_aeaf83b598c252b329eca52e852768e0c}{BasePowerFE}}(globalBasis.flat(), element),}
\DoxyCodeLine{101           \mbox{\hyperlink{a01258_a06d85364de82f545719a105ecd6d9629}{neumannBoundary}}\{p\_neumannBoundary\},}
\DoxyCodeLine{102           \mbox{\hyperlink{a01258_a4b65a8b484bd3c7fb306557dc8e63848}{emod\_}}\{emod\},}
\DoxyCodeLine{103           \mbox{\hyperlink{a01258_a2cabafb4cfd93e8dd230d6ebb79bf529}{nu\_}}\{nu\},}
\DoxyCodeLine{104           \mbox{\hyperlink{a01258_aa055b97524c73a6917b026571f3de686}{thickness\_}}\{thickness\} \{}
...
\DoxyCodeLine{108       \mbox{\hyperlink{a01258_a56e9fd510e99e289f2adb7ed355533f4}{numberOfNodes}}     = fe.size();}
\DoxyCodeLine{109       \mbox{\hyperlink{a01258_a4a66b053a96b697a9f11efaf1376b0e7}{dispAtNodes}}.resize(fe.size());}
\DoxyCodeLine{110       \mbox{\hyperlink{a01258_a63b27f61b7f57f12671618edf3ef99ef}{order}}      = 2 * (fe.localBasis().order());}
\DoxyCodeLine{111       \mbox{\hyperlink{a01258_a9bb0dc0af5e814b54f98b1ae39c31332}{localBasis}} = Dune::CachedLocalBasis(fe.localBasis());}
\DoxyCodeLine{112       \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (\textcolor{keyword}{requires} \{ this-\/>\mbox{\hyperlink{a01194_a4b49c02de08fb5c115affa646c5f249a}{localView}}().element().impl().getQuadratureRule(\mbox{\hyperlink{a01258_a63b27f61b7f57f12671618edf3ef99ef}{order}}); \})}
...
\DoxyCodeLine{114           \mbox{\hyperlink{a01258_a9bb0dc0af5e814b54f98b1ae39c31332}{localBasis}}.bind(this-\/>localView().element().impl().getQuadratureRule(\mbox{\hyperlink{a01258_a63b27f61b7f57f12671618edf3ef99ef}{order}}), Dune::bindDerivatives(0, 1, 2));}
\DoxyCodeLine{115         \textcolor{keywordflow}{else}}
\DoxyCodeLine{116           \mbox{\hyperlink{a01258_a9bb0dc0af5e814b54f98b1ae39c31332}{localBasis}}.bind(Dune::QuadratureRules<double, myDim>::rule(this-\/>\mbox{\hyperlink{a01194_a4b49c02de08fb5c115affa646c5f249a}{localView}}().element().type(), \mbox{\hyperlink{a01258_a63b27f61b7f57f12671618edf3ef99ef}{order}}),}
\DoxyCodeLine{117                           Dune::bindDerivatives(0, 1, 2));}
\DoxyCodeLine{118       \textcolor{keywordflow}{else}}
\DoxyCodeLine{119         \mbox{\hyperlink{a01258_a9bb0dc0af5e814b54f98b1ae39c31332}{localBasis}}.bind(Dune::QuadratureRules<double, myDim>::rule(this-\/>\mbox{\hyperlink{a01194_a4b49c02de08fb5c115affa646c5f249a}{localView}}().element().type(), \mbox{\hyperlink{a01258_a63b27f61b7f57f12671618edf3ef99ef}{order}}),}
\DoxyCodeLine{120                         Dune::bindDerivatives(0, 1, 2));}
\DoxyCodeLine{121 }
\DoxyCodeLine{122       \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (!std::is\_same\_v<VolumeLoad, utils::LoadDefault>) \mbox{\hyperlink{a01258_a313ee03a124d29ac3d5c758e206321d3}{volumeLoad}} = p\_volumeLoad;}
...
\DoxyCodeLine{124         \mbox{\hyperlink{a01258_a563abc01ddb7619f4ceea05a8b308284}{neumannBoundaryLoad}} = p\_neumannBoundaryLoad;}
\DoxyCodeLine{125 }
\DoxyCodeLine{126       assert(((not p\_neumannBoundary and not \mbox{\hyperlink{a01258_a563abc01ddb7619f4ceea05a8b308284}{neumannBoundaryLoad}}) or (p\_neumannBoundary and \mbox{\hyperlink{a01258_a563abc01ddb7619f4ceea05a8b308284}{neumannBoundaryLoad}}))}
...
\DoxyCodeLine{142     \textcolor{keyword}{auto} \mbox{\hyperlink{a01258_a7e42edf0686f54efc607942eb1f9be44}{getDisplacementFunction}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01258_ada03913c70f89a6feab860e6871b1a58}{FERequirementType}}\& par,}
...
\DoxyCodeLine{145 }
\DoxyCodeLine{146       Dune::BlockVector<Dune::RealTuple<ScalarType, Traits::worlddim>> disp(\mbox{\hyperlink{a01258_a4a66b053a96b697a9f11efaf1376b0e7}{dispAtNodes}}.size());}
...
\DoxyCodeLine{149           \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} k2 = 0U; k2 < \mbox{\hyperlink{a01258_a72ab40a0cd36ae7aed708f82780c20b0}{worlddim}}; ++k2)}
\DoxyCodeLine{150             disp[i][k2] = dx.value()[i * \mbox{\hyperlink{a01258_a72ab40a0cd36ae7aed708f82780c20b0}{worlddim}} + k2]}
...
\DoxyCodeLine{154           \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} k2 = 0U; k2 < \mbox{\hyperlink{a01258_a72ab40a0cd36ae7aed708f82780c20b0}{worlddim}}; ++k2)}
...
\DoxyCodeLine{159       Dune::StandardLocalFunction uFunction(\mbox{\hyperlink{a01258_a9bb0dc0af5e814b54f98b1ae39c31332}{localBasis}}, disp, geo);}
\DoxyCodeLine{160       \textcolor{keywordflow}{return} std::make\_pair(uFunction, disp);}
\DoxyCodeLine{161     \}}
\DoxyCodeLine{162 }
\DoxyCodeLine{171     \textcolor{keywordtype}{double} \mbox{\hyperlink{a01258_adc2c303a601a1100fbe0a6f7987e0d8e}{calculateScalar}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01258_ada03913c70f89a6feab860e6871b1a58}{FERequirementType}}\& par)\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} calculateScalarImpl<double>(par); \}}
\DoxyCodeLine{172 }
\DoxyCodeLine{183     \textcolor{keywordtype}{void} \mbox{\hyperlink{a01258_aadd4c3a051e2c530a9fa5ebb86417141}{calculateAt}}([[maybe\_unused]] \textcolor{keyword}{const} \mbox{\hyperlink{a01226}{ResultRequirementsType}}\& req,}
\DoxyCodeLine{184                      [[maybe\_unused]] \textcolor{keyword}{const} \mbox{\hyperlink{a01326}{Dune::FieldVector<double, Traits::mydim>}}\& local,}
\DoxyCodeLine{185                      [[maybe\_unused]] \mbox{\hyperlink{a01222}{ResultTypeMap<double>}}\& result)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{191         \mbox{\hyperlink{a01258_a9bb0dc0af5e814b54f98b1ae39c31332}{localBasis}};}
...
\DoxyCodeLine{194         \mbox{\hyperlink{a01258_a313ee03a124d29ac3d5c758e206321d3}{volumeLoad}};}
...
\DoxyCodeLine{197         \mbox{\hyperlink{a01258_a563abc01ddb7619f4ceea05a8b308284}{neumannBoundaryLoad}};}
\DoxyCodeLine{198     \textcolor{keyword}{const} BoundaryPatch<GridView>* \mbox{\hyperlink{a01258_a06d85364de82f545719a105ecd6d9629}{neumannBoundary}};}
\DoxyCodeLine{199     \textcolor{keyword}{mutable} Dune::BlockVector<Dune::RealTuple<double, Traits::dimension>> \mbox{\hyperlink{a01258_a4a66b053a96b697a9f11efaf1376b0e7}{dispAtNodes}};}
\DoxyCodeLine{200     \textcolor{keywordtype}{double} \mbox{\hyperlink{a01258_a4b65a8b484bd3c7fb306557dc8e63848}{emod\_}};}
\DoxyCodeLine{201     \textcolor{keywordtype}{double} \mbox{\hyperlink{a01258_a2cabafb4cfd93e8dd230d6ebb79bf529}{nu\_}};}
\DoxyCodeLine{202     \textcolor{keywordtype}{double} \mbox{\hyperlink{a01258_aa055b97524c73a6917b026571f3de686}{thickness\_}};}
\DoxyCodeLine{203     \textcolor{keywordtype}{size\_t} \mbox{\hyperlink{a01258_a56e9fd510e99e289f2adb7ed355533f4}{numberOfNodes}}\{0\};}
\DoxyCodeLine{204     \textcolor{keywordtype}{int} \mbox{\hyperlink{a01258_a63b27f61b7f57f12671618edf3ef99ef}{order}}\{\};}
\DoxyCodeLine{205 }
...
\DoxyCodeLine{219     \textcolor{keyword}{auto} \mbox{\hyperlink{a01258_a83c5d12a0591fce31bc29ea903156863}{calculateScalarImpl}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01258_ada03913c70f89a6feab860e6871b1a58}{FERequirementType}}\& par, \textcolor{keyword}{const} std::optional<\textcolor{keyword}{const} Eigen::VectorX<ScalarType>>\& dx}
...
\DoxyCodeLine{223       \textcolor{keyword}{const} \textcolor{keyword}{auto} [uFunction, uNodes] = \mbox{\hyperlink{a01258_a7e42edf0686f54efc607942eb1f9be44}{getDisplacementFunction}}(par, dx);}
...
\DoxyCodeLine{237 }
\DoxyCodeLine{238         \textcolor{keyword}{const} \textcolor{keyword}{auto}\& Ndd                     = \mbox{\hyperlink{a01258_a9bb0dc0af5e814b54f98b1ae39c31332}{localBasis}}.evaluateSecondDerivatives(gpIndex);}
...
\DoxyCodeLine{253         \textcolor{keyword}{const} ScalarType membraneEnergy = \mbox{\hyperlink{a01258_aa055b97524c73a6917b026571f3de686}{thickness\_}} * \mbox{\hyperlink{a00295_a10529d3a284b885b2f89440faa693877}{energyHelper}}(epsV, GInv, \mbox{\hyperlink{a01258_a4b65a8b484bd3c7fb306557dc8e63848}{emod\_}}, \mbox{\hyperlink{a01258_a2cabafb4cfd93e8dd230d6ebb79bf529}{nu\_}});}
\DoxyCodeLine{254         \textcolor{keyword}{const} ScalarType bendingEnergy  = Dune::power(\mbox{\hyperlink{a01258_aa055b97524c73a6917b026571f3de686}{thickness\_}}, 3) / 12.0 * \mbox{\hyperlink{a00295_a10529d3a284b885b2f89440faa693877}{energyHelper}}(kappaV, GInv, \mbox{\hyperlink{a01258_a4b65a8b484bd3c7fb306557dc8e63848}{emod\_}}, \mbox{\hyperlink{a01258_a2cabafb4cfd93e8dd230d6ebb79bf529}{nu\_}});}
\DoxyCodeLine{255         energy += (membraneEnergy + bendingEnergy) * geo.integrationElement(gp.position()) * gp.weight();}
\DoxyCodeLine{256       \}}
\DoxyCodeLine{257 }
\DoxyCodeLine{258       \textcolor{keywordflow}{if} (\mbox{\hyperlink{a01258_a313ee03a124d29ac3d5c758e206321d3}{volumeLoad}}) \{}
...
\DoxyCodeLine{261           \textcolor{keyword}{const} Eigen::Vector<double, Traits::worlddim> fExt = \mbox{\hyperlink{a01258_a313ee03a124d29ac3d5c758e206321d3}{volumeLoad}}(toEigen(geo.global(gp.position())), lambda);}
...
\DoxyCodeLine{267       \textcolor{keywordflow}{if} (not \mbox{\hyperlink{a01258_a06d85364de82f545719a105ecd6d9629}{neumannBoundary}} and not \mbox{\hyperlink{a01258_a563abc01ddb7619f4ceea05a8b308284}{neumannBoundaryLoad}}) \textcolor{keywordflow}{return} energy;}
\DoxyCodeLine{268 }
...
\DoxyCodeLine{270       \textcolor{keywordflow}{for} (\textcolor{keyword}{auto}\&\& intersection : intersections(\mbox{\hyperlink{a01258_a06d85364de82f545719a105ecd6d9629}{neumannBoundary}}-\/>gridView(), element)) \{}
\DoxyCodeLine{271         \textcolor{keywordflow}{if} (not \mbox{\hyperlink{a01258_a06d85364de82f545719a105ecd6d9629}{neumannBoundary}} or not \mbox{\hyperlink{a01258_a06d85364de82f545719a105ecd6d9629}{neumannBoundary}}-\/>contains(intersection)) \textcolor{keywordflow}{continue};}
\DoxyCodeLine{272 }
\DoxyCodeLine{273         \textcolor{keyword}{const} \textcolor{keyword}{auto}\& quadLine = Dune::QuadratureRules<double, Traits::mydim -\/ 1>::rule(intersection.type(), \mbox{\hyperlink{a01258_a63b27f61b7f57f12671618edf3ef99ef}{order}});}
\DoxyCodeLine{274 }
...
\DoxyCodeLine{277           \textcolor{keyword}{const} \mbox{\hyperlink{a01326}{Dune::FieldVector<double, Traits::mydim>}}\& quadPos}
...
\DoxyCodeLine{287               = \mbox{\hyperlink{a01258_a563abc01ddb7619f4ceea05a8b308284}{neumannBoundaryLoad}}(toEigen(intersection.geometry().global(curQuad.position())), lambda);}
