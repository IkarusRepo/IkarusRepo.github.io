\hypertarget{a00029_source}{}\doxysection{pythonautodiffdefinitions.\+hh}
\label{a00029_source}\index{pythonautodiffdefinitions.hh@{pythonautodiffdefinitions.hh}}
...
\DoxyCodeLine{16 }
\DoxyCodeLine{17 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00306}{Python}} \{}
...
\DoxyCodeLine{30 }
\DoxyCodeLine{36     \textcolor{keyword}{static} \textcolor{keywordtype}{void} \mbox{\hyperlink{a01511_aab78500f06d24b5eb1cd894b68eec03c}{toC}}(PyObject* list, autodiff::Real<order, T>\& v) \{}
...
\DoxyCodeLine{46     \}}
\DoxyCodeLine{47 }
\DoxyCodeLine{53     \textcolor{keyword}{static} PyObject* \mbox{\hyperlink{a01511_ae7c12c134c747ccf36ff0bf9c453f69e}{toPy}}(\textcolor{keyword}{const} autodiff::Real<order, T>\& v) \{}
