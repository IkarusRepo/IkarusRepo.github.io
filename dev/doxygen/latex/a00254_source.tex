\hypertarget{a00254_source}{}\doxysection{nonlinearelastic.\+hh}
\label{a00254_source}\index{nonlinearelastic.hh@{nonlinearelastic.hh}}
...
\DoxyCodeLine{20 }
\DoxyCodeLine{21 \textcolor{preprocessor}{  \#include <\mbox{\hyperlink{a00182}{ikarus/finiteelements/febase.hh}}>}}
\DoxyCodeLine{22 \textcolor{preprocessor}{  \#include <\mbox{\hyperlink{a00194}{ikarus/finiteelements/fehelper.hh}}>}}
\DoxyCodeLine{23 \textcolor{preprocessor}{  \#include <\mbox{\hyperlink{a00191}{ikarus/finiteelements/ferequirements.hh}}>}}
\DoxyCodeLine{24 \textcolor{preprocessor}{  \#include <\mbox{\hyperlink{a00236}{ikarus/finiteelements/mechanics/loads.hh}}>}}
...
\DoxyCodeLine{172   \textcolor{keyword}{auto} \mbox{\hyperlink{a01524_a01ea8b2e688566c391df267a040298ee}{getInternalEnergy}}(\textcolor{keyword}{const} Eigen::Vector<ScalarType, strainDim>\& strain)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{191   \textcolor{keyword}{auto} \mbox{\hyperlink{a01524_af7716846e0ca64181119e58548126231}{getStress}}(\textcolor{keyword}{const} Eigen::Vector<ScalarType, strainDim>\& strain)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{198   \}}
\DoxyCodeLine{199 }
\DoxyCodeLine{200   \textcolor{keyword}{const} \mbox{\hyperlink{a01524_a0b822da239b00331cc6f5a952976ef1e}{Geometry}}\& \mbox{\hyperlink{a01524_a6268324f3dce0ad16478747170581a3e}{geometry}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} *geo\_; \}}
\DoxyCodeLine{201   [[nodiscard]] \textcolor{keywordtype}{size\_t} \mbox{\hyperlink{a01524_afc0d3706a93eefe0238e9053e8421708}{numberOfNodes}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} numberOfNodes\_; \}}
\DoxyCodeLine{202   [[nodiscard]] \textcolor{keywordtype}{int} \mbox{\hyperlink{a01524_ae131607ff0fc7856d7635f8e05c6cf70}{order}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} order\_; \}}
\DoxyCodeLine{203 }
...
\DoxyCodeLine{216   \textcolor{keyword}{auto} \mbox{\hyperlink{a01524_a7c8edbff09762bdb9cae26d4cf6b0a91}{calculateAtImpl}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01368}{Requirement}}\& req, \textcolor{keyword}{const} \mbox{\hyperlink{a01772}{Dune::FieldVector<double, Traits::mydim>}}\& local,}
...
\DoxyCodeLine{219 }
\DoxyCodeLine{220     \textcolor{keyword}{using }RTWrapper = \mbox{\hyperlink{a01392}{ResultWrapper<RT<typename Traits::ctype, myDim, Traits::worlddim>}}, \mbox{\hyperlink{a00384_acfb09bb7db104db62d3d1d2dc3e009b2a57dea6f5039281b7fee517fc43bf3110}{ResultShape::Vector}}>;}
\DoxyCodeLine{221     \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (isSameResultType<RT, ResultTypes::PK2Stress>) \{}
\DoxyCodeLine{222       \textcolor{keyword}{const} \textcolor{keyword}{auto} uFunction = \mbox{\hyperlink{a01524_abd6925cc756ecdffea3976c3ad252dac}{displacementFunction}}(req);}
...
\DoxyCodeLine{225 }
\DoxyCodeLine{226       \textcolor{keywordflow}{return} RTWrapper\{mat\_.template stresses<StrainTags::greenLagrangian>(\mbox{\hyperlink{a00380_ga4304655095296ce9283e012587817a51}{toVoigt}}(E))\};}
\DoxyCodeLine{227     \}}
\DoxyCodeLine{228   \}}
\DoxyCodeLine{229 }
\DoxyCodeLine{230 \textcolor{keyword}{private}:}
\DoxyCodeLine{231   \textcolor{comment}{//> CRTP}}
\DoxyCodeLine{232   \textcolor{keyword}{const} \textcolor{keyword}{auto}\& underlying()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} \textcolor{keyword}{static\_cast<}\textcolor{keyword}{const }\mbox{\hyperlink{a01336}{FE}}\&\textcolor{keyword}{>}(*this); \}}
...
\DoxyCodeLine{236   \mbox{\hyperlink{a01524_a301b03982ef1629b26bac4e6ab522797}{Material}} mat\_;}
...
\DoxyCodeLine{249   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01524_aa54197bd165210db66028abcda00be24}{calculateMatrixImpl}}(}
\DoxyCodeLine{250       \textcolor{keyword}{const} \mbox{\hyperlink{a01368}{Requirement}}\& par, \textcolor{keyword}{const} \mbox{\hyperlink{a00384_a390d5311179ec61d163a29c943b3d1a0}{MatrixAffordance}}\& affordance, \textcolor{keyword}{typename} Traits::template MatrixType<> K,}
...
\DoxyCodeLine{253     \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00404}{Dune}};}
\DoxyCodeLine{254     \textcolor{keyword}{const} \textcolor{keyword}{auto} uFunction = \mbox{\hyperlink{a01524_abd6925cc756ecdffea3976c3ad252dac}{displacementFunction}}(par, dx);}
\DoxyCodeLine{255     \textcolor{keyword}{const} \textcolor{keyword}{auto} eps       = \mbox{\hyperlink{a01524_a285fd9ad1535df453f184154587bb1ff}{strainFunction}}(par, dx);}
...
\DoxyCodeLine{260       \textcolor{keyword}{const} \textcolor{keyword}{auto} C            = \mbox{\hyperlink{a01524_aaf1eac20d733fcd9f2c7ac68dbbddc5c}{materialTangent}}(EVoigt);}
\DoxyCodeLine{261 }
\DoxyCodeLine{262       \textcolor{keyword}{const} \textcolor{keyword}{auto} stresses = \mbox{\hyperlink{a01524_af7716846e0ca64181119e58548126231}{getStress}}(EVoigt);}
...
\DoxyCodeLine{268           K.template block<myDim, myDim>(i * \mbox{\hyperlink{a01524_a75f37a35f01f4440faec8355c25e85e7}{myDim}}, j * \mbox{\hyperlink{a01524_a75f37a35f01f4440faec8355c25e85e7}{myDim}}) += (bopI.transpose() * C * bopJ + kgIJ) * intElement;}
\DoxyCodeLine{269         \}}
\DoxyCodeLine{270       \}}
\DoxyCodeLine{271     \}}
\DoxyCodeLine{272   \}}
...
\DoxyCodeLine{275   \textcolor{keyword}{auto} \mbox{\hyperlink{a01524_a149037d90b4c2765fdf28c35eeb91f12}{calculateScalarImpl}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01368}{Requirement}}\& par, \mbox{\hyperlink{a00384_af6f894084edd9109762b86222995ef2a}{ScalarAffordance}} affordance,}
...
\DoxyCodeLine{279     \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00404}{Dune}};}
\DoxyCodeLine{280 }
\DoxyCodeLine{281     \textcolor{keyword}{const} \textcolor{keyword}{auto} eps     = \mbox{\hyperlink{a01524_a285fd9ad1535df453f184154587bb1ff}{strainFunction}}(par, dx);}
...
\DoxyCodeLine{287       \textcolor{keyword}{const} \textcolor{keyword}{auto} internalEnergy = \mbox{\hyperlink{a01524_a01ea8b2e688566c391df267a040298ee}{getInternalEnergy}}(EVoigt);}
...
\DoxyCodeLine{295   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01524_a76de3bbd2b95cd470e59d0314b27e18f}{calculateVectorImpl}}(}
\DoxyCodeLine{296       \textcolor{keyword}{const} \mbox{\hyperlink{a01368}{Requirement}}\& par, \mbox{\hyperlink{a00384_aab9e3e38507d1db7602bc750718c302a}{VectorAffordance}} affordance, \textcolor{keyword}{typename} Traits::template VectorType<ScalarType> force,}
...
\DoxyCodeLine{299     \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00404}{Dune}};}
\DoxyCodeLine{300     \textcolor{keyword}{const} \textcolor{keyword}{auto} eps = \mbox{\hyperlink{a01524_a285fd9ad1535df453f184154587bb1ff}{strainFunction}}(par, dx);}
\DoxyCodeLine{301 }
...
\DoxyCodeLine{306       \textcolor{keyword}{const} \textcolor{keyword}{auto} stresses     = \mbox{\hyperlink{a01524_af7716846e0ca64181119e58548126231}{getStress}}(EVoigt);}
...
\DoxyCodeLine{309         force.template segment<myDim>(\mbox{\hyperlink{a01524_a75f37a35f01f4440faec8355c25e85e7}{myDim}} * i) += bopI.transpose() * stresses * intElement;}
\DoxyCodeLine{310       \}}
\DoxyCodeLine{311     \}}
\DoxyCodeLine{312   \}}
\DoxyCodeLine{313 \};}
...
\DoxyCodeLine{322 \textcolor{keyword}{auto} \mbox{\hyperlink{a00384_a6f028adf5a1a78301381fe92b241d550}{nonLinearElastic}}(\textcolor{keyword}{const} MAT\& mat) \{}
\DoxyCodeLine{323   \mbox{\hyperlink{a01528}{NonLinearElasticPre<MAT>}} pre(mat);}
\DoxyCodeLine{324 }
