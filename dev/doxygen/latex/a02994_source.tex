\hypertarget{a02994_source}{}\doxysection{python/ikarus/materials/materials.hh}
\label{a02994_source}\index{materials.hh@{materials.hh}}
\mbox{\hyperlink{a02994}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{11 }
\DoxyCodeLine{12 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a02991}{ikarus/finiteelements/mechanics/materials.hh}}>}}
...
\DoxyCodeLine{15 }
\DoxyCodeLine{16 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00384_ga2c5ed0e112e5ea2865689ad21282c5e6}{addMaterialsSubModule}}(pybind11::module\& m) \{}
\DoxyCodeLine{17   \textcolor{keyword}{namespace }py = pybind11;}
\DoxyCodeLine{18   \textcolor{keyword}{using namespace }pybind11::literals;}
\DoxyCodeLine{19   \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00396}{Ikarus}};}
\DoxyCodeLine{20   \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00412}{Eigen}};}
\DoxyCodeLine{21 }
...
\DoxyCodeLine{23 }
\DoxyCodeLine{24   \mbox{\hyperlink{a00362_a4f679b27b8832c36acea41eab8e0d0bc}{ENUM\_BINDINGS\_WITH\_MODULE}}(\mbox{\hyperlink{a00385_gacef1e451de1a99845c59d7391064fb8f}{StrainTags}}, materials);}
\DoxyCodeLine{25   \mbox{\hyperlink{a00362_a4f679b27b8832c36acea41eab8e0d0bc}{ENUM\_BINDINGS\_WITH\_MODULE}}(\mbox{\hyperlink{a00385_ga70b4ce43c53cc5e949d49919f437501e}{StressTags}}, materials);}
\DoxyCodeLine{26   \mbox{\hyperlink{a00362_a4f679b27b8832c36acea41eab8e0d0bc}{ENUM\_BINDINGS\_WITH\_MODULE}}(\mbox{\hyperlink{a00385_ga05ac785124262c1e323d2f937d520a1b}{TangentModuliTags}}, materials);}
\DoxyCodeLine{27 }
...
\DoxyCodeLine{49       [](\mbox{\hyperlink{a00385_gacef1e451de1a99845c59d7391064fb8f}{StrainTags}} from, \mbox{\hyperlink{a00385_gacef1e451de1a99845c59d7391064fb8f}{StrainTags}} to, Eigen::MatrixXd E) -\/> Eigen::MatrixXd \{}
\DoxyCodeLine{50         \textcolor{keyword}{auto} callTransformStrain =}
\DoxyCodeLine{51             []<\mbox{\hyperlink{a00385_gacef1e451de1a99845c59d7391064fb8f}{StrainTags}} from\_, \mbox{\hyperlink{a00385_gacef1e451de1a99845c59d7391064fb8f}{StrainTags}} to\_>(\textcolor{keyword}{const} Eigen::MatrixXd\& eRaw) -\/> Eigen::MatrixXd \{}
...
\DoxyCodeLine{76             \textcolor{keywordflow}{case} \mbox{\hyperlink{a00385_ggacef1e451de1a99845c59d7391064fb8fa0eb1f1f7a6a355c2f4260b74c21d80f3}{Ikarus::StrainTags::displacementGradient}}:}
...
\DoxyCodeLine{79             \textcolor{keywordflow}{case} \mbox{\hyperlink{a00385_ggacef1e451de1a99845c59d7391064fb8faea40a9960a7a89c4f366beeab85d07d2}{Ikarus::StrainTags::rightCauchyGreenTensor}}:}
...
\DoxyCodeLine{90             \textcolor{keywordflow}{case} \mbox{\hyperlink{a00385_ggacef1e451de1a99845c59d7391064fb8fa0eb1f1f7a6a355c2f4260b74c21d80f3}{Ikarus::StrainTags::displacementGradient}}:}
...
\DoxyCodeLine{93             \textcolor{keywordflow}{case} \mbox{\hyperlink{a00385_ggacef1e451de1a99845c59d7391064fb8faea40a9960a7a89c4f366beeab85d07d2}{Ikarus::StrainTags::rightCauchyGreenTensor}}:}
...
\DoxyCodeLine{104             \textcolor{keywordflow}{case} \mbox{\hyperlink{a00385_ggacef1e451de1a99845c59d7391064fb8fa0eb1f1f7a6a355c2f4260b74c21d80f3}{Ikarus::StrainTags::displacementGradient}}:}
...
\DoxyCodeLine{107             \textcolor{keywordflow}{case} \mbox{\hyperlink{a00385_ggacef1e451de1a99845c59d7391064fb8fa61fc106262d2e2049866894bb4f862a5}{Ikarus::StrainTags::deformationGradient}}:}
