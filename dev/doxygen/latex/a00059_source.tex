...
\DoxyCodeLine{50 \textcolor{keyword}{consteval} \textcolor{keywordtype}{int} \mbox{\hyperlink{a00314_ga45ac3fa7e384aa760181de7a1377dc14}{countType}}() \{}
...
\DoxyCodeLine{69 \textcolor{keyword}{using }\mbox{\hyperlink{a00314_ga0ba1bf25ee478b1b1d9e96c1dcd831a0}{ReturnType}} = std::invoke\_result\_t<Fun, Args...>;}
\DoxyCodeLine{70 }
\DoxyCodeLine{79 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T, \textcolor{keyword}{typename} Tuple>}
\DoxyCodeLine{80 \textcolor{keyword}{struct }\mbox{\hyperlink{a01580}{hasType}} : std::false\_type}
\DoxyCodeLine{81 \{}
\DoxyCodeLine{82 \};}
\DoxyCodeLine{83 }
...
\DoxyCodeLine{86 \textcolor{keyword}{struct }\mbox{\hyperlink{a01580}{hasType}}<T, std::tuple<>> : std::false\_type}
\DoxyCodeLine{87 \{}
\DoxyCodeLine{88 \};}
\DoxyCodeLine{89 }
...
\DoxyCodeLine{221 \textcolor{keyword}{struct }\mbox{\hyperlink{a01600}{Index}};}
\DoxyCodeLine{222 \textcolor{preprocessor}{\#ifndef DOXYGEN}}
\DoxyCodeLine{223 \textcolor{keyword}{template} <\textcolor{keyword}{class} T>}
\DoxyCodeLine{224 \textcolor{keyword}{struct }\mbox{\hyperlink{a01600}{Index}}<T, std::tuple<>>}
\DoxyCodeLine{225 \{}
...
\DoxyCodeLine{230 \textcolor{keyword}{struct }\mbox{\hyperlink{a01600}{Index}}<T, std::tuple<T, Types...>>}
\DoxyCodeLine{231 \{}
...
\DoxyCodeLine{260 \textcolor{keyword}{struct }\mbox{\hyperlink{a01604}{Rebind}};}
\DoxyCodeLine{261 }
...
\DoxyCodeLine{267 \textcolor{keyword}{struct }\mbox{\hyperlink{a01604}{Rebind}}<Container<OldType, Args...>, NewType>}
\DoxyCodeLine{268 \{}
...
\DoxyCodeLine{276 \textcolor{keyword}{struct }\mbox{\hyperlink{a01604}{Rebind}}<Container<OldType, N>, NewType>}
\DoxyCodeLine{277 \{}
...
\DoxyCodeLine{293 \textcolor{keyword}{struct }\mbox{\hyperlink{a01608}{FunctionTraits}};}
\DoxyCodeLine{294 }
...
\DoxyCodeLine{300 \textcolor{keyword}{struct }\mbox{\hyperlink{a01608}{FunctionTraits}}<R (*)(Args...)>}
\DoxyCodeLine{301 \{}
...
\DoxyCodeLine{312 \textcolor{keyword}{struct }\mbox{\hyperlink{a01608}{FunctionTraits}}<R (C::*)(Args...) const>}
\DoxyCodeLine{313 \{}
...
\DoxyCodeLine{337 \textcolor{keyword}{struct }FunctionTraits<T, \mbox{\hyperlink{a00321}{Dune}}::void\_t<decltype(\&T::operator())>> : \textcolor{keyword}{public} FunctionTraits<decltype(\&T::operator())>}
\DoxyCodeLine{338 \{}
\DoxyCodeLine{339 \};}
