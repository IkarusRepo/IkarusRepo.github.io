...
\DoxyCodeLine{66 }
\DoxyCodeLine{67     cls.def(\mbox{\hyperlink{a00316_ac8243891c1b961e50a066140ab79a142}{pybind11::init}}([](\textcolor{keyword}{const} \mbox{\hyperlink{a01456}{Basis}}\& \mbox{\hyperlink{a00335_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}) \{ \textcolor{keywordflow}{return} \textcolor{keyword}{new} \mbox{\hyperlink{a01492}{DirichletValues}}(\mbox{\hyperlink{a00335_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}); \}),}
...
\DoxyCodeLine{72             [](\mbox{\hyperlink{a01492}{DirichletValues}}\& self, \textcolor{keyword}{const} std::function<\textcolor{keywordtype}{void}(Eigen::Ref<Eigen::VectorX<bool>>, \textcolor{keywordtype}{int})>\& f) \{}
...
\DoxyCodeLine{76               \};}
\DoxyCodeLine{77               self.\mbox{\hyperlink{a01492_a7de80e6ad56431b46750ddbc2580c45e}{fixBoundaryDOFs}}(lambda);}
\DoxyCodeLine{78             \});}
\DoxyCodeLine{79 }
\DoxyCodeLine{80     cls.def(\textcolor{stringliteral}{"{}fixBoundaryDOFsUsingLocalView"{}},}
\DoxyCodeLine{81             [](\mbox{\hyperlink{a01492}{DirichletValues}}\& self,}
...
\DoxyCodeLine{90               \};}
\DoxyCodeLine{91               self.\mbox{\hyperlink{a01492_a7de80e6ad56431b46750ddbc2580c45e}{fixBoundaryDOFs}}(lambda);}
\DoxyCodeLine{92             \});}
\DoxyCodeLine{93 }
...
\DoxyCodeLine{105               \};}
\DoxyCodeLine{106               self.\mbox{\hyperlink{a01492_a7de80e6ad56431b46750ddbc2580c45e}{fixBoundaryDOFs}}(lambda);}
\DoxyCodeLine{107             \});}
\DoxyCodeLine{108 }
\DoxyCodeLine{109     cls.def(\textcolor{stringliteral}{"{}fixDOFs"{}},}
\DoxyCodeLine{110             [](\mbox{\hyperlink{a01492}{DirichletValues}}\& self, \textcolor{keyword}{const} std::function<\textcolor{keywordtype}{void}(Eigen::Ref<Eigen::VectorX<bool>>, \textcolor{keyword}{const} \mbox{\hyperlink{a01456}{Basis}}\&)>\& f) \{}
\DoxyCodeLine{111               self.\mbox{\hyperlink{a01492_a7de80e6ad56431b46750ddbc2580c45e}{fixBoundaryDOFs}}(f);}
\DoxyCodeLine{112             \});}
\DoxyCodeLine{113   \}}
\DoxyCodeLine{114 }
