...
\DoxyCodeLine{33     \textcolor{keyword}{using }\mbox{\hyperlink{a01212_ae3eeda5463148aeab6bec5e774791384}{RealFE}}            = RealFE\_;                 }
\DoxyCodeLine{34     \textcolor{keyword}{using }\mbox{\hyperlink{a01212_a89a700073503fa0567afbcb5f4638b7e}{Basis}}             = \textcolor{keyword}{typename} RealFE::Basis;  }
\DoxyCodeLine{35     \textcolor{keyword}{using }\mbox{\hyperlink{a01336}{Traits}}            = \mbox{\hyperlink{a01336}{TraitsFromFE<Basis, FERequirementType\_, useEigenRef>}};  }
\DoxyCodeLine{36     \textcolor{keyword}{using }\mbox{\hyperlink{a01212_a7a35e87063266fd105193cbde16286fe}{LocalView}}         = \textcolor{keyword}{typename} \mbox{\hyperlink{a01336_a36437741d63f3d325f363c8df4d2aac5}{Traits::LocalView}};                            }
\DoxyCodeLine{37     \textcolor{keyword}{using }\mbox{\hyperlink{a01212_a13e58c2d0abbeccf2ae33f94d0f335b8}{Element}}           = \textcolor{keyword}{typename} \mbox{\hyperlink{a01336_a179f7c62c0c2fef548d7ae31705de71e}{Traits::Element}};                              }
\DoxyCodeLine{38     \textcolor{keyword}{using }\mbox{\hyperlink{a01212_a89666ec5f15efd5047f9bd4734b9da67}{FERequirementType}} = \textcolor{keyword}{typename} \mbox{\hyperlink{a01336_ae29466435644541bf50d0f8fecbac1dd}{Traits::FERequirementType}};  }
\DoxyCodeLine{39 }
\DoxyCodeLine{46     \textcolor{keywordtype}{void} \mbox{\hyperlink{a01212_a2650fc875e359aab7e22e59ccbed53f8}{calculateMatrix}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01212_a89666ec5f15efd5047f9bd4734b9da67}{FERequirementType}}\& req, \textcolor{keyword}{typename} Traits::template MatrixType<> h)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{80     \}}
\DoxyCodeLine{81 }
\DoxyCodeLine{88     \textcolor{keywordtype}{void} \mbox{\hyperlink{a01212_a70030068b3205be5d75548ce1f1c126f}{calculateVector}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01212_a89666ec5f15efd5047f9bd4734b9da67}{FERequirementType}}\& req, \textcolor{keyword}{typename} Traits::template VectorType<> g)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{163     \textcolor{keyword}{explicit} \mbox{\hyperlink{a01212_a0945c8f2eb83323d6b8767b4ce47c919}{AutoDiffFE}}(Args\&\&... args) : \mbox{\hyperlink{a01212_ae3eeda5463148aeab6bec5e774791384}{RealFE}}\{std::forward<Args>(args)...\} \{\}}
\DoxyCodeLine{164   \};}
