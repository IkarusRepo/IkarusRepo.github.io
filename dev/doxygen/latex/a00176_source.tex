\hypertarget{a00176_source}{}\doxysection{traction.\+hh}
\label{a00176_source}\index{traction.hh@{traction.hh}}
...
\DoxyCodeLine{9 }
\DoxyCodeLine{10 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00128}{ikarus/finiteelements/ferequirements.hh}}>}}
\DoxyCodeLine{11 }
...
\DoxyCodeLine{22 \textcolor{keyword}{struct }\mbox{\hyperlink{a01444}{NeumannBoundaryLoadPre}}}
\DoxyCodeLine{23 \{}
\DoxyCodeLine{24   \textcolor{keyword}{using }\mbox{\hyperlink{a01444_a57f15a0941a7f2f5cd9be9365b07cc62}{GridView}}                = GV;}
\DoxyCodeLine{25   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01444_a30ab2377a70a599a759395ddbe87c162}{worldDim}} = GridView::dimensionworld;}
\DoxyCodeLine{26   \textcolor{keyword}{const} BoundaryPatch<GridView>* \mbox{\hyperlink{a01444_a7041712ee512583c44a163cafc33787f}{neumannBoundary}};}
\DoxyCodeLine{27 }
\DoxyCodeLine{28   std::function<Eigen::Vector<double, worldDim>(\textcolor{keyword}{const} \mbox{\hyperlink{a01692}{Dune::FieldVector<double, worldDim>}}\&, \textcolor{keyword}{const} \textcolor{keywordtype}{double}\&)> \mbox{\hyperlink{a01444_abcca43aca1a4a4bcad580991d79b80e9}{load}};}
\DoxyCodeLine{29   \textcolor{keyword}{using }\mbox{\hyperlink{a01444_ab141e7f54614dccc0924c0bf678760d4}{BoundaryPatchType}} = BoundaryPatch<GridView>;}
\DoxyCodeLine{30 }
\DoxyCodeLine{31   \textcolor{keyword}{template} <\textcolor{keyword}{typename} PreFE, \textcolor{keyword}{typename} FE>}
\DoxyCodeLine{32   \textcolor{keyword}{using }\mbox{\hyperlink{a01440}{Skill}} = \mbox{\hyperlink{a01440}{Traction<PreFE, FE>}};}
\DoxyCodeLine{33 \};}
\DoxyCodeLine{34 }
\DoxyCodeLine{43 \textcolor{keyword}{template} <\textcolor{keyword}{typename} PreFE, \textcolor{keyword}{typename} FE>}
\DoxyCodeLine{44 \textcolor{keyword}{class }\mbox{\hyperlink{a01440}{Traction}}}
\DoxyCodeLine{45 \{}
\DoxyCodeLine{46 \textcolor{keyword}{public}:}
\DoxyCodeLine{47   \textcolor{keyword}{using }\mbox{\hyperlink{a01372}{Traits}} = \mbox{\hyperlink{a01316_a826c356a5afb013faffb5f7ac893cff4}{PreFE::Traits}};}
\DoxyCodeLine{48   \textcolor{keyword}{using }\mbox{\hyperlink{a01344}{Requirement}} =}
\DoxyCodeLine{49       \mbox{\hyperlink{a01344}{FERequirementsFactory<FESolutions::displacement, FEParameter::loadfactor, Traits::useEigenRef>::type}};}
\DoxyCodeLine{50   \textcolor{keyword}{using }\mbox{\hyperlink{a01440_a16ae410689450d27c7fe33618c65eff5}{LocalView}}               = \textcolor{keyword}{typename} \mbox{\hyperlink{a01372_a06bdad066f621e46875af45a22677a3c}{Traits::LocalView}};}
\DoxyCodeLine{51   \textcolor{keyword}{using }\mbox{\hyperlink{a01440_a1ad8822c3690b4d9b7fa07998d581551}{GridView}}                = \textcolor{keyword}{typename} \mbox{\hyperlink{a01372_a3ec0294824df467074f5070cb58f5a91}{Traits::GridView}};}
\DoxyCodeLine{52   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01440_a9867415553291c23807ce946f1e33b2f}{myDim}}    = \mbox{\hyperlink{a01372_ae15b8efa9f66a3caee81d99dd5c648de}{Traits::mydim}};}
\DoxyCodeLine{53   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01440_aae1169ffc7dc4ba675566010710a6bd1}{worldDim}} = \mbox{\hyperlink{a01372_a5d611e1d48285bac5c5ebd6fda9c7cc7}{Traits::worlddim}};}
\DoxyCodeLine{54   \textcolor{keyword}{using }\mbox{\hyperlink{a01444}{Pre}}                     = \mbox{\hyperlink{a01444}{NeumannBoundaryLoadPre<GridView>}};}
\DoxyCodeLine{55 }
\DoxyCodeLine{61   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01440_ae5de3515f363e3e48877175fe53cdb27}{Traction}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01444}{Pre}}\& pre)}
...
\DoxyCodeLine{68   \textcolor{keyword}{auto} \mbox{\hyperlink{a01440_aee928b8c9bd09b4aa6d8e571d410d909}{calculateAtImpl}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01344}{Requirement}}\& req, \textcolor{keyword}{const} \mbox{\hyperlink{a01692}{Dune::FieldVector<double, Traits::mydim>}}\& local,}
...
\DoxyCodeLine{72   \textcolor{keyword}{auto} \mbox{\hyperlink{a01440_ae250d2db37fa9808a61e78ff740f81ee}{calculateScalarImpl}}(}
\DoxyCodeLine{73       \textcolor{keyword}{const} \mbox{\hyperlink{a01344}{Requirement}}\& par, \mbox{\hyperlink{a00363_af6f894084edd9109762b86222995ef2a}{ScalarAffordance}} affordance,}
...
\DoxyCodeLine{90         \textcolor{keyword}{const} \mbox{\hyperlink{a01692}{Dune::FieldVector<double, myDim>}}\& quadPos = intersection.geometryInInside().global(curQuad.position());}
\DoxyCodeLine{91 }
...
\DoxyCodeLine{107   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01440_aaff30fab3991b4bc486b498382226238}{calculateVectorImpl}}(}
\DoxyCodeLine{108       \textcolor{keyword}{const} \mbox{\hyperlink{a01344}{Requirement}}\& par, \mbox{\hyperlink{a00363_aab9e3e38507d1db7602bc750718c302a}{VectorAffordance}} affordance, \textcolor{keyword}{typename} Traits::template VectorType<ST> force,}
...
\DoxyCodeLine{113     \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00381}{Dune}};}
\DoxyCodeLine{114     \textcolor{keyword}{const} \textcolor{keyword}{auto} uFunction = underlying().displacementFunction(par, dx);}
\DoxyCodeLine{115     \textcolor{keyword}{const} \textcolor{keyword}{auto}\& lambda   = par.\mbox{\hyperlink{a01344_af11316c1f0fca6982a2d7497bc71a10c}{parameter}}();}
...
\DoxyCodeLine{126         \textcolor{keyword}{const} \mbox{\hyperlink{a01692}{Dune::FieldVector<double, myDim>}}\& quadPos = intersection.geometryInInside().global(curQuad.position());}
...
\DoxyCodeLine{135           force.template segment<worldDim>(\mbox{\hyperlink{a01440_aae1169ffc7dc4ba675566010710a6bd1}{worldDim}} * i) -\/= udCi * neumannValue * curQuad.weight() * intElement;}
\DoxyCodeLine{136         \}}
\DoxyCodeLine{137       \}}
\DoxyCodeLine{138     \}}
\DoxyCodeLine{139   \}}
...
\DoxyCodeLine{142   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01440_ac37e6714de6453b6ea385b45399ada6b}{calculateMatrixImpl}}(}
\DoxyCodeLine{143       \textcolor{keyword}{const} \mbox{\hyperlink{a01344}{Requirement}}\&, \mbox{\hyperlink{a00363_a390d5311179ec61d163a29c943b3d1a0}{MatrixAffordance}}, \textcolor{keyword}{typename} Traits::template MatrixType<>,}
...
\DoxyCodeLine{147   std::function<Eigen::Vector<double, worldDim>(\textcolor{keyword}{const} \mbox{\hyperlink{a01692}{Dune::FieldVector<double, worldDim>}}\&, \textcolor{keyword}{const} \textcolor{keywordtype}{double}\&)>}
...
\DoxyCodeLine{152   \textcolor{keyword}{const} \textcolor{keyword}{auto}\& underlying()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} \textcolor{keyword}{static\_cast<}\textcolor{keyword}{const }\mbox{\hyperlink{a01312}{FE}}\&\textcolor{keyword}{>}(*this); \}}
...
\DoxyCodeLine{165 \textcolor{keyword}{auto} \mbox{\hyperlink{a00363_ac2ae666c1ffd22e3c22a3418ab390893}{neumannBoundaryLoad}}(\textcolor{keyword}{const} BoundaryPatch<GV>* patch, F\&\& load) \{}
\DoxyCodeLine{166   \mbox{\hyperlink{a01444}{NeumannBoundaryLoadPre<GV>}} pre(patch, std::forward<F>(load));}
\DoxyCodeLine{167 }
