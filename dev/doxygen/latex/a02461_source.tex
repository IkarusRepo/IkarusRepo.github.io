...
\DoxyCodeLine{20 }
\DoxyCodeLine{21 \textcolor{preprocessor}{  \#include <\mbox{\hyperlink{a00194}{ikarus/finiteelements/febases/powerbasisfe.hh}}>}}
\DoxyCodeLine{22 \textcolor{preprocessor}{  \#include <\mbox{\hyperlink{a00191}{ikarus/finiteelements/fehelper.hh}}>}}
\DoxyCodeLine{23 \textcolor{preprocessor}{  \#include <\mbox{\hyperlink{a00206}{ikarus/finiteelements/ferequirements.hh}}>}}
\DoxyCodeLine{24 \textcolor{preprocessor}{  \#include <\mbox{\hyperlink{a00203}{ikarus/finiteelements/fetraits.hh}}>}}
\DoxyCodeLine{25 \textcolor{preprocessor}{  \#include <\mbox{\hyperlink{a00218}{ikarus/finiteelements/mechanics/loads.hh}}>}}
\DoxyCodeLine{26 \textcolor{preprocessor}{  \#include <\mbox{\hyperlink{a00248}{ikarus/finiteelements/mechanics/materials/tags.hh}}>}}
\DoxyCodeLine{27 \textcolor{preprocessor}{  \#include <\mbox{\hyperlink{a00257}{ikarus/finiteelements/physicshelper.hh}}>}}
\DoxyCodeLine{28 \textcolor{preprocessor}{  \#include <\mbox{\hyperlink{a00023}{ikarus/utils/defaultfunctions.hh}}>}}
...
\DoxyCodeLine{225     \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00331}{Dune}};}
...
\DoxyCodeLine{257   \textcolor{keyword}{auto} \mbox{\hyperlink{a01338_a765f9740fe927b34ab4d0add274be811}{calculateAt}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01338_a358fe3461a6465be28ecc1198de63977}{FERequirementType}}\& req, \textcolor{keyword}{const} \mbox{\hyperlink{a01370}{Dune::FieldVector<double, Traits::mydim>}}\& local)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{284     \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00331}{Dune}};}
