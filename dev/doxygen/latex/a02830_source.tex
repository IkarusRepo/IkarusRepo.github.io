\hypertarget{a02830_source}{}\doxysection{python/dirichletvalues/dirichletvalues.hh}
\label{a02830_source}\index{dirichletvalues.hh@{dirichletvalues.hh}}
...
\DoxyCodeLine{26 }
\DoxyCodeLine{27 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00218}{ikarus/finiteelements/ferequirements.hh}}>}}
\DoxyCodeLine{28 }
\DoxyCodeLine{29 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00389}{Ikarus::Python}} \{}
\DoxyCodeLine{30 }
...
\DoxyCodeLine{67 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00389_a7f83fd37212b1411d1dbae8f7064882c}{forwardCorrectFunction}}(\mbox{\hyperlink{a01767}{DirichletValues}}\& \mbox{\hyperlink{a00402_a453691a9a22118c4736e30240481a281}{dirichletValues}}, \textcolor{keyword}{const} pybind11::function\& functor, \textcolor{keyword}{auto}\&\& cppFunction) \{}
\DoxyCodeLine{68   \textcolor{keyword}{using }Basis        = \textcolor{keyword}{typename} \mbox{\hyperlink{a01767_a2e6f1ef4a810a7269303f54a6f74539f}{DirichletValues::Basis}};}
\DoxyCodeLine{69   \textcolor{keyword}{using }Intersection = \textcolor{keyword}{typename} Basis::GridView::Intersection;}
\DoxyCodeLine{70   \textcolor{keyword}{using }BackendType  = \textcolor{keyword}{typename} \mbox{\hyperlink{a01767_a3db820fbcd2b7edf58ce3b21b261f621}{DirichletValues::BackendType}};}
...
\DoxyCodeLine{114 \}}
\DoxyCodeLine{115 }
\DoxyCodeLine{146 \textcolor{keyword}{template} <\textcolor{keyword}{class }\mbox{\hyperlink{a01767}{DirichletValues}}, \textcolor{keyword}{class}... options>}
\DoxyCodeLine{147 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00367_ga39b6df6adfe4858b13ac71f5830f29f6}{registerDirichletValues}}(pybind11::handle scope, pybind11::class\_<DirichletValues, options...> cls) \{}
\DoxyCodeLine{148   \textcolor{keyword}{using }pybind11::operator\textcolor{stringliteral}{"{}"{}}\_a;}
\DoxyCodeLine{149 }
\DoxyCodeLine{150   \textcolor{keyword}{using }Basis        = \textcolor{keyword}{typename} \mbox{\hyperlink{a01767_a2e6f1ef4a810a7269303f54a6f74539f}{DirichletValues::Basis}};}
\DoxyCodeLine{151   \textcolor{keyword}{using }BackendType  = \textcolor{keyword}{typename} \mbox{\hyperlink{a01767_a3db820fbcd2b7edf58ce3b21b261f621}{DirichletValues::BackendType}};}
\DoxyCodeLine{152   \textcolor{keyword}{using }FlagsType    = \textcolor{keyword}{typename} \mbox{\hyperlink{a01767_aa71c2b94b37f2b4e83f9f1e059e6fe4c}{DirichletValues::FlagsType}};}
...
\DoxyCodeLine{173   \}}
\DoxyCodeLine{174 }
\DoxyCodeLine{175   cls.def(\mbox{\hyperlink{a00375_ac8243891c1b961e50a066140ab79a142}{pybind11::init}}([](\textcolor{keyword}{const} Basis\& \mbox{\hyperlink{a00401_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}) \{ \textcolor{keywordflow}{return} \textcolor{keyword}{new} \mbox{\hyperlink{a01767}{DirichletValues}}(\mbox{\hyperlink{a00401_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}); \}), pybind11::keep\_alive<1, 2>());}
\DoxyCodeLine{176 }
\DoxyCodeLine{177   cls.def\_property\_readonly(\textcolor{stringliteral}{"{}container"{}}, \&\mbox{\hyperlink{a01767_af8495b65eac223b7b6c64f07b31cc814}{DirichletValues::container}});}
\DoxyCodeLine{178   cls.def\_property\_readonly(\textcolor{stringliteral}{"{}size"{}}, \&\mbox{\hyperlink{a01767_a010fa7b0721c137eb61221493e52dc92}{DirichletValues::size}});}
\DoxyCodeLine{179   cls.def(\textcolor{stringliteral}{"{}\_\_len\_\_"{}}, \&\mbox{\hyperlink{a01767_a010fa7b0721c137eb61221493e52dc92}{DirichletValues::size}});}
\DoxyCodeLine{180   cls.def\_property\_readonly(\textcolor{stringliteral}{"{}fixedDOFsize"{}}, \&\mbox{\hyperlink{a01767_aeb299b04b2777be56012b32a3b2e6a9c}{DirichletValues::fixedDOFsize}});}
\DoxyCodeLine{181   cls.def(\textcolor{stringliteral}{"{}isConstrained"{}}, [](\mbox{\hyperlink{a01767}{DirichletValues}}\& self, std::size\_t i) -\/> \textcolor{keywordtype}{bool} \{ \textcolor{keywordflow}{return} self.\mbox{\hyperlink{a01767_a1b1fccdb71619c0a49aa24977682d43a}{isConstrained}}(i); \});}
\DoxyCodeLine{182   cls.def(\textcolor{stringliteral}{"{}setSingleDOF"{}}, [](\mbox{\hyperlink{a01767}{DirichletValues}}\& self, std::size\_t i, \textcolor{keywordtype}{bool} flag) \{ self.\mbox{\hyperlink{a01767_a179a4b05a361fc9ea0a3e935dcf0e45a}{setSingleDOF}}(i, flag); \});}
\DoxyCodeLine{183   cls.def(\textcolor{stringliteral}{"{}isConstrained"{}}, [](\mbox{\hyperlink{a01767}{DirichletValues}}\& self, MultiIndex i) -\/> \textcolor{keywordtype}{bool} \{ \textcolor{keywordflow}{return} self.\mbox{\hyperlink{a01767_a1b1fccdb71619c0a49aa24977682d43a}{isConstrained}}(i); \});}
\DoxyCodeLine{184   cls.def(\textcolor{stringliteral}{"{}setSingleDOF"{}}, [](\mbox{\hyperlink{a01767}{DirichletValues}}\& self, MultiIndex i, \textcolor{keywordtype}{bool} flag) \{ self.\mbox{\hyperlink{a01767_a179a4b05a361fc9ea0a3e935dcf0e45a}{setSingleDOF}}(i, flag); \});}
\DoxyCodeLine{185   cls.def(\textcolor{stringliteral}{"{}reset"{}}, \&\mbox{\hyperlink{a01767_ab8ae184ec5c0c79a893a8111d7315442}{DirichletValues::reset}});}
\DoxyCodeLine{186 }
\DoxyCodeLine{187   cls.def(\textcolor{stringliteral}{"{}fixDOFs"{}},}
\DoxyCodeLine{188           [](\mbox{\hyperlink{a01767}{DirichletValues}}\& self, \textcolor{keyword}{const} std::function<\textcolor{keywordtype}{void}(\textcolor{keyword}{const} Basis\&, Eigen::Ref<Eigen::VectorX<bool>>)>\& f) \{}
\DoxyCodeLine{189             \textcolor{keyword}{auto} lambda = [\&](\textcolor{keyword}{const} Basis\& \mbox{\hyperlink{a00401_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}, BackendType\& vec) \{ f(\mbox{\hyperlink{a00401_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}, vec.vector()); \};}
\DoxyCodeLine{190             self.\mbox{\hyperlink{a01767_a956ce2cdc09731f001821c7b59d49e85}{fixDOFs}}(lambda);}
\DoxyCodeLine{191           \});}
\DoxyCodeLine{192 \}}
\DoxyCodeLine{193 }
