...
\DoxyCodeLine{30 \mbox{\hyperlink{a01910}{Dune::FieldVector<ST, size>}} \mbox{\hyperlink{a00411_a0fdba7f3ebe4bf1ada6618f450b50221}{toDune}}(\textcolor{keyword}{const} Eigen::Vector<ST, size>\& vec) \{}
\DoxyCodeLine{31   \mbox{\hyperlink{a01910}{Dune::FieldVector<ST, size>}} fieldVector;}
...
\DoxyCodeLine{47 \mbox{\hyperlink{a01910}{Dune::FieldVector<ST, rows>}} \mbox{\hyperlink{a00411_a0fdba7f3ebe4bf1ada6618f450b50221}{toDune}}(\textcolor{keyword}{const} Eigen::Matrix<ST, rows, 0>\& vec) \{}
\DoxyCodeLine{48   assert(vec.cols() == 1 \&\& \textcolor{stringliteral}{"{}The passed matrix needs to have a single column."{}});}
\DoxyCodeLine{49   \mbox{\hyperlink{a01910}{Dune::FieldVector<ST, rows>}} fieldVector\{0.0\};}
\DoxyCodeLine{50 }
...
\DoxyCodeLine{66 Dune::FieldMatrix<ST, rows, cols> \mbox{\hyperlink{a00411_a0fdba7f3ebe4bf1ada6618f450b50221}{toDune}}(\textcolor{keyword}{const} Eigen::Matrix<ST, rows, cols>\& mat) \{}
...
\DoxyCodeLine{83 Eigen::Map<const Eigen::Vector<ST, size>> \mbox{\hyperlink{a00411_aaa7e8e9b8bd8247afecc24cdd54ec658}{toEigenMap}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01910}{Dune::FieldVector<ST, size>}}\& vec) \{}
...
\DoxyCodeLine{95 Eigen::Map<Eigen::Vector<ST, size>> \mbox{\hyperlink{a00411_aaa7e8e9b8bd8247afecc24cdd54ec658}{toEigenMap}}(\mbox{\hyperlink{a01910}{Dune::FieldVector<ST, size>}}\& vec) \{}
