...
\DoxyCodeLine{20 }
\DoxyCodeLine{21 \textcolor{preprocessor}{  \#include <\mbox{\hyperlink{a00317}{ikarus/finiteelements/febase.hh}}>}}
\DoxyCodeLine{22 \textcolor{preprocessor}{  \#include <\mbox{\hyperlink{a00299}{ikarus/finiteelements/fehelper.hh}}>}}
\DoxyCodeLine{23 \textcolor{preprocessor}{  \#include <\mbox{\hyperlink{a00314}{ikarus/finiteelements/ferequirements.hh}}>}}
...
\DoxyCodeLine{26 \textcolor{preprocessor}{  \#include <\mbox{\hyperlink{a00293}{ikarus/finiteelements/physicshelper.hh}}>}}
...
\DoxyCodeLine{60 \textcolor{keyword}{class }\mbox{\hyperlink{a01524}{NonLinearElastic}} : \textcolor{keyword}{public} \mbox{\hyperlink{a01404}{ResultTypeBase}}<ResultTypes::PK2Stress, ResultTypes::PK2StressFull>}
\DoxyCodeLine{61 \{}
...
\DoxyCodeLine{85       : mat\_\{pre.\mbox{\hyperlink{a01524_a881c2f56424f21b925f6fee08f2b83b2}{material}}\} \{\}}
\DoxyCodeLine{86 }
...
\DoxyCodeLine{190   \textcolor{keyword}{decltype}(\textcolor{keyword}{auto}) \mbox{\hyperlink{a01524_a881c2f56424f21b925f6fee08f2b83b2}{material}}() \textcolor{keyword}{const} \{}
\DoxyCodeLine{191     \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (\mbox{\hyperlink{a01980}{Concepts::AutodiffScalar<ScalarType>}})}
...
\DoxyCodeLine{209   \textcolor{keyword}{auto} \mbox{\hyperlink{a01524_a7c8edbff09762bdb9cae26d4cf6b0a91}{calculateAtImpl}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01368}{Requirement}}\& req, \textcolor{keyword}{const} \mbox{\hyperlink{a01784}{Dune::FieldVector<double, Traits::mydim>}}\& local,}
...
\DoxyCodeLine{212 }
\DoxyCodeLine{213     \textcolor{keyword}{using }RTWrapper = \mbox{\hyperlink{a01392}{ResultWrapper<RT<typename Traits::ctype, myDim, Traits::worlddim>}}, \mbox{\hyperlink{a00384_acfb09bb7db104db62d3d1d2dc3e009b2a57dea6f5039281b7fee517fc43bf3110}{ResultShape::Vector}}>;}
...
\DoxyCodeLine{215       \textcolor{keyword}{const} \textcolor{keyword}{auto} uFunction = \mbox{\hyperlink{a01524_abd6925cc756ecdffea3976c3ad252dac}{displacementFunction}}(req);}
...
\DoxyCodeLine{224       \}();}
\DoxyCodeLine{225       \textcolor{keywordflow}{return} RTWrapper\{mat.template stresses<StrainTags::greenLagrangian>(enlargeIfReduced<Material>(\mbox{\hyperlink{a00380_ga4304655095296ce9283e012587817a51}{toVoigt}}(E)))\};}
\DoxyCodeLine{226     \}}
\DoxyCodeLine{227   \}}
\DoxyCodeLine{228 }
\DoxyCodeLine{229 \textcolor{keyword}{private}:}
\DoxyCodeLine{230   \textcolor{comment}{//> CRTP}}
\DoxyCodeLine{231   \textcolor{keyword}{const} \textcolor{keyword}{auto}\& underlying()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} \textcolor{keyword}{static\_cast<}\textcolor{keyword}{const }\mbox{\hyperlink{a01336}{FE}}\&\textcolor{keyword}{>}(*this); \}}
...
\DoxyCodeLine{235   \mbox{\hyperlink{a01524_a301b03982ef1629b26bac4e6ab522797}{Material}} mat\_;}
...
\DoxyCodeLine{248   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01524_aa54197bd165210db66028abcda00be24}{calculateMatrixImpl}}(}
\DoxyCodeLine{249       \textcolor{keyword}{const} \mbox{\hyperlink{a01368}{Requirement}}\& par, \textcolor{keyword}{const} \mbox{\hyperlink{a00384_a390d5311179ec61d163a29c943b3d1a0}{MatrixAffordance}}\& affordance, \textcolor{keyword}{typename} Traits::template MatrixType<> K,}
...
\DoxyCodeLine{252     \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00404}{Dune}};}
\DoxyCodeLine{253     \textcolor{keyword}{const} \textcolor{keyword}{auto} uFunction = \mbox{\hyperlink{a01524_abd6925cc756ecdffea3976c3ad252dac}{displacementFunction}}(par, dx);}
\DoxyCodeLine{254     \textcolor{keyword}{const} \textcolor{keyword}{auto} eps       = \mbox{\hyperlink{a01524_a285fd9ad1535df453f184154587bb1ff}{strainFunction}}(par, dx);}
...
\DoxyCodeLine{259       \textcolor{keyword}{const} \textcolor{keyword}{auto} C            = \mbox{\hyperlink{a01524_aaf1eac20d733fcd9f2c7ac68dbbddc5c}{materialTangent}}(EVoigt);}
\DoxyCodeLine{260 }
\DoxyCodeLine{261       \textcolor{keyword}{const} \textcolor{keyword}{auto} stresses = \mbox{\hyperlink{a01524_af7716846e0ca64181119e58548126231}{getStress}}(EVoigt);}
...
\DoxyCodeLine{267           K.template block<myDim, myDim>(i * \mbox{\hyperlink{a01524_a75f37a35f01f4440faec8355c25e85e7}{myDim}}, j * \mbox{\hyperlink{a01524_a75f37a35f01f4440faec8355c25e85e7}{myDim}}) += (bopI.transpose() * C * bopJ + kgIJ) * intElement;}
\DoxyCodeLine{268         \}}
\DoxyCodeLine{269       \}}
\DoxyCodeLine{270     \}}
\DoxyCodeLine{271   \}}
...
\DoxyCodeLine{274   \textcolor{keyword}{auto} \mbox{\hyperlink{a01524_a149037d90b4c2765fdf28c35eeb91f12}{calculateScalarImpl}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01368}{Requirement}}\& par, \mbox{\hyperlink{a00384_af6f894084edd9109762b86222995ef2a}{ScalarAffordance}} affordance,}
...
\DoxyCodeLine{278     \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00404}{Dune}};}
\DoxyCodeLine{279 }
\DoxyCodeLine{280     \textcolor{keyword}{const} \textcolor{keyword}{auto} eps     = \mbox{\hyperlink{a01524_a285fd9ad1535df453f184154587bb1ff}{strainFunction}}(par, dx);}
...
\DoxyCodeLine{286       \textcolor{keyword}{const} \textcolor{keyword}{auto} internalEnergy = \mbox{\hyperlink{a01524_a01ea8b2e688566c391df267a040298ee}{getInternalEnergy}}(EVoigt);}
...
\DoxyCodeLine{294   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01524_a76de3bbd2b95cd470e59d0314b27e18f}{calculateVectorImpl}}(}
\DoxyCodeLine{295       \textcolor{keyword}{const} \mbox{\hyperlink{a01368}{Requirement}}\& par, \mbox{\hyperlink{a00384_aab9e3e38507d1db7602bc750718c302a}{VectorAffordance}} affordance, \textcolor{keyword}{typename} Traits::template VectorType<ScalarType> force,}
...
\DoxyCodeLine{298     \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00404}{Dune}};}
\DoxyCodeLine{299     \textcolor{keyword}{const} \textcolor{keyword}{auto} eps = \mbox{\hyperlink{a01524_a285fd9ad1535df453f184154587bb1ff}{strainFunction}}(par, dx);}
\DoxyCodeLine{300 }
...
\DoxyCodeLine{305       \textcolor{keyword}{const} \textcolor{keyword}{auto} stresses     = \mbox{\hyperlink{a01524_af7716846e0ca64181119e58548126231}{getStress}}(EVoigt);}
...
\DoxyCodeLine{308         force.template segment<myDim>(\mbox{\hyperlink{a01524_a75f37a35f01f4440faec8355c25e85e7}{myDim}} * i) += bopI.transpose() * stresses * intElement;}
\DoxyCodeLine{309       \}}
\DoxyCodeLine{310     \}}
\DoxyCodeLine{311   \}}
\DoxyCodeLine{312 \};}
...
\DoxyCodeLine{321 \textcolor{keyword}{auto} \mbox{\hyperlink{a00384_a6f028adf5a1a78301381fe92b241d550}{nonLinearElastic}}(\textcolor{keyword}{const} MAT\& mat) \{}
\DoxyCodeLine{322   \mbox{\hyperlink{a01528}{NonLinearElasticPre<MAT>}} pre(mat);}
\DoxyCodeLine{323 }
