...
\DoxyCodeLine{21 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a02764}{ikarus/utils/basis.hh}}>}}
...
\DoxyCodeLine{46 \textcolor{keyword}{struct }\mbox{\hyperlink{a01592}{SparseMatrixWrapper}}}
\DoxyCodeLine{47 \{}
\DoxyCodeLine{48   \mbox{\hyperlink{a01592_adea8b485a2a498cb28c69debdb841f21}{SparseMatrixWrapper}}(Eigen::SparseMatrix<T>\& matrix)}
\DoxyCodeLine{49       : \mbox{\hyperlink{a01592_a32da660f4237007b18c282ea7bb38b8b}{matrixRef}}(matrix) \{\}}
\DoxyCodeLine{50   std::reference\_wrapper<Eigen::SparseMatrix<T>> \mbox{\hyperlink{a01592_a32da660f4237007b18c282ea7bb38b8b}{matrixRef}};}
\DoxyCodeLine{51 \};}
\DoxyCodeLine{52 }
...
\DoxyCodeLine{57       scope, \textcolor{stringliteral}{"{}SparseMatrixWrapper"{}}, Dune::Python::GenerateTypeName(Dune::className<\mbox{\hyperlink{a01592}{SparseMatrixWrapper<T>}}>()),}
...
\DoxyCodeLine{61         .def(\textcolor{stringliteral}{"{}\_\_setitem\_\_"{}}, [](\mbox{\hyperlink{a01592}{SparseMatrixWrapper<T>}}\& self, std::array<int, 2> index,}
\DoxyCodeLine{62                                \textcolor{keywordtype}{double} val) \{ self.\mbox{\hyperlink{a01592_a32da660f4237007b18c282ea7bb38b8b}{matrixRef}}.get().coeffRef(index[0], index[1]) = val; \})}
\DoxyCodeLine{63         .def(\textcolor{stringliteral}{"{}\_\_getitem\_\_"{}}, [](\mbox{\hyperlink{a01592}{SparseMatrixWrapper<T>}}\& self, std::array<int, 2> index) \{}
\DoxyCodeLine{64           \textcolor{keywordflow}{return} self.\mbox{\hyperlink{a01592_a32da660f4237007b18c282ea7bb38b8b}{matrixRef}}.get().coeffRef(index[0], index[1]);}
\DoxyCodeLine{65         \});}
\DoxyCodeLine{66   \}}
\DoxyCodeLine{67 \}}
\DoxyCodeLine{68 }
...
\DoxyCodeLine{81       \mbox{\hyperlink{a01596}{ScalarWrapper<std::reference\_wrapper<typename AssemblerManipulator::ScalarType>}}>,}
...
\DoxyCodeLine{84                          \mbox{\hyperlink{a01592}{SparseMatrixWrapper<double>}}, Eigen::Ref<Eigen::MatrixXd>>>;}
...
\DoxyCodeLine{95                           \textcolor{keyword}{using }Traits            = \mbox{\hyperlink{a01848}{Ikarus::traits::FunctionTraits<F>}};}
...
\DoxyCodeLine{103                               \textcolor{keyword}{typename} \mbox{\hyperlink{a01860}{Ikarus::traits::ChangeArgTypeAtPos<F, lastIndex, NewArg>::NewFunctionType}};}
\DoxyCodeLine{104 }
