...
We use \href{https://reuse.software/}{\texttt{ REUSE software}} to manage our licenses. All licenses reside in the folder {\ttfamily LICENSES}. Each source file here has the corresponding header for license information. The \mbox{\hyperlink{a00363}{Ikarus}} source and header files are released under {\ttfamily LGPL-\/3.\+0-\/or-\/later}.
