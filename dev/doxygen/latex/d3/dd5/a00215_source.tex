\hypertarget{a00215_source}{}\doxysection{griddrawer.\+hh}
\label{a00215_source}\index{griddrawer.hh@{griddrawer.hh}}
...
\DoxyCodeLine{18 }
\DoxyCodeLine{30 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Gr\textcolor{keywordtype}{id}View>}
\DoxyCodeLine{31 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00215_a2634a2b365ea0b95c6dcfad0dbefac1f}{draw}}(\textcolor{keyword}{const} GridView\& gridView, \textcolor{keywordtype}{bool} forever = \textcolor{keyword}{false}) \{}
...
\DoxyCodeLine{36   \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} edgeCodim = GridView::dimension -\/ 1;}
\DoxyCodeLine{37   \textcolor{keywordflow}{for} (\textcolor{keyword}{auto}\&\& element : elements(gridView)) \{}
\DoxyCodeLine{38     std::array<std::array<double, 2>, GridView::dimensionworld> edgeCoords\{\};}
...
\DoxyCodeLine{43         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} j = 0; j < GridView::dimensionworld; ++j)}
\DoxyCodeLine{44           edgeCoords[j][i] = vertCoords[j];}
\DoxyCodeLine{45       \}}
\DoxyCodeLine{46       \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (GridView::dimensionworld == 3) \{}
