\hypertarget{a00056_source}{}\doxysection{concepts.\+hh}
\label{a00056_source}\index{concepts.hh@{concepts.hh}}
...
\DoxyCodeLine{23 }
\DoxyCodeLine{24 \textcolor{preprocessor}{\#include "{}\mbox{\hyperlink{a00191}{ikarus/assembler/dirichletbcenforcement.hh}}"{}}}
\DoxyCodeLine{25 \textcolor{preprocessor}{\#include "{}\mbox{\hyperlink{a00305}{ikarus/finiteelements/mechanics/materials/tags.hh}}"{}}}
\DoxyCodeLine{26 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00035}{ikarus/utils/traits.hh}}>}}
\DoxyCodeLine{27 }
...
\DoxyCodeLine{30 \textcolor{keyword}{struct }\mbox{\hyperlink{a01736}{EigenBase}};}
\DoxyCodeLine{31 \}}
\DoxyCodeLine{32 }
...
\DoxyCodeLine{38 \textcolor{keyword}{auto} \mbox{\hyperlink{a00384_ac2c6469be19ce4ef2e630bfa1c5a5e24}{transpose}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01736}{Eigen::EigenBase<Derived>}}\& A);}
...
\DoxyCodeLine{50   \textcolor{keyword}{concept }\mbox{\hyperlink{a01932}{FlatInterLeavedBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{82   \textcolor{keyword}{concept }\mbox{\hyperlink{a01933}{LagrangeNode}} = Impl::LagrangeNodeHelper<Dune::Functions::LagrangeNode, N>::value;}
\DoxyCodeLine{83 }
\DoxyCodeLine{91   \textcolor{keyword}{template} <\textcolor{keyword}{typename} N, \textcolor{keywordtype}{int} order>}
\DoxyCodeLine{92   \textcolor{keyword}{concept }\mbox{\hyperlink{a01934}{LagrangeNodeOfOrder}} = Impl::LagrangeNodeHelperOfOrder<Dune::Functions::LagrangeNode, N, order>::value;}
\DoxyCodeLine{93 }
\DoxyCodeLine{102   \textcolor{keyword}{template} <\textcolor{keyword}{typename} B>}
\DoxyCodeLine{103   \textcolor{keyword}{concept }\mbox{\hyperlink{a01935}{FlatLexicographicBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{116   \textcolor{keyword}{concept }\mbox{\hyperlink{a01936}{FlatIndexBasis}} = \mbox{\hyperlink{a01935}{FlatLexicographicBasis<B>}} or \mbox{\hyperlink{a01932}{FlatInterLeavedBasis<B>}};}
\DoxyCodeLine{117 }
\DoxyCodeLine{126   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Basis>}
\DoxyCodeLine{127   \textcolor{keyword}{concept }\mbox{\hyperlink{a01937}{BlockedInterLeavedBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{140   \textcolor{keyword}{concept }\mbox{\hyperlink{a01938}{BlockedLexicographicBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{150   \textcolor{keyword}{concept }\mbox{\hyperlink{a01939}{DuneLocalBasis}} = \textcolor{keyword}{requires}(DLB\& duneLocalBasis) \{}
...
\DoxyCodeLine{175   \textcolor{keyword}{concept }\mbox{\hyperlink{a01940}{BlockedIndexBasis}} = \mbox{\hyperlink{a01938}{BlockedLexicographicBasis<B>}} or \mbox{\hyperlink{a01937}{BlockedInterLeavedBasis<B>}};}
\DoxyCodeLine{176 }
...
\DoxyCodeLine{185   \textcolor{keyword}{concept }\mbox{\hyperlink{a01941}{PathFollowingStrategy}} = \textcolor{keyword}{requires}(PF pft, NLO nop, SA args) \{}
...
\DoxyCodeLine{200   \textcolor{keyword}{concept }\mbox{\hyperlink{a01942}{AdaptiveStepSizingStrategy}} = \textcolor{keyword}{requires}(ASS adaptiveStepSizing, NLSI info, SA args, \mbox{\hyperlink{a00384_abcf5978fa18a6e0aadc5e19c4a0edaa9}{NonLinearOperator}} nop) \{}
...
\DoxyCodeLine{215   \textcolor{keyword}{concept }\mbox{\hyperlink{a01943}{LinearSolverCheck}} = \textcolor{keyword}{requires}(LS\& linearSolver, M\& A, V\& vec) \{}
...
\DoxyCodeLine{229   \textcolor{keyword}{concept }\mbox{\hyperlink{a01944}{NonLinearSolverCheckForPathFollowing}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{246   \textcolor{keyword}{concept }\mbox{\hyperlink{a01945}{MultiplyAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x* y; \};}
\DoxyCodeLine{247 }
\DoxyCodeLine{255   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{256   \textcolor{keyword}{concept }\mbox{\hyperlink{a01946}{AddAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x + y; \};}
\DoxyCodeLine{257 }
\DoxyCodeLine{265   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{266   \textcolor{keyword}{concept }\mbox{\hyperlink{a01947}{SubstractAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x -\/ y; \};}
\DoxyCodeLine{267 }
\DoxyCodeLine{276   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{277   \textcolor{keyword}{concept }\mbox{\hyperlink{a01948}{MultiplyAssignAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x *= y; \};}
\DoxyCodeLine{278 }
\DoxyCodeLine{287   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{288   \textcolor{keyword}{concept }\mbox{\hyperlink{a01949}{DivideAssignAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x /= y; \};}
\DoxyCodeLine{289 }
\DoxyCodeLine{298   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{299   \textcolor{keyword}{concept }\mbox{\hyperlink{a01950}{AddAssignAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x += y; \};}
\DoxyCodeLine{300 }
\DoxyCodeLine{309   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{310   \textcolor{keyword}{concept }\mbox{\hyperlink{a01951}{SubstractAssignAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x -\/= y; \};}
\DoxyCodeLine{311 }
\DoxyCodeLine{319   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{320   \textcolor{keyword}{concept }\mbox{\hyperlink{a01952}{DivideAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x / y; \};}
\DoxyCodeLine{321 }
\DoxyCodeLine{328   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L>}
\DoxyCodeLine{329   \textcolor{keyword}{concept }\mbox{\hyperlink{a01953}{NegateAble}} = \textcolor{keyword}{requires}(L x) \{ -\/x; \};}
\DoxyCodeLine{330 }
\DoxyCodeLine{337   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L>}
\DoxyCodeLine{338   \textcolor{keyword}{concept }\mbox{\hyperlink{a01954}{TransposeAble}} = \textcolor{keyword}{requires}(L x) \{ \mbox{\hyperlink{a00384_ac2c6469be19ce4ef2e630bfa1c5a5e24}{transpose}}(x); \};}
\DoxyCodeLine{339 }
\DoxyCodeLine{346   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Op, \textcolor{keyword}{typename}... Args>}
\DoxyCodeLine{347   \textcolor{keyword}{concept }\mbox{\hyperlink{a01955}{IsFunctorWithArgs}} = \textcolor{keyword}{requires}(Op op, Args... args) \{ op(args...); \};}
\DoxyCodeLine{348 }
\DoxyCodeLine{354   \textcolor{keyword}{template} <\textcolor{keyword}{typename} V>}
\DoxyCodeLine{355   \textcolor{keyword}{concept }\mbox{\hyperlink{a01956}{EigenVector}} = \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{bool}\textcolor{keyword}{>}(V::IsVectorAtCompileTime);}
\DoxyCodeLine{356 }
\DoxyCodeLine{362   \textcolor{keyword}{template} <\textcolor{keyword}{typename} M>}
\DoxyCodeLine{363   \textcolor{keyword}{concept }\mbox{\hyperlink{a01957}{EigenMatrix}} = traits::isSpecializationTypeAndNonTypes<Eigen::Matrix, M>::value;}
\DoxyCodeLine{364 }
...
\DoxyCodeLine{369 }
\DoxyCodeLine{370   \mbox{\hyperlink{a00056_ac8757039febcebb4741b376dc8258d6d}{MAKE\_EIGEN\_FIXED\_VECTOR\_CONCEPT}}(1)}
\DoxyCodeLine{371   \mbox{\hyperlink{a00056_ac8757039febcebb4741b376dc8258d6d}{MAKE\_EIGEN\_FIXED\_VECTOR\_CONCEPT}}(2)}
\DoxyCodeLine{372   \mbox{\hyperlink{a00056_ac8757039febcebb4741b376dc8258d6d}{MAKE\_EIGEN\_FIXED\_VECTOR\_CONCEPT}}(3)}
\DoxyCodeLine{373   \mbox{\hyperlink{a00056_ac8757039febcebb4741b376dc8258d6d}{MAKE\_EIGEN\_FIXED\_VECTOR\_CONCEPT}}(4)}
\DoxyCodeLine{374   \mbox{\hyperlink{a00056_ac8757039febcebb4741b376dc8258d6d}{MAKE\_EIGEN\_FIXED\_VECTOR\_CONCEPT}}(5)}
\DoxyCodeLine{375   \mbox{\hyperlink{a00056_ac8757039febcebb4741b376dc8258d6d}{MAKE\_EIGEN\_FIXED\_VECTOR\_CONCEPT}}(6)}
\DoxyCodeLine{376 }
...
\DoxyCodeLine{381 }
\DoxyCodeLine{382   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(1, 1)}
\DoxyCodeLine{383 }
\DoxyCodeLine{384   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(1, 2)}
\DoxyCodeLine{385   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(2, 2)}
\DoxyCodeLine{386 }
\DoxyCodeLine{387   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(1, 3)}
\DoxyCodeLine{388   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(2, 3)}
\DoxyCodeLine{389   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(3, 2)}
\DoxyCodeLine{390   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(3, 3)}
\DoxyCodeLine{391 }
\DoxyCodeLine{392   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(1, 4)}
\DoxyCodeLine{393   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(2, 4)}
\DoxyCodeLine{394   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(3, 4)}
\DoxyCodeLine{395   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(4, 2)}
\DoxyCodeLine{396   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(4, 3)}
\DoxyCodeLine{397   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(4, 4)}
\DoxyCodeLine{398 }
\DoxyCodeLine{399   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(1, 5)}
\DoxyCodeLine{400   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(2, 5)}
\DoxyCodeLine{401   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(3, 5)}
\DoxyCodeLine{402   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(4, 5)}
\DoxyCodeLine{403   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(5, 2)}
\DoxyCodeLine{404   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(5, 3)}
\DoxyCodeLine{405   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(5, 4)}
\DoxyCodeLine{406   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(5, 5)}
\DoxyCodeLine{407 }
\DoxyCodeLine{408   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(1, 6)}
\DoxyCodeLine{409   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(2, 6)}
\DoxyCodeLine{410   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(3, 6)}
\DoxyCodeLine{411   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(4, 6)}
\DoxyCodeLine{412   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(5, 6)}
\DoxyCodeLine{413   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(6, 2)}
\DoxyCodeLine{414   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(6, 3)}
\DoxyCodeLine{415   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(6, 4)}
\DoxyCodeLine{416   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(6, 5)}
\DoxyCodeLine{417   \mbox{\hyperlink{a00056_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(6, 6)}
\DoxyCodeLine{418 }
...
\DoxyCodeLine{422 }
\DoxyCodeLine{423   \mbox{\hyperlink{a00056_aba360f830591dbc713b7fa692d614101}{MAKE\_EIGEN\_FIXED\_MATRIX\_OR\_VOIGT\_CONCEPT}}(1, 1)}
\DoxyCodeLine{424   \mbox{\hyperlink{a00056_aba360f830591dbc713b7fa692d614101}{MAKE\_EIGEN\_FIXED\_MATRIX\_OR\_VOIGT\_CONCEPT}}(2, 3)}
\DoxyCodeLine{425   \mbox{\hyperlink{a00056_aba360f830591dbc713b7fa692d614101}{MAKE\_EIGEN\_FIXED\_MATRIX\_OR\_VOIGT\_CONCEPT}}(3, 6)}
\DoxyCodeLine{426 }
...
\DoxyCodeLine{457   \textcolor{keyword}{concept }\mbox{\hyperlink{a01958}{IsMaterial}} = Impl::isMaterial<MaterialToCheck, Material>();}
\DoxyCodeLine{458 }
\DoxyCodeLine{459   \textcolor{keyword}{namespace }Impl \{}
\DoxyCodeLine{460     \textcolor{keyword}{template} <\textcolor{keyword}{typename} T>}
\DoxyCodeLine{461     \textcolor{keyword}{concept }\mbox{\hyperlink{a01961}{ResultType}} = \textcolor{keyword}{requires}(T t) \{}
...
\DoxyCodeLine{476   \textcolor{keyword}{concept }\mbox{\hyperlink{a01960}{GeometricallyLinearMaterial}} = MAT::strainTag == \mbox{\hyperlink{a00373_ggacef1e451de1a99845c59d7391064fb8fa9a932b3cb396238423eb2f33ec17d6aa}{StrainTags::linear}};}
\DoxyCodeLine{477 }
...
\DoxyCodeLine{488   \textcolor{keyword}{concept }\mbox{\hyperlink{a01961}{ResultType}} =}
...
\DoxyCodeLine{500   \textcolor{keyword}{concept }\mbox{\hyperlink{a01962}{FlatAssembler}} = \textcolor{keyword}{requires}(T t, \textcolor{keyword}{const} \textcolor{keyword}{typename} T::FERequirement\& req,}
...
\DoxyCodeLine{531   \textcolor{keyword}{concept }\mbox{\hyperlink{a01963}{ScalarFlatAssembler}} =}
\DoxyCodeLine{532       \mbox{\hyperlink{a01962}{Concepts::FlatAssembler<T>}} and \textcolor{keyword}{requires}(T t, \textcolor{keyword}{const} \textcolor{keyword}{typename} T::FERequirement\& req,}
...
\DoxyCodeLine{545   \textcolor{keyword}{concept }\mbox{\hyperlink{a01964}{VectorFlatAssembler}} = \mbox{\hyperlink{a01963}{Concepts::ScalarFlatAssembler<T>}} and}
...
\DoxyCodeLine{562   \textcolor{keyword}{concept }\mbox{\hyperlink{a01965}{MatrixFlatAssembler}} = \mbox{\hyperlink{a01964}{Concepts::VectorFlatAssembler<T>}} and}
...
\DoxyCodeLine{572   \textcolor{keyword}{concept }\mbox{\hyperlink{a01966}{DataCollector}} = \textcolor{keyword}{requires}(DC dc) \{}
...
\DoxyCodeLine{581   \textcolor{keyword}{concept }\mbox{\hyperlink{a01967}{GridView}} = \textcolor{keyword}{requires}(GV g) \{}
...
\DoxyCodeLine{608   \textcolor{keyword}{concept }\mbox{\hyperlink{a01968}{AutodiffScalar}} = Impl::is\_dual<T>::value;}
\DoxyCodeLine{609 }
