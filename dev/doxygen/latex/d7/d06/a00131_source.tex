...
\DoxyCodeLine{16 \textcolor{preprocessor}{\#  include <\mbox{\hyperlink{a00035}{ikarus/utils/eigendunetransformations.hh}}>}}
\DoxyCodeLine{17 }
...
\DoxyCodeLine{30   Eigen::Matrix3d \mbox{\hyperlink{a00298_a7a5b9f5e83f6918ca1726fb4316c3b86}{calcTransformationMatrix2D}}(\textcolor{keyword}{const} Geometry\& geometry) \{}
...
\DoxyCodeLine{62   Eigen::Matrix<double, 6, 6> \mbox{\hyperlink{a00298_a95234ab8588ced83708c6e5a30e2368e}{calcTransformationMatrix3D}}(\textcolor{keyword}{const} Geometry\& geometry) \{}
...
\DoxyCodeLine{103   \textcolor{keyword}{struct }\mbox{\hyperlink{a01241}{EASQ1E4}} \{}
\DoxyCodeLine{104     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01241_a091b2d7ab16564e0355e5078fae6eabd}{strainSize}}         = 3;}
\DoxyCodeLine{105     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01241_ad14763e1531d0b04751e51cc1ca0f23f}{enhancedStrainSize}} = 4;}
\DoxyCodeLine{106     \textcolor{keyword}{using }\mbox{\hyperlink{a01241_aa88f171600c9a12e1e56f0eac6184b20}{MType}}                             = Eigen::Matrix<double, strainSize, enhancedStrainSize>;}
\DoxyCodeLine{107 }
\DoxyCodeLine{108     \mbox{\hyperlink{a01241_ac30d67e782b291e459cad4eacdf16cf2}{EASQ1E4}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{109     \textcolor{keyword}{explicit} \mbox{\hyperlink{a01241_a322fdf68966e7fb0ee8165f0c966cc40}{EASQ1E4}}(\textcolor{keyword}{const} Geometry\& geometry\_)}
\DoxyCodeLine{110         : \mbox{\hyperlink{a01241_a98834915295f56b2eb15eae744202339}{geometry}}\{std::make\_shared<Geometry>(geometry\_)\},}
\DoxyCodeLine{111           \mbox{\hyperlink{a01241_a39592b62d7442344006f6c1f7254631f}{T0InverseTransformed}}\{\mbox{\hyperlink{a00298_a7a5b9f5e83f6918ca1726fb4316c3b86}{calcTransformationMatrix2D}}(geometry\_)\} \{\}}
\DoxyCodeLine{112 }
\DoxyCodeLine{113     \textcolor{keyword}{auto} \mbox{\hyperlink{a01241_a69fd71138345d01372e9434a1fa904fe}{calcM}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01341}{Dune::FieldVector<double, 2>}}\& quadPos)\textcolor{keyword}{ const }\{}
\DoxyCodeLine{114       \mbox{\hyperlink{a01241_aa88f171600c9a12e1e56f0eac6184b20}{MType}} M;}
\DoxyCodeLine{115       M.setZero(\mbox{\hyperlink{a01241_a091b2d7ab16564e0355e5078fae6eabd}{strainSize}}, \mbox{\hyperlink{a01241_ad14763e1531d0b04751e51cc1ca0f23f}{enhancedStrainSize}});}
...
\DoxyCodeLine{122       \textcolor{keyword}{const} \textcolor{keywordtype}{double} detJ = \mbox{\hyperlink{a01241_a98834915295f56b2eb15eae744202339}{geometry}}-\/>integrationElement(quadPos);}
\DoxyCodeLine{123       M                 = \mbox{\hyperlink{a01241_a39592b62d7442344006f6c1f7254631f}{T0InverseTransformed}} / detJ * M;}
\DoxyCodeLine{124       \textcolor{keywordflow}{return} M;}
\DoxyCodeLine{125     \}}
\DoxyCodeLine{126 }
\DoxyCodeLine{127     std::shared\_ptr<Geometry> \mbox{\hyperlink{a01241_a98834915295f56b2eb15eae744202339}{geometry}};}
\DoxyCodeLine{128     Eigen::Matrix3d \mbox{\hyperlink{a01241_a39592b62d7442344006f6c1f7254631f}{T0InverseTransformed}};}
\DoxyCodeLine{129   \};}
\DoxyCodeLine{130 }
\DoxyCodeLine{138   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Geometry>}
\DoxyCodeLine{139   \textcolor{keyword}{struct }\mbox{\hyperlink{a01245}{EASQ1E5}} \{}
\DoxyCodeLine{140     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01245_ac0cb21ead6bd716ddee697328ba429f7}{strainSize}}         = 3;}
\DoxyCodeLine{141     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01245_a295cad836cda5a090316e80d37107d97}{enhancedStrainSize}} = 5;}
\DoxyCodeLine{142     \textcolor{keyword}{using }\mbox{\hyperlink{a01245_a00ce3ccf82b2acbae524f52ea42de95a}{MType}}                             = Eigen::Matrix<double, strainSize, enhancedStrainSize>;}
\DoxyCodeLine{143 }
\DoxyCodeLine{144     \mbox{\hyperlink{a01245_a4f508bc3cac3ed9504183f1768eca6a1}{EASQ1E5}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{145     \textcolor{keyword}{explicit} \mbox{\hyperlink{a01245_a56469a9df101001a6aad3aab9e51b568}{EASQ1E5}}(\textcolor{keyword}{const} Geometry\& geometry\_)}
\DoxyCodeLine{146         : \mbox{\hyperlink{a01245_a933c1aed3dbfda6e87955129651ca3e2}{geometry}}\{std::make\_shared<Geometry>(geometry\_)\},}
\DoxyCodeLine{147           \mbox{\hyperlink{a01245_abc4ffe4eb222fc40c893f69b2aa96f25}{T0InverseTransformed}}\{\mbox{\hyperlink{a00298_a7a5b9f5e83f6918ca1726fb4316c3b86}{calcTransformationMatrix2D}}(geometry\_)\} \{\}}
\DoxyCodeLine{148 }
\DoxyCodeLine{149     \textcolor{keyword}{auto} \mbox{\hyperlink{a01245_a624d83c80aa923e821696c9cc2deef85}{calcM}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01341}{Dune::FieldVector<double, 2>}}\& quadPos)\textcolor{keyword}{ const }\{}
\DoxyCodeLine{150       \mbox{\hyperlink{a01245_a00ce3ccf82b2acbae524f52ea42de95a}{MType}} M;}
...
\DoxyCodeLine{159       \textcolor{keyword}{const} \textcolor{keywordtype}{double} detJ = \mbox{\hyperlink{a01245_a933c1aed3dbfda6e87955129651ca3e2}{geometry}}-\/>integrationElement(quadPos);}
\DoxyCodeLine{160       M                 = \mbox{\hyperlink{a01245_abc4ffe4eb222fc40c893f69b2aa96f25}{T0InverseTransformed}} / detJ * M;}
\DoxyCodeLine{161       \textcolor{keywordflow}{return} M;}
\DoxyCodeLine{162     \}}
\DoxyCodeLine{163 }
\DoxyCodeLine{164     std::shared\_ptr<Geometry> \mbox{\hyperlink{a01245_a933c1aed3dbfda6e87955129651ca3e2}{geometry}};}
\DoxyCodeLine{165     Eigen::Matrix3d \mbox{\hyperlink{a01245_abc4ffe4eb222fc40c893f69b2aa96f25}{T0InverseTransformed}};}
\DoxyCodeLine{166   \};}
\DoxyCodeLine{167 }
\DoxyCodeLine{175   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Geometry>}
\DoxyCodeLine{176   \textcolor{keyword}{struct }\mbox{\hyperlink{a01249}{EASQ1E7}} \{}
\DoxyCodeLine{177     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01249_a7b988c0a64a63311a1c6861a4a45ed4f}{strainSize}}         = 3;}
\DoxyCodeLine{178     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01249_ad0b8cacc2ddc15f583977858ee760077}{enhancedStrainSize}} = 7;}
\DoxyCodeLine{179     \textcolor{keyword}{using }\mbox{\hyperlink{a01249_a38aee3dda331f7f4071c6348ea511cca}{MType}}                             = Eigen::Matrix<double, strainSize, enhancedStrainSize>;}
\DoxyCodeLine{180 }
\DoxyCodeLine{181     \mbox{\hyperlink{a01249_a59966ec62660dc7eeb1f12400b3ad672}{EASQ1E7}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{182     \textcolor{keyword}{explicit} \mbox{\hyperlink{a01249_a8ac7ec46a513c44a892e48e297324abf}{EASQ1E7}}(\textcolor{keyword}{const} Geometry\& geometry\_)}
\DoxyCodeLine{183         : \mbox{\hyperlink{a01249_ac28ee04d63153dd9323a2926e2f9a8b9}{geometry}}\{std::make\_shared<Geometry>(geometry\_)\},}
\DoxyCodeLine{184           \mbox{\hyperlink{a01249_acd663cb202adf116ebab1d2cfbd708ea}{T0InverseTransformed}}\{\mbox{\hyperlink{a00298_a7a5b9f5e83f6918ca1726fb4316c3b86}{calcTransformationMatrix2D}}(geometry\_)\} \{\}}
\DoxyCodeLine{185 }
\DoxyCodeLine{186     \textcolor{keyword}{auto} \mbox{\hyperlink{a01249_a984954a677451b2f71a968c8e30d5658}{calcM}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01341}{Dune::FieldVector<double, 2>}}\& quadPos)\textcolor{keyword}{ const }\{}
\DoxyCodeLine{187       \mbox{\hyperlink{a01249_a38aee3dda331f7f4071c6348ea511cca}{MType}} M;}
...
\DoxyCodeLine{198       \textcolor{keyword}{const} \textcolor{keywordtype}{double} detJ = \mbox{\hyperlink{a01249_ac28ee04d63153dd9323a2926e2f9a8b9}{geometry}}-\/>integrationElement(quadPos);}
\DoxyCodeLine{199       M                 = \mbox{\hyperlink{a01249_acd663cb202adf116ebab1d2cfbd708ea}{T0InverseTransformed}} / detJ * M;}
\DoxyCodeLine{200       \textcolor{keywordflow}{return} M;}
\DoxyCodeLine{201     \}}
\DoxyCodeLine{202 }
\DoxyCodeLine{203     std::shared\_ptr<Geometry> \mbox{\hyperlink{a01249_ac28ee04d63153dd9323a2926e2f9a8b9}{geometry}};}
\DoxyCodeLine{204     Eigen::Matrix3d \mbox{\hyperlink{a01249_acd663cb202adf116ebab1d2cfbd708ea}{T0InverseTransformed}};}
\DoxyCodeLine{205   \};}
\DoxyCodeLine{206 }
\DoxyCodeLine{214   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Geometry>}
\DoxyCodeLine{215   \textcolor{keyword}{struct }\mbox{\hyperlink{a01253}{EASH1E9}} \{}
\DoxyCodeLine{216     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01253_a3a3b04261ab9c37d87211f79317b6c72}{strainSize}}         = 6;}
\DoxyCodeLine{217     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01253_acece1d0df4ecbe282f035d1961f632d8}{enhancedStrainSize}} = 9;}
\DoxyCodeLine{218     \textcolor{keyword}{using }\mbox{\hyperlink{a01253_a7212ed3754aa79af50a76848d95eb4d5}{MType}}                             = Eigen::Matrix<double, strainSize, enhancedStrainSize>;}
\DoxyCodeLine{219 }
\DoxyCodeLine{220     \mbox{\hyperlink{a01253_a5d74fc8ebfb04e85b70d8bd252624552}{EASH1E9}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{221     \textcolor{keyword}{explicit} \mbox{\hyperlink{a01253_a32418ed3d63b290057d27523e468873f}{EASH1E9}}(\textcolor{keyword}{const} Geometry\& geometry\_)}
\DoxyCodeLine{222         : \mbox{\hyperlink{a01253_a9348ce08ebf36d33aebade14c436a313}{geometry}}\{std::make\_shared<Geometry>(geometry\_)\},}
\DoxyCodeLine{223           \mbox{\hyperlink{a01253_a426a7f668cba849850916bdf61d3f72b}{T0InverseTransformed}}\{\mbox{\hyperlink{a00298_a95234ab8588ced83708c6e5a30e2368e}{calcTransformationMatrix3D}}(geometry\_)\} \{\}}
\DoxyCodeLine{224 }
\DoxyCodeLine{225     \textcolor{keyword}{auto} \mbox{\hyperlink{a01253_a00fa6978f126c09a3961b18e460155e7}{calcM}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01341}{Dune::FieldVector<double, 3>}}\& quadPos)\textcolor{keyword}{ const }\{}
\DoxyCodeLine{226       \mbox{\hyperlink{a01253_a7212ed3754aa79af50a76848d95eb4d5}{MType}} M;}
...
\DoxyCodeLine{240       \textcolor{keyword}{const} \textcolor{keywordtype}{double} detJ = \mbox{\hyperlink{a01253_a9348ce08ebf36d33aebade14c436a313}{geometry}}-\/>integrationElement(quadPos);}
\DoxyCodeLine{241       M                 = \mbox{\hyperlink{a01253_a426a7f668cba849850916bdf61d3f72b}{T0InverseTransformed}} / detJ * M;}
\DoxyCodeLine{242       \textcolor{keywordflow}{return} M;}
\DoxyCodeLine{243     \}}
\DoxyCodeLine{244     std::shared\_ptr<Geometry> \mbox{\hyperlink{a01253_a9348ce08ebf36d33aebade14c436a313}{geometry}};}
\DoxyCodeLine{245     Eigen::Matrix<double, 6, 6> \mbox{\hyperlink{a01253_a426a7f668cba849850916bdf61d3f72b}{T0InverseTransformed}};}
\DoxyCodeLine{246   \};}
\DoxyCodeLine{247 }
\DoxyCodeLine{255   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Geometry>}
\DoxyCodeLine{256   \textcolor{keyword}{struct }\mbox{\hyperlink{a01257}{EASH1E21}} \{}
\DoxyCodeLine{257     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01257_add6a1247960eb038a2cc4d129b0b79e5}{strainSize}}         = 6;}
\DoxyCodeLine{258     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01257_af2217d81619792495bb7ee6ea40205bd}{enhancedStrainSize}} = 21;}
\DoxyCodeLine{259     \textcolor{keyword}{using }\mbox{\hyperlink{a01257_ae4d88268d8bbccfa19801db35b60564f}{MType}}                             = Eigen::Matrix<double, strainSize, enhancedStrainSize>;}
\DoxyCodeLine{260 }
\DoxyCodeLine{261     \mbox{\hyperlink{a01257_a8c5b5847f3fec76168c02e05114b1df5}{EASH1E21}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{262     \textcolor{keyword}{explicit} \mbox{\hyperlink{a01257_a72cdd4c83d4373c7623f9a397eb6d520}{EASH1E21}}(\textcolor{keyword}{const} Geometry\& geometry\_)}
\DoxyCodeLine{263         : \mbox{\hyperlink{a01257_adde8fea3f6eb6e806044c5131a7bc919}{geometry}}\{std::make\_shared<Geometry>(geometry\_)\},}
\DoxyCodeLine{264           \mbox{\hyperlink{a01257_aff9381f83c01e85c46cce75c3bf9633b}{T0InverseTransformed}}\{\mbox{\hyperlink{a00298_a95234ab8588ced83708c6e5a30e2368e}{calcTransformationMatrix3D}}(geometry\_)\} \{\}}
\DoxyCodeLine{265 }
\DoxyCodeLine{266     \textcolor{keyword}{auto} \mbox{\hyperlink{a01257_a58741a35769a0b13c530e47ffd8dffcd}{calcM}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01341}{Dune::FieldVector<double, 3>}}\& quadPos)\textcolor{keyword}{ const }\{}
\DoxyCodeLine{267       \mbox{\hyperlink{a01257_ae4d88268d8bbccfa19801db35b60564f}{MType}} M;}
...
\DoxyCodeLine{295 }
\DoxyCodeLine{296       \textcolor{keyword}{const} \textcolor{keywordtype}{double} detJ = \mbox{\hyperlink{a01257_adde8fea3f6eb6e806044c5131a7bc919}{geometry}}-\/>integrationElement(quadPos);}
\DoxyCodeLine{297       M                 = \mbox{\hyperlink{a01257_aff9381f83c01e85c46cce75c3bf9633b}{T0InverseTransformed}} / detJ * M;}
\DoxyCodeLine{298       \textcolor{keywordflow}{return} M;}
\DoxyCodeLine{299     \}}
\DoxyCodeLine{300 }
\DoxyCodeLine{301     std::shared\_ptr<Geometry> \mbox{\hyperlink{a01257_adde8fea3f6eb6e806044c5131a7bc919}{geometry}};}
\DoxyCodeLine{302     Eigen::Matrix<double, 6, 6> \mbox{\hyperlink{a01257_aff9381f83c01e85c46cce75c3bf9633b}{T0InverseTransformed}};}
\DoxyCodeLine{303   \};}
\DoxyCodeLine{304 }
\DoxyCodeLine{312   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Geometry>}
\DoxyCodeLine{313   \textcolor{keyword}{using }\mbox{\hyperlink{a00298_a87e3feaaba5839ab7b515df24438c07f}{EAS2DVariant}} = std::variant<std::monostate, EASQ1E4<Geometry>, \mbox{\hyperlink{a01245}{EASQ1E5<Geometry>}}, \mbox{\hyperlink{a01249}{EASQ1E7<Geometry>}}>;}
\DoxyCodeLine{314 }
\DoxyCodeLine{322   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Geometry>}
\DoxyCodeLine{323   \textcolor{keyword}{using }\mbox{\hyperlink{a00298_a4e486ca9fc463568d5018e15b3d68b0d}{EAS3DVariant}} = std::variant<std::monostate, EASH1E9<Geometry>, \mbox{\hyperlink{a01257}{EASH1E21<Geometry>}}>;}
\DoxyCodeLine{324 }
\DoxyCodeLine{334   \textcolor{keyword}{template} <\textcolor{keyword}{typename} DisplacementBasedElement>}
\DoxyCodeLine{335   \textcolor{keyword}{class }\mbox{\hyperlink{a01261}{EnhancedAssumedStrains}} : \textcolor{keyword}{public} DisplacementBasedElement \{}
\DoxyCodeLine{336   \textcolor{keyword}{public}:}
\DoxyCodeLine{337     \textcolor{keyword}{using }\mbox{\hyperlink{a01261_a5a888bacae06491a7e890c9424518f25}{FERequirementType}}      = \textcolor{keyword}{typename} DisplacementBasedElement::FERequirementType;}
\DoxyCodeLine{338     \textcolor{keyword}{using }\mbox{\hyperlink{a01261_a5ed0cee3df4cbf8a9aed6a705dd8642e}{ResultRequirementsType}} = \textcolor{keyword}{typename} DisplacementBasedElement::ResultRequirementsType;}
\DoxyCodeLine{339     \textcolor{keyword}{using }\mbox{\hyperlink{a01261_a5699ce520159375f9737ec518130e50e}{LocalView}}              = \textcolor{keyword}{typename} DisplacementBasedElement::LocalView;}
\DoxyCodeLine{340     \textcolor{keyword}{using }\mbox{\hyperlink{a01261_aee26978267fb07c5c013a33bbc85f380}{GridView}}               = \textcolor{keyword}{typename} DisplacementBasedElement::GridView;}
\DoxyCodeLine{341     \textcolor{keyword}{using }\mbox{\hyperlink{a01261_a550c9fb8dcd8c64d21c9adaf4749c866}{Traits}}                 = \textcolor{keyword}{typename} DisplacementBasedElement::Traits;}
...
\DoxyCodeLine{354                                 \mbox{\hyperlink{a01261}{EnhancedAssumedStrains}}>) \textcolor{keyword}{explicit} \mbox{\hyperlink{a01261_a1f09e03a1efdba3ff76ad0f37acc0abc}{EnhancedAssumedStrains}}(Args\&\&... args)}
\DoxyCodeLine{355         : DisplacementBasedElement(std::forward<Args>(args)...) \{\}}
\DoxyCodeLine{356 }
\DoxyCodeLine{365     \textcolor{keywordtype}{double} \mbox{\hyperlink{a01261_aa455935bfd539dbd145450c9e8732bdc}{calculateScalar}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01261_a5a888bacae06491a7e890c9424518f25}{FERequirementType}}\& par)\textcolor{keyword}{ const }\{}
\DoxyCodeLine{366       \textcolor{keywordflow}{if} (\mbox{\hyperlink{a01261_a27a311be4e36cbb8d68d96e6d9046afd}{isDisplacementBased}}()) \textcolor{keywordflow}{return} DisplacementBasedElement::calculateScalar(par);}
...
\DoxyCodeLine{369     \}}
\DoxyCodeLine{370 }
\DoxyCodeLine{376     \textcolor{keywordtype}{bool} \mbox{\hyperlink{a01261_a27a311be4e36cbb8d68d96e6d9046afd}{isDisplacementBased}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} std::holds\_alternative<std::monostate>(easVariant\_); \}}
\DoxyCodeLine{377 }
\DoxyCodeLine{386     \textcolor{keyword}{inline} \textcolor{keywordtype}{void} \mbox{\hyperlink{a01261_a3a92d4669635a5ab22a10bc353111d95}{calculateVector}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01261_a5a888bacae06491a7e890c9424518f25}{FERequirementType}}\& par, \textcolor{keyword}{typename} Traits::template VectorType<> force)\textcolor{keyword}{ const }\{}
\DoxyCodeLine{387       calculateVectorImpl<double>(par, force);}
\DoxyCodeLine{388     \}}
\DoxyCodeLine{389 }
\DoxyCodeLine{395     \textcolor{keyword}{const} \textcolor{keyword}{auto}\& \mbox{\hyperlink{a01261_ab8c3ff043b0808de14656d79ec56de5f}{easVariant}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} easVariant\_; \}}
\DoxyCodeLine{396 }
\DoxyCodeLine{402     \textcolor{keyword}{auto} \mbox{\hyperlink{a01261_aa75e2ef6c92f084608e36d5aa6a1122e}{getNumberOfEASParameters}}()\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{411     \}}
\DoxyCodeLine{412 }
\DoxyCodeLine{421     \textcolor{keywordtype}{void} \mbox{\hyperlink{a01261_a7f2216c3b8f6b94145ae586324018376}{calculateMatrix}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01261_a5a888bacae06491a7e890c9424518f25}{FERequirementType}}\& par, \textcolor{keyword}{typename} Traits::template MatrixType<> K)\textcolor{keyword}{ const }\{}
\DoxyCodeLine{422       \textcolor{keyword}{using namespace }Dune::DerivativeDirections;}
\DoxyCodeLine{423       \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00302}{Dune}};}
\DoxyCodeLine{424 }
\DoxyCodeLine{428       DisplacementBasedElement::calculateMatrix(par, K);}
\DoxyCodeLine{429 }
\DoxyCodeLine{430       \textcolor{keywordflow}{if} (\mbox{\hyperlink{a01261_a27a311be4e36cbb8d68d96e6d9046afd}{isDisplacementBased}}()) \textcolor{keywordflow}{return};}
\DoxyCodeLine{431 }
...
\DoxyCodeLine{444     \}}
\DoxyCodeLine{445 }
\DoxyCodeLine{460     \textcolor{keywordtype}{void} \mbox{\hyperlink{a01261_a22e25753bb3cf0c5b296c3af10c443b6}{calculateAt}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01261_a5ed0cee3df4cbf8a9aed6a705dd8642e}{ResultRequirementsType}}\& req, \textcolor{keyword}{const} \mbox{\hyperlink{a01341}{Dune::FieldVector<double, Traits::mydim>}}\& local,}
\DoxyCodeLine{461                      \mbox{\hyperlink{a01229}{ResultTypeMap<double>}}\& result)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{464       \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00302}{Dune}};}
\DoxyCodeLine{465 }
\DoxyCodeLine{466       DisplacementBasedElement::calculateAt(req, local, result);}
\DoxyCodeLine{467 }
\DoxyCodeLine{468       \textcolor{keywordflow}{if} (\mbox{\hyperlink{a01261_a27a311be4e36cbb8d68d96e6d9046afd}{isDisplacementBased}}()) \textcolor{keywordflow}{return};}
\DoxyCodeLine{469 }
\DoxyCodeLine{470       \textcolor{keyword}{const} \textcolor{keyword}{auto}\& d        = req.getGlobalSolution(\mbox{\hyperlink{a00285_ggaea763c94a1cecbeefc4f8661debcc5a3a0c2d35f5f278a229db5ba41d40120f1c}{Ikarus::FESolutions::displacement}});}
...
\DoxyCodeLine{489               \textcolor{keyword}{typename} \mbox{\hyperlink{a01229_a72132ad19ec7049750ba2c4f60cde93f}{ResultTypeMap<double>::ResultArray}} resultVector;}
\DoxyCodeLine{490               \textcolor{keywordflow}{if} (req.isResultRequested(\mbox{\hyperlink{a00285_gga531be167e924b749eb8b4ccc7f1c18c9ad8cbb8fe32024cc3f1376a24d27aeae7}{ResultType::linearStress}})) \{}
\DoxyCodeLine{491                 resultVector.resize(3, 1);}
\DoxyCodeLine{492                 resultVector = result.\mbox{\hyperlink{a01229_a7f9a61700e42a5507d7dfcfd059a4067}{getResult}}(\mbox{\hyperlink{a00285_gga531be167e924b749eb8b4ccc7f1c18c9ad8cbb8fe32024cc3f1376a24d27aeae7}{ResultType::linearStress}}) + easStress;}
\DoxyCodeLine{493                 result.\mbox{\hyperlink{a01229_aa399a96000daf40950e388eb0b23a7c0}{insertOrAssignResult}}(\mbox{\hyperlink{a00285_gga531be167e924b749eb8b4ccc7f1c18c9ad8cbb8fe32024cc3f1376a24d27aeae7}{ResultType::linearStress}}, resultVector);}
...
\DoxyCodeLine{499     \}}
\DoxyCodeLine{500 }
\DoxyCodeLine{506     \textcolor{keywordtype}{void} \mbox{\hyperlink{a01261_a3990ba9792f807ae9d0c2f5fd7fb7e85}{setEASType}}(\textcolor{keywordtype}{int} numberOfEASParameters\_) \{}
...
\DoxyCodeLine{509           and (not \mbox{\hyperlink{a01261_a27a311be4e36cbb8d68d96e6d9046afd}{isDisplacementBased}}()))}
...
\DoxyCodeLine{518             easVariant\_ = \mbox{\hyperlink{a01241}{EASQ1E4}}(localView().element().geometry());}
\DoxyCodeLine{519             \textcolor{keywordflow}{break};}
\DoxyCodeLine{520           \textcolor{keywordflow}{case} 5:}
\DoxyCodeLine{521             easVariant\_ = \mbox{\hyperlink{a01245}{EASQ1E5}}(localView().element().geometry());}
\DoxyCodeLine{522             \textcolor{keywordflow}{break};}
\DoxyCodeLine{523           \textcolor{keywordflow}{case} 7:}
\DoxyCodeLine{524             easVariant\_ = \mbox{\hyperlink{a01249}{EASQ1E7}}(localView().element().geometry());}
...
\DoxyCodeLine{536             easVariant\_ = \mbox{\hyperlink{a01253}{EASH1E9}}(localView().element().geometry());}
\DoxyCodeLine{537             \textcolor{keywordflow}{break};}
\DoxyCodeLine{538           \textcolor{keywordflow}{case} 21:}
\DoxyCodeLine{539             easVariant\_ = \mbox{\hyperlink{a01257}{EASH1E21}}(localView().element().geometry());}
...
\DoxyCodeLine{550     \textcolor{keyword}{inline} ScalarType \mbox{\hyperlink{a01261_afc5adc55bc187c5d033a90cbae91ae44}{calculateScalarImpl}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01261_a5a888bacae06491a7e890c9424518f25}{FERequirementType}}\& par,}
...
\DoxyCodeLine{553       \textcolor{keywordflow}{if} (\mbox{\hyperlink{a01261_a27a311be4e36cbb8d68d96e6d9046afd}{isDisplacementBased}}()) \textcolor{keywordflow}{return} DisplacementBasedElement::template calculateScalarImpl<ScalarType>(par, dx);}
...
\DoxyCodeLine{559     \textcolor{keywordtype}{void} \mbox{\hyperlink{a01261_afa32c429e6121e0573a0fedbe43d2f45}{calculateVectorImpl}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01261_a5a888bacae06491a7e890c9424518f25}{FERequirementType}}\& par, \textcolor{keyword}{typename} Traits::template VectorType<ScalarType> force,}
...
\DoxyCodeLine{562       \textcolor{keywordflow}{if} (\mbox{\hyperlink{a01261_a27a311be4e36cbb8d68d96e6d9046afd}{isDisplacementBased}}()) \textcolor{keywordflow}{return};}
\DoxyCodeLine{563       \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00302}{Dune}};}
\DoxyCodeLine{564       \textcolor{keyword}{const} \textcolor{keyword}{auto}\& d       = par.getGlobalSolution(\mbox{\hyperlink{a00285_ggaea763c94a1cecbeefc4f8661debcc5a3a0c2d35f5f278a229db5ba41d40120f1c}{Ikarus::FESolutions::displacement}});}
...
\DoxyCodeLine{611     \textcolor{keyword}{using }EAS2DVariantImpl = \mbox{\hyperlink{a00298_a87e3feaaba5839ab7b515df24438c07f}{EAS2DVariant<typename LocalView::Element::Geometry>}};}
\DoxyCodeLine{612     \textcolor{keyword}{using }EAS3DVariantImpl = \mbox{\hyperlink{a00298_a4e486ca9fc463568d5018e15b3d68b0d}{EAS3DVariant<typename LocalView::Element::Geometry>}};}
...
\DoxyCodeLine{619       \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00302}{Dune}};}
