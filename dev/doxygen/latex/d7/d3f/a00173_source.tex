...
\DoxyCodeLine{16 }
\DoxyCodeLine{17   \textcolor{keyword}{struct }\mbox{\hyperlink{a01322}{DefaultMembraneStrain}} \{}
\DoxyCodeLine{29     \textcolor{keyword}{template} <\textcolor{keyword}{typename} Geometry>}
\DoxyCodeLine{30     \textcolor{keyword}{auto} \mbox{\hyperlink{a01322_acfe8c5424970d44c34005e13e851494a}{value}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01362}{Dune::FieldVector<double, 2>}}\& gpPos, \textcolor{keyword}{const} Geometry\& geo, \textcolor{keyword}{const} \textcolor{keyword}{auto}\& uFunction) \textcolor{keyword}{const}}
...
\DoxyCodeLine{35       \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00315}{Dune}};}
...
\DoxyCodeLine{65     \textcolor{keyword}{auto} \mbox{\hyperlink{a01322_a1c17239105e26dfdc369583624d8a200}{derivative}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01362}{Dune::FieldVector<double, 2>}}\& gpPos, \textcolor{keyword}{const} Eigen::Matrix<ScalarType, 2, 3>\& jcur,}
...
\DoxyCodeLine{96     \textcolor{keyword}{auto} \mbox{\hyperlink{a01322_a95cb97998e73fcf05fb7d9df0249b2e9}{secondDerivative}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01362}{Dune::FieldVector<double, 2>}}\& gpPos, \textcolor{keyword}{const} \textcolor{keyword}{auto}\& dNAtGp, \textcolor{keyword}{const} Geometry\& geo,}
