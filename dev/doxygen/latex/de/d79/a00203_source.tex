\hypertarget{a00203_source}{}\doxysection{controlvtkwriter.\+hh}
\label{a00203_source}\index{controlvtkwriter.hh@{controlvtkwriter.hh}}
...
\DoxyCodeLine{31   \textcolor{keyword}{class }\mbox{\hyperlink{a01525}{ControlSubsamplingVertexVTKWriter}} : \textcolor{keyword}{public} \mbox{\hyperlink{a01537}{IObserver}}<ControlMessages> \{}
...
\DoxyCodeLine{44     \mbox{\hyperlink{a01525_ac1580434b973badf5715358d5365a2b6}{ControlSubsamplingVertexVTKWriter}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01429}{Basis}}\& p\_basis, \textcolor{keyword}{const} Eigen::VectorXd\& sol, \textcolor{keywordtype}{int} refinementLevels = 0)}
\DoxyCodeLine{45         : basis\{\&p\_basis\}, vtkWriter(p\_basis.gridView(), \mbox{\hyperlink{a00302}{Dune}}::refinementLevels(refinementLevels)), solution\{\&sol\} \{\}}
\DoxyCodeLine{46 }
\DoxyCodeLine{56     \textcolor{keyword}{auto} \mbox{\hyperlink{a01525_a351251161ca8fbb31aaea0cffaac3e90}{setFieldInfo}}(std::string\&\& name, Dune::VTK::FieldInfo::Type type, std::size\_t size,}
...
\DoxyCodeLine{60     \}}
\DoxyCodeLine{61 }
\DoxyCodeLine{67     \textcolor{keyword}{auto} \mbox{\hyperlink{a01525_ab19f208c66b4af13d7248800d4fd1179}{setFileNamePrefix}}(std::string\&\& p\_name) \{ prefixString = std::move(p\_name); \}}
\DoxyCodeLine{68 }
\DoxyCodeLine{77     \textcolor{keywordtype}{void} \mbox{\hyperlink{a01525_aa0c6914ffa6bcdbf95d0e5a815ca44ef}{updateImpl}}(\mbox{\hyperlink{a00292_ga35fa62fd2d4186a9750af3d0692f2893}{ControlMessages}} message) \textcolor{keyword}{final} \{}
...
\DoxyCodeLine{80         \textcolor{keywordflow}{case} \mbox{\hyperlink{a00292_gga35fa62fd2d4186a9750af3d0692f2893a0d30d757bf062e88728ebe7f8e2b2577}{ControlMessages::SOLUTION\_CHANGED}}: \{}
...
\DoxyCodeLine{92     \mbox{\hyperlink{a01429}{Basis}} \textcolor{keyword}{const}* basis;}
