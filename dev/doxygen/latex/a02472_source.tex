\hypertarget{a02472_source}{}\doxysection{python/finiteelements/nonlinearelastic.hh}
\label{a02472_source}\index{nonlinearelastic.hh@{nonlinearelastic.hh}}
\mbox{\hyperlink{a02472}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{18 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a02469}{ikarus/finiteelements/mechanics/nonlinearelastic.hh}}>}}
\DoxyCodeLine{19 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a02448}{ikarus/utils/basis.hh}}>}}
\DoxyCodeLine{20 }
...
\DoxyCodeLine{26 }
\DoxyCodeLine{27   \textcolor{keyword}{using }GlobalBasis    = \textcolor{keyword}{typename} \mbox{\hyperlink{a01338_ae61be1f5b6bdd9443c5ac05e1c526e2f}{NonLinearElastic::Basis}};}
\DoxyCodeLine{28   \textcolor{keyword}{using }FlatBasis      = \textcolor{keyword}{typename} \mbox{\hyperlink{a01338_afc4ec54126ffcf064c026548b8def36f}{NonLinearElastic::FlatBasis}};}
\DoxyCodeLine{29   \textcolor{keyword}{using }GridView       = \textcolor{keyword}{typename} GlobalBasis::GridView;}
\DoxyCodeLine{30   \textcolor{keyword}{using }Element        = \textcolor{keyword}{typename} \mbox{\hyperlink{a01338_a6b5b825027cf741ba76c9683701373d5}{NonLinearElastic::Element}};}
\DoxyCodeLine{31   \textcolor{keyword}{using }Traits         = \textcolor{keyword}{typename} \mbox{\hyperlink{a01338_a470c63e09f0085be08a18eca7c31edc5}{NonLinearElastic::Traits}};}
\DoxyCodeLine{32   \textcolor{keyword}{using }\mbox{\hyperlink{a01250}{FERequirements}} = \textcolor{keyword}{typename} \mbox{\hyperlink{a01338_a845acdbdee4d31a14517c29a6e41a633}{NonLinearElastic::FERequirementType}};}
\DoxyCodeLine{33   \textcolor{keyword}{using }\mbox{\hyperlink{a01310}{Material}}       = \textcolor{keyword}{typename} \mbox{\hyperlink{a01338_ac44404a0f9d5ee9c786775dc0b8ef760}{NonLinearElastic::Material}};}
\DoxyCodeLine{34   \textcolor{keyword}{using }\mbox{\hyperlink{a01250}{FERequirements}} = \textcolor{keyword}{typename} \mbox{\hyperlink{a01338_a845acdbdee4d31a14517c29a6e41a633}{NonLinearElastic::FERequirementType}};}
\DoxyCodeLine{35 }
