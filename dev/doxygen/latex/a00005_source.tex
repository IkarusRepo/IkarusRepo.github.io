\hypertarget{a00005_source}{}\doxysection{nonlinearoperator.\+hh}
\label{a00005_source}\index{nonlinearoperator.hh@{nonlinearoperator.hh}}
...
\DoxyCodeLine{14 }
\DoxyCodeLine{15 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00038}{ikarus/utils/traits.hh}}>}}
\DoxyCodeLine{16 }
...
\DoxyCodeLine{141 \textcolor{keyword}{auto} \mbox{\hyperlink{a00325_ac4a51a33b91a6e959c61fb4a71cef19c}{initResults}}(\textcolor{keyword}{const} Impl::Functions<DerivativeArgs...>\& derivativesFunctions,}
\DoxyCodeLine{142                  \textcolor{keyword}{const} Impl::Parameter<ParameterArgs...>\& parameterI) \{}
\DoxyCodeLine{143   \textcolor{keywordflow}{return} Impl::makeTupleOfValuesAndReferences(}
\DoxyCodeLine{144       derivativesFunctions.args, parameterI,}
...
\DoxyCodeLine{211         derivativesEvaluated\_(\mbox{\hyperlink{a00325_ac4a51a33b91a6e959c61fb4a71cef19c}{initResults}}(derivativesFunctions, parameterI)) \{\}}
\DoxyCodeLine{212 }
