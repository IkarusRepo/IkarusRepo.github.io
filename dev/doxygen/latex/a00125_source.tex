...
\DoxyCodeLine{102   \}}
\DoxyCodeLine{103 }
\DoxyCodeLine{112   Dune::VTK::Precision \mbox{\hyperlink{a01495_ab9e28cd4cd0bc79ab808c4ef6fe59635}{precision}}()\textcolor{keyword}{ const override }\{ \textcolor{keywordflow}{return} prec\_; \}}
\DoxyCodeLine{113 }
\DoxyCodeLine{122   \mbox{\hyperlink{a01495_ab1268cbd3d4ff4d2fa70dac608c6daac}{ResultFunction}}(std::vector<FiniteElement>* fes, \textcolor{keyword}{const} \mbox{\hyperlink{a01495_a18155bd0f8ff92d6a92babb0033f6a52}{FERequirementType}}\& req,}
...
\DoxyCodeLine{131   \textcolor{keywordtype}{double} evaluateComponent(\textcolor{keywordtype}{int} eleID, \textcolor{keyword}{const} \mbox{\hyperlink{a01619}{Dune::FieldVector<ctype, griddim>}}\& local, \textcolor{keywordtype}{int} comp)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{138   \}}
\DoxyCodeLine{139 }
\DoxyCodeLine{140   \mbox{\hyperlink{a01495_a6d7963f63478595dabdcc5c82c8e8b7a}{GridView}} gridView\_;}
\DoxyCodeLine{141   \mbox{\hyperlink{a01495_a18155bd0f8ff92d6a92babb0033f6a52}{FERequirementType}} feRequirements\_;}
...
\DoxyCodeLine{161 \textcolor{keyword}{auto} \mbox{\hyperlink{a00351_a5ad885bbd85519a4b64ad78fa43d0916}{makeResultFunction}}(std::vector<FE>* fes, \textcolor{keyword}{const} \textcolor{keyword}{typename} \mbox{\hyperlink{a01435_a86c0fea1b37e487f3c78cde6facca9c3}{FE::Requirement}}\& req,}
...
\DoxyCodeLine{183 \textcolor{keyword}{auto} \mbox{\hyperlink{a00351_a8e219f42670ea0f6eaf22f8164ac89cb}{makeResultVtkFunction}}(std::vector<FE>* fes, \textcolor{keyword}{const} \textcolor{keyword}{typename} \mbox{\hyperlink{a01435_a86c0fea1b37e487f3c78cde6facca9c3}{FE::Requirement}}\& req) \{}
\DoxyCodeLine{184   \textcolor{keywordflow}{return} Dune::Vtk::Function<typename FE::GridView>(std::make\_shared<\mbox{\hyperlink{a01495}{ResultFunction<FE, RT, UserFunction>}}>(fes, req));}
\DoxyCodeLine{185 \}}
\DoxyCodeLine{186 }
