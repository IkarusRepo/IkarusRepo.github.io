\hypertarget{a00068_source}{}\doxysection{init.\+hh}
\label{a00068_source}\index{init.hh@{init.hh}}
...
\DoxyCodeLine{25 }
\DoxyCodeLine{32 \textcolor{keyword}{class }\mbox{\hyperlink{a01756}{IkarusInstance}}}
\DoxyCodeLine{33 \{}
\DoxyCodeLine{34 \textcolor{keyword}{public}:}
\DoxyCodeLine{40   \textcolor{keyword}{static} \mbox{\hyperlink{a01756}{IkarusInstance}}\& \mbox{\hyperlink{a01756_a76a31b1d9f5b1fba7180451b1edddf0a}{getInstance}}() \{}
\DoxyCodeLine{41     \textcolor{keyword}{static} \mbox{\hyperlink{a01756}{IkarusInstance}} instance;}
\DoxyCodeLine{42     \textcolor{keywordflow}{return} instance;}
\DoxyCodeLine{43   \}}
\DoxyCodeLine{44 }
\DoxyCodeLine{50   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01756_a833f9b23184e3d0f5b06f5b7b85d9233}{enableFileLogger}}(std::string\&\& filename = \textcolor{stringliteral}{"{}"{}}) \{}
...
\DoxyCodeLine{66   \textcolor{keyword}{friend} \textcolor{keywordtype}{void} \mbox{\hyperlink{a01756_a4865c52ed9d7e9c0f00e8bd5295ee853}{init}}(\textcolor{keywordtype}{int} argc, \textcolor{keywordtype}{char}** argv, \textcolor{keywordtype}{bool} \mbox{\hyperlink{a01756_a833f9b23184e3d0f5b06f5b7b85d9233}{enableFileLogger}});}
\DoxyCodeLine{67   \mbox{\hyperlink{a01756}{IkarusInstance}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{68   std::string executableName\_;}
\DoxyCodeLine{69 }
\DoxyCodeLine{70 \textcolor{keyword}{public}:}
\DoxyCodeLine{71   \mbox{\hyperlink{a01756_ab4ee067880d13079efa9b45cd0bcef43}{IkarusInstance}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01756}{IkarusInstance}}\&) = \textcolor{keyword}{delete};}
\DoxyCodeLine{72   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01756_a7f11ddf595903d8796cbff4943e620a6}{operator=}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01756}{IkarusInstance}}\&) = \textcolor{keyword}{delete};}
\DoxyCodeLine{73 \};}
\DoxyCodeLine{74 }
\DoxyCodeLine{82 \textcolor{keywordtype}{void} \textcolor{keyword}{inline} \mbox{\hyperlink{a00363_ac8243891c1b961e50a066140ab79a142}{init}}(\textcolor{keywordtype}{int} argc, \textcolor{keywordtype}{char}** argv, \textcolor{keywordtype}{bool} enableFileLogger = \textcolor{keyword}{true}) \{}
\DoxyCodeLine{83   Dune::MPIHelper::instance(argc, argv);}
\DoxyCodeLine{84   \textcolor{keyword}{auto}\& instance           = \mbox{\hyperlink{a01756_a76a31b1d9f5b1fba7180451b1edddf0a}{IkarusInstance::getInstance}}();}
