...
\DoxyCodeLine{35     \textcolor{keywordtype}{bool} \mbox{\hyperlink{a01524_a08fa473dcdfbdb5dcf759546ea2da3b8}{draw}}                        = \textcolor{keyword}{true};}
\DoxyCodeLine{36     \textcolor{keywordtype}{bool} \mbox{\hyperlink{a01524_ac9946207ee221c94e843ea7c048a16a3}{writeSlopeStatementIfFailed}} = \textcolor{keyword}{true};}
\DoxyCodeLine{37     \textcolor{keywordtype}{double} \mbox{\hyperlink{a01524_a6c1e702608ca901f9f7efca524560b25}{tolerance}}                 = 1e-\/2;}
\DoxyCodeLine{38   \};}
\DoxyCodeLine{39 }
...
\DoxyCodeLine{53   \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00311_gacb9e813539bfd84df99ad097cabc9de9}{checkGradient}}(}
\DoxyCodeLine{54       NonlinearOperator\& nonLinOp, \mbox{\hyperlink{a01524}{CheckFlags}} checkFlags = \mbox{\hyperlink{a01524}{CheckFlags}}(),}
...
\DoxyCodeLine{114   \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00311_ga553465359c199ef676945832587d2869}{checkJacobian}}(}
\DoxyCodeLine{115       NonlinearOperator\& nonLinOp, \mbox{\hyperlink{a01524}{CheckFlags}} checkFlags = \mbox{\hyperlink{a01524}{CheckFlags}}(),}
...
\DoxyCodeLine{133       \textcolor{keyword}{auto} value = (nonLinOp.value() -\/ e -\/ t * jacofv).\mbox{\hyperlink{a00311_ga0ffc0c74dbd9aeee3e53b199a21b828c}{norm}}();}
...
\DoxyCodeLine{167   \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00311_ga5d1a87964a3d6b6ddc994532e93b6798}{checkHessian}}(}
\DoxyCodeLine{168       NonlinearOperator\& nonLinOp, \mbox{\hyperlink{a01524}{CheckFlags}} checkFlags = \mbox{\hyperlink{a01524}{CheckFlags}}(),}
