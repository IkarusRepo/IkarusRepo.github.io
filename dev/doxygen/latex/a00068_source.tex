\hypertarget{a00068_source}{}\doxysection{algorithms.\+hh}
\label{a00068_source}\index{algorithms.hh@{algorithms.hh}}
...
\DoxyCodeLine{15 }
\DoxyCodeLine{16 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00023}{ikarus/utils/traits.hh}}>}}
\DoxyCodeLine{17 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00337}{Ikarus::utils}} \{}
\DoxyCodeLine{18 }
...
\DoxyCodeLine{44 \textcolor{keyword}{auto} \mbox{\hyperlink{a00322_ga0ccbb016e46741bd00c69436dc11e2d0}{appendUnique}}(std::ranges::random\_access\_range \textcolor{keyword}{auto}\& r, T\&\& v) \{}
...
\DoxyCodeLine{64 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00322_ga2b7954c72a2393ab7494fa0b66d828cd}{printContent}}(C\&\& c, std::ostream\& os = std::cout) \{}
...
\DoxyCodeLine{77 \textcolor{keyword}{auto} \mbox{\hyperlink{a00322_ga7f597d87c8f2bcbf4afc65ebc929b680}{transformValueRangeToPointerRange}}(C\& cont) \{}
...
\DoxyCodeLine{92 \textcolor{keyword}{auto} \mbox{\hyperlink{a00322_ga83bd9e4f59f0aa9fadd797efefa751d9}{transformPointerRangeToReferenceRange}}(C\& cont) \{}
...
\DoxyCodeLine{100 \textcolor{keyword}{auto} \mbox{\hyperlink{a00337_a4c617d2458cc6d792f5ba3e6c64a0c7f}{makeNestedTupleFlat}}(std::tuple<Types...> tup);}
...
\DoxyCodeLine{134         \textcolor{keywordflow}{return} std::tuple\_cat(\mbox{\hyperlink{a00337_a4c617d2458cc6d792f5ba3e6c64a0c7f}{makeNestedTupleFlat}}(T()), makeNestedTupleFlatImpl<Types...>());}
...
\DoxyCodeLine{139         \textcolor{keywordflow}{return} \mbox{\hyperlink{a00337_a4c617d2458cc6d792f5ba3e6c64a0c7f}{makeNestedTupleFlat}}(T());}
...
\DoxyCodeLine{466 \textcolor{keyword}{auto} \mbox{\hyperlink{a00337_a4c617d2458cc6d792f5ba3e6c64a0c7f}{makeNestedTupleFlat}}(std::tuple<Types...>) \{}
...
\DoxyCodeLine{480 \textcolor{keyword}{auto} \mbox{\hyperlink{a00337_a162c64656f5917b717a6b44ebf4c9ebf}{makeNestedTupleFlatAndStoreReferences}}(Tuple\&\& tup) \{}
...
\DoxyCodeLine{497 \textcolor{keyword}{requires} \mbox{\hyperlink{a01651}{traits::Pointer<T>}}}
\DoxyCodeLine{498 \textcolor{keyword}{auto}\& \mbox{\hyperlink{a00337_aa156028e47fc302b02a7e70dea888034}{returnReferenceOrNulloptIfObjectIsNullPtr}}(T v) \{}
