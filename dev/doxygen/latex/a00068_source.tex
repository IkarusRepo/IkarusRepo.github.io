\hypertarget{a00068_source}{}\doxysection{functionsanitychecks.\+hh}
\label{a00068_source}\index{functionsanitychecks.hh@{functionsanitychecks.hh}}
...
\DoxyCodeLine{28   \textcolor{keywordtype}{double} drawResultAndReturnSlope(std::string\&\& functionName, \textcolor{keyword}{const} std::function<\textcolor{keywordtype}{double}(\textcolor{keywordtype}{double})>\& ftfunc, \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00233_a2634a2b365ea0b95c6dcfad0dbefac1f}{draw}},}
\DoxyCodeLine{29                                   \textcolor{keywordtype}{int} slopeOfReference);}
\DoxyCodeLine{30 \} \textcolor{comment}{// namespace Impl}}
\DoxyCodeLine{34 \textcolor{comment}{}\textcolor{keyword}{struct }\mbox{\hyperlink{a01524}{CheckFlags}}}
\DoxyCodeLine{35 \{}
\DoxyCodeLine{36   \textcolor{keywordtype}{bool} \mbox{\hyperlink{a01524_a08fa473dcdfbdb5dcf759546ea2da3b8}{draw}}                        = \textcolor{keyword}{true};}
\DoxyCodeLine{37   \textcolor{keywordtype}{bool} \mbox{\hyperlink{a01524_ac9946207ee221c94e843ea7c048a16a3}{writeSlopeStatementIfFailed}} = \textcolor{keyword}{true};}
\DoxyCodeLine{38   \textcolor{keywordtype}{double} \mbox{\hyperlink{a01524_a6c1e702608ca901f9f7efca524560b25}{tolerance}}                 = 1e-\/2;}
\DoxyCodeLine{39 \};}
\DoxyCodeLine{40 }
...
\DoxyCodeLine{55     NonlinearOperator\& nonLinOp, \mbox{\hyperlink{a01524}{CheckFlags}} checkFlags = \mbox{\hyperlink{a01524}{CheckFlags}}(),}
...
\DoxyCodeLine{116     NonlinearOperator\& nonLinOp, \mbox{\hyperlink{a01524}{CheckFlags}} checkFlags = \mbox{\hyperlink{a01524}{CheckFlags}}(),}
...
\DoxyCodeLine{169     NonlinearOperator\& nonLinOp, \mbox{\hyperlink{a01524}{CheckFlags}} checkFlags = \mbox{\hyperlink{a01524}{CheckFlags}}(),}
