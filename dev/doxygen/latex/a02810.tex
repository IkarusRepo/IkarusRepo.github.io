...
\begin{DoxyItemize}
\item 2021-\/2024 Alexander Müller
\item 2022-\/2024 Tarun Kumar Mitruka Vinod Kumar Mitruka
\item 2022 Tobias Willmann
\item 2023-\/2024 Henrik Jakob
\item 2023-\/2024 Anika Strauss
\end{DoxyItemize}

We use \href{https://reuse.software/}{\texttt{ REUSE software}} to manage our licenses. All licenses reside in the folder {\ttfamily LICENSES}. Each source file here has the corresponding header for license information. The \mbox{\hyperlink{a00375}{Ikarus}} source and header files are released under {\ttfamily LGPL-\/3.\+0-\/or-\/later}.
