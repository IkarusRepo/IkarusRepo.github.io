\hypertarget{a02473_source}{}\doxysection{python/dirichletvalues/dirichletvalues.hh}
\label{a02473_source}\index{dirichletvalues.hh@{dirichletvalues.hh}}
...
\DoxyCodeLine{24 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00334}{Ikarus::Python}} \{}
\DoxyCodeLine{25 }
...
\DoxyCodeLine{51 }
\DoxyCodeLine{52   \textcolor{keyword}{using }\mbox{\hyperlink{a01454}{Basis}}        = \textcolor{keyword}{typename} \mbox{\hyperlink{a01494_a2e6f1ef4a810a7269303f54a6f74539f}{DirichletValues::Basis}};}
\DoxyCodeLine{53   \textcolor{keyword}{using }BackendType  = \textcolor{keyword}{typename} \mbox{\hyperlink{a01494_a3db820fbcd2b7edf58ce3b21b261f621}{DirichletValues::BackendType}};}
\DoxyCodeLine{54   \textcolor{keyword}{using }FlagsType    = \textcolor{keyword}{typename} \mbox{\hyperlink{a01494_aa71c2b94b37f2b4e83f9f1e059e6fe4c}{DirichletValues::FlagsType}};}
...
\DoxyCodeLine{66 }
\DoxyCodeLine{67   cls.def(\mbox{\hyperlink{a00325_ac8243891c1b961e50a066140ab79a142}{pybind11::init}}([](\textcolor{keyword}{const} \mbox{\hyperlink{a01454}{Basis}}\& \mbox{\hyperlink{a00345_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}) \{ \textcolor{keywordflow}{return} \textcolor{keyword}{new} \mbox{\hyperlink{a01494}{DirichletValues}}(\mbox{\hyperlink{a00345_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}); \}), pybind11::keep\_alive<1, 2>());}
\DoxyCodeLine{68 }
...
\DoxyCodeLine{75             \};}
\DoxyCodeLine{76             self.\mbox{\hyperlink{a01494_a57486778cd8e2e42be337b5d1ff0d564}{fixBoundaryDOFs}}(lambda);}
\DoxyCodeLine{77           \});}
\DoxyCodeLine{78 }
...
\DoxyCodeLine{89             \};}
\DoxyCodeLine{90             self.\mbox{\hyperlink{a01494_a57486778cd8e2e42be337b5d1ff0d564}{fixBoundaryDOFs}}(lambda);}
\DoxyCodeLine{91           \});}
\DoxyCodeLine{92 }
...
\DoxyCodeLine{104         \};}
\DoxyCodeLine{105         self.\mbox{\hyperlink{a01494_a57486778cd8e2e42be337b5d1ff0d564}{fixBoundaryDOFs}}(lambda);}
\DoxyCodeLine{106       \});}
\DoxyCodeLine{107 }
\DoxyCodeLine{108   cls.def(\textcolor{stringliteral}{"{}fixDOFs"{}},}
\DoxyCodeLine{109           [](\mbox{\hyperlink{a01494}{DirichletValues}}\& self, \textcolor{keyword}{const} std::function<\textcolor{keywordtype}{void}(Eigen::Ref<Eigen::VectorX<bool>>, \textcolor{keyword}{const} \mbox{\hyperlink{a01454}{Basis}}\&)>\& f) \{}
\DoxyCodeLine{110             self.\mbox{\hyperlink{a01494_a57486778cd8e2e42be337b5d1ff0d564}{fixBoundaryDOFs}}(f);}
\DoxyCodeLine{111           \});}
\DoxyCodeLine{112 \}}
\DoxyCodeLine{113 }
