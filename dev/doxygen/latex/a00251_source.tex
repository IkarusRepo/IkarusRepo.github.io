...
\DoxyCodeLine{26       \textcolor{keywordflow}{return} \mbox{\hyperlink{a00324_ga4304655095296ce9283e012587817a51}{toVoigt}}(mat.derived(), strainlike);}
\DoxyCodeLine{27     \}}
\DoxyCodeLine{28   \};}
\DoxyCodeLine{29 }
...
\DoxyCodeLine{48       \textcolor{keywordflow}{return} \mbox{\hyperlink{a00324_ga106e11a950fe2545890e811d2e9545fd}{fromVoigt}}(vec.derived(), strainlike);}
\DoxyCodeLine{49     \}}
\DoxyCodeLine{50   \};}
\DoxyCodeLine{51 }
...
\DoxyCodeLine{62 }
\DoxyCodeLine{63 \textcolor{keyword}{namespace }ResultType \{}
...
\DoxyCodeLine{69 \textcolor{preprocessor}{    friend auto toString(resultTypeName) \{ return \#resultTypeName; \}                                            \(\backslash\)}}
...
\DoxyCodeLine{121 }
\DoxyCodeLine{124 }
\DoxyCodeLine{125   \mbox{\hyperlink{a00334_aac8ac85aa33c94bb4b1350b323e39544}{REGISTER\_SIMPLE\_SYMMETRIC\_RESULTTYPE}}(linearStress, worldDim, worldDim, \textcolor{keyword}{false});}
\DoxyCodeLine{126   \mbox{\hyperlink{a00334_aac8ac85aa33c94bb4b1350b323e39544}{REGISTER\_SIMPLE\_SYMMETRIC\_RESULTTYPE}}(PK2Stress, worldDim, worldDim, \textcolor{keyword}{false});}
\DoxyCodeLine{127   \mbox{\hyperlink{a00334_aac8ac85aa33c94bb4b1350b323e39544}{REGISTER\_SIMPLE\_SYMMETRIC\_RESULTTYPE}}(cauchyStress, worldDim, worldDim, \textcolor{keyword}{false});}
\DoxyCodeLine{128 }
\DoxyCodeLine{129   \mbox{\hyperlink{a00334_a375aac447f75294b272ffe18d56a6ee7}{REGISTER\_SIMPLE\_RESULTTYPE}}(director, worldDim, 1);}
\DoxyCodeLine{130   \mbox{\hyperlink{a00334_a375aac447f75294b272ffe18d56a6ee7}{REGISTER\_SIMPLE\_RESULTTYPE}}(magnetization, worldDim, 1);}
\DoxyCodeLine{131   \mbox{\hyperlink{a00334_a375aac447f75294b272ffe18d56a6ee7}{REGISTER\_SIMPLE\_RESULTTYPE}}(gradientNormOfMagnetization, 1, 1);}
\DoxyCodeLine{132   \mbox{\hyperlink{a00334_a375aac447f75294b272ffe18d56a6ee7}{REGISTER\_SIMPLE\_RESULTTYPE}}(vectorPotential, worldDim, 1);}
\DoxyCodeLine{133   \mbox{\hyperlink{a00334_a375aac447f75294b272ffe18d56a6ee7}{REGISTER\_SIMPLE\_RESULTTYPE}}(divergenceOfVectorPotential, 1, 1);}
\DoxyCodeLine{134 }
\DoxyCodeLine{135   \mbox{\hyperlink{a00334_a375aac447f75294b272ffe18d56a6ee7}{REGISTER\_SIMPLE\_RESULTTYPE}}(BField, worldDim, 1);}
\DoxyCodeLine{136   \mbox{\hyperlink{a00334_a375aac447f75294b272ffe18d56a6ee7}{REGISTER\_SIMPLE\_RESULTTYPE}}(HField, worldDim, 1);}
\DoxyCodeLine{137 }
\DoxyCodeLine{138   \mbox{\hyperlink{a00334_a375aac447f75294b272ffe18d56a6ee7}{REGISTER\_SIMPLE\_RESULTTYPE}}(customType, Eigen::Dynamic, Eigen::Dynamic);}
\DoxyCodeLine{139 \} \textcolor{comment}{// namespace ResultType}}
\DoxyCodeLine{140 }
\DoxyCodeLine{141 \textcolor{keyword}{enum class} \mbox{\hyperlink{a00328_acfb09bb7db104db62d3d1d2dc3e009b2}{ResultShape}}}
\DoxyCodeLine{142 \{}
\DoxyCodeLine{143   \mbox{\hyperlink{a00328_acfb09bb7db104db62d3d1d2dc3e009b2a57dea6f5039281b7fee517fc43bf3110}{Vector}},}
\DoxyCodeLine{144   \mbox{\hyperlink{a00328_acfb09bb7db104db62d3d1d2dc3e009b2af53df0293e169f562bc1d9a20e1d2589}{Matrix}}}
\DoxyCodeLine{145 \};}
\DoxyCodeLine{146 }
\DoxyCodeLine{153 \textcolor{keyword}{template} <\textcolor{keyword}{typename} RT, ResultShape storedResultShape = ResultShape::Vector>}
\DoxyCodeLine{154 \textcolor{keyword}{struct }\mbox{\hyperlink{a01276}{ResultWrapper}} : RT}
\DoxyCodeLine{155 \{}
...
\DoxyCodeLine{160   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{bool} storedValueIsVector       = storedResultShape == \mbox{\hyperlink{a00328_acfb09bb7db104db62d3d1d2dc3e009b2a57dea6f5039281b7fee517fc43bf3110}{ResultShape::Vector}};}
\DoxyCodeLine{161 }
\DoxyCodeLine{162 \textcolor{keyword}{public}:}
\DoxyCodeLine{163   \textcolor{keyword}{using }\mbox{\hyperlink{a01276_ad2e94e390a1a328d7abd8006f29dbbd2}{VecType}} = std::invoke\_result\_t<\textcolor{keyword}{decltype}(\&RT::Vectorizer::template transform<ResultTypeValueType>),}
\DoxyCodeLine{164                                        \textcolor{keyword}{const} ResultTypeValueType\&>;}
\DoxyCodeLine{165   \textcolor{keyword}{using }\mbox{\hyperlink{a01276_a3be8a4f7e4b67bc2bb90a826c1ed7c85}{MatType}} =}
...
\DoxyCodeLine{167                            \textcolor{keyword}{const} \mbox{\hyperlink{a01276_ad2e94e390a1a328d7abd8006f29dbbd2}{VecType}}\&, \textcolor{keywordtype}{int}, \textcolor{keywordtype}{int}>;}
\DoxyCodeLine{168   \textcolor{keyword}{using }\mbox{\hyperlink{a01276_a1baf31b4a8525d6b81860c8f0a0b6a84}{StoredType}} = std::conditional\_t<storedValueIsVector, VecType, MatType>;}
\DoxyCodeLine{169   \textcolor{keyword}{using }\mbox{\hyperlink{a01276_aef0efc55342d144366f8eddbc6fe00f9}{ResultType}} = RT;}
\DoxyCodeLine{170 }
\DoxyCodeLine{175   \textcolor{keyword}{auto} \mbox{\hyperlink{a01276_ae1be56ef0981f28e1dfa4f77453251d3}{asVec}}()\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{180   \}}
\DoxyCodeLine{181 }
\DoxyCodeLine{188   \textcolor{keyword}{auto} \mbox{\hyperlink{a01276_ae5c30a9c8da8fe6bb01b1cee0fc43155}{asMat}}(Eigen::Index rows = rowsAtCompileTime, Eigen::Index cols = colsAtCompileTime)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{201   \}}
\DoxyCodeLine{202   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01276_a826dcccf70e97474b01126970e2839ac}{ResultWrapper}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{203   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01276_a623510c28007eb075ed7719de10562b2}{ResultWrapper}}(\mbox{\hyperlink{a01276_a1baf31b4a8525d6b81860c8f0a0b6a84}{StoredType}}\&\& value) \{ this-\/>value\_ = std::move(value); \}}
\DoxyCodeLine{204   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01276_ae3ec0250a8cce10dae2b6eacec3ffe11}{ResultWrapper}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01276_a1baf31b4a8525d6b81860c8f0a0b6a84}{StoredType}}\& value) \{ this-\/>value\_ = value; \}}
\DoxyCodeLine{205   \mbox{\hyperlink{a01276}{ResultWrapper}}\& \mbox{\hyperlink{a01276_adbc957bfc9a97390ce57d778dd7c91a1}{operator=}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01276_a1baf31b4a8525d6b81860c8f0a0b6a84}{StoredType}}\& value) \{}
\DoxyCodeLine{206     this-\/>value\_ = value;}
\DoxyCodeLine{207     \textcolor{keywordflow}{return} *\textcolor{keyword}{this};}
\DoxyCodeLine{208   \}}
\DoxyCodeLine{209   \mbox{\hyperlink{a01276}{ResultWrapper}}\& \mbox{\hyperlink{a01276_a6a1deb7c814879d79eaa5fe467666b2f}{operator=}}(\mbox{\hyperlink{a01276_a1baf31b4a8525d6b81860c8f0a0b6a84}{StoredType}}\&\& value) \{}
...
\DoxyCodeLine{215   \mbox{\hyperlink{a01276_a1baf31b4a8525d6b81860c8f0a0b6a84}{StoredType}} value\_\{\};}
\DoxyCodeLine{216 \};}
\DoxyCodeLine{217 }
...
\DoxyCodeLine{229 \textcolor{keyword}{auto} \mbox{\hyperlink{a00328_a0853622412d4cedc078b81ba454eb250}{toString}}() \{}
\DoxyCodeLine{230   \textcolor{keywordflow}{return} \mbox{\hyperlink{a00328_a0853622412d4cedc078b81ba454eb250}{toString}}(Impl::DummyRT<RT>\{\});}
\DoxyCodeLine{231 \}}
\DoxyCodeLine{232 }
\DoxyCodeLine{238 \textcolor{keyword}{template} <\textcolor{keyword}{template} <\textcolor{keyword}{typename}, \textcolor{keywordtype}{int}, \textcolor{keywordtype}{int}> \textcolor{keyword}{class }RT1, \textcolor{keyword}{template} <\textcolor{keyword}{typename}, \textcolor{keywordtype}{int}, \textcolor{keywordtype}{int}> \textcolor{keyword}{class }RT2>}
\DoxyCodeLine{239 \textcolor{keyword}{constexpr} \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00328_aae9d6a05f2ca4f54c0524404e27e7ed1}{isSameResultType}} = std::is\_same\_v<Impl::DummyRT<RT1>, Impl::DummyRT<RT2>>;}
\DoxyCodeLine{240 }
\DoxyCodeLine{241 \} \textcolor{comment}{// namespace Ikarus}}
