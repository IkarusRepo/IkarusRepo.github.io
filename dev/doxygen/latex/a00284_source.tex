...
\DoxyCodeLine{20 }
\DoxyCodeLine{21 \textcolor{preprocessor}{  \#include <\mbox{\hyperlink{a00299}{ikarus/finiteelements/fehelper.hh}}>}}
\DoxyCodeLine{22 \textcolor{preprocessor}{  \#include <\mbox{\hyperlink{a00314}{ikarus/finiteelements/ferequirements.hh}}>}}
\DoxyCodeLine{23 \textcolor{preprocessor}{  \#include <\mbox{\hyperlink{a00305}{ikarus/finiteelements/feresulttypes.hh}}>}}
\DoxyCodeLine{24 \textcolor{preprocessor}{  \#include <\mbox{\hyperlink{a02861}{ikarus/finiteelements/mechanics/materials.hh}}>}}
\DoxyCodeLine{25 \textcolor{preprocessor}{  \#include <\mbox{\hyperlink{a00293}{ikarus/finiteelements/physicshelper.hh}}>}}
\DoxyCodeLine{26 }
...
\DoxyCodeLine{55 \textcolor{keyword}{class }\mbox{\hyperlink{a01468}{LinearElastic}} : \textcolor{keyword}{public} \mbox{\hyperlink{a01404}{ResultTypeBase}}<ResultTypes::linearStress, ResultTypes::linearStressFull>}
\DoxyCodeLine{56 \{}
...
\DoxyCodeLine{78       : mat\_\{pre.\mbox{\hyperlink{a01468_ae8b49ae1862243dd12fc703a52c5d7da}{material}}\} \{\}}
\DoxyCodeLine{79 }
...
\DoxyCodeLine{162   \textcolor{keyword}{decltype}(\textcolor{keyword}{auto}) \mbox{\hyperlink{a01468_ae8b49ae1862243dd12fc703a52c5d7da}{material}}() \textcolor{keyword}{const} \{}
\DoxyCodeLine{163     \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (\mbox{\hyperlink{a01980}{Concepts::AutodiffScalar<ScalarType>}})}
...
\DoxyCodeLine{182   \textcolor{keyword}{auto} \mbox{\hyperlink{a01468_a85f5316ee97d0e5fa3f940d4a333a7c6}{calculateAtImpl}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01368}{Requirement}}\& req, \textcolor{keyword}{const} \mbox{\hyperlink{a01784}{Dune::FieldVector<double, Traits::mydim>}}\& local,}
\DoxyCodeLine{183                        Dune::PriorityTag<1>) \textcolor{keyword}{const} \{}
\DoxyCodeLine{184     \textcolor{keyword}{using }RTWrapper = \mbox{\hyperlink{a01392}{ResultWrapper<RT<typename Traits::ctype, myDim, Traits::worlddim>}}, \mbox{\hyperlink{a00384_acfb09bb7db104db62d3d1d2dc3e009b2a57dea6f5039281b7fee517fc43bf3110}{ResultShape::Vector}}>;}
\DoxyCodeLine{185 }
...
\DoxyCodeLine{188       \textcolor{keyword}{const} \textcolor{keyword}{auto} eps     = \mbox{\hyperlink{a01468_afbb960bfdbf6438f2a62dc1f2b785175}{strainFunction}}(req);}
...
\DoxyCodeLine{202   \textcolor{keyword}{const} \textcolor{keyword}{auto}\& underlying()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} \textcolor{keyword}{static\_cast<}\textcolor{keyword}{const }\mbox{\hyperlink{a01336}{FE}}\&\textcolor{keyword}{>}(*this); \}}
...
\DoxyCodeLine{207   \mbox{\hyperlink{a01468_ae31fb3e60ec01ebcaded334ba99ec8ba}{Material}} mat\_;}
...
\DoxyCodeLine{213   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01468_ac7b1a691458d895da8fdc2ded0c786df}{calculateMatrixImpl}}(}
\DoxyCodeLine{214       \textcolor{keyword}{const} \mbox{\hyperlink{a01368}{Requirement}}\& par, \textcolor{keyword}{const} \mbox{\hyperlink{a00384_a390d5311179ec61d163a29c943b3d1a0}{MatrixAffordance}}\& affordance, \textcolor{keyword}{typename} Traits::template MatrixType<> K,}
...
\DoxyCodeLine{216     \textcolor{keyword}{const} \textcolor{keyword}{auto} eps = \mbox{\hyperlink{a01468_afbb960bfdbf6438f2a62dc1f2b785175}{strainFunction}}(par, dx);}
\DoxyCodeLine{217     \textcolor{keyword}{using namespace }Dune::DerivativeDirections;}
\DoxyCodeLine{218     \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00404}{Dune}};}
\DoxyCodeLine{219 }
\DoxyCodeLine{220     \textcolor{keyword}{const} \textcolor{keyword}{auto} C = \mbox{\hyperlink{a01468_a3d8da7696605af68b619c2c416d5107a}{materialTangent}}();}
...
\DoxyCodeLine{227           K.template block<myDim, myDim>(i * \mbox{\hyperlink{a01468_a158fdcb8defa5741db223f85ea1ad598}{myDim}}, j * \mbox{\hyperlink{a01468_a158fdcb8defa5741db223f85ea1ad598}{myDim}}) += bopI.transpose() * C * bopJ * intElement;}
\DoxyCodeLine{228         \}}
\DoxyCodeLine{229       \}}
\DoxyCodeLine{230     \}}
\DoxyCodeLine{231   \}}
...
\DoxyCodeLine{234   \textcolor{keyword}{auto} \mbox{\hyperlink{a01468_a73a64dc32dd1d8983cda0c6df2f0cc3c}{calculateScalarImpl}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01368}{Requirement}}\& par, \mbox{\hyperlink{a00384_af6f894084edd9109762b86222995ef2a}{ScalarAffordance}} affordance,}
...
\DoxyCodeLine{237     \textcolor{keyword}{const} \textcolor{keyword}{auto} uFunction = \mbox{\hyperlink{a01468_ac84232db4745b425dfe6631ff1a3fc11}{displacementFunction}}(par, dx);}
\DoxyCodeLine{238     \textcolor{keyword}{const} \textcolor{keyword}{auto} eps       = \mbox{\hyperlink{a01468_afbb960bfdbf6438f2a62dc1f2b785175}{strainFunction}}(par, dx);}
...
\DoxyCodeLine{241     \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00404}{Dune}};}
\DoxyCodeLine{242 }
\DoxyCodeLine{243     \textcolor{keyword}{const} \textcolor{keyword}{auto} C = \mbox{\hyperlink{a01468_a3d8da7696605af68b619c2c416d5107a}{materialTangent}}();}
\DoxyCodeLine{244 }
...
\DoxyCodeLine{254   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01468_a88be43beed4215c905c755e9e1723ec9}{calculateVectorImpl}}(}
\DoxyCodeLine{255       \textcolor{keyword}{const} \mbox{\hyperlink{a01368}{Requirement}}\& par, \mbox{\hyperlink{a00384_aab9e3e38507d1db7602bc750718c302a}{VectorAffordance}} affordance, \textcolor{keyword}{typename} Traits::template VectorType<ScalarType> force,}
...
\DoxyCodeLine{257     \textcolor{keyword}{const} \textcolor{keyword}{auto} eps = \mbox{\hyperlink{a01468_afbb960bfdbf6438f2a62dc1f2b785175}{strainFunction}}(par, dx);}
\DoxyCodeLine{258     \textcolor{keyword}{using namespace }Dune::DerivativeDirections;}
\DoxyCodeLine{259     \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00404}{Dune}};}
\DoxyCodeLine{260 }
\DoxyCodeLine{261     \textcolor{keyword}{const} \textcolor{keyword}{auto} C = \mbox{\hyperlink{a01468_a3d8da7696605af68b619c2c416d5107a}{materialTangent}}();}
\DoxyCodeLine{262 }
...
\DoxyCodeLine{269         force.template segment<myDim>(\mbox{\hyperlink{a01468_a158fdcb8defa5741db223f85ea1ad598}{myDim}} * i) += bopI.transpose() * stresses * intElement;}
\DoxyCodeLine{270       \}}
\DoxyCodeLine{271     \}}
\DoxyCodeLine{272   \}}
\DoxyCodeLine{273 \};}
...
\DoxyCodeLine{282 \textcolor{keyword}{auto} \mbox{\hyperlink{a00384_af9e2c0087fa5819ca15d064776034a6f}{linearElastic}}(\textcolor{keyword}{const} MAT\& mat) \{}
\DoxyCodeLine{283   \mbox{\hyperlink{a01472}{LinearElasticPre<MAT>}} pre(mat);}
\DoxyCodeLine{284 }
