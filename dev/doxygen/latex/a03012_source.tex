\hypertarget{a03012_source}{}\doxysection{utils/concepts.hh}
\label{a03012_source}\index{concepts.hh@{concepts.hh}}
\mbox{\hyperlink{a03012}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{23 }
\DoxyCodeLine{24 \textcolor{preprocessor}{\#include "{}\mbox{\hyperlink{a00176}{ikarus/assembler/dirichletbcenforcement.hh}}"{}}}
...
\DoxyCodeLine{27 }
\DoxyCodeLine{28 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00412}{Eigen}} \{}
\DoxyCodeLine{29 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Derived>}
\DoxyCodeLine{30 \textcolor{keyword}{struct }\mbox{\hyperlink{a01831}{EigenBase}};}
\DoxyCodeLine{31 \}}
\DoxyCodeLine{32 }
\DoxyCodeLine{33 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00396}{Ikarus}} \{}
\DoxyCodeLine{34 }
\DoxyCodeLine{35 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Derived>}
\DoxyCodeLine{36 \textcolor{keyword}{auto} \mbox{\hyperlink{a00396_ac2c6469be19ce4ef2e630bfa1c5a5e24}{transpose}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01831}{Eigen::EigenBase<Derived>}}\& A);}
...
\DoxyCodeLine{48   \textcolor{keyword}{concept }\mbox{\hyperlink{a02029}{FlatInterLeavedBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{80   \textcolor{keyword}{concept }\mbox{\hyperlink{a02030}{LagrangeNode}} = Impl::LagrangeNodeHelper<Dune::Functions::LagrangeNode, N>::value;}
\DoxyCodeLine{81 }
\DoxyCodeLine{89   \textcolor{keyword}{template} <\textcolor{keyword}{typename} N, \textcolor{keywordtype}{int} order>}
\DoxyCodeLine{90   \textcolor{keyword}{concept }\mbox{\hyperlink{a02031}{LagrangeNodeOfOrder}} = Impl::LagrangeNodeHelperOfOrder<Dune::Functions::LagrangeNode, N, order>::value;}
\DoxyCodeLine{91 }
\DoxyCodeLine{100   \textcolor{keyword}{template} <\textcolor{keyword}{typename} B>}
\DoxyCodeLine{101   \textcolor{keyword}{concept }\mbox{\hyperlink{a02032}{FlatLexicographicBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{114   \textcolor{keyword}{concept }\mbox{\hyperlink{a02033}{FlatIndexBasis}} = \mbox{\hyperlink{a02032}{FlatLexicographicBasis<B>}} or \mbox{\hyperlink{a02029}{FlatInterLeavedBasis<B>}};}
\DoxyCodeLine{115 }
\DoxyCodeLine{124   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Basis>}
\DoxyCodeLine{125   \textcolor{keyword}{concept }\mbox{\hyperlink{a02034}{BlockedInterLeavedBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{138   \textcolor{keyword}{concept }\mbox{\hyperlink{a02035}{BlockedLexicographicBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{148   \textcolor{keyword}{concept }\mbox{\hyperlink{a02036}{DuneLocalBasis}} = \textcolor{keyword}{requires}(DLB\& duneLocalBasis) \{}
...
\DoxyCodeLine{173   \textcolor{keyword}{concept }\mbox{\hyperlink{a02037}{BlockedIndexBasis}} = \mbox{\hyperlink{a02035}{BlockedLexicographicBasis<B>}} or \mbox{\hyperlink{a02034}{BlockedInterLeavedBasis<B>}};}
\DoxyCodeLine{174 }
...
\DoxyCodeLine{183   \textcolor{keyword}{concept }\mbox{\hyperlink{a02038}{PathFollowingStrategy}} = \textcolor{keyword}{requires}(PF pft, NLO nop, SA args) \{}
...
\DoxyCodeLine{198   \textcolor{keyword}{concept }\mbox{\hyperlink{a02039}{AdaptiveStepSizingStrategy}} = \textcolor{keyword}{requires}(ASS adaptiveStepSizing, NLSI info, SA args, \mbox{\hyperlink{a00396_abcf5978fa18a6e0aadc5e19c4a0edaa9}{NonLinearOperator}} nop) \{}
...
\DoxyCodeLine{213   \textcolor{keyword}{concept }\mbox{\hyperlink{a02040}{LinearSolverCheck}} = \textcolor{keyword}{requires}(LS\& linearSolver, M\& A, V\& vec) \{}
...
\DoxyCodeLine{227   \textcolor{keyword}{concept }\mbox{\hyperlink{a02041}{NonLinearSolverCheckForPathFollowing}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{244   \textcolor{keyword}{concept }\mbox{\hyperlink{a02042}{MultiplyAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x* y; \};}
\DoxyCodeLine{245 }
\DoxyCodeLine{253   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{254   \textcolor{keyword}{concept }\mbox{\hyperlink{a02043}{AddAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x + y; \};}
\DoxyCodeLine{255 }
\DoxyCodeLine{263   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{264   \textcolor{keyword}{concept }\mbox{\hyperlink{a02044}{SubstractAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x -\/ y; \};}
\DoxyCodeLine{265 }
\DoxyCodeLine{274   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{275   \textcolor{keyword}{concept }\mbox{\hyperlink{a02045}{MultiplyAssignAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x *= y; \};}
\DoxyCodeLine{276 }
\DoxyCodeLine{285   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{286   \textcolor{keyword}{concept }\mbox{\hyperlink{a02046}{DivideAssignAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x /= y; \};}
\DoxyCodeLine{287 }
\DoxyCodeLine{296   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{297   \textcolor{keyword}{concept }\mbox{\hyperlink{a02047}{AddAssignAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x += y; \};}
\DoxyCodeLine{298 }
\DoxyCodeLine{307   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{308   \textcolor{keyword}{concept }\mbox{\hyperlink{a02048}{SubstractAssignAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x -\/= y; \};}
\DoxyCodeLine{309 }
\DoxyCodeLine{317   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{318   \textcolor{keyword}{concept }\mbox{\hyperlink{a02049}{DivideAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x / y; \};}
\DoxyCodeLine{319 }
\DoxyCodeLine{326   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L>}
\DoxyCodeLine{327   \textcolor{keyword}{concept }\mbox{\hyperlink{a02050}{NegateAble}} = \textcolor{keyword}{requires}(L x) \{ -\/x; \};}
\DoxyCodeLine{328 }
\DoxyCodeLine{335   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L>}
\DoxyCodeLine{336   \textcolor{keyword}{concept }\mbox{\hyperlink{a02051}{TransposeAble}} = \textcolor{keyword}{requires}(L x) \{ \mbox{\hyperlink{a00396_ac2c6469be19ce4ef2e630bfa1c5a5e24}{transpose}}(x); \};}
\DoxyCodeLine{337 }
\DoxyCodeLine{344   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Op, \textcolor{keyword}{typename}... Args>}
\DoxyCodeLine{345   \textcolor{keyword}{concept }\mbox{\hyperlink{a02052}{IsFunctorWithArgs}} = \textcolor{keyword}{requires}(Op op, Args... args) \{ op(args...); \};}
\DoxyCodeLine{346 }
\DoxyCodeLine{352   \textcolor{keyword}{template} <\textcolor{keyword}{typename} V>}
\DoxyCodeLine{353   \textcolor{keyword}{concept }\mbox{\hyperlink{a02053}{EigenVector}} = \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{bool}\textcolor{keyword}{>}(V::IsVectorAtCompileTime);}
\DoxyCodeLine{354 }
\DoxyCodeLine{360   \textcolor{keyword}{template} <\textcolor{keyword}{typename} M>}
\DoxyCodeLine{361   \textcolor{keyword}{concept }\mbox{\hyperlink{a02054}{EigenMatrix}} = traits::isSpecializationTypeAndNonTypes<Eigen::Matrix, M>::value;}
\DoxyCodeLine{362 }
...
\DoxyCodeLine{367 }
\DoxyCodeLine{368   \mbox{\hyperlink{a03012_ac8757039febcebb4741b376dc8258d6d}{MAKE\_EIGEN\_FIXED\_VECTOR\_CONCEPT}}(1)}
\DoxyCodeLine{369   \mbox{\hyperlink{a03012_ac8757039febcebb4741b376dc8258d6d}{MAKE\_EIGEN\_FIXED\_VECTOR\_CONCEPT}}(2)}
\DoxyCodeLine{370   \mbox{\hyperlink{a03012_ac8757039febcebb4741b376dc8258d6d}{MAKE\_EIGEN\_FIXED\_VECTOR\_CONCEPT}}(3)}
\DoxyCodeLine{371   \mbox{\hyperlink{a03012_ac8757039febcebb4741b376dc8258d6d}{MAKE\_EIGEN\_FIXED\_VECTOR\_CONCEPT}}(4)}
\DoxyCodeLine{372   \mbox{\hyperlink{a03012_ac8757039febcebb4741b376dc8258d6d}{MAKE\_EIGEN\_FIXED\_VECTOR\_CONCEPT}}(5)}
\DoxyCodeLine{373   \mbox{\hyperlink{a03012_ac8757039febcebb4741b376dc8258d6d}{MAKE\_EIGEN\_FIXED\_VECTOR\_CONCEPT}}(6)}
\DoxyCodeLine{374 }
...
\DoxyCodeLine{379 }
\DoxyCodeLine{380   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(1, 1)}
\DoxyCodeLine{381 }
\DoxyCodeLine{382   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(1, 2)}
\DoxyCodeLine{383   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(2, 2)}
\DoxyCodeLine{384 }
\DoxyCodeLine{385   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(1, 3)}
\DoxyCodeLine{386   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(2, 3)}
\DoxyCodeLine{387   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(3, 2)}
\DoxyCodeLine{388   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(3, 3)}
\DoxyCodeLine{389 }
\DoxyCodeLine{390   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(1, 4)}
\DoxyCodeLine{391   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(2, 4)}
\DoxyCodeLine{392   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(3, 4)}
\DoxyCodeLine{393   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(4, 2)}
\DoxyCodeLine{394   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(4, 3)}
\DoxyCodeLine{395   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(4, 4)}
\DoxyCodeLine{396 }
\DoxyCodeLine{397   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(1, 5)}
\DoxyCodeLine{398   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(2, 5)}
\DoxyCodeLine{399   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(3, 5)}
\DoxyCodeLine{400   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(4, 5)}
\DoxyCodeLine{401   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(5, 2)}
\DoxyCodeLine{402   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(5, 3)}
\DoxyCodeLine{403   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(5, 4)}
\DoxyCodeLine{404   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(5, 5)}
\DoxyCodeLine{405 }
\DoxyCodeLine{406   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(1, 6)}
\DoxyCodeLine{407   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(2, 6)}
\DoxyCodeLine{408   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(3, 6)}
\DoxyCodeLine{409   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(4, 6)}
\DoxyCodeLine{410   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(5, 6)}
\DoxyCodeLine{411   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(6, 2)}
\DoxyCodeLine{412   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(6, 3)}
\DoxyCodeLine{413   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(6, 4)}
\DoxyCodeLine{414   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(6, 5)}
\DoxyCodeLine{415   \mbox{\hyperlink{a03012_a5556bdb5e6cc63333c07f9ef487fb478}{MAKE\_EIGEN\_FIXED\_MATRIX\_CONCEPT}}(6, 6)}
\DoxyCodeLine{416 }
...
\DoxyCodeLine{420 }
\DoxyCodeLine{421   \mbox{\hyperlink{a03012_aba360f830591dbc713b7fa692d614101}{MAKE\_EIGEN\_FIXED\_MATRIX\_OR\_VOIGT\_CONCEPT}}(1, 1)}
\DoxyCodeLine{422   \mbox{\hyperlink{a03012_aba360f830591dbc713b7fa692d614101}{MAKE\_EIGEN\_FIXED\_MATRIX\_OR\_VOIGT\_CONCEPT}}(2, 3)}
\DoxyCodeLine{423   \mbox{\hyperlink{a03012_aba360f830591dbc713b7fa692d614101}{MAKE\_EIGEN\_FIXED\_MATRIX\_OR\_VOIGT\_CONCEPT}}(3, 6)}
\DoxyCodeLine{424 }
...
\DoxyCodeLine{441 }
\DoxyCodeLine{454   \textcolor{keyword}{template} <\textcolor{keyword}{template} <\textcolor{keyword}{typename}...> \textcolor{keyword}{class }MaterialToCheck, \textcolor{keyword}{typename} \mbox{\hyperlink{a00385_gga05ac785124262c1e323d2f937d520a1bad92a8333dd3ccb895cc65f7455b71206}{Material}}>}
\DoxyCodeLine{455   \textcolor{keyword}{concept }\mbox{\hyperlink{a02055}{IsMaterial}} = Impl::isMaterial<MaterialToCheck, Material>();}
\DoxyCodeLine{456 }
\DoxyCodeLine{457   \textcolor{keyword}{namespace }Impl \{}
\DoxyCodeLine{458     \textcolor{keyword}{template} <\textcolor{keyword}{typename} T>}
\DoxyCodeLine{459     \textcolor{keyword}{concept }\mbox{\hyperlink{a02058}{ResultType}} = \textcolor{keyword}{requires}(T t) \{}
...
\DoxyCodeLine{463       \{ \mbox{\hyperlink{a00396_aef80b6b5b45dcfbea4f722f51a84f53f}{toString}}(t) \} -\/> std::same\_as<std::string>; \textcolor{comment}{// The toString function}}
\DoxyCodeLine{464     \};}
\DoxyCodeLine{465   \} \textcolor{comment}{// namespace Impl}}
\DoxyCodeLine{466 }
\DoxyCodeLine{473   \textcolor{keyword}{template} <\textcolor{keyword}{typename} MAT>}
\DoxyCodeLine{474   \textcolor{keyword}{concept }\mbox{\hyperlink{a02057}{GeometricallyLinearMaterial}} = MAT::strainTag == \mbox{\hyperlink{a00385_ggacef1e451de1a99845c59d7391064fb8fa9a932b3cb396238423eb2f33ec17d6aa}{StrainTags::linear}};}
\DoxyCodeLine{475 }
...
\DoxyCodeLine{486   \textcolor{keyword}{concept }\mbox{\hyperlink{a02058}{ResultType}} =}
...
\DoxyCodeLine{498   \textcolor{keyword}{concept }\mbox{\hyperlink{a02059}{FlatAssembler}} = \textcolor{keyword}{requires}(T t, \textcolor{keyword}{const} \textcolor{keyword}{typename} T::FERequirement\& req,}
\DoxyCodeLine{499                                    \textcolor{keyword}{typename} T::AffordanceCollectionType affordance, \mbox{\hyperlink{a00396_a9f83fad9f4c149f249165a13f2370eec}{DBCOption}} dbcOption) \{}
...
\DoxyCodeLine{529   \textcolor{keyword}{concept }\mbox{\hyperlink{a02060}{ScalarFlatAssembler}} =}
\DoxyCodeLine{530       \mbox{\hyperlink{a02059}{Concepts::FlatAssembler<T>}} and \textcolor{keyword}{requires}(T t, \textcolor{keyword}{const} \textcolor{keyword}{typename} T::FERequirement\& req,}
\DoxyCodeLine{531                                               \textcolor{keyword}{typename} T::AffordanceCollectionType affordance, \mbox{\hyperlink{a00396_a9f83fad9f4c149f249165a13f2370eec}{DBCOption}} dbcOption) \{}
...
\DoxyCodeLine{543   \textcolor{keyword}{concept }\mbox{\hyperlink{a02061}{VectorFlatAssembler}} = \mbox{\hyperlink{a02060}{Concepts::ScalarFlatAssembler<T>}} and}
\DoxyCodeLine{544                                 \textcolor{keyword}{requires}(T t, \textcolor{keyword}{const} \textcolor{keyword}{typename} T::FERequirement\& req,}
\DoxyCodeLine{545                                          \textcolor{keyword}{typename} T::AffordanceCollectionType affordance, \mbox{\hyperlink{a00396_a9f83fad9f4c149f249165a13f2370eec}{DBCOption}} dbcOption) \{}
\DoxyCodeLine{546                                   \{}
...
\DoxyCodeLine{560   \textcolor{keyword}{concept }\mbox{\hyperlink{a02062}{MatrixFlatAssembler}} = \mbox{\hyperlink{a02061}{Concepts::VectorFlatAssembler<T>}} and}
\DoxyCodeLine{561                                 \textcolor{keyword}{requires}(T t, \textcolor{keyword}{const} \textcolor{keyword}{typename} T::FERequirement\& req,}
\DoxyCodeLine{562                                          \textcolor{keyword}{typename} T::AffordanceCollectionType affordance, \mbox{\hyperlink{a00396_a9f83fad9f4c149f249165a13f2370eec}{DBCOption}} dbcOption) \{}
...
\DoxyCodeLine{570   \textcolor{keyword}{concept }\mbox{\hyperlink{a02063}{DataCollector}} = \textcolor{keyword}{requires}(DC dc) \{}
...
\DoxyCodeLine{579   \textcolor{keyword}{concept }\mbox{\hyperlink{a02064}{GridView}} = \textcolor{keyword}{requires}(GV g) \{}
...
\DoxyCodeLine{606   \textcolor{keyword}{concept }\mbox{\hyperlink{a02065}{AutodiffScalar}} = Impl::is\_dual<T>::value;}
\DoxyCodeLine{607 }
