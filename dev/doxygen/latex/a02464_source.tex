\hypertarget{a02464_source}{}\doxysection{python/finiteelements/nonlinearelastic.hh}
\label{a02464_source}\index{nonlinearelastic.hh@{nonlinearelastic.hh}}
...
\DoxyCodeLine{18 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a02461}{ikarus/finiteelements/mechanics/nonlinearelastic.hh}}>}}
\DoxyCodeLine{19 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a02470}{ikarus/utils/basis.hh}}>}}
\DoxyCodeLine{20 }
...
\DoxyCodeLine{26 }
\DoxyCodeLine{27   \textcolor{keyword}{using }GlobalBasis    = \textcolor{keyword}{typename} \mbox{\hyperlink{a01338_aa4ecab060cee08abbdcaf3d46b59118e}{NonLinearElastic::Basis}};}
\DoxyCodeLine{28   \textcolor{keyword}{using }FlatBasis      = \textcolor{keyword}{typename} \mbox{\hyperlink{a01338_a905bbe5c87f735b15507abf10863f073}{NonLinearElastic::FlatBasis}};}
\DoxyCodeLine{29   \textcolor{keyword}{using }GridView       = \textcolor{keyword}{typename} GlobalBasis::GridView;}
\DoxyCodeLine{30   \textcolor{keyword}{using }Element        = \textcolor{keyword}{typename} \mbox{\hyperlink{a01338_ab33cfebc8e589f24ba787d4076ee676c}{NonLinearElastic::Element}};}
\DoxyCodeLine{31   \textcolor{keyword}{using }Traits         = \textcolor{keyword}{typename} \mbox{\hyperlink{a01338_aef9577cd5e260ba7b82835c935011035}{NonLinearElastic::Traits}};}
\DoxyCodeLine{32   \textcolor{keyword}{using }\mbox{\hyperlink{a01250}{FERequirements}} = \textcolor{keyword}{typename} \mbox{\hyperlink{a01338_a358fe3461a6465be28ecc1198de63977}{NonLinearElastic::FERequirementType}};}
\DoxyCodeLine{33   \textcolor{keyword}{using }\mbox{\hyperlink{a01310}{Material}}       = \textcolor{keyword}{typename} \mbox{\hyperlink{a01338_aa5d9c80e5f15dd6b52e7ec188754a49d}{NonLinearElastic::Material}};}
\DoxyCodeLine{34   \textcolor{keyword}{using }\mbox{\hyperlink{a01250}{FERequirements}} = \textcolor{keyword}{typename} \mbox{\hyperlink{a01338_a358fe3461a6465be28ecc1198de63977}{NonLinearElastic::FERequirementType}};}
\DoxyCodeLine{35 }
\DoxyCodeLine{36   cls.def(\mbox{\hyperlink{a00325_ac8243891c1b961e50a066140ab79a142}{pybind11::init}}([](\textcolor{keyword}{const} GlobalBasis\& \mbox{\hyperlink{a00345_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}, \textcolor{keyword}{const} Element\& element, \textcolor{keyword}{const} \mbox{\hyperlink{a01310}{Material}}\& mat) \{}
\DoxyCodeLine{37             \textcolor{keywordflow}{return} \textcolor{keyword}{new} \mbox{\hyperlink{a00347_a6114e5fee4b037e1baa43925a79eee38}{NonLinearElastic}}(\mbox{\hyperlink{a00345_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}, element, mat);}
\DoxyCodeLine{38           \}),}
...
\DoxyCodeLine{42       \mbox{\hyperlink{a01370}{Dune::FieldVector<double, Traits::worlddim>}}, \textcolor{keyword}{const} \textcolor{keywordtype}{double}\&)>;}
\DoxyCodeLine{43 }
\DoxyCodeLine{44   cls.def(\mbox{\hyperlink{a00325_ac8243891c1b961e50a066140ab79a142}{pybind11::init}}(}
\DoxyCodeLine{45               [](\textcolor{keyword}{const} GlobalBasis\& \mbox{\hyperlink{a00345_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}, \textcolor{keyword}{const} Element\& element, \textcolor{keyword}{const} \mbox{\hyperlink{a01310}{Material}}\& mat, \textcolor{keyword}{const} LoadFunction volumeLoad) \{}
\DoxyCodeLine{46                 \textcolor{keywordflow}{return} \textcolor{keyword}{new} \mbox{\hyperlink{a00347_a6114e5fee4b037e1baa43925a79eee38}{NonLinearElastic}}(\mbox{\hyperlink{a00345_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}, element, mat, volumeLoad);}
\DoxyCodeLine{47               \}),}
\DoxyCodeLine{48           pybind11::keep\_alive<1, 2>(), pybind11::keep\_alive<1, 3>());}
\DoxyCodeLine{49 }
\DoxyCodeLine{50   cls.def(\mbox{\hyperlink{a00325_ac8243891c1b961e50a066140ab79a142}{pybind11::init}}([](\textcolor{keyword}{const} GlobalBasis\& \mbox{\hyperlink{a00345_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}, \textcolor{keyword}{const} Element\& element, \textcolor{keyword}{const} \mbox{\hyperlink{a01310}{Material}}\& mat,}
...
\DoxyCodeLine{53             \textcolor{keywordflow}{return} \textcolor{keyword}{new} \mbox{\hyperlink{a00347_a6114e5fee4b037e1baa43925a79eee38}{NonLinearElastic}}(\mbox{\hyperlink{a00345_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}, element, mat, volumeLoad, \&bp, neumannBoundaryLoad);}
\DoxyCodeLine{54           \}),}
...
\DoxyCodeLine{83       [](\mbox{\hyperlink{a01338}{NonLinearElastic}}\& self) -\/> LocalViewWrapper \{}
...
\DoxyCodeLine{93           [](\mbox{\hyperlink{a01338}{NonLinearElastic}}\& self, \textcolor{keyword}{const} \mbox{\hyperlink{a01250}{FERequirements}}\& req) \{ \textcolor{keywordflow}{return} self.calculateScalar(req); \});}
\DoxyCodeLine{94   cls.def(\textcolor{stringliteral}{"{}calculateVector"{}}, [](\mbox{\hyperlink{a01338}{NonLinearElastic}}\& self, \textcolor{keyword}{const} \mbox{\hyperlink{a01250}{FERequirements}}\& req, Eigen::Ref<Eigen::VectorXd> vec) \{}
...
\DoxyCodeLine{99       [](\mbox{\hyperlink{a01338}{NonLinearElastic}}\& self, \textcolor{keyword}{const} \mbox{\hyperlink{a01250}{FERequirements}}\& req, Eigen::Ref<Eigen::MatrixXd> mat) \{}
...
\DoxyCodeLine{106       [](\mbox{\hyperlink{a01338}{NonLinearElastic}}\& self, \textcolor{keyword}{const} \mbox{\hyperlink{a01250}{FERequirements}}\& req, \textcolor{keyword}{const} \mbox{\hyperlink{a01370}{Dune::FieldVector<double, Traits::mydim>}}\& local,}
