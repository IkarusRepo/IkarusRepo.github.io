...
\DoxyCodeLine{20 }
\DoxyCodeLine{21 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00334}{Ikarus::Python}} \{}
\DoxyCodeLine{22 }
...
\DoxyCodeLine{24 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00334_a4124469fcacfc527cb971b40fe86e244}{registerNonLinearElastic}}(pybind11::handle scope, pybind11::class\_<NonLinearElastic, options...> cls) \{}
...
\DoxyCodeLine{42       \mbox{\hyperlink{a01490}{Dune::FieldVector<double, Traits::worlddim>}}, \textcolor{keyword}{const} \textcolor{keywordtype}{double}\&)>;}
\DoxyCodeLine{43 }
...
\DoxyCodeLine{106       [](\mbox{\hyperlink{a01338}{NonLinearElastic}}\& self, \textcolor{keyword}{const} \mbox{\hyperlink{a01250}{FERequirements}}\& req, \textcolor{keyword}{const} \mbox{\hyperlink{a01490}{Dune::FieldVector<double, Traits::mydim>}}\& local,}
