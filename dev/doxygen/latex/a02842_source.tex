\hypertarget{a02842_source}{}\doxysection{finiteelements/mechanics/materials/interface.hh}
\label{a02842_source}\index{interface.hh@{interface.hh}}
...
\DoxyCodeLine{15 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00056}{ikarus/utils/concepts.hh}}>}}
\DoxyCodeLine{16 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00050}{ikarus/utils/linearalgebrahelper.hh}}>}}
\DoxyCodeLine{17 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00035}{ikarus/utils/traits.hh}}>}}
\DoxyCodeLine{18 }
...
\DoxyCodeLine{44   \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (MAT::isReduced and \mbox{\hyperlink{a01956}{Concepts::EigenVector<S>}}) \{}
...
\DoxyCodeLine{57 \textcolor{keyword}{concept }\mbox{\hyperlink{a01930}{CorrectStrainSize}} = hasCorrectSize<MAT, S>();}
\DoxyCodeLine{58 }
...
\DoxyCodeLine{135   \textcolor{keyword}{requires} \mbox{\hyperlink{a01930}{CorrectStrainSize<MaterialImpl, Derived>}}}
...
\DoxyCodeLine{139 }
\DoxyCodeLine{140     \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (\mbox{\hyperlink{a01956}{Concepts::EigenVector<Derived>}}) \{ \textcolor{comment}{// receiving vector means voigt notation}}
...
\DoxyCodeLine{159   \textcolor{keyword}{requires} \mbox{\hyperlink{a01930}{CorrectStrainSize<MaterialImpl, Derived>}}}
...
\DoxyCodeLine{180   \textcolor{keyword}{requires} \mbox{\hyperlink{a01930}{CorrectStrainSize<MaterialImpl, Derived>}}}
...
\DoxyCodeLine{207     \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (\mbox{\hyperlink{a01956}{Concepts::EigenVector<Derived>}}) \{ \textcolor{comment}{// receiving vector means Voigt notation}}
