\hypertarget{a00236_source}{}\doxysection{assemblermanipulatorfuser.\+hh}
\label{a00236_source}\index{assemblermanipulatorfuser.hh@{assemblermanipulatorfuser.hh}}
...
\DoxyCodeLine{10 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00245}{ikarus/assembler/assemblermanipulatorbuildingblocks.hh}}>}}
\DoxyCodeLine{11 }
\DoxyCodeLine{12 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00363}{Ikarus}} \{}
\DoxyCodeLine{13 }
...
\DoxyCodeLine{36 \textcolor{keyword}{class }\mbox{\hyperlink{a01224}{AssemblerManipulator}};}
\DoxyCodeLine{37 }
...
\DoxyCodeLine{53 \textcolor{keyword}{class }\mbox{\hyperlink{a01224}{AssemblerManipulator}}<A, ScalarAss>}
...
\DoxyCodeLine{59   \textcolor{keyword}{using }\mbox{\hyperlink{a01228_aeaad22dd904f173dd227a85ccb7f63a4}{WrappedAssembler}} = A;}
\DoxyCodeLine{60 }
\DoxyCodeLine{61 \textcolor{keyword}{protected}:}
\DoxyCodeLine{62   \textcolor{keyword}{using }\mbox{\hyperlink{a01228_ae4ed17fb7f07d2e51a7d9c358452e551}{ScalarAssemblerImpl}}      = ScalarAss::template Implementation<AssemblerManipulator, WrappedAssembler>;}
\DoxyCodeLine{63   \textcolor{keyword}{using }\mbox{\hyperlink{a01228_a260e635e4fac77e9f19ea8a460e19a64}{ScalarAssemblerInterface}} = ScalarAss::template Interface<AssemblerManipulator, A, typename A::ScalarType>;}
\DoxyCodeLine{64 }
\DoxyCodeLine{65   \textcolor{keyword}{friend} \mbox{\hyperlink{a01228_ab64a9c8c9de782ad8eb2a7474af6a6b8}{ScalarAssemblerImpl}};}
\DoxyCodeLine{66   \textcolor{keyword}{friend} \mbox{\hyperlink{a01228_adbb012d9d185dc929dafa6e7b20b3c57}{ScalarAssemblerInterface}};}
\DoxyCodeLine{67 }
...
\DoxyCodeLine{104 }
\DoxyCodeLine{105   \textcolor{keyword}{using }\mbox{\hyperlink{a01228_a8b10e4fc60d5a41a51056800153a3288}{CallBackTypes}} =}
...
\DoxyCodeLine{115   \textcolor{keyword}{requires}(not std::is\_same\_v<std::remove\_cvref\_t<std::tuple\_element\_t<0, std::tuple<Args...>>>, \mbox{\hyperlink{a01224}{AssemblerManipulator}}>)}
\DoxyCodeLine{116   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01228_a502e5187d87b7a8062903ca3608042ec}{AssemblerManipulator}}(Args\&\&... args)}
\DoxyCodeLine{117       : \mbox{\hyperlink{a01228_aeaad22dd904f173dd227a85ccb7f63a4}{WrappedAssembler}}(std::forward<Args>(args)...) \{\}}
\DoxyCodeLine{118 }
\DoxyCodeLine{119 \textcolor{keyword}{private}:}
\DoxyCodeLine{120   \mbox{\hyperlink{a00236_ab88748ddf71ad00ec25d8e9dabcefa82}{BASECLASSMEMBERFUNCTION}}(getScalarImpl, A)}
\DoxyCodeLine{121 }
...
\DoxyCodeLine{136 \textcolor{keyword}{class }\mbox{\hyperlink{a01224}{AssemblerManipulator}}<A, ScalarAss, VectorAss>}
...
\DoxyCodeLine{144   \textcolor{keyword}{using }\mbox{\hyperlink{a01232_a23910dd23aec1d66ae2163ae5c3feff2}{WrappedAssembler}} = A;}
\DoxyCodeLine{145 }
\DoxyCodeLine{146 \textcolor{keyword}{protected}:}
\DoxyCodeLine{147   \textcolor{keyword}{using }\mbox{\hyperlink{a01232_ad548d9c186819f0b92a304cc2f055ea5}{ScalarAssemblerImpl}}      = ScalarAss::template Implementation<AssemblerManipulator, WrappedAssembler>;}
\DoxyCodeLine{148   \textcolor{keyword}{using }\mbox{\hyperlink{a01232_a34f8528f5c053818af2178851cc31b81}{VectorAssemblerImpl}}      = VectorAss::template Implementation<AssemblerManipulator, WrappedAssembler>;}
\DoxyCodeLine{149   \textcolor{keyword}{using }\mbox{\hyperlink{a01232_ad011335ef113c9289854486361e6590c}{ScalarAssemblerInterface}} = ScalarAss::template Interface<AssemblerManipulator, A, typename A::ScalarType>;}
\DoxyCodeLine{150   \textcolor{keyword}{using }\mbox{\hyperlink{a01232_a1009f6d702cf0d1dcf20816174a6b52a}{VectorAssemblerInterface}} = VectorAss::template Interface<AssemblerManipulator, A, typename A::VectorType>;}
\DoxyCodeLine{151 }
\DoxyCodeLine{152   \textcolor{keyword}{friend} \mbox{\hyperlink{a01232_a073d6709deb7c8af88e80d78a9d9d52e}{ScalarAssemblerImpl}};}
\DoxyCodeLine{153   \textcolor{keyword}{friend} \mbox{\hyperlink{a01232_a9a0d3c2f6a5fbb66d3ec88793685bcd4}{VectorAssemblerImpl}};}
\DoxyCodeLine{154   \textcolor{keyword}{friend} \mbox{\hyperlink{a01232_a0110ff846e287a2e9bec794c35d94bc2}{ScalarAssemblerInterface}};}
\DoxyCodeLine{155   \textcolor{keyword}{friend} \mbox{\hyperlink{a01232_add1c52fad1611dd03df81b50797a3540}{VectorAssemblerInterface}};}
\DoxyCodeLine{156 }
...
\DoxyCodeLine{199 }
\DoxyCodeLine{200   \textcolor{keyword}{using }\mbox{\hyperlink{a01232_a548596506a305bb51457e888633857ef}{CallBackTypes}} =}
...
\DoxyCodeLine{210   \textcolor{keyword}{requires}(not std::is\_same\_v<std::remove\_cvref\_t<std::tuple\_element\_t<0, std::tuple<Args...>>>, \mbox{\hyperlink{a01224}{AssemblerManipulator}}>)}
\DoxyCodeLine{211   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01232_aa7a37ed96edb529292f6d5c76f771d92}{AssemblerManipulator}}(Args\&\&... args)}
\DoxyCodeLine{212       : \mbox{\hyperlink{a01232_a23910dd23aec1d66ae2163ae5c3feff2}{WrappedAssembler}}(std::forward<Args>(args)...) \{\}}
\DoxyCodeLine{213 }
\DoxyCodeLine{214 \textcolor{keyword}{private}:}
\DoxyCodeLine{215   \mbox{\hyperlink{a00236_ab88748ddf71ad00ec25d8e9dabcefa82}{BASECLASSMEMBERFUNCTION}}(getScalarImpl, WrappedAssembler)}
\DoxyCodeLine{216   \mbox{\hyperlink{a00236_ab88748ddf71ad00ec25d8e9dabcefa82}{BASECLASSMEMBERFUNCTION}}(getRawVectorImpl, WrappedAssembler)}
\DoxyCodeLine{217   \mbox{\hyperlink{a00236_ab88748ddf71ad00ec25d8e9dabcefa82}{BASECLASSMEMBERFUNCTION}}(getReducedVectorImpl, WrappedAssembler)}
\DoxyCodeLine{218   \mbox{\hyperlink{a00236_ab88748ddf71ad00ec25d8e9dabcefa82}{BASECLASSMEMBERFUNCTION}}(getVectorImpl, WrappedAssembler)}
\DoxyCodeLine{219 }
...
\DoxyCodeLine{235 \textcolor{keyword}{class }\mbox{\hyperlink{a01224}{AssemblerManipulator}}<A, ScalarAss, VectorAss, MatrixAss>}
...
\DoxyCodeLine{248   \textcolor{keyword}{using }\mbox{\hyperlink{a01236_a62123a4b3e6532f92f9126bbb6ce90a7}{WrappedAssembler}} = A;}
\DoxyCodeLine{249 }
\DoxyCodeLine{250 \textcolor{keyword}{protected}:}
\DoxyCodeLine{251   \textcolor{keyword}{using }\mbox{\hyperlink{a01236_ae6e112a7cb6a5167ba97b53bb5c7d238}{ScalarAssemblerImpl}}      = ScalarAss::template Implementation<AssemblerManipulator, A>;}
\DoxyCodeLine{252   \textcolor{keyword}{using }\mbox{\hyperlink{a01236_ae958fb1ffccb3bd993d73cdf2b404705}{VectorAssemblerImpl}}      = VectorAss::template Implementation<AssemblerManipulator, A>;}
\DoxyCodeLine{253   \textcolor{keyword}{using }\mbox{\hyperlink{a01236_a4d15f9b228606ffd26ae5b511cd95ff3}{MatrixAssemblerImpl}}      = MatrixAss::template Implementation<AssemblerManipulator, A>;}
\DoxyCodeLine{254   \textcolor{keyword}{using }\mbox{\hyperlink{a01236_a111dfa9dc910a06976a89677d7275575}{ScalarAssemblerInterface}} = ScalarAss::template Interface<AssemblerManipulator, A, typename A::ScalarType>;}
\DoxyCodeLine{255   \textcolor{keyword}{using }\mbox{\hyperlink{a01236_a6cf604621f5a5391f9e79967b8977eb5}{VectorAssemblerInterface}} = VectorAss::template Interface<AssemblerManipulator, A, typename A::VectorType>;}
\DoxyCodeLine{256   \textcolor{keyword}{using }\mbox{\hyperlink{a01236_a6a7c3a2c35ff4ef52ce0d3b4e304ed54}{MatrixAssemblerInterface}} = MatrixAss::template Interface<AssemblerManipulator, A, typename A::MatrixType>;}
\DoxyCodeLine{257 }
\DoxyCodeLine{258   \textcolor{keyword}{friend} \mbox{\hyperlink{a01236_a71d8c2e510825482ad8b865cdcc97865}{ScalarAssemblerImpl}};}
\DoxyCodeLine{259   \textcolor{keyword}{friend} \mbox{\hyperlink{a01236_a58429a8398105c51c4582c1b72d7bc8c}{VectorAssemblerImpl}};}
\DoxyCodeLine{260   \textcolor{keyword}{friend} \mbox{\hyperlink{a01236_a8218e9d8992798ad9d6377ee9c171f04}{MatrixAssemblerImpl}};}
\DoxyCodeLine{261   \textcolor{keyword}{friend} \mbox{\hyperlink{a01236_a81430cd85aea660bdbbf36e6ec5a5499}{MatrixAssemblerInterface}};}
\DoxyCodeLine{262   \textcolor{keyword}{friend} \mbox{\hyperlink{a01236_af20b695138ce2baa088d243c56b8a5fe}{ScalarAssemblerInterface}};}
\DoxyCodeLine{263   \textcolor{keyword}{friend} \mbox{\hyperlink{a01236_a7122782f660bef5b917c0c566e791759}{VectorAssemblerInterface}};}
\DoxyCodeLine{264 }
...
\DoxyCodeLine{313 }
\DoxyCodeLine{314   \textcolor{keyword}{using }\mbox{\hyperlink{a01236_a0a878d8bc56fdbfbfbebc2ceb1ded67f}{CallBackTypes}} =}
...
\DoxyCodeLine{325   \textcolor{keyword}{requires}(not std::is\_same\_v<std::remove\_cvref\_t<std::tuple\_element\_t<0, std::tuple<Args...>>>, \mbox{\hyperlink{a01224}{AssemblerManipulator}}>)}
\DoxyCodeLine{326   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01236_ab1188db460e760d50f1bddda973a4915}{AssemblerManipulator}}(Args\&\&... args)}
\DoxyCodeLine{327       : \mbox{\hyperlink{a01236_a62123a4b3e6532f92f9126bbb6ce90a7}{WrappedAssembler}}(std::forward<Args>(args)...) \{\}}
\DoxyCodeLine{328 }
\DoxyCodeLine{329 \textcolor{keyword}{private}:}
\DoxyCodeLine{330   \mbox{\hyperlink{a00236_ab88748ddf71ad00ec25d8e9dabcefa82}{BASECLASSMEMBERFUNCTION}}(getScalarImpl, A)}
\DoxyCodeLine{331   \mbox{\hyperlink{a00236_ab88748ddf71ad00ec25d8e9dabcefa82}{BASECLASSMEMBERFUNCTION}}(getRawVectorImpl, A)}
\DoxyCodeLine{332   \mbox{\hyperlink{a00236_ab88748ddf71ad00ec25d8e9dabcefa82}{BASECLASSMEMBERFUNCTION}}(getReducedVectorImpl, A)}
\DoxyCodeLine{333   \mbox{\hyperlink{a00236_ab88748ddf71ad00ec25d8e9dabcefa82}{BASECLASSMEMBERFUNCTION}}(getVectorImpl, A)}
\DoxyCodeLine{334   \mbox{\hyperlink{a00236_ab88748ddf71ad00ec25d8e9dabcefa82}{BASECLASSMEMBERFUNCTION}}(getRawMatrixImpl, A)}
\DoxyCodeLine{335 }
\DoxyCodeLine{336   \mbox{\hyperlink{a00236_ab88748ddf71ad00ec25d8e9dabcefa82}{BASECLASSMEMBERFUNCTION}}(getReducedMatrixImpl, A)}
\DoxyCodeLine{337 }
\DoxyCodeLine{338   \mbox{\hyperlink{a00236_ab88748ddf71ad00ec25d8e9dabcefa82}{BASECLASSMEMBERFUNCTION}}(getMatrixImpl, A)}
\DoxyCodeLine{339 }
...
\DoxyCodeLine{355 \textcolor{keyword}{auto} \mbox{\hyperlink{a00363_afc83c2d114028f47280b981daf728ebe}{makeAssemblerManipulator}}(A\&\& a) \{}
\DoxyCodeLine{356   \textcolor{keyword}{constexpr} \textcolor{keywordtype}{bool} scal = \mbox{\hyperlink{a01882}{Concepts::ScalarFlatAssembler<std::remove\_cvref\_t<A>}}>;}
\DoxyCodeLine{357   \textcolor{keyword}{constexpr} \textcolor{keywordtype}{bool} vec  = \mbox{\hyperlink{a01883}{Concepts::VectorFlatAssembler<std::remove\_cvref\_t<A>}}>;}
\DoxyCodeLine{358   \textcolor{keyword}{constexpr} \textcolor{keywordtype}{bool} mat  = \mbox{\hyperlink{a01884}{Concepts::MatrixFlatAssembler<std::remove\_cvref\_t<A>}}>;}
...
\DoxyCodeLine{361         \mbox{\hyperlink{a01224}{AssemblerManipulator}}<std::remove\_cvref\_t<A>, Impl::AssemblerInterfaceHelper<ScalarAssembler, ScalarManipulator>,}
...
\DoxyCodeLine{366         \mbox{\hyperlink{a01224}{AssemblerManipulator}}<std::remove\_cvref\_t<A>, Impl::AssemblerInterfaceHelper<ScalarAssembler, ScalarManipulator>,}
...
\DoxyCodeLine{369     \textcolor{keywordflow}{return} std::make\_shared<\mbox{\hyperlink{a01224}{AssemblerManipulator}}<std::remove\_cvref\_t<A>,}
