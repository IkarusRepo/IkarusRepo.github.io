\hypertarget{a02833_source}{}\doxysection{finiteelements/mechanics/materials/interface.hh}
\label{a02833_source}\index{interface.hh@{interface.hh}}
...
\DoxyCodeLine{44   \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (MAT::isReduced and \mbox{\hyperlink{a01948}{Concepts::EigenVector<S>}}) \{}
...
\DoxyCodeLine{57 \textcolor{keyword}{concept }\mbox{\hyperlink{a01922}{CorrectStrainSize}} = hasCorrectSize<MAT, S>();}
\DoxyCodeLine{58 }
...
\DoxyCodeLine{135   \textcolor{keyword}{requires} \mbox{\hyperlink{a01922}{CorrectStrainSize<MaterialImpl, Derived>}}}
...
\DoxyCodeLine{139 }
\DoxyCodeLine{140     \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (\mbox{\hyperlink{a01948}{Concepts::EigenVector<Derived>}}) \{ \textcolor{comment}{// receiving vector means voigt notation}}
...
\DoxyCodeLine{159   \textcolor{keyword}{requires} \mbox{\hyperlink{a01922}{CorrectStrainSize<MaterialImpl, Derived>}}}
...
\DoxyCodeLine{180   \textcolor{keyword}{requires} \mbox{\hyperlink{a01922}{CorrectStrainSize<MaterialImpl, Derived>}}}
...
\DoxyCodeLine{207     \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (\mbox{\hyperlink{a01948}{Concepts::EigenVector<Derived>}}) \{ \textcolor{comment}{// receiving vector means Voigt notation}}
