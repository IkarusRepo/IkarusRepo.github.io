...
\DoxyCodeLine{32 Eigen::Tensor<typename Derived::Scalar, rank> \mbox{\hyperlink{a00356_ga5cfd9d098384fb067d897b3c0499b447}{tensorView}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01649}{Eigen::EigenBase<Derived>}}\& matrix,}
...
\DoxyCodeLine{37 \}}
\DoxyCodeLine{38 }
\DoxyCodeLine{47 \textcolor{keyword}{auto} \mbox{\hyperlink{a00356_gab2cea9ac847cc3635812467c9d96ceb4}{dyadic}}(\textcolor{keyword}{const} \textcolor{keyword}{auto}\& A\_ij, \textcolor{keyword}{const} \textcolor{keyword}{auto}\& B\_kl) \{}
...
\DoxyCodeLine{60 \textcolor{keyword}{auto} \mbox{\hyperlink{a00356_ga1c9618ef351cd986d4f64fde7f52e860}{symmetricIdentityFourthOrder}}() \{}
...
\DoxyCodeLine{82 \textcolor{keyword}{auto} \mbox{\hyperlink{a00356_ga2368a572348c410fd7e7deb6c6e3964a}{symmetricFourthOrder}}(\textcolor{keyword}{const} \textcolor{keyword}{auto}\& A, \textcolor{keyword}{const} \textcolor{keyword}{auto}\& B) \{}
...
\DoxyCodeLine{101 \textcolor{keyword}{auto} \mbox{\hyperlink{a00356_gadb08b6f9cc40847b70286dc314a23000}{identityFourthOrder}}() \{}
...
\DoxyCodeLine{122 \textcolor{keyword}{auto} \mbox{\hyperlink{a00356_ga8fa2b440586483c1ee0f9b90b9081da2}{fourthOrderIKJL}}(\textcolor{keyword}{const} Eigen::MatrixBase<AType>\& A, \textcolor{keyword}{const} Eigen::MatrixBase<BType>\& B) \{}
...
\DoxyCodeLine{145 \textcolor{keyword}{auto} \mbox{\hyperlink{a00356_gaea03dbfcd8f85ef7af004c7e09244aa9}{symTwoSlots}}(\textcolor{keyword}{const} Eigen::TensorFixedSize<ScalarType, Eigen::Sizes<dim, dim, dim, dim>>\& t,}
...
\DoxyCodeLine{151 \}}
\DoxyCodeLine{152 }
\DoxyCodeLine{166 \textcolor{keyword}{constexpr} Eigen::Index \mbox{\hyperlink{a00356_ga4304655095296ce9283e012587817a51}{toVoigt}}(Eigen::Index i, Eigen::Index j) \textcolor{keyword}{noexcept} \{}
...
\DoxyCodeLine{194 Eigen::Matrix<ScalarType, 6, 6> \mbox{\hyperlink{a00356_ga4304655095296ce9283e012587817a51}{toVoigt}}(\textcolor{keyword}{const} Eigen::TensorFixedSize<ScalarType, Eigen::Sizes<3, 3, 3, 3>>\& ft) \{}
...
\DoxyCodeLine{200           mat(\mbox{\hyperlink{a00356_ga4304655095296ce9283e012587817a51}{toVoigt}}(i, j), \mbox{\hyperlink{a00356_ga4304655095296ce9283e012587817a51}{toVoigt}}(k, l)) = ft(i, j, k, l);}
...
\DoxyCodeLine{224 \textcolor{keyword}{auto} \mbox{\hyperlink{a00356_ga4304655095296ce9283e012587817a51}{toVoigt}}(\textcolor{keyword}{const} Eigen::Matrix<ST, size, size, Options, size, size>\& E, \textcolor{keywordtype}{bool} isStrain = \textcolor{keyword}{true}) \{}
...
\DoxyCodeLine{256 \textcolor{keyword}{auto} \mbox{\hyperlink{a00356_ga106e11a950fe2545890e811d2e9545fd}{fromVoigt}}(\textcolor{keyword}{const} Eigen::Vector<ST, size>\& EVoigt, \textcolor{keywordtype}{bool} isStrain = \textcolor{keyword}{true}) \{}
\DoxyCodeLine{257   \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} matrixSize = (-\/1 + \mbox{\hyperlink{a00360_ae55d4d0c3478ab3ecf54ce905ddf223b}{ct\_sqrt}}(1 + 8 * size)) / 2;}
...
\DoxyCodeLine{270 \}}
\DoxyCodeLine{271 }
\DoxyCodeLine{285 \textcolor{keyword}{constexpr} std::array<size\_t, 2> \mbox{\hyperlink{a00356_ga106e11a950fe2545890e811d2e9545fd}{fromVoigt}}(\textcolor{keywordtype}{size\_t} i) \{}
...
\DoxyCodeLine{312 \textcolor{keyword}{auto} \mbox{\hyperlink{a00356_ga106e11a950fe2545890e811d2e9545fd}{fromVoigt}}(\textcolor{keyword}{const} Eigen::Matrix<ScalarType, 6, 6>\& CVoigt) \{}
...
\DoxyCodeLine{317       \textcolor{keyword}{auto} firstIndices                                                       = \mbox{\hyperlink{a00356_ga106e11a950fe2545890e811d2e9545fd}{fromVoigt}}(i);}
\DoxyCodeLine{318       \textcolor{keyword}{auto} secondIndices                                                      = \mbox{\hyperlink{a00356_ga106e11a950fe2545890e811d2e9545fd}{fromVoigt}}(j);}
...
\DoxyCodeLine{336 Eigen::Matrix3d \mbox{\hyperlink{a00360_a7a5b9f5e83f6918ca1726fb4316c3b86}{calcTransformationMatrix2D}}(\textcolor{keyword}{const} Geometry\& geometry) \{}
...
\DoxyCodeLine{369 Eigen::Matrix<double, 6, 6> \mbox{\hyperlink{a00360_a95234ab8588ced83708c6e5a30e2368e}{calcTransformationMatrix3D}}(\textcolor{keyword}{const} Geometry\& geometry) \{}
