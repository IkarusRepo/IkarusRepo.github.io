\hypertarget{a00053_source}{}\doxysection{traversal.\+hh}
\label{a00053_source}\index{traversal.hh@{traversal.hh}}
...
\DoxyCodeLine{11 }
\DoxyCodeLine{12 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00377}{Ikarus::utils}} \{}
\DoxyCodeLine{13 }
...
\DoxyCodeLine{31 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00377_a63742d75d099b93da7ddf6e78a3c1f56}{forEachLeafOrPowerLeafNode}}(T\&\& tree, TreePath\&\& treePath, PowerFunc\&\& powerFunc, LeafFunc\&\& leafFunc) \{}
...
\DoxyCodeLine{41         \mbox{\hyperlink{a00377_a63742d75d099b93da7ddf6e78a3c1f56}{forEachLeafOrPowerLeafNode}}(tree.child(i), childTreePath, powerFunc, leafFunc);}
\DoxyCodeLine{42       \}}
\DoxyCodeLine{43     \}}
...
\DoxyCodeLine{48       \mbox{\hyperlink{a00377_a63742d75d099b93da7ddf6e78a3c1f56}{forEachLeafOrPowerLeafNode}}(tree.child(i), childTreePath, powerFunc, leafFunc);}
\DoxyCodeLine{49     \});}
\DoxyCodeLine{50   \}}
\DoxyCodeLine{51 \}}
\DoxyCodeLine{52 }
...
\DoxyCodeLine{64 \textcolor{keyword}{requires}(std::convertible\_to<F, std::function<bool(\textcolor{keywordtype}{int}, \mbox{\hyperlink{a01704}{Dune::FieldVector<double, size>}} \&\&)>>)}
\DoxyCodeLine{65 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00377_a9bfdb235951b98b7a214704baf9c6f95}{forEachLagrangeNodePosition}}(\textcolor{keyword}{const} LV\& localView, F\&\& f) \{}
\DoxyCodeLine{66   \textcolor{keyword}{static\_assert}(\mbox{\hyperlink{a01865}{Concepts::LagrangeNode}}<std::remove\_cvref\_t<\textcolor{keyword}{decltype}(localView.tree().child(0))>>,}
...
\DoxyCodeLine{74     \textcolor{keyword}{auto} ithCoord = [\&i](\textcolor{keyword}{const} \mbox{\hyperlink{a01704}{Dune::FieldVector<double, size>}}\& x) \{ \textcolor{keywordflow}{return} x[i]; \};}
