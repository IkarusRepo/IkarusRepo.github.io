\hypertarget{a00053_source}{}\doxysection{nonlinearoperator.\+hh}
\label{a00053_source}\index{nonlinearoperator.hh@{nonlinearoperator.hh}}
...
\DoxyCodeLine{115 \textcolor{keyword}{auto} \mbox{\hyperlink{a00375_ac00abda505aa8ccc73ce59afd165ce49}{parameter}}(Args\&\&... args) \{}
...
\DoxyCodeLine{127 \textcolor{keyword}{auto} \mbox{\hyperlink{a00375_ab787b670f0d338c870988f417cf85f76}{functions}}(Args\&\&... args) \{}
...
\DoxyCodeLine{141 \textcolor{keyword}{auto} \mbox{\hyperlink{a00375_ab346d8d79af81fa5312a67cd8b4e6d9a}{initResults}}(\textcolor{keyword}{const} std::tuple<DerivativeArgs...>\& derivativesFunctions,}
\DoxyCodeLine{142                  \textcolor{keyword}{const} std::tuple<ParameterArgs...>\& \mbox{\hyperlink{a00375_ac00abda505aa8ccc73ce59afd165ce49}{parameter}}) \{}
\DoxyCodeLine{143   \textcolor{keywordflow}{return} Impl::makeTupleOfValuesAndReferences(}
\DoxyCodeLine{144       derivativesFunctions, \mbox{\hyperlink{a00375_ac00abda505aa8ccc73ce59afd165ce49}{parameter}},}
...
\DoxyCodeLine{155 \textcolor{keyword}{class }\mbox{\hyperlink{a01815}{NonLinearOperator}}}
\DoxyCodeLine{156 \{}
\DoxyCodeLine{157 \textcolor{keyword}{public}:}
\DoxyCodeLine{158   \mbox{\hyperlink{a01815_a2308f86b14266d7b7049b0a12cf20cdc}{NonLinearOperator}}([[maybe\_unused]] \textcolor{keyword}{const} TypeListOne\& derivativesFunctions,}
...
\DoxyCodeLine{173 \textcolor{keyword}{class }\mbox{\hyperlink{a00375_abcf5978fa18a6e0aadc5e19c4a0edaa9}{NonLinearOperator}}<Impl::Functions<DerivativeArgs...>, Impl::Parameter<ParameterArgs...>>}
\DoxyCodeLine{174 \{}
\DoxyCodeLine{175 \textcolor{keyword}{public}:}
\DoxyCodeLine{176   \textcolor{keyword}{using }FunctionReturnValues =}
\DoxyCodeLine{177       std::tuple<\mbox{\hyperlink{a00373_ga0ba1bf25ee478b1b1d9e96c1dcd831a0}{Ikarus::traits::ReturnType}}<DerivativeArgs, ParameterArgs\&...>...>; }
...
\DoxyCodeLine{212   explicit \mbox{\hyperlink{a01815_a2308f86b14266d7b7049b0a12cf20cdc}{NonLinearOperator}}(const Impl::Functions<DerivativeArgs...>\& derivativesFunctions,}
...
\DoxyCodeLine{216         derivativesEvaluated\_(\mbox{\hyperlink{a00375_ab346d8d79af81fa5312a67cd8b4e6d9a}{initResults}}(derivatives\_, args\_)) \{\}}
\DoxyCodeLine{217 }
\DoxyCodeLine{224   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Funcs>}
\DoxyCodeLine{225   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01815_a2308f86b14266d7b7049b0a12cf20cdc}{NonLinearOperator}}(\textcolor{keyword}{const} Funcs\& derivativesFunctions, \textcolor{keyword}{const} Impl::Parameter<ParameterArgs...>\& parameterI)}
\DoxyCodeLine{226       : derivatives\_\{derivativesFunctions.args\},}
\DoxyCodeLine{227         args\_\{parameterI.args\},}
\DoxyCodeLine{228         derivativesEvaluated\_(\mbox{\hyperlink{a00375_ab346d8d79af81fa5312a67cd8b4e6d9a}{initResults}}(derivatives\_, args\_)) \{\}}
\DoxyCodeLine{229 }
...
\DoxyCodeLine{355     \textcolor{keyword}{auto} fs = \mbox{\hyperlink{a00375_ab787b670f0d338c870988f417cf85f76}{functions}}([\&derivatives]() -\/> \textcolor{keyword}{decltype}(\textcolor{keyword}{auto}) \{ \textcolor{keywordflow}{return} std::get<Derivatives>(derivatives); \}()...);}
\DoxyCodeLine{356     \mbox{\hyperlink{a01815}{Ikarus::NonLinearOperator}}<Impl::Functions<std::tuple\_element\_t<Derivatives, \textcolor{keyword}{decltype}(derivatives\_)>...>,}
...
\DoxyCodeLine{365       std::is\_reference\_v<\mbox{\hyperlink{a00373_ga0ba1bf25ee478b1b1d9e96c1dcd831a0}{Ikarus::traits::ReturnType}}<DerivativeArgs, ParameterArgs\&...>>,}
\DoxyCodeLine{366       std::reference\_wrapper<std::remove\_reference\_t<\mbox{\hyperlink{a00373_ga0ba1bf25ee478b1b1d9e96c1dcd831a0}{Ikarus::traits::ReturnType}}<DerivativeArgs, ParameterArgs\&...>>>,}
\DoxyCodeLine{367       std::remove\_cvref\_t<\mbox{\hyperlink{a00373_ga0ba1bf25ee478b1b1d9e96c1dcd831a0}{Ikarus::traits::ReturnType}}<DerivativeArgs, ParameterArgs\&...>>>...>;}
\DoxyCodeLine{368 }
...
\DoxyCodeLine{382 \mbox{\hyperlink{a00375_abcf5978fa18a6e0aadc5e19c4a0edaa9}{NonLinearOperator}}(\textcolor{keyword}{const} Impl::Functions<DerivativeArgs\&\&...>\& a, \textcolor{keyword}{const} Impl::Parameter<ParameterArgs...>\& b)}
\DoxyCodeLine{383     -\/> \mbox{\hyperlink{a01815}{NonLinearOperator}}<Impl::Functions<DerivativeArgs...>, Impl::Parameter<ParameterArgs...>>;}
