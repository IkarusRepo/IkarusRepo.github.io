...
\DoxyCodeLine{12 }
\DoxyCodeLine{13 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00341}{Ikarus::utils}} \{}
\DoxyCodeLine{24 \textcolor{keyword}{template} <\textcolor{keywordtype}{int} size, \textcolor{keyword}{typename} LV>}
\DoxyCodeLine{25 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00323_gac0aa110e209c93e655de9df0915c2fcc}{obtainLagrangeNodePositions}}(\textcolor{keyword}{const} LV\& localView,}
\DoxyCodeLine{26                                  std::vector<\mbox{\hyperlink{a01520}{Dune::FieldVector<double, size>}}>\& lagrangeNodeCoords) \{}
\DoxyCodeLine{27   \textcolor{keyword}{static\_assert}(\mbox{\hyperlink{a01649}{Concepts::LagrangeNode}}<std::remove\_cvref\_t<\textcolor{keyword}{decltype}(localView.tree().child(0))>>,}
...
\DoxyCodeLine{34     \textcolor{keyword}{auto} ithCoord = [\&i](\textcolor{keyword}{const} \mbox{\hyperlink{a01520}{Dune::FieldVector<double, size>}}\& x) \{ \textcolor{keywordflow}{return} x[i]; \};}
...
\DoxyCodeLine{51 \textcolor{keyword}{auto} \mbox{\hyperlink{a00323_ga30df35336d19b00bc5db2a0b52ce650e}{referenceElementSubEntityPositions}}(FE\& fe, \textcolor{keywordtype}{int} codim) \{}
\DoxyCodeLine{52   \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} dim            = FE::Traits::mydim;}
\DoxyCodeLine{53   \textcolor{keyword}{const} \textcolor{keyword}{auto}\& element          = fe.gridElement();}
...
\DoxyCodeLine{69 \textcolor{keyword}{auto} \mbox{\hyperlink{a00323_ga8c05dce8a66fc4efbe31674b87d18298}{referenceElementVertexPositions}}(FE\& fe) \{}
\DoxyCodeLine{70   \textcolor{keywordflow}{return} \mbox{\hyperlink{a00323_ga30df35336d19b00bc5db2a0b52ce650e}{referenceElementSubEntityPositions}}(fe, FE::Traits::mydim);}
\DoxyCodeLine{71 \}}
\DoxyCodeLine{72 }
