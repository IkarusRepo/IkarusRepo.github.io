...
\DoxyCodeLine{10 \textcolor{preprocessor}{\#include "{}\mbox{\hyperlink{a00014}{concepts.hh}}"{}}}
\DoxyCodeLine{11 \textcolor{preprocessor}{\#include "{}\mbox{\hyperlink{a00017}{traits.hh}}"{}}}
\DoxyCodeLine{12 }
...
\DoxyCodeLine{24 }
\DoxyCodeLine{25 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00337}{Ikarus}} \{}
\DoxyCodeLine{26 }
\DoxyCodeLine{34 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Derived>}
\DoxyCodeLine{35 \textcolor{keyword}{auto} \mbox{\hyperlink{a00332_gaa33adfa2e95d7040a816bb2da81d275d}{orthonormalizeMatrixColumns}}(\textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& A) \{}
...
\DoxyCodeLine{57 \textcolor{keyword}{auto} \mbox{\hyperlink{a00332_ga545d74839895f4576a3b8c97d72abefd}{viewAsFlatEigenVector}}(Dune::BlockVector<ValueType>\& blockedVector) \{}
...
\DoxyCodeLine{72 \textcolor{keyword}{auto} \mbox{\hyperlink{a00332_ga545d74839895f4576a3b8c97d72abefd}{viewAsFlatEigenVector}}(\textcolor{keyword}{const} Dune::BlockVector<ValueType>\& blockedVector) \{}
...
\DoxyCodeLine{88 \textcolor{keyword}{auto} \mbox{\hyperlink{a00332_gaf9d7cf401f9f03ce1aae728c646ce178}{viewAsEigenMatrixAsDynFixed}}(Dune::BlockVector<ValueType>\& blockedVector) \{}
...
\DoxyCodeLine{104 \textcolor{keyword}{auto} \mbox{\hyperlink{a00332_gaf9d7cf401f9f03ce1aae728c646ce178}{viewAsEigenMatrixAsDynFixed}}(\textcolor{keyword}{const} Dune::BlockVector<ValueType>\& blockedVector) \{}
...
\DoxyCodeLine{120 \textcolor{keyword}{auto} \mbox{\hyperlink{a00332_gac25618d0e7c4aece653662d2541b61ec}{viewAsEigenMatrixFixedDyn}}(Dune::BlockVector<ValueType>\& blockedVector) \{}
...
\DoxyCodeLine{135 \textcolor{keyword}{auto} \mbox{\hyperlink{a00332_gac25618d0e7c4aece653662d2541b61ec}{viewAsEigenMatrixFixedDyn}}(\textcolor{keyword}{const} Dune::BlockVector<ValueType>\& blockedVector) \{}
...
\DoxyCodeLine{150 \textcolor{keywordtype}{size\_t} \mbox{\hyperlink{a00332_ga609664964681787f2f736f772b82a01e}{correctionSize}}(\textcolor{keyword}{const} Dune::BlockVector<Type>\& a)}
\DoxyCodeLine{151 \textcolor{keyword}{requires} \textcolor{keyword}{requires} \{ \mbox{\hyperlink{a00332_ga609664964681787f2f736f772b82a01e}{Type::correctionSize}}; \}}
\DoxyCodeLine{152 \{}
\DoxyCodeLine{153   \textcolor{keywordflow}{return} a.size() * \mbox{\hyperlink{a00332_ga609664964681787f2f736f772b82a01e}{Type::correctionSize}};}
\DoxyCodeLine{154 \}}
\DoxyCodeLine{155 }
\DoxyCodeLine{163 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Type>}
\DoxyCodeLine{164 \textcolor{keywordtype}{size\_t} \mbox{\hyperlink{a00332_gac1df27a0dfa864327029cdb906a1840c}{valueSize}}(\textcolor{keyword}{const} Dune::BlockVector<Type>\& a)}
\DoxyCodeLine{165 \textcolor{keyword}{requires} \textcolor{keyword}{requires} \{ \mbox{\hyperlink{a00332_gac1df27a0dfa864327029cdb906a1840c}{Type::valueSize}}; \}}
\DoxyCodeLine{166 \{}
\DoxyCodeLine{167   \textcolor{keywordflow}{return} a.size() * \mbox{\hyperlink{a00332_gac1df27a0dfa864327029cdb906a1840c}{Type::valueSize}};}
\DoxyCodeLine{168 \}}
\DoxyCodeLine{169 }
\DoxyCodeLine{179 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Type, \textcolor{keyword}{typename} Derived>}
\DoxyCodeLine{180 Dune::BlockVector<Type>\& \mbox{\hyperlink{a00332_ga09cedf6a65b142340c1934c987ed064c}{operator+=}}(Dune::BlockVector<Type>\& a, \textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& b)}
\DoxyCodeLine{181 \textcolor{keyword}{requires}(\mbox{\hyperlink{a01719}{Ikarus::Concepts::AddAssignAble}}<Type, \textcolor{keyword}{decltype}(b.template segment<Type::correctionSize>(0))> and}
\DoxyCodeLine{182          \textcolor{keyword}{requires}() \{ \mbox{\hyperlink{a00332_ga609664964681787f2f736f772b82a01e}{Type::correctionSize}}; \})}
\DoxyCodeLine{183 \{}
\DoxyCodeLine{184   assert(\mbox{\hyperlink{a00332_ga609664964681787f2f736f772b82a01e}{correctionSize}}(a) == \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{size\_t}\textcolor{keyword}{>}(b.size()) \&\& \textcolor{stringliteral}{"{} The passed vector has wrong size"{}});}
\DoxyCodeLine{185   \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} i = 0U; i < a.size(); ++i)}
\DoxyCodeLine{186     a[i] += b.template segment<Type::correctionSize>(i * \mbox{\hyperlink{a00332_ga609664964681787f2f736f772b82a01e}{Type::correctionSize}});}
...
\DoxyCodeLine{200 Dune::BlockVector<Type>\& \mbox{\hyperlink{a00332_ga90c40b4eebec59eeb02294cd7cb0470c}{operator-\/=}}(Dune::BlockVector<Type>\& a, \textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& b)}
\DoxyCodeLine{201 \textcolor{keyword}{requires}(\mbox{\hyperlink{a01719}{Ikarus::Concepts::AddAssignAble}}<Type, \textcolor{keyword}{decltype}(b.template segment<Type::correctionSize>(0))> and}
\DoxyCodeLine{202          \textcolor{keyword}{requires}() \{ \mbox{\hyperlink{a00332_ga609664964681787f2f736f772b82a01e}{Type::correctionSize}}; \})}
\DoxyCodeLine{203 \{}
...
\DoxyCodeLine{217 Dune::TupleVector<Types...>\& \mbox{\hyperlink{a00332_ga09cedf6a65b142340c1934c987ed064c}{operator+=}}(Dune::TupleVector<Types...>\& a, \textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& b) \{}
...
\DoxyCodeLine{221     \textcolor{keyword}{const} \textcolor{keywordtype}{size\_t} size = \mbox{\hyperlink{a00332_ga609664964681787f2f736f772b82a01e}{correctionSize}}(a[i]);}
...
\DoxyCodeLine{239 Dune::BlockVector<ManifoldPoint>\& \mbox{\hyperlink{a00332_gadab36ca6a3183fb9fedbb02b3ecba736}{addInEmbedding}}(Dune::BlockVector<ManifoldPoint>\& a,}
\DoxyCodeLine{240                                                  \textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& b)}
\DoxyCodeLine{241 \textcolor{keyword}{requires}(\mbox{\hyperlink{a01719}{Ikarus::Concepts::AddAssignAble}}<ManifoldPoint, \textcolor{keyword}{decltype}(b.template segment<ManifoldPoint::valueSize>(0))> and}
\DoxyCodeLine{242          \textcolor{keyword}{requires}() \{ \mbox{\hyperlink{a00332_gac1df27a0dfa864327029cdb906a1840c}{ManifoldPoint::valueSize}}; \})}
\DoxyCodeLine{243 \{}
\DoxyCodeLine{244   assert(\mbox{\hyperlink{a00332_gac1df27a0dfa864327029cdb906a1840c}{valueSize}}(a) == \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{size\_t}\textcolor{keyword}{>}(b.size()) \&\& \textcolor{stringliteral}{"{} The passed vector has wrong size"{}});}
\DoxyCodeLine{245   \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} i = 0U; i < a.size(); ++i)}
\DoxyCodeLine{246     a[i].\mbox{\hyperlink{a00332_gadab36ca6a3183fb9fedbb02b3ecba736}{addInEmbedding}}(b.template segment<ManifoldPoint::valueSize>(i * \mbox{\hyperlink{a00332_gac1df27a0dfa864327029cdb906a1840c}{ManifoldPoint::valueSize}}));}
...
\DoxyCodeLine{259 \textcolor{keyword}{auto} \mbox{\hyperlink{a00332_ga0ffc0c74dbd9aeee3e53b199a21b828c}{norm}}(\textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& v) \{}
\DoxyCodeLine{260   \textcolor{keywordflow}{return} v.norm();}
\DoxyCodeLine{261 \}}
\DoxyCodeLine{262 }
\DoxyCodeLine{269 \textcolor{keyword}{auto} \mbox{\hyperlink{a00332_ga0ffc0c74dbd9aeee3e53b199a21b828c}{norm}}(\textcolor{keyword}{const} std::floating\_point \textcolor{keyword}{auto}\& v) \{ \textcolor{keywordflow}{return} std::abs(v); \}}
\DoxyCodeLine{270 }
\DoxyCodeLine{280 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Scalar, \textcolor{keywordtype}{int} size>}
\DoxyCodeLine{281 \textcolor{keyword}{auto} \mbox{\hyperlink{a00332_gacbc60e06e8e43a9bc14660189eb1baa1}{operator*}}(\textcolor{keyword}{const} Eigen::DiagonalMatrix<Scalar, size>\& a, \textcolor{keyword}{const} Eigen::DiagonalMatrix<Scalar, size>\& b) \{}
...
\DoxyCodeLine{295 \textcolor{keyword}{auto} \mbox{\hyperlink{a00332_ga09cedf6a65b142340c1934c987ed064c}{operator+=}}(Eigen::DiagonalMatrix<Scalar, size>\& a, \textcolor{keyword}{const} Eigen::DiagonalMatrix<Scalar, size>\& b) \{}
...
\DoxyCodeLine{311 \textcolor{keyword}{auto} \mbox{\hyperlink{a00332_ga098b554b29619e0cea837f3daa6e0e30}{operator+}}(\textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& a, \textcolor{keyword}{const} Eigen::DiagonalMatrix<Scalar, size>\& b) \{}
...
\DoxyCodeLine{328 \textcolor{keyword}{auto} \mbox{\hyperlink{a00332_ga098b554b29619e0cea837f3daa6e0e30}{operator+}}(\textcolor{keyword}{const} Eigen::DiagonalMatrix<Scalar, size>\& a, \textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& b) \{}
...
\DoxyCodeLine{341 \textcolor{keyword}{auto} \mbox{\hyperlink{a00332_ga9ab6437d6235e378a6171bfffd4bf1cc}{operator-\/}}(\textcolor{keyword}{const} Eigen::DiagonalMatrix<Scalar, size>\& a) \{}
...
\DoxyCodeLine{355 \textcolor{keyword}{auto} \mbox{\hyperlink{a00332_ga098b554b29619e0cea837f3daa6e0e30}{operator+}}(\textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& a, \textcolor{keyword}{const} Eigen::DiagonalWrapper<Derived2>\& b) \{}
...
\DoxyCodeLine{371 \textcolor{keyword}{auto} \mbox{\hyperlink{a00332_ga098b554b29619e0cea837f3daa6e0e30}{operator+}}(\textcolor{keyword}{const} Eigen::DiagonalWrapper<Derived>\& a, \textcolor{keyword}{const} Eigen::MatrixBase<Derived2>\& b) \{}
...
\DoxyCodeLine{385 std::ostream\& \mbox{\hyperlink{a00332_gac2cdcc3047e59b91a4874a1355503cd5}{operator<<}}(std::ostream\& os, \textcolor{keyword}{const} Eigen::DiagonalMatrix<Scalar, size>\& a) \{}
...
\DoxyCodeLine{398 Derived \mbox{\hyperlink{a00332_gabd35ea7f69bcc71ee90ea421a1c48167}{sym}}(\textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& A) \{}
...
\DoxyCodeLine{410 Derived \mbox{\hyperlink{a00332_ga1496a9776a583f8b09c4244a68453394}{skew}}(\textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& A) \{}
...
\DoxyCodeLine{421 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00332_ga40c08050aff1e3e49e58c7823ecbcc77}{printForMaple}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01545}{Eigen::EigenBase<Derived>}}\& A) \{}
...
\DoxyCodeLine{427     \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00347}{Eigen}};}
...
\DoxyCodeLine{444 \textcolor{keyword}{auto} \mbox{\hyperlink{a00332_ga821ecf80e4a83241318d825f49cd79e4}{createRandomVector}}(\textcolor{keyword}{typename} FieldVectorT::value\_type lower = -\/1, \textcolor{keyword}{typename} FieldVectorT::value\_type upper = 1) \{}
...
\DoxyCodeLine{462 Eigen::Matrix<ScalarType, 3, 3> \mbox{\hyperlink{a00332_ga1496a9776a583f8b09c4244a68453394}{skew}}(\textcolor{keyword}{const} Eigen::Vector<ScalarType, 3>\& a) \{}
...
\DoxyCodeLine{483 \textcolor{keyword}{constexpr} \textcolor{keyword}{auto} \mbox{\hyperlink{a00332_ga8bdeefaffd49685e7dcd89f34af51d76}{voigtNotationContainer}} = std::get<dim -\/ 1>(Impl::voigtIndices);}
\DoxyCodeLine{484 }
...
\DoxyCodeLine{498 \textcolor{keyword}{auto} \mbox{\hyperlink{a00332_ga19d425a4fbc72c2ef7a97d71de9329a4}{staticCondensation}}(\textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& E,}
...
\DoxyCodeLine{526 \textcolor{keyword}{auto} \mbox{\hyperlink{a00332_ga2f675229501979101656ec4dee7764d5}{removeCol}}(\textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& E, \textcolor{keyword}{const} std::array<size\_t, sizeOfRemovedCols>\& indices) \{}
...
\DoxyCodeLine{552 \textcolor{keyword}{auto} \mbox{\hyperlink{a00332_ga378c5569b7b899586e7c8006fb776351}{toVoigtAndMaybeReduce}}(\textcolor{keyword}{const} Eigen::Matrix<ST, 3, 3>\& E, [[maybe\_unused]] \textcolor{keyword}{const} MaterialImpl\& material,}
...
\DoxyCodeLine{555     \textcolor{keywordflow}{return} \mbox{\hyperlink{a00333_ga4304655095296ce9283e012587817a51}{toVoigt}}(E, isStrain);}
\DoxyCodeLine{556   \textcolor{keywordflow}{else} \{}
\DoxyCodeLine{557     \textcolor{keyword}{auto} ev = \mbox{\hyperlink{a00333_ga4304655095296ce9283e012587817a51}{toVoigt}}(E, isStrain);}
...
\DoxyCodeLine{559 }
\DoxyCodeLine{560     \textcolor{keyword}{auto} evRed = \mbox{\hyperlink{a00332_ga2f675229501979101656ec4dee7764d5}{removeCol}}(ev, MaterialImpl::fixedVoigtIndices);}
...
\DoxyCodeLine{580 \textcolor{keyword}{decltype}(\textcolor{keyword}{auto}) \mbox{\hyperlink{a00332_ga30500f2c49b7d1997c7eb7b6ee90ad75}{enlargeIfReduced}}(\textcolor{keyword}{const} Eigen::MatrixBase<Derived>\& E) \{}
\DoxyCodeLine{581   \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (!Concepts::EigenVector6<Derived> and \mbox{\hyperlink{a01725}{Concepts::EigenVector<Derived>}}) \{}
