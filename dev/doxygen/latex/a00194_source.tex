\hypertarget{a00194_source}{}\doxysection{eas3d.\+hh}
\label{a00194_source}\index{eas3d.hh@{eas3d.hh}}
...
\DoxyCodeLine{24 \textcolor{keyword}{struct }\mbox{\hyperlink{a01271}{H1E9}}}
\DoxyCodeLine{25 \{}
\DoxyCodeLine{26   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01271_ae9198131bd07f28e06519c81d22020d1}{strainSize}}         = 6;}
\DoxyCodeLine{27   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01271_abae7fca7b5ca54582745e3444b1401c3}{enhancedStrainSize}} = 9;}
\DoxyCodeLine{28   \textcolor{keyword}{using }\mbox{\hyperlink{a01271_a4ebc7570a1a18ca9d2cc77d5d1d4a05f}{MType}}                             = Eigen::Matrix<double, strainSize, enhancedStrainSize>;}
\DoxyCodeLine{29 }
\DoxyCodeLine{30   \mbox{\hyperlink{a01271_af2ffc65346e400a7ce3cc5fb0a3be34a}{H1E9}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{31   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01271_a3b14b18f924c0b5000ec609d441239ac}{H1E9}}(\textcolor{keyword}{const} GEO\& geometry)}
...
\DoxyCodeLine{34 }
\DoxyCodeLine{35   \textcolor{keyword}{auto} \mbox{\hyperlink{a01271_adafa86c9c1ed38a3b165af332dfe2afc}{calcM}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01487}{Dune::FieldVector<double, 3>}}\& quadPos)\textcolor{keyword}{ const }\{}
\DoxyCodeLine{36     \mbox{\hyperlink{a01271_a4ebc7570a1a18ca9d2cc77d5d1d4a05f}{MType}} M;}
...
\DoxyCodeLine{68 \textcolor{keyword}{struct }\mbox{\hyperlink{a01275}{H1E21}}}
\DoxyCodeLine{69 \{}
\DoxyCodeLine{70   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01275_a19e3d9c840f9658f89195785a1b0f297}{strainSize}}         = 6;}
\DoxyCodeLine{71   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01275_a47e656c5d4423d24042884f4e55c69b5}{enhancedStrainSize}} = 21;}
\DoxyCodeLine{72   \textcolor{keyword}{using }\mbox{\hyperlink{a01275_a8c1fd9df374e95dded0e56da5c2ca5a5}{MType}}                             = Eigen::Matrix<double, strainSize, enhancedStrainSize>;}
\DoxyCodeLine{73 }
\DoxyCodeLine{74   \mbox{\hyperlink{a01275_a5017b24cf2908ad7c580a81c8c4ad30b}{H1E21}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{75   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01275_aca335ca86d7dab9633f751acac7978bc}{H1E21}}(\textcolor{keyword}{const} Geometry\& geometry\_)}
...
\DoxyCodeLine{78 }
\DoxyCodeLine{79   \textcolor{keyword}{auto} \mbox{\hyperlink{a01275_a941f708e558b767c8e5406e82cc40f61}{calcM}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01487}{Dune::FieldVector<double, 3>}}\& quadPos)\textcolor{keyword}{ const }\{}
\DoxyCodeLine{80     \mbox{\hyperlink{a01275_a8c1fd9df374e95dded0e56da5c2ca5a5}{MType}} M;}
