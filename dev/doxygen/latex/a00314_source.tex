\hypertarget{a00314_source}{}\doxysection{feresulttypes.\+hh}
\label{a00314_source}\index{feresulttypes.hh@{feresulttypes.hh}}
...
\DoxyCodeLine{11 }
\DoxyCodeLine{18 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00396}{Ikarus}} \{}
...
\DoxyCodeLine{26       \textcolor{keywordflow}{return} \mbox{\hyperlink{a00392_ga4304655095296ce9283e012587817a51}{toVoigt}}(mat.derived(), strainlike);}
\DoxyCodeLine{27     \}}
\DoxyCodeLine{28   \};}
\DoxyCodeLine{29 }
...
\DoxyCodeLine{48       \textcolor{keywordflow}{return} \mbox{\hyperlink{a00392_gadc8e9e9f3838d0392a5fcf1e11374ee9}{fromVoigt}}(vec.derived(), strainlike);}
\DoxyCodeLine{49     \}}
\DoxyCodeLine{50   \};}
\DoxyCodeLine{51 }
...
\DoxyCodeLine{121 }
\DoxyCodeLine{124 }
\DoxyCodeLine{125   \mbox{\hyperlink{a00403_a60454300a3ee8c6fdd19a7a62dce2202}{REGISTER\_SIMPLE\_SYMMETRIC\_RESULTTYPE}}(linearStress, worldDim, worldDim, \textcolor{keyword}{false});}
\DoxyCodeLine{126   \mbox{\hyperlink{a00403_a60454300a3ee8c6fdd19a7a62dce2202}{REGISTER\_SIMPLE\_SYMMETRIC\_RESULTTYPE}}(PK2Stress, worldDim, worldDim, \textcolor{keyword}{false});}
\DoxyCodeLine{127   \mbox{\hyperlink{a00403_a60454300a3ee8c6fdd19a7a62dce2202}{REGISTER\_SIMPLE\_SYMMETRIC\_RESULTTYPE}}(cauchyStress, worldDim, worldDim, \textcolor{keyword}{false});}
\DoxyCodeLine{128 }
\DoxyCodeLine{129   \textcolor{comment}{// The following resulttypes are for reduced materials to obtain the full 3D stress state}}
\DoxyCodeLine{130   \mbox{\hyperlink{a00403_a60454300a3ee8c6fdd19a7a62dce2202}{REGISTER\_SIMPLE\_SYMMETRIC\_RESULTTYPE}}(linearStressFull, 3, 3, \textcolor{keyword}{false});}
\DoxyCodeLine{131   \mbox{\hyperlink{a00403_a60454300a3ee8c6fdd19a7a62dce2202}{REGISTER\_SIMPLE\_SYMMETRIC\_RESULTTYPE}}(PK2StressFull, 3, 3, \textcolor{keyword}{false});}
\DoxyCodeLine{132   \mbox{\hyperlink{a00403_a60454300a3ee8c6fdd19a7a62dce2202}{REGISTER\_SIMPLE\_SYMMETRIC\_RESULTTYPE}}(cauchyStressFull, 3, 3, \textcolor{keyword}{false});}
\DoxyCodeLine{133 }
\DoxyCodeLine{134   \mbox{\hyperlink{a00403_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(director, worldDim, 1);}
\DoxyCodeLine{135   \mbox{\hyperlink{a00403_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(magnetization, worldDim, 1);}
\DoxyCodeLine{136   \mbox{\hyperlink{a00403_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(gradientNormOfMagnetization, 1, 1);}
\DoxyCodeLine{137   \mbox{\hyperlink{a00403_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(vectorPotential, worldDim, 1);}
\DoxyCodeLine{138   \mbox{\hyperlink{a00403_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(divergenceOfVectorPotential, 1, 1);}
\DoxyCodeLine{139 }
\DoxyCodeLine{140   \mbox{\hyperlink{a00403_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(BField, worldDim, 1);}
\DoxyCodeLine{141   \mbox{\hyperlink{a00403_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(HField, worldDim, 1);}
\DoxyCodeLine{142 }
\DoxyCodeLine{143   \mbox{\hyperlink{a00403_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(cauchyAxialForce, 1, 1);}
\DoxyCodeLine{144   \mbox{\hyperlink{a00403_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(PK2AxialForce, 1, 1);}
\DoxyCodeLine{145   \mbox{\hyperlink{a00403_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(linearAxialForce, 1, 1);}
\DoxyCodeLine{146 }
\DoxyCodeLine{147   \mbox{\hyperlink{a00403_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(customType, Eigen::Dynamic, Eigen::Dynamic);}
\DoxyCodeLine{148 \} \textcolor{comment}{// namespace ResultTypes}}
\DoxyCodeLine{149 }
\DoxyCodeLine{150 \textcolor{keyword}{enum class} \mbox{\hyperlink{a00396_acfb09bb7db104db62d3d1d2dc3e009b2}{ResultShape}}}
\DoxyCodeLine{151 \{}
\DoxyCodeLine{152   \mbox{\hyperlink{a00396_acfb09bb7db104db62d3d1d2dc3e009b2a57dea6f5039281b7fee517fc43bf3110}{Vector}},}
\DoxyCodeLine{153   \mbox{\hyperlink{a00396_acfb09bb7db104db62d3d1d2dc3e009b2af53df0293e169f562bc1d9a20e1d2589}{Matrix}}}
\DoxyCodeLine{154 \};}
\DoxyCodeLine{155 }
\DoxyCodeLine{162 \textcolor{keyword}{template} <\textcolor{keyword}{typename} RT, ResultShape storedResultShape = ResultShape::Vector>}
\DoxyCodeLine{163 \textcolor{keyword}{struct }\mbox{\hyperlink{a01411}{ResultWrapper}} : RT}
\DoxyCodeLine{164 \{}
...
\DoxyCodeLine{169   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{bool} storedValueIsVector       = storedResultShape == \mbox{\hyperlink{a00396_acfb09bb7db104db62d3d1d2dc3e009b2a57dea6f5039281b7fee517fc43bf3110}{ResultShape::Vector}};}
\DoxyCodeLine{170 }
\DoxyCodeLine{171 \textcolor{keyword}{public}:}
\DoxyCodeLine{172   \textcolor{keyword}{using }\mbox{\hyperlink{a01411_ad2e94e390a1a328d7abd8006f29dbbd2}{VecType}} = std::invoke\_result\_t<\textcolor{keyword}{decltype}(\&RT::Vectorizer::template transform<ResultTypeValueType>),}
\DoxyCodeLine{173                                        \textcolor{keyword}{const} ResultTypeValueType\&>;}
\DoxyCodeLine{174   \textcolor{keyword}{using }\mbox{\hyperlink{a01411_a3be8a4f7e4b67bc2bb90a826c1ed7c85}{MatType}} =}
...
\DoxyCodeLine{176                            \textcolor{keyword}{const} \mbox{\hyperlink{a01411_ad2e94e390a1a328d7abd8006f29dbbd2}{VecType}}\&, \textcolor{keywordtype}{int}, \textcolor{keywordtype}{int}>;}
\DoxyCodeLine{177   \textcolor{keyword}{using }\mbox{\hyperlink{a01411_a1baf31b4a8525d6b81860c8f0a0b6a84}{StoredType}} = std::conditional\_t<storedValueIsVector, VecType, MatType>;}
\DoxyCodeLine{178   \textcolor{keyword}{using }\mbox{\hyperlink{a01411_aef0efc55342d144366f8eddbc6fe00f9}{ResultType}} = RT;}
\DoxyCodeLine{179 }
\DoxyCodeLine{184   \textcolor{keyword}{auto} \mbox{\hyperlink{a01411_ae1be56ef0981f28e1dfa4f77453251d3}{asVec}}()\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{189   \}}
\DoxyCodeLine{190 }
\DoxyCodeLine{197   \textcolor{keyword}{auto} \mbox{\hyperlink{a01411_ae5c30a9c8da8fe6bb01b1cee0fc43155}{asMat}}(Eigen::Index rows = rowsAtCompileTime, Eigen::Index cols = colsAtCompileTime)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{210   \}}
\DoxyCodeLine{211   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01411_a826dcccf70e97474b01126970e2839ac}{ResultWrapper}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{212   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01411_a623510c28007eb075ed7719de10562b2}{ResultWrapper}}(\mbox{\hyperlink{a01411_a1baf31b4a8525d6b81860c8f0a0b6a84}{StoredType}}\&\& value) \{ this-\/>value\_ = std::move(value); \}}
\DoxyCodeLine{213   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01411_ae3ec0250a8cce10dae2b6eacec3ffe11}{ResultWrapper}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01411_a1baf31b4a8525d6b81860c8f0a0b6a84}{StoredType}}\& value) \{ this-\/>value\_ = value; \}}
\DoxyCodeLine{214   \mbox{\hyperlink{a01411}{ResultWrapper}}\& \mbox{\hyperlink{a01411_adbc957bfc9a97390ce57d778dd7c91a1}{operator=}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01411_a1baf31b4a8525d6b81860c8f0a0b6a84}{StoredType}}\& value) \{}
\DoxyCodeLine{215     this-\/>value\_ = value;}
\DoxyCodeLine{216     \textcolor{keywordflow}{return} *\textcolor{keyword}{this};}
\DoxyCodeLine{217   \}}
\DoxyCodeLine{218   \mbox{\hyperlink{a01411}{ResultWrapper}}\& \mbox{\hyperlink{a01411_a6a1deb7c814879d79eaa5fe467666b2f}{operator=}}(\mbox{\hyperlink{a01411_a1baf31b4a8525d6b81860c8f0a0b6a84}{StoredType}}\&\& value) \{}
...
\DoxyCodeLine{224   \mbox{\hyperlink{a01411_a1baf31b4a8525d6b81860c8f0a0b6a84}{StoredType}} value\_\{\};}
\DoxyCodeLine{225 \};}
\DoxyCodeLine{226 }
...
\DoxyCodeLine{238 \textcolor{keyword}{auto} \mbox{\hyperlink{a00396_a38629395c2d43ba44328b01ce0c0daf3}{makeRT}}() \{}
...
\DoxyCodeLine{248 \textcolor{keyword}{auto} \mbox{\hyperlink{a00396_aef80b6b5b45dcfbea4f722f51a84f53f}{toString}}() \{}
\DoxyCodeLine{249   \textcolor{keywordflow}{return} \mbox{\hyperlink{a00396_aef80b6b5b45dcfbea4f722f51a84f53f}{toString}}(Impl::DummyRT<RT>\{\});}
\DoxyCodeLine{250 \}}
\DoxyCodeLine{251 }
...
\DoxyCodeLine{258 \textcolor{keyword}{constexpr} \textcolor{keyword}{static} \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00396_aae9d6a05f2ca4f54c0524404e27e7ed1}{isSameResultType}} = std::is\_same\_v<Impl::DummyRT<RT1>, Impl::DummyRT<RT2>>;}
\DoxyCodeLine{259 }
...
\DoxyCodeLine{265   \textcolor{keyword}{struct }hasType<T, \mbox{\hyperlink{a00395}{std}}::tuple<Us...>> : std::disjunction<std::is\_same<T, Us>...>}
\DoxyCodeLine{266   \{}
\DoxyCodeLine{267   \};}
...
\DoxyCodeLine{276 \textcolor{keyword}{struct }\mbox{\hyperlink{a01423}{ResultTypeBase}}}
\DoxyCodeLine{277 \{}
...
\DoxyCodeLine{283   \textcolor{keyword}{static} \textcolor{keyword}{consteval} \textcolor{keywordtype}{bool} \mbox{\hyperlink{a01423_af33553a01e6940265639d561c31b7746}{supportsResultType}}() \{}
\DoxyCodeLine{284     \textcolor{keywordflow}{return} Impl::hasType<decltype(makeRT<RT>()), \mbox{\hyperlink{a01423_ac43d0000154d9bd08d7fdce3c279ccbb}{SupportedResultTypes}}>::value;}
\DoxyCodeLine{285   \}}
\DoxyCodeLine{286 }
\DoxyCodeLine{287   \textcolor{keyword}{using }\mbox{\hyperlink{a01423_ac43d0000154d9bd08d7fdce3c279ccbb}{SupportedResultTypes}} = std::tuple<decltype(makeRT<ResultTypes>())...>;}
\DoxyCodeLine{288 \};}
\DoxyCodeLine{289 }
