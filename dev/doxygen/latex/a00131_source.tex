...
\DoxyCodeLine{51 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00372_a0c58c17676c73945cb11eff8a80309ae}{registerCalculateAt}}(pybind11::handle scope, pybind11::class\_<FE, options...> cls, \textcolor{keyword}{auto} resultTypesTuple) \{}
...
\DoxyCodeLine{135       [](\mbox{\hyperlink{a01309}{FE}}\& self) -\/> LocalViewWrapper \{}
\DoxyCodeLine{136         \textcolor{keyword}{auto} lvWrapped = LocalViewWrapper(self.\mbox{\hyperlink{a01309_a1425316afd592244682b9ccc48cf59ef}{localView}}().globalBasis());}
...
\DoxyCodeLine{140         lvWrapped.base().bind(self.\mbox{\hyperlink{a01309_a1425316afd592244682b9ccc48cf59ef}{localView}}().element());}
\DoxyCodeLine{141         \textcolor{keywordflow}{return} lvWrapped;}
\DoxyCodeLine{142       \},}
\DoxyCodeLine{143       pybind11::keep\_alive<0, 1>());}
\DoxyCodeLine{144 }
\DoxyCodeLine{145   \mbox{\hyperlink{a00372_a0c58c17676c73945cb11eff8a80309ae}{registerCalculateAt}}(scope, cls, \textcolor{keyword}{typename} \mbox{\hyperlink{a01489_ada59c15363d83f6e635ecd6e1672d6a4}{FE::SupportedResultTypes}}());}
\DoxyCodeLine{146   \mbox{\hyperlink{a00372_a32c3989a8ef1dbc581313ef17a0c6f5b}{registerFERequirement}}(scope, cls);}
\DoxyCodeLine{147 \}}
\DoxyCodeLine{148 }
