\hypertarget{a00131_source}{}\doxysection{fehelper.\+hh}
\label{a00131_source}\index{fehelper.hh@{fehelper.hh}}
...
\DoxyCodeLine{7 }
\DoxyCodeLine{8 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00059}{ikarus/utils/traversal.hh}}>}}
\DoxyCodeLine{9 }
\DoxyCodeLine{10 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00331}{Ikarus::FEHelper}} \{}
\DoxyCodeLine{23 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Traits, \textcolor{keyword}{typename} ST>}
\DoxyCodeLine{24 \textcolor{keyword}{auto} \mbox{\hyperlink{a00331_a98c9e3d7c5cc47d0c177684a18a41bd5}{localSolutionBlockVector}}(\textcolor{keyword}{const} \textcolor{keyword}{typename} Traits::FERequirementType::SolutionVectorTypeRaw\& x,}
...
\DoxyCodeLine{54                        std::vector<typename LocalView::MultiIndex>\& \mbox{\hyperlink{a00331_a44e16df41148f7e4538be224814a3423}{globalIndices}}) \{}
...
\DoxyCodeLine{57       \mbox{\hyperlink{a00331_a44e16df41148f7e4538be224814a3423}{globalIndices}}.push\_back(localView.index(node.localIndex(i)));}
\DoxyCodeLine{58   \}}
\DoxyCodeLine{59 }
...
\DoxyCodeLine{72                         std::vector<typename LocalView::MultiIndex>\& \mbox{\hyperlink{a00331_a44e16df41148f7e4538be224814a3423}{globalIndices}}) \{}
...
\DoxyCodeLine{77         \mbox{\hyperlink{a00331_a44e16df41148f7e4538be224814a3423}{globalIndices}}.push\_back(localView.index(node.child(j).localIndex(i)));}
\DoxyCodeLine{78   \}}
...
\DoxyCodeLine{90 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00331_a2a4ac5503d4288b339457aae427ff661}{globalIndicesFromLocalView}}(\textcolor{keyword}{const} LocalView\& localView,}
\DoxyCodeLine{91                                 std::vector<typename LocalView::MultiIndex>\& \mbox{\hyperlink{a00331_a44e16df41148f7e4538be224814a3423}{globalIndices}}) \{}
\DoxyCodeLine{92   \mbox{\hyperlink{a00331_a44e16df41148f7e4538be224814a3423}{globalIndices}}.clear();}
...
\DoxyCodeLine{97     leafNodeIndices(localView, node, \mbox{\hyperlink{a00331_a44e16df41148f7e4538be224814a3423}{globalIndices}});}
\DoxyCodeLine{98   \};}
\DoxyCodeLine{99 }
...
\DoxyCodeLine{101     powerNodeIndices(localView, node, \mbox{\hyperlink{a00331_a44e16df41148f7e4538be224814a3423}{globalIndices}});}
\DoxyCodeLine{102   \};}
\DoxyCodeLine{103 }
\DoxyCodeLine{104   \mbox{\hyperlink{a00341_a63742d75d099b93da7ddf6e78a3c1f56}{utils::forEachLeafOrPowerLeafNode}}(localView.tree(), Dune::TypeTree::hybridTreePath(), powerOpFunc, leafOpFunc);}
\DoxyCodeLine{105 \}}
\DoxyCodeLine{106 }
\DoxyCodeLine{118 \textcolor{keyword}{template} <\textcolor{keyword}{typename} FiniteElement>}
\DoxyCodeLine{119 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00331_a44e16df41148f7e4538be224814a3423}{globalIndices}}(\textcolor{keyword}{const} FiniteElement\& fe, std::vector<typename FiniteElement::LocalView::MultiIndex>\& \mbox{\hyperlink{a00331_a44e16df41148f7e4538be224814a3423}{globalIndices}}) \{}
\DoxyCodeLine{120   \mbox{\hyperlink{a00331_a2a4ac5503d4288b339457aae427ff661}{globalIndicesFromLocalView}}(fe.localView(), \mbox{\hyperlink{a00331_a44e16df41148f7e4538be224814a3423}{globalIndices}});}
\DoxyCodeLine{121 \}}
