...
\DoxyCodeLine{12 }
\DoxyCodeLine{13 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00363}{Ikarus::FEHelper}} \{}
...
\DoxyCodeLine{28 \textcolor{keyword}{auto} \mbox{\hyperlink{a00363_a899043a23720a93e6ce9be9025c3a4bb}{localSolutionBlockVector}}(}
...
\DoxyCodeLine{61                        std::vector<typename LocalView::MultiIndex>\& \mbox{\hyperlink{a00363_a44e16df41148f7e4538be224814a3423}{globalIndices}}) \{}
...
\DoxyCodeLine{64       \mbox{\hyperlink{a00363_a44e16df41148f7e4538be224814a3423}{globalIndices}}.push\_back(localView.index(node.localIndex(i)));}
\DoxyCodeLine{65   \}}
\DoxyCodeLine{66 }
...
\DoxyCodeLine{79                         std::vector<typename LocalView::MultiIndex>\& \mbox{\hyperlink{a00363_a44e16df41148f7e4538be224814a3423}{globalIndices}}) \{}
...
\DoxyCodeLine{84         \mbox{\hyperlink{a00363_a44e16df41148f7e4538be224814a3423}{globalIndices}}.push\_back(localView.index(node.child(j).localIndex(i)));}
\DoxyCodeLine{85   \}}
...
\DoxyCodeLine{97 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00363_a2a4ac5503d4288b339457aae427ff661}{globalIndicesFromLocalView}}(\textcolor{keyword}{const} LocalView\& localView,}
\DoxyCodeLine{98                                 std::vector<typename LocalView::MultiIndex>\& \mbox{\hyperlink{a00363_a44e16df41148f7e4538be224814a3423}{globalIndices}}) \{}
\DoxyCodeLine{99   assert(localView.bound());}
\DoxyCodeLine{100   \mbox{\hyperlink{a00363_a44e16df41148f7e4538be224814a3423}{globalIndices}}.clear();}
...
\DoxyCodeLine{105     leafNodeIndices(localView, node, \mbox{\hyperlink{a00363_a44e16df41148f7e4538be224814a3423}{globalIndices}});}
\DoxyCodeLine{106   \};}
\DoxyCodeLine{107 }
...
\DoxyCodeLine{109     powerNodeIndices(localView, node, \mbox{\hyperlink{a00363_a44e16df41148f7e4538be224814a3423}{globalIndices}});}
\DoxyCodeLine{110   \};}
\DoxyCodeLine{111 }
\DoxyCodeLine{112   \mbox{\hyperlink{a00374_a63742d75d099b93da7ddf6e78a3c1f56}{utils::forEachLeafOrPowerLeafNode}}(localView.tree(), Dune::TypeTree::hybridTreePath(), powerOpFunc, leafOpFunc);}
\DoxyCodeLine{113 \}}
\DoxyCodeLine{114 }
\DoxyCodeLine{126 \textcolor{keyword}{template} <\textcolor{keyword}{typename} FiniteElement>}
\DoxyCodeLine{127 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00363_a44e16df41148f7e4538be224814a3423}{globalIndices}}(\textcolor{keyword}{const} FiniteElement\& fe, std::vector<typename FiniteElement::LocalView::MultiIndex>\& \mbox{\hyperlink{a00363_a44e16df41148f7e4538be224814a3423}{globalIndices}}) \{}
\DoxyCodeLine{128   \mbox{\hyperlink{a00363_a2a4ac5503d4288b339457aae427ff661}{globalIndicesFromLocalView}}(fe.localView(), \mbox{\hyperlink{a00363_a44e16df41148f7e4538be224814a3423}{globalIndices}});}
\DoxyCodeLine{129 \}}
