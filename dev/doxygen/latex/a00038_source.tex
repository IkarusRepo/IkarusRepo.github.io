...
\DoxyCodeLine{22 }
\DoxyCodeLine{23 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00338}{Eigen}} \{}
\DoxyCodeLine{24 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Derived>}
\DoxyCodeLine{25 \textcolor{keyword}{struct }\mbox{\hyperlink{a01488}{EigenBase}};}
\DoxyCodeLine{26 \}}
\DoxyCodeLine{27 }
\DoxyCodeLine{28 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00328}{Ikarus}} \{}
...
\DoxyCodeLine{33 \textcolor{keyword}{auto} \mbox{\hyperlink{a00328_ac2c6469be19ce4ef2e630bfa1c5a5e24}{transpose}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01488}{Eigen::EigenBase<Derived>}}\& A);}
...
\DoxyCodeLine{45   \textcolor{keyword}{concept }\mbox{\hyperlink{a01648}{FlatInterLeavedBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{77   \textcolor{keyword}{concept }\mbox{\hyperlink{a01649}{LagrangeNode}} = Impl::LagrangeNodeHelper<Dune::Functions::LagrangeNode, N>::value;}
\DoxyCodeLine{78 }
\DoxyCodeLine{86   \textcolor{keyword}{template} <\textcolor{keyword}{typename} N, \textcolor{keywordtype}{int} order>}
\DoxyCodeLine{87   \textcolor{keyword}{concept }\mbox{\hyperlink{a01650}{LagrangeNodeOfOrder}} = Impl::LagrangeNodeHelperOfOrder<Dune::Functions::LagrangeNode, N, order>::value;}
\DoxyCodeLine{88 }
\DoxyCodeLine{97   \textcolor{keyword}{template} <\textcolor{keyword}{typename} B>}
\DoxyCodeLine{98   \textcolor{keyword}{concept }\mbox{\hyperlink{a01651}{FlatLexicographicBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{111   \textcolor{keyword}{concept }\mbox{\hyperlink{a01652}{FlatIndexBasis}} = \mbox{\hyperlink{a01651}{FlatLexicographicBasis<B>}} or \mbox{\hyperlink{a01648}{FlatInterLeavedBasis<B>}};}
\DoxyCodeLine{112 }
\DoxyCodeLine{121   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Basis>}
\DoxyCodeLine{122   \textcolor{keyword}{concept }\mbox{\hyperlink{a01653}{BlockedInterLeavedBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{135   \textcolor{keyword}{concept }\mbox{\hyperlink{a01654}{BlockedLexicographicBasis}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{145   \textcolor{keyword}{concept }\mbox{\hyperlink{a01655}{DuneLocalBasis}} = \textcolor{keyword}{requires}(DLB\& duneLocalBasis) \{}
...
\DoxyCodeLine{170   \textcolor{keyword}{concept }\mbox{\hyperlink{a01656}{BlockedIndexBasis}} = \mbox{\hyperlink{a01654}{BlockedLexicographicBasis<B>}} or \mbox{\hyperlink{a01653}{BlockedInterLeavedBasis<B>}};}
\DoxyCodeLine{171 }
...
\DoxyCodeLine{180   \textcolor{keyword}{concept }\mbox{\hyperlink{a01657}{PathFollowingStrategy}} = \textcolor{keyword}{requires}(PF pft, NLO nop, SA args) \{}
...
\DoxyCodeLine{195   \textcolor{keyword}{concept }\mbox{\hyperlink{a01658}{AdaptiveStepSizingStrategy}} = \textcolor{keyword}{requires}(ASS adaptiveStepSizing, NLSI info, SA args, NonLinearOperator nop) \{}
...
\DoxyCodeLine{210   \textcolor{keyword}{concept }\mbox{\hyperlink{a01659}{LinearSolverCheck}} = \textcolor{keyword}{requires}(LS\& linearSolver, M\& A, V\& vec) \{}
...
\DoxyCodeLine{224   \textcolor{keyword}{concept }\mbox{\hyperlink{a01660}{NonLinearSolverCheckForPathFollowing}} = \textcolor{keyword}{requires} \{}
...
\DoxyCodeLine{241   \textcolor{keyword}{concept }\mbox{\hyperlink{a01661}{MultiplyAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x* y; \};}
\DoxyCodeLine{242 }
\DoxyCodeLine{250   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{251   \textcolor{keyword}{concept }\mbox{\hyperlink{a01662}{AddAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x + y; \};}
\DoxyCodeLine{252 }
\DoxyCodeLine{260   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{261   \textcolor{keyword}{concept }\mbox{\hyperlink{a01663}{SubstractAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x -\/ y; \};}
\DoxyCodeLine{262 }
\DoxyCodeLine{271   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{272   \textcolor{keyword}{concept }\mbox{\hyperlink{a01664}{MultiplyAssignAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x *= y; \};}
\DoxyCodeLine{273 }
\DoxyCodeLine{282   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{283   \textcolor{keyword}{concept }\mbox{\hyperlink{a01665}{DivideAssignAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x /= y; \};}
\DoxyCodeLine{284 }
\DoxyCodeLine{293   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{294   \textcolor{keyword}{concept }\mbox{\hyperlink{a01666}{AddAssignAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x += y; \};}
\DoxyCodeLine{295 }
\DoxyCodeLine{304   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{305   \textcolor{keyword}{concept }\mbox{\hyperlink{a01667}{SubstractAssignAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x -\/= y; \};}
\DoxyCodeLine{306 }
\DoxyCodeLine{314   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L, \textcolor{keyword}{typename} R>}
\DoxyCodeLine{315   \textcolor{keyword}{concept }\mbox{\hyperlink{a01668}{DivideAble}} = \textcolor{keyword}{requires}(L x, R y) \{ x / y; \};}
\DoxyCodeLine{316 }
\DoxyCodeLine{323   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L>}
\DoxyCodeLine{324   \textcolor{keyword}{concept }\mbox{\hyperlink{a01669}{NegateAble}} = \textcolor{keyword}{requires}(L x) \{ -\/x; \};}
\DoxyCodeLine{325 }
\DoxyCodeLine{332   \textcolor{keyword}{template} <\textcolor{keyword}{typename} L>}
\DoxyCodeLine{333   \textcolor{keyword}{concept }\mbox{\hyperlink{a01670}{TransposeAble}} = \textcolor{keyword}{requires}(L x) \{ \mbox{\hyperlink{a00328_ac2c6469be19ce4ef2e630bfa1c5a5e24}{transpose}}(x); \};}
\DoxyCodeLine{334 }
\DoxyCodeLine{342   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Op, \textcolor{keyword}{typename}... Args>}
\DoxyCodeLine{343   \textcolor{keyword}{concept }\mbox{\hyperlink{a01671}{IsFunctorWithArgs}} = \textcolor{keyword}{requires}(Op op, Args... args) \{ op(args...); \};}
\DoxyCodeLine{344 }
\DoxyCodeLine{352   \textcolor{keyword}{template} <\textcolor{keyword}{typename} V>}
\DoxyCodeLine{353   \textcolor{keyword}{concept }\mbox{\hyperlink{a01672}{EigenVector}} = \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{bool}\textcolor{keyword}{>}(V::IsVectorAtCompileTime);}
\DoxyCodeLine{354 }
...
\DoxyCodeLine{445 \textcolor{comment}{}  \textcolor{keyword}{template} <\textcolor{keyword}{template} <\textcolor{keyword}{typename}...> \textcolor{keyword}{class }MaterialToCheck, \textcolor{keyword}{typename} \mbox{\hyperlink{a00317_gga05ac785124262c1e323d2f937d520a1bad92a8333dd3ccb895cc65f7455b71206}{Material}}>}
\DoxyCodeLine{446   \textcolor{keyword}{concept }\mbox{\hyperlink{a01673}{IsMaterial}} = Impl::isMaterial<MaterialToCheck, Material>();}
\DoxyCodeLine{447 }
