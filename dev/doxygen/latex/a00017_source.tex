...
\DoxyCodeLine{181 \textcolor{keyword}{requires}(\mbox{\hyperlink{a01646}{Ikarus::Concepts::AddAssignAble}}<Type, \textcolor{keyword}{decltype}(b.template segment<Type::correctionSize>(0))> and}
...
\DoxyCodeLine{201 \textcolor{keyword}{requires}(\mbox{\hyperlink{a01646}{Ikarus::Concepts::AddAssignAble}}<Type, \textcolor{keyword}{decltype}(b.template segment<Type::correctionSize>(0))> and}
...
\DoxyCodeLine{241 \textcolor{keyword}{requires}(\mbox{\hyperlink{a01646}{Ikarus::Concepts::AddAssignAble}}<ManifoldPoint, \textcolor{keyword}{decltype}(b.template segment<ManifoldPoint::valueSize>(0))> and}
...
\DoxyCodeLine{421 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00320_ga40c08050aff1e3e49e58c7823ecbcc77}{printForMaple}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01470}{Eigen::EigenBase<Derived>}}\& A) \{}
...
\DoxyCodeLine{581   \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (!Concepts::EigenVector6<Derived> and \mbox{\hyperlink{a01652}{Concepts::EigenVector<Derived>}}) \{}
\DoxyCodeLine{582     \textcolor{keyword}{static\_assert}(\mbox{\hyperlink{a01318_a9c276dd6faf7062d02dde5c01644fd10}{Material::isReduced}}, \textcolor{stringliteral}{"{}You should only end up here, if your material is reduced"{}});}
\DoxyCodeLine{583 }
...
\DoxyCodeLine{594     \textcolor{keyword}{static\_assert}(\mbox{\hyperlink{a01318_a9c276dd6faf7062d02dde5c01644fd10}{Material::isReduced}}, \textcolor{stringliteral}{"{}You should only end up here, if your material is reduced"{}});}
\DoxyCodeLine{595 }
