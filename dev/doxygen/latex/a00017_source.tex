...
\DoxyCodeLine{64 \textcolor{keyword}{requires}(std::convertible\_to<F, std::function<bool(\textcolor{keywordtype}{int}, \mbox{\hyperlink{a01784}{Dune::FieldVector<double, size>}} \&\&)>>)}
...
\DoxyCodeLine{66   \textcolor{keyword}{static\_assert}(\mbox{\hyperlink{a01945}{Concepts::LagrangeNode}}<std::remove\_cvref\_t<\textcolor{keyword}{decltype}(localView.tree().child(0))>>,}
...
\DoxyCodeLine{74     \textcolor{keyword}{auto} ithCoord = [\&i](\textcolor{keyword}{const} \mbox{\hyperlink{a01784}{Dune::FieldVector<double, size>}}\& x) \{ \textcolor{keywordflow}{return} x[i]; \};}
