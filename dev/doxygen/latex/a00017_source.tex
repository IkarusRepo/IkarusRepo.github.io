...
\DoxyCodeLine{181 \textcolor{keyword}{requires}(\mbox{\hyperlink{a01636}{Ikarus::Concepts::AddAssignAble}}<Type, \textcolor{keyword}{decltype}(b.template segment<Type::correctionSize>(0))> and}
...
\DoxyCodeLine{201 \textcolor{keyword}{requires}(\mbox{\hyperlink{a01636}{Ikarus::Concepts::AddAssignAble}}<Type, \textcolor{keyword}{decltype}(b.template segment<Type::correctionSize>(0))> and}
...
\DoxyCodeLine{241 \textcolor{keyword}{requires}(\mbox{\hyperlink{a01636}{Ikarus::Concepts::AddAssignAble}}<ManifoldPoint, \textcolor{keyword}{decltype}(b.template segment<ManifoldPoint::valueSize>(0))> and}
...
\DoxyCodeLine{421 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00311_ga40c08050aff1e3e49e58c7823ecbcc77}{printForMaple}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01460}{Eigen::EigenBase<Derived>}}\& A) \{}
...
\DoxyCodeLine{581   \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (!Concepts::EigenVector6<Derived> and \mbox{\hyperlink{a01642}{Concepts::EigenVector<Derived>}}) \{}
