...
\DoxyCodeLine{16 }
\DoxyCodeLine{17 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00343}{Python}} \{}
...
\DoxyCodeLine{33   \};}
\DoxyCodeLine{34 }
\DoxyCodeLine{40   \textcolor{keyword}{static} \textcolor{keywordtype}{void} \mbox{\hyperlink{a01580_aab78500f06d24b5eb1cd894b68eec03c}{toC}}(PyObject* list, autodiff::Real<order, T>\& v) \{}
...
\DoxyCodeLine{50   \}}
\DoxyCodeLine{51 }
\DoxyCodeLine{57   \textcolor{keyword}{static} PyObject* \mbox{\hyperlink{a01580_ae7c12c134c747ccf36ff0bf9c453f69e}{toPy}}(\textcolor{keyword}{const} autodiff::Real<order, T>\& v) \{}
