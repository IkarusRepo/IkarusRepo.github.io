...
\DoxyCodeLine{31   \textcolor{keyword}{class }\mbox{\hyperlink{a01206}{AutoDiffFE}} : \textcolor{keyword}{public} RealFE\_ \{}
\DoxyCodeLine{32   \textcolor{keyword}{public}:}
\DoxyCodeLine{33     \textcolor{keyword}{using }\mbox{\hyperlink{a01206_ae3eeda5463148aeab6bec5e774791384}{RealFE}}            = RealFE\_;                 }
\DoxyCodeLine{34     \textcolor{keyword}{using }\mbox{\hyperlink{a01206_a89a700073503fa0567afbcb5f4638b7e}{Basis}}             = \textcolor{keyword}{typename} RealFE::Basis;  }
\DoxyCodeLine{35     \textcolor{keyword}{using }\mbox{\hyperlink{a01330}{Traits}}            = \mbox{\hyperlink{a01330}{TraitsFromFE<Basis, FERequirementType\_, useEigenRef>}};  }
\DoxyCodeLine{36     \textcolor{keyword}{using }\mbox{\hyperlink{a01206_a7a35e87063266fd105193cbde16286fe}{LocalView}}         = \textcolor{keyword}{typename} \mbox{\hyperlink{a01330_a36437741d63f3d325f363c8df4d2aac5}{Traits::LocalView}};                            }
\DoxyCodeLine{37     \textcolor{keyword}{using }\mbox{\hyperlink{a01206_a13e58c2d0abbeccf2ae33f94d0f335b8}{Element}}           = \textcolor{keyword}{typename} \mbox{\hyperlink{a01330_a179f7c62c0c2fef548d7ae31705de71e}{Traits::Element}};                              }
\DoxyCodeLine{38     \textcolor{keyword}{using }\mbox{\hyperlink{a01206_a89666ec5f15efd5047f9bd4734b9da67}{FERequirementType}} = \textcolor{keyword}{typename} \mbox{\hyperlink{a01330_ae29466435644541bf50d0f8fecbac1dd}{Traits::FERequirementType}};  }
\DoxyCodeLine{39 }
\DoxyCodeLine{46     \textcolor{keywordtype}{void} \mbox{\hyperlink{a01206_a2650fc875e359aab7e22e59ccbed53f8}{calculateMatrix}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01206_a89666ec5f15efd5047f9bd4734b9da67}{FERequirementType}}\& req, \textcolor{keyword}{typename} Traits::template MatrixType<> h)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{80     \}}
\DoxyCodeLine{81 }
\DoxyCodeLine{88     \textcolor{keywordtype}{void} \mbox{\hyperlink{a01206_a70030068b3205be5d75548ce1f1c126f}{calculateVector}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01206_a89666ec5f15efd5047f9bd4734b9da67}{FERequirementType}}\& req, \textcolor{keyword}{typename} Traits::template VectorType<> g)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{111     \}}
\DoxyCodeLine{112 }
\DoxyCodeLine{120     \textcolor{keywordtype}{void} \mbox{\hyperlink{a01206_aa35fb8992a69d3b8a4272722eea90c8a}{calculateLocalSystem}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01206_a89666ec5f15efd5047f9bd4734b9da67}{FERequirementType}}\& req, \textcolor{keyword}{typename} Traits::template MatrixType<> h,}
...
\DoxyCodeLine{126     \}}
\DoxyCodeLine{127 }
\DoxyCodeLine{134     [[nodiscard]] \textcolor{keywordtype}{double} \mbox{\hyperlink{a01206_a1ceee52422b438e6c24386e7c17dc124}{calculateScalar}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01206_a89666ec5f15efd5047f9bd4734b9da67}{FERequirementType}}\& par)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{146     \}}
\DoxyCodeLine{147 }
\DoxyCodeLine{153     \textcolor{keyword}{const} \mbox{\hyperlink{a01206_ae3eeda5463148aeab6bec5e774791384}{RealFE}}\& \mbox{\hyperlink{a01206_af1726c92c0d829e25de3bfede15c4291}{realFE}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} *\textcolor{keyword}{this}; \}}
\DoxyCodeLine{154 }
\DoxyCodeLine{162     \textcolor{keyword}{template} <\textcolor{keyword}{typename}... Args>}
\DoxyCodeLine{163     \textcolor{keyword}{explicit} \mbox{\hyperlink{a01206_a0945c8f2eb83323d6b8767b4ce47c919}{AutoDiffFE}}(Args\&\&... args) : \mbox{\hyperlink{a01206_ae3eeda5463148aeab6bec5e774791384}{RealFE}}\{std::forward<Args>(args)...\} \{\}}
\DoxyCodeLine{164   \};}
