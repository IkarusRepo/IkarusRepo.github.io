...
\DoxyCodeLine{14 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00292}{Ikarus}} \{}
\DoxyCodeLine{15 }
...
\DoxyCodeLine{27       \mbox{\hyperlink{a00292_a90678a80e6b2b4849072623df02dae58}{planeStressLinearElasticMaterialTangent}}(\textcolor{keywordtype}{double} E, \textcolor{keywordtype}{double} nu) \{}
...
\DoxyCodeLine{48       \mbox{\hyperlink{a00292_afc9c57d60ca4a8c1075c44d926e497a8}{linearElasticMaterialTangent3D}}(\textcolor{keywordtype}{double} E, \textcolor{keywordtype}{double} nu) \{}
...
\DoxyCodeLine{65   \textcolor{keyword}{struct }\mbox{\hyperlink{a01291}{TraitsFromLocalView}} \{}
\DoxyCodeLine{66     \textcolor{keyword}{using }\mbox{\hyperlink{a01291_aa0c1ac11ffc970e6afb09d360f2f84cf}{GridEntity}} = \textcolor{keyword}{typename} LocalView::Element;}
\DoxyCodeLine{68     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01291_a47ccda97cc8e04f87be6d2c3a165ba98}{worlddim}} = GridEntity::Geometry::coorddimension;}
\DoxyCodeLine{69 }
\DoxyCodeLine{71     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01291_ab29f61e7d71697962fe41642d683f9f5}{mydim}} = GridEntity::mydimension;}
\DoxyCodeLine{72 }
\DoxyCodeLine{74     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01291_aae28c168c70513855e463fed63b13502}{dimension}} = GridEntity::dimension;}
\DoxyCodeLine{75 }
\DoxyCodeLine{77     \textcolor{keyword}{template} <\textcolor{keyword}{typename} ScalarType = \textcolor{keywordtype}{double}>}
\DoxyCodeLine{78     \textcolor{keyword}{using }\mbox{\hyperlink{a01291_a8eb13a47b7fbaca4d8cedc28665dc522}{VectorType}} = std::conditional\_t<useRef, Eigen::Ref<Eigen::VectorX<ScalarType>>, Eigen::VectorX<ScalarType>\&>;}
\DoxyCodeLine{79 }
\DoxyCodeLine{81     \textcolor{keyword}{template} <\textcolor{keyword}{typename} ScalarType = \textcolor{keywordtype}{double}>}
\DoxyCodeLine{82     \textcolor{keyword}{using }\mbox{\hyperlink{a01291_a1865d55ba52b06685f13bc81517feb1c}{MatrixType}} = std::conditional\_t<useRef, Eigen::Ref<Eigen::MatrixX<ScalarType>>, Eigen::MatrixX<ScalarType>\&>;}
\DoxyCodeLine{83   \};}
\DoxyCodeLine{84 }
\DoxyCodeLine{87   \textcolor{keyword}{struct }\mbox{\hyperlink{a01295}{YoungsModulusAndPoissonsRatio}} \{}
\DoxyCodeLine{88     \textcolor{keywordtype}{double} \mbox{\hyperlink{a01295_a6c00be8aacc18c845b00748b1e56c83c}{emodul}};}
\DoxyCodeLine{89     \textcolor{keywordtype}{double} \mbox{\hyperlink{a01295_acb99903e7b1b13967a0757d284e014ed}{nu}};}
\DoxyCodeLine{90   \};}
\DoxyCodeLine{91 }
\DoxyCodeLine{93   \textcolor{keyword}{struct }\mbox{\hyperlink{a01299}{YoungsModulusAndShearModulus}} \{}
\DoxyCodeLine{94     \textcolor{keywordtype}{double} \mbox{\hyperlink{a01299_ab9d965c2a2c0409682aaea9ca45be83b}{emodul}};}
\DoxyCodeLine{95     \textcolor{keywordtype}{double} \mbox{\hyperlink{a01299_a12468705489862b9e7470f197b499d0f}{mu}};}
\DoxyCodeLine{96   \};}
\DoxyCodeLine{97 }
\DoxyCodeLine{99   \textcolor{keyword}{struct }\mbox{\hyperlink{a01303}{YoungsModulusAndBulkModulus}} \{}
\DoxyCodeLine{100     \textcolor{keywordtype}{double} \mbox{\hyperlink{a01303_a218a7076cb5434dd30811ffe50b39964}{emodul}};}
\DoxyCodeLine{101     \textcolor{keywordtype}{double} \mbox{\hyperlink{a01303_a996ac473697809e0e44551037cf6d4f0}{K}};}
\DoxyCodeLine{102   \};}
\DoxyCodeLine{103 }
\DoxyCodeLine{105   \textcolor{keyword}{struct }\mbox{\hyperlink{a01307}{YoungsModulusAndLamesFirstParameter}} \{}
\DoxyCodeLine{106     \textcolor{keywordtype}{double} \mbox{\hyperlink{a01307_ac0163a851cf3f135906c79a95cca835f}{emodul}};}
\DoxyCodeLine{107     \textcolor{keywordtype}{double} \mbox{\hyperlink{a01307_ab38e15b12e0e703652627c73b8639ee8}{lambda}};}
\DoxyCodeLine{108   \};}
\DoxyCodeLine{109 }
\DoxyCodeLine{111   \textcolor{keyword}{struct }\mbox{\hyperlink{a01311}{BulkModulusAndLamesFirstParameter}} \{}
\DoxyCodeLine{112     \textcolor{keywordtype}{double} \mbox{\hyperlink{a01311_a4f5868738c5673adf557e914123d0c8e}{K}};}
\DoxyCodeLine{113     \textcolor{keywordtype}{double} \mbox{\hyperlink{a01311_a82f624b8171315c48c0bb5d39ef2f5d8}{lambda}};}
\DoxyCodeLine{114   \};}
\DoxyCodeLine{115 }
\DoxyCodeLine{117   \textcolor{keyword}{struct }\mbox{\hyperlink{a01315}{LamesFirstParameterAndShearModulus}} \{}
\DoxyCodeLine{118     \textcolor{keywordtype}{double} \mbox{\hyperlink{a01315_a0157695e9fc8b735e86f828cc35b64fc}{lambda}};}
\DoxyCodeLine{119     \textcolor{keywordtype}{double} \mbox{\hyperlink{a01315_a3558ad06d2a831f0d412d76956d516f8}{mu}};}
\DoxyCodeLine{120   \};}
\DoxyCodeLine{121 }
\DoxyCodeLine{127   \textcolor{keyword}{template} <\textcolor{keyword}{typename} MaterialParameter>}
\DoxyCodeLine{128   \textcolor{keyword}{concept }\mbox{\hyperlink{a01555}{MaterialParameterTuple}} = std::is\_same\_v<MaterialParameter, YoungsModulusAndPoissonsRatio> or std::is\_same\_v<}
...
\DoxyCodeLine{141   \textcolor{keyword}{struct }\mbox{\hyperlink{a01319}{ConvertLameConstants}} \{}
\DoxyCodeLine{142     \textcolor{keyword}{constexpr} \textcolor{keywordtype}{double} \mbox{\hyperlink{a01319_ab180d31a46c95ba6f5f9ba596095c7f9}{toLamesFirstParameter}}() \textcolor{keyword}{requires}(}
\DoxyCodeLine{143         !std::is\_same\_v<}
\DoxyCodeLine{144             ValuePair,}
\DoxyCodeLine{145             \mbox{\hyperlink{a01307}{YoungsModulusAndLamesFirstParameter}}> and !std::is\_same\_v<ValuePair, BulkModulusAndLamesFirstParameter> and !std::is\_same\_v<ValuePair, LamesFirstParameterAndShearModulus>) \{}
...
\DoxyCodeLine{161     \}}
\DoxyCodeLine{162 }
\DoxyCodeLine{163     \textcolor{keyword}{constexpr} \textcolor{keywordtype}{double} \mbox{\hyperlink{a01319_a01f6532092896ff2e3556aace6704af4}{toBulkModulus}}() \textcolor{keyword}{requires}(}
\DoxyCodeLine{164         !std::is\_same\_v<}
\DoxyCodeLine{165             ValuePair, \mbox{\hyperlink{a01303}{YoungsModulusAndBulkModulus}}> and !std::is\_same\_v<ValuePair, BulkModulusAndLamesFirstParameter>) \{}
...
\DoxyCodeLine{184     \}}
\DoxyCodeLine{185 }
\DoxyCodeLine{186     \textcolor{keyword}{constexpr} \textcolor{keywordtype}{double} \mbox{\hyperlink{a01319_ad29a653238be34f96ae24902aa523657}{toShearModulus}}() \textcolor{keyword}{requires}(}
\DoxyCodeLine{187         !std::is\_same\_v<}
\DoxyCodeLine{188             ValuePair,}
\DoxyCodeLine{189             \mbox{\hyperlink{a01299}{YoungsModulusAndShearModulus}}> and !std::is\_same\_v<ValuePair, LamesFirstParameterAndShearModulus>) \{}
...
\DoxyCodeLine{208     \}}
\DoxyCodeLine{209 }
\DoxyCodeLine{210     \textcolor{keyword}{constexpr} \textcolor{keywordtype}{double} \mbox{\hyperlink{a01319_abf0e01900bfaeacf08cc9af500f42c05}{toPWaveModulus}}() \{}
...
\DoxyCodeLine{237     \}}
\DoxyCodeLine{238 }
\DoxyCodeLine{239     \textcolor{keyword}{constexpr} \textcolor{keywordtype}{double} \mbox{\hyperlink{a01319_a7193fdef2358be914614114c45345112}{toPoissonsRatio}}() \textcolor{keyword}{requires}(!std::is\_same\_v<ValuePair, YoungsModulusAndPoissonsRatio>) \{}
...
\DoxyCodeLine{262     \}}
\DoxyCodeLine{263 }
\DoxyCodeLine{264     \textcolor{keyword}{constexpr} \textcolor{keywordtype}{double} \mbox{\hyperlink{a01319_a0f0c758dceaa0c252ef5a7fb78911048}{toYoungsModulus}}() \textcolor{keyword}{requires}(}
\DoxyCodeLine{265         !std::is\_same\_v<}
\DoxyCodeLine{266             ValuePair,}
\DoxyCodeLine{267             \mbox{\hyperlink{a01295}{YoungsModulusAndPoissonsRatio}}> and !std::is\_same\_v<ValuePair, YoungsModulusAndShearModulus> and !std::is\_same\_v<ValuePair, YoungsModulusAndBulkModulus> and !std::is\_same\_v<ValuePair, YoungsModulusAndLamesFirstParameter>) \{}
...
\DoxyCodeLine{276     \}}
\DoxyCodeLine{277 }
\DoxyCodeLine{278   private : \textcolor{keyword}{friend} \mbox{\hyperlink{a01319}{ConvertLameConstants<YoungsModulusAndPoissonsRatio>}} \mbox{\hyperlink{a01319_aafc9afc69d20972e526bd6202a342739}{convertLameConstants}}(}
\DoxyCodeLine{279                 \textcolor{keyword}{const} \mbox{\hyperlink{a01295}{YoungsModulusAndPoissonsRatio}}\& p\_vp);}
\DoxyCodeLine{280     \textcolor{keyword}{friend} \mbox{\hyperlink{a01319}{ConvertLameConstants<YoungsModulusAndShearModulus>}} \mbox{\hyperlink{a01319_aafc9afc69d20972e526bd6202a342739}{convertLameConstants}}(}
\DoxyCodeLine{281         \textcolor{keyword}{const} \mbox{\hyperlink{a01299}{YoungsModulusAndShearModulus}}\& p\_vp);}
\DoxyCodeLine{282 }
\DoxyCodeLine{283     \textcolor{keyword}{friend} \mbox{\hyperlink{a01319}{ConvertLameConstants<YoungsModulusAndBulkModulus>}} \mbox{\hyperlink{a01319_aafc9afc69d20972e526bd6202a342739}{convertLameConstants}}(}
\DoxyCodeLine{284         \textcolor{keyword}{const} \mbox{\hyperlink{a01303}{YoungsModulusAndBulkModulus}}\& p\_vp);}
\DoxyCodeLine{285 }
\DoxyCodeLine{286     \textcolor{keyword}{friend} \mbox{\hyperlink{a01319}{ConvertLameConstants<LamesFirstParameterAndShearModulus>}} \mbox{\hyperlink{a01319_aafc9afc69d20972e526bd6202a342739}{convertLameConstants}}(}
\DoxyCodeLine{287         \textcolor{keyword}{const} \mbox{\hyperlink{a01315}{LamesFirstParameterAndShearModulus}}\& p\_vp);}
\DoxyCodeLine{288 }
\DoxyCodeLine{289     \textcolor{keyword}{friend} \mbox{\hyperlink{a01319}{ConvertLameConstants<BulkModulusAndLamesFirstParameter>}} \mbox{\hyperlink{a01319_aafc9afc69d20972e526bd6202a342739}{convertLameConstants}}(}
\DoxyCodeLine{290         \textcolor{keyword}{const} \mbox{\hyperlink{a01311}{BulkModulusAndLamesFirstParameter}}\& p\_vp);}
\DoxyCodeLine{291     \mbox{\hyperlink{a01319}{ConvertLameConstants}}(ValuePair\&\& p\_vp) : vp(p\_vp) \{\}}
...
\DoxyCodeLine{300   \};}
\DoxyCodeLine{301   \textcolor{keyword}{inline} \mbox{\hyperlink{a01319}{ConvertLameConstants<YoungsModulusAndPoissonsRatio>}} \mbox{\hyperlink{a00292_aef16f39eb73407dd874bc14426576a4e}{convertLameConstants}}(}
\DoxyCodeLine{302       \textcolor{keyword}{const} \mbox{\hyperlink{a01295}{YoungsModulusAndPoissonsRatio}}\& p\_vp) \{}
\DoxyCodeLine{303     \textcolor{keywordflow}{return} \{p\_vp\};}
\DoxyCodeLine{304   \}}
\DoxyCodeLine{305   \textcolor{keyword}{inline} \mbox{\hyperlink{a01319}{ConvertLameConstants<YoungsModulusAndShearModulus>}} \mbox{\hyperlink{a00292_aef16f39eb73407dd874bc14426576a4e}{convertLameConstants}}(}
\DoxyCodeLine{306       \textcolor{keyword}{const} \mbox{\hyperlink{a01299}{YoungsModulusAndShearModulus}}\& p\_vp) \{}
\DoxyCodeLine{307     \textcolor{keywordflow}{return} \{p\_vp\};}
\DoxyCodeLine{308   \}}
\DoxyCodeLine{309   \textcolor{keyword}{inline} \mbox{\hyperlink{a01319}{ConvertLameConstants<YoungsModulusAndBulkModulus>}} \mbox{\hyperlink{a00292_aef16f39eb73407dd874bc14426576a4e}{convertLameConstants}}(}
\DoxyCodeLine{310       \textcolor{keyword}{const} \mbox{\hyperlink{a01303}{YoungsModulusAndBulkModulus}}\& p\_vp) \{}
\DoxyCodeLine{311     \textcolor{keywordflow}{return} \{p\_vp\};}
\DoxyCodeLine{312   \}}
\DoxyCodeLine{313   \textcolor{keyword}{inline} \mbox{\hyperlink{a01319}{ConvertLameConstants<LamesFirstParameterAndShearModulus>}} \mbox{\hyperlink{a00292_aef16f39eb73407dd874bc14426576a4e}{convertLameConstants}}(}
\DoxyCodeLine{314       \textcolor{keyword}{const} \mbox{\hyperlink{a01315}{LamesFirstParameterAndShearModulus}}\& p\_vp) \{}
\DoxyCodeLine{315     \textcolor{keywordflow}{return} \{p\_vp\};}
\DoxyCodeLine{316   \}}
\DoxyCodeLine{317   \textcolor{keyword}{inline} \mbox{\hyperlink{a01319}{ConvertLameConstants<BulkModulusAndLamesFirstParameter>}} \mbox{\hyperlink{a00292_aef16f39eb73407dd874bc14426576a4e}{convertLameConstants}}(}
\DoxyCodeLine{318       \textcolor{keyword}{const} \mbox{\hyperlink{a01311}{BulkModulusAndLamesFirstParameter}}\& p\_vp) \{}
\DoxyCodeLine{319     \textcolor{keywordflow}{return} \{p\_vp\};}
\DoxyCodeLine{320   \}}
\DoxyCodeLine{321 }
\DoxyCodeLine{328   \textcolor{keyword}{inline} \textcolor{keyword}{auto} \mbox{\hyperlink{a00292_a32940ef922d090491ffcaa9bf2a44aef}{toLamesFirstParameterAndShearModulus}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01295}{YoungsModulusAndPoissonsRatio}}\& matParameter) \{}
\DoxyCodeLine{329     \textcolor{keyword}{auto} lambda = \mbox{\hyperlink{a00292_aef16f39eb73407dd874bc14426576a4e}{convertLameConstants}}(matParameter).toLamesFirstParameter();}
\DoxyCodeLine{330     \textcolor{keyword}{auto} mu     = \mbox{\hyperlink{a00292_aef16f39eb73407dd874bc14426576a4e}{convertLameConstants}}(matParameter).toShearModulus();}
\DoxyCodeLine{331 }
\DoxyCodeLine{332     \textcolor{keywordflow}{return} \mbox{\hyperlink{a01315}{LamesFirstParameterAndShearModulus}}\{.\mbox{\hyperlink{a01315_a0157695e9fc8b735e86f828cc35b64fc}{lambda}} = lambda, .mu = mu\};}
\DoxyCodeLine{333   \}}
\DoxyCodeLine{334 }
\DoxyCodeLine{341   \textcolor{keyword}{inline} \textcolor{keyword}{auto} \mbox{\hyperlink{a00292_a4161393d679e5ec44806e6e911e26dee}{toYoungsModulusAndPoissonsRatio}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01315}{LamesFirstParameterAndShearModulus}}\& matParameter) \{}
\DoxyCodeLine{342     \textcolor{keyword}{auto} emod = \mbox{\hyperlink{a00292_aef16f39eb73407dd874bc14426576a4e}{convertLameConstants}}(matParameter).toYoungsModulus();}
\DoxyCodeLine{343     \textcolor{keyword}{auto} nu   = \mbox{\hyperlink{a00292_aef16f39eb73407dd874bc14426576a4e}{convertLameConstants}}(matParameter).toPoissonsRatio();}
\DoxyCodeLine{344 }
\DoxyCodeLine{345     \textcolor{keywordflow}{return} \mbox{\hyperlink{a01295}{YoungsModulusAndPoissonsRatio}}\{.\mbox{\hyperlink{a01295_a6c00be8aacc18c845b00748b1e56c83c}{emodul}} = emod, .nu = nu\};}
\DoxyCodeLine{346   \}}
\DoxyCodeLine{347 }
