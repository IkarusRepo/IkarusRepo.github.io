\hypertarget{a02723_source}{}\doxysection{utils/dirichletvalues.hh}
\label{a02723_source}\index{dirichletvalues.hh@{dirichletvalues.hh}}
...
\DoxyCodeLine{27 }
\DoxyCodeLine{28 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00065}{ikarus/utils/concepts.hh}}>}}
\DoxyCodeLine{29 }
\DoxyCodeLine{30 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00378}{Dune}} \{}
\DoxyCodeLine{31 \textcolor{keyword}{template} <\textcolor{keyword}{class} K, \textcolor{keywordtype}{int} N>}
\DoxyCodeLine{32 \textcolor{keyword}{class }\mbox{\hyperlink{a01677}{FieldVector}};}
\DoxyCodeLine{33 \}}
\DoxyCodeLine{34 }
\DoxyCodeLine{35 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00360}{Ikarus}} \{}
\DoxyCodeLine{36 }
\DoxyCodeLine{40 \textcolor{keyword}{template} <\textcolor{keyword}{class}>}
\DoxyCodeLine{41 \textcolor{keyword}{struct }\mbox{\hyperlink{a01681}{DeriveSizeType}};}
\DoxyCodeLine{42 }
\DoxyCodeLine{43 \textcolor{keyword}{template} <Concepts::EigenVector T>}
\DoxyCodeLine{44 \textcolor{keyword}{struct }\mbox{\hyperlink{a01681}{DeriveSizeType}}<T>}
\DoxyCodeLine{45 \{}
\DoxyCodeLine{46   \textcolor{keyword}{using }\mbox{\hyperlink{a01685_ad2f15a80c92d0ac72c16edbe30b7e9ba}{SizeType}} = Eigen::Index;}
\DoxyCodeLine{47 \};}
\DoxyCodeLine{48 }
\DoxyCodeLine{49 \textcolor{keyword}{template} <>}
\DoxyCodeLine{50 \textcolor{keyword}{struct }\mbox{\hyperlink{a01681}{DeriveSizeType}}<\mbox{\hyperlink{a00359}{std}}::vector<bool>>}
\DoxyCodeLine{51 \{}
\DoxyCodeLine{52   \textcolor{keyword}{using }\mbox{\hyperlink{a01689_a737ba53080c8f2b8d01f458dd574de9c}{SizeType}} = std::vector<bool>::size\_type;}
\DoxyCodeLine{53 \};}
\DoxyCodeLine{54 }
...
\DoxyCodeLine{66 \textcolor{keyword}{class }\mbox{\hyperlink{a01693}{DirichletValues}}}
\DoxyCodeLine{67 \{}
\DoxyCodeLine{68 \textcolor{keyword}{public}:}
\DoxyCodeLine{69   \textcolor{keyword}{using }\mbox{\hyperlink{a01693_a2e6f1ef4a810a7269303f54a6f74539f}{Basis}}                         = std::remove\_cvref\_t<B>;}
\DoxyCodeLine{70   \textcolor{keyword}{using }\mbox{\hyperlink{a01693_aa71c2b94b37f2b4e83f9f1e059e6fe4c}{FlagsType}}                     = FC;}
\DoxyCodeLine{71   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01693_a79e90730d4ac67efb5e38590c0429df5}{worldDimension}} = Basis::GridView::dimensionworld;}
\DoxyCodeLine{72   \textcolor{keyword}{using }\mbox{\hyperlink{a01693_a3db820fbcd2b7edf58ce3b21b261f621}{BackendType}}                   = \textcolor{keyword}{decltype}(Dune::Functions::istlVectorBackend(std::declval<FlagsType\&>()));}
\DoxyCodeLine{73   \textcolor{keyword}{using }\mbox{\hyperlink{a01693_ace0ece5adceb26d9db00c7c096568ea0}{SizeType}}                      = \textcolor{keyword}{typename} \mbox{\hyperlink{a01681}{DeriveSizeType<FlagsType>::SizeType}};}
\DoxyCodeLine{74   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01693_aeb81ceb2617369a584dd12f4574ab1dc}{DirichletValues}}(\textcolor{keyword}{const} B\& \mbox{\hyperlink{a01693_ae783c95d2e4b55d9d37f4c141b1d719b}{basis}})}
\DoxyCodeLine{75       : basis\_\{\mbox{\hyperlink{a01693_ae783c95d2e4b55d9d37f4c141b1d719b}{basis}}\},}
...
\DoxyCodeLine{92   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01693_a3b40113e1bf44f2e269242d677afcc55}{fixBoundaryDOFs}}(F\&\& f, TreePath\&\& treePath = \{\}) \{}
...
\DoxyCodeLine{96 }
\DoxyCodeLine{97     \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (\mbox{\hyperlink{a01860}{Concepts::IsFunctorWithArgs<F, BackendType, typename Basis::MultiIndex>}}) \{}
...
\DoxyCodeLine{103     \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (Concepts::IsFunctorWithArgs<F, \mbox{\hyperlink{a01693_a3db820fbcd2b7edf58ce3b21b261f621}{BackendType}}, int, SubSpaceLocalView,}
...
\DoxyCodeLine{123   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01693_a956ce2cdc09731f001821c7b59d49e85}{fixDOFs}}(F\&\& f) \{}
...
\DoxyCodeLine{135   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01693_a179a4b05a361fc9ea0a3e935dcf0e45a}{setSingleDOF}}(\textcolor{keyword}{const} MultiIndex i, \textcolor{keywordtype}{bool} flag) \{}
\DoxyCodeLine{136     dirichletFlagsBackend\_[i] = flag;}
\DoxyCodeLine{137   \}}
\DoxyCodeLine{138 }
\DoxyCodeLine{146   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01693_a2c8ce98339eddd3f3bf1cdbf4e07a45f}{setSingleDOF}}(std::size\_t i, \textcolor{keywordtype}{bool} flag)}
...
\DoxyCodeLine{150   \}}
\DoxyCodeLine{151 }
\DoxyCodeLine{155   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01693_ab8ae184ec5c0c79a893a8111d7315442}{reset}}() \{}
...
\DoxyCodeLine{161   \textcolor{keyword}{const} \textcolor{keyword}{auto}\& \mbox{\hyperlink{a01693_ae783c95d2e4b55d9d37f4c141b1d719b}{basis}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} basis\_; \}}
\DoxyCodeLine{162 }
...
\DoxyCodeLine{166   [[nodiscard]] \textcolor{keywordtype}{bool} \mbox{\hyperlink{a01693_a1b1fccdb71619c0a49aa24977682d43a}{isConstrained}}(\textcolor{keyword}{const} MultiIndex\& multiIndex) \textcolor{keyword}{const} \{}
...
\DoxyCodeLine{171   [[nodiscard]] \textcolor{keywordtype}{bool} \mbox{\hyperlink{a01693_a1cdd766b0feb7e85ac3d3df10704e659}{isConstrained}}(std::size\_t i) \textcolor{keyword}{const}}
...
\DoxyCodeLine{178   \textcolor{keyword}{auto} \mbox{\hyperlink{a01693_aeb299b04b2777be56012b32a3b2e6a9c}{fixedDOFsize}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} std::ranges::count(dirichletFlags\_, \textcolor{keyword}{true}); \}}
\DoxyCodeLine{179 }
\DoxyCodeLine{180   \textcolor{comment}{/* \(\backslash\)brief Returns how many degrees of freedom there are */}}
\DoxyCodeLine{181   \textcolor{keyword}{auto} \mbox{\hyperlink{a01693_a010fa7b0721c137eb61221493e52dc92}{size}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} dirichletFlags\_.size(); \}}
\DoxyCodeLine{182 }
\DoxyCodeLine{183   \textcolor{comment}{/* \(\backslash\)brief Returns the underlying dof flag container */}}
\DoxyCodeLine{184   \textcolor{keyword}{auto}\& \mbox{\hyperlink{a01693_af8495b65eac223b7b6c64f07b31cc814}{container}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} dirichletFlags\_; \}}
\DoxyCodeLine{185 }
\DoxyCodeLine{195   \textcolor{keyword}{template} <\textcolor{keyword}{typename} F>}
\DoxyCodeLine{196   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01693_abc3413114cb9272944e1b44606c6a0a1}{storeInhomogeneousBoundaryCondition}}(F\&\& f) \{}
...
\DoxyCodeLine{203   \}}
\DoxyCodeLine{204 }
\DoxyCodeLine{214   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01693_ac3950f8821f8e8c1f2a8b8f8a7e86875}{evaluateInhomogeneousBoundaryCondition}}(Eigen::VectorXd\& xIh, \textcolor{keyword}{const} \textcolor{keywordtype}{double}\& lambda) \{}
...
\DoxyCodeLine{224   \}}
\DoxyCodeLine{225 }
\DoxyCodeLine{235   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01693_a5d7fdc80dfd3ebdcb58f0770844f71da}{evaluateInhomogeneousBoundaryConditionDerivative}}(Eigen::VectorXd\& xIh, \textcolor{keyword}{const} \textcolor{keywordtype}{double}\& lambda) \{}
...
\DoxyCodeLine{249   \mbox{\hyperlink{a01693_a2e6f1ef4a810a7269303f54a6f74539f}{Basis}} basis\_;}
\DoxyCodeLine{250   \mbox{\hyperlink{a01693_aa71c2b94b37f2b4e83f9f1e059e6fe4c}{FlagsType}} dirichletFlags\_;}
\DoxyCodeLine{251   \mbox{\hyperlink{a01693_a3db820fbcd2b7edf58ce3b21b261f621}{BackendType}} dirichletFlagsBackend\_;}
...
\DoxyCodeLine{255         \textcolor{keyword}{const} \mbox{\hyperlink{a01677}{Dune::FieldVector<double, worldDimension>}}\&, \textcolor{keyword}{const} \textcolor{keywordtype}{double}\&)>;}
