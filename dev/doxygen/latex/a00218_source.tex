\hypertarget{a00218_source}{}\doxysection{material.\+hh}
\label{a00218_source}\index{material.hh@{material.hh}}
...
\DoxyCodeLine{16 }
\DoxyCodeLine{17 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a02991}{ikarus/finiteelements/mechanics/materials.hh}}>}}
\DoxyCodeLine{18 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a03012}{ikarus/utils/concepts.hh}}>}}
\DoxyCodeLine{19 }
...
\DoxyCodeLine{51 }
\DoxyCodeLine{52 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00414}{Ikarus::Python}} \{}
\DoxyCodeLine{53 }
...
\DoxyCodeLine{60         \mbox{\hyperlink{a00396_a5e27551f9edaebc557108aa164899b54}{convertLameConstants}}(T\{kwargs[param1.c\_str()].cast<double>(), kwargs[param2.c\_str()].cast<\textcolor{keywordtype}{double}>()\});}
\DoxyCodeLine{61 }
...
\DoxyCodeLine{76   \}}
\DoxyCodeLine{77 }
\DoxyCodeLine{78   \mbox{\hyperlink{a01667}{Ikarus::LamesFirstParameterAndShearModulus}} extractMaterialParameters(\textcolor{keyword}{const} pybind11::kwargs\& kwargs) \{}
...
\DoxyCodeLine{107 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00414_a3a4831265d4a775b43c50c25242a2910}{registerMaterial}}(pybind11::handle scope, pybind11::class\_<Material, options...> cls) \{}
...
\DoxyCodeLine{110 }
\DoxyCodeLine{111   cls.def(\mbox{\hyperlink{a00396_ac8243891c1b961e50a066140ab79a142}{pybind11::init}}([](\textcolor{keyword}{const} py::kwargs\& kwargs) \{}
\DoxyCodeLine{112     \textcolor{keyword}{auto} matParameter = Impl::extractMaterialParameters(kwargs);}
\DoxyCodeLine{113     \textcolor{keywordflow}{return} \textcolor{keyword}{new} \mbox{\hyperlink{a00385_gga05ac785124262c1e323d2f937d520a1bad92a8333dd3ccb895cc65f7455b71206}{Material}}(matParameter);}
\DoxyCodeLine{114   \}));}
\DoxyCodeLine{115 }
\DoxyCodeLine{116   std::string materialname = Material::name();}
\DoxyCodeLine{117 }
\DoxyCodeLine{118   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(cls, \mbox{\hyperlink{a00385_gga05ac785124262c1e323d2f937d520a1bad92a8333dd3ccb895cc65f7455b71206}{Material}}, storedEnergy, vecSize);}
\DoxyCodeLine{119   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(cls, \mbox{\hyperlink{a00385_gga05ac785124262c1e323d2f937d520a1bad92a8333dd3ccb895cc65f7455b71206}{Material}}, stresses, vecSize);}
\DoxyCodeLine{120   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(cls, \mbox{\hyperlink{a00385_gga05ac785124262c1e323d2f937d520a1bad92a8333dd3ccb895cc65f7455b71206}{Material}}, tangentModuli, vecSize);}
\DoxyCodeLine{121 }
\DoxyCodeLine{122   \textcolor{keyword}{using }PlaneStressClass = \textcolor{keyword}{decltype}(\mbox{\hyperlink{a00407_aa7b4cfc28796165e32b16cb12ab8ccd4}{Materials::planeStress}}(std::declval<Material>()));}
...
\DoxyCodeLine{134   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(pS, PlaneStressClass, storedEnergy, 3);}
\DoxyCodeLine{135   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(pS, PlaneStressClass, stresses, 3);}
\DoxyCodeLine{136   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(pS, PlaneStressClass, tangentModuli, 3);}
\DoxyCodeLine{137   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(pS, PlaneStressClass, storedEnergy, 6);}
\DoxyCodeLine{138   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(pS, PlaneStressClass, stresses, 6);}
\DoxyCodeLine{139   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(pS, PlaneStressClass, tangentModuli, 6);}
\DoxyCodeLine{140 }
\DoxyCodeLine{141   cls.def(\textcolor{stringliteral}{"{}asPlaneStress"{}}, [](\mbox{\hyperlink{a00385_gga05ac785124262c1e323d2f937d520a1bad92a8333dd3ccb895cc65f7455b71206}{Material}}\& self) \{}
\DoxyCodeLine{142     \textcolor{keywordflow}{return} \mbox{\hyperlink{a00407_aa7b4cfc28796165e32b16cb12ab8ccd4}{Materials::planeStress}}(self);}
\DoxyCodeLine{143   \}); \textcolor{comment}{/* no keep\_alive since planeStress copies the material */}}
\DoxyCodeLine{144 }
\DoxyCodeLine{145   \textcolor{keyword}{using }PlaneStrainClass = \textcolor{keyword}{decltype}(\mbox{\hyperlink{a00407_a5b428881c8ea5104acd909e769b7910b}{Materials::planeStrain}}(std::declval<Material>()));}
...
\DoxyCodeLine{156   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(pStrain, PlaneStrainClass, storedEnergy, 3);}
\DoxyCodeLine{157   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(pStrain, PlaneStrainClass, stresses, 3);}
\DoxyCodeLine{158   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(pStrain, PlaneStrainClass, tangentModuli, 3);}
\DoxyCodeLine{159   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(pStrain, PlaneStrainClass, storedEnergy, 6);}
\DoxyCodeLine{160   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(pStrain, PlaneStrainClass, stresses, 6);}
\DoxyCodeLine{161   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(pStrain, PlaneStrainClass, tangentModuli, 6);}
\DoxyCodeLine{162 }
\DoxyCodeLine{163   cls.def(\textcolor{stringliteral}{"{}asPlaneStrain"{}}, [](\mbox{\hyperlink{a00385_gga05ac785124262c1e323d2f937d520a1bad92a8333dd3ccb895cc65f7455b71206}{Material}}\& self) \{}
\DoxyCodeLine{164     \textcolor{keywordflow}{return} \mbox{\hyperlink{a00407_a5b428881c8ea5104acd909e769b7910b}{Materials::planeStrain}}(self);}
\DoxyCodeLine{165   \}); \textcolor{comment}{/* no keep\_alive since planeStrain copies the material */}}
\DoxyCodeLine{166   \textcolor{keyword}{using }ShellMaterialClass = \textcolor{keyword}{decltype}(\mbox{\hyperlink{a00407_a87bf89dc04e6f4021681129ae4e9a0ee}{Materials::shellMaterial}}(std::declval<Material>()));}
...
\DoxyCodeLine{175   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(shellmaterial, ShellMaterialClass, storedEnergy, 5);}
\DoxyCodeLine{176   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(shellmaterial, ShellMaterialClass, stresses, 5);}
\DoxyCodeLine{177   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(shellmaterial, ShellMaterialClass, tangentModuli, 5);}
\DoxyCodeLine{178   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(shellmaterial, ShellMaterialClass, storedEnergy, 6);}
\DoxyCodeLine{179   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(shellmaterial, ShellMaterialClass, stresses, 6);}
\DoxyCodeLine{180   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(shellmaterial, ShellMaterialClass, tangentModuli, 6);}
\DoxyCodeLine{181 }
\DoxyCodeLine{182   cls.def(\textcolor{stringliteral}{"{}asShellMaterial"{}}, [](\mbox{\hyperlink{a00385_gga05ac785124262c1e323d2f937d520a1bad92a8333dd3ccb895cc65f7455b71206}{Material}}\& self) \{}
\DoxyCodeLine{183     \textcolor{keywordflow}{return} \mbox{\hyperlink{a00407_a87bf89dc04e6f4021681129ae4e9a0ee}{Materials::shellMaterial}}(self);}
\DoxyCodeLine{184   \}); \textcolor{comment}{/* no keep\_alive since shellMaterial copies the material */}}
\DoxyCodeLine{185   \textcolor{keyword}{using }BeamMaterialClass = \textcolor{keyword}{decltype}(\mbox{\hyperlink{a00407_ab89e3a8a28d4e7241ab9dfd41fbbd153}{Materials::beamMaterial}}(std::declval<Material>()));}
...
\DoxyCodeLine{194   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(beammaterial, BeamMaterialClass, storedEnergy, 4);}
\DoxyCodeLine{195   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(beammaterial, BeamMaterialClass, stresses, 4);}
\DoxyCodeLine{196   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(beammaterial, BeamMaterialClass, tangentModuli, 4);}
\DoxyCodeLine{197   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(beammaterial, BeamMaterialClass, storedEnergy, 6);}
\DoxyCodeLine{198   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(beammaterial, BeamMaterialClass, stresses, 6);}
\DoxyCodeLine{199   \mbox{\hyperlink{a00218_a52604789ad84df5cf20d4571f90af39e}{MAKE\_MaterialFunction}}(beammaterial, BeamMaterialClass, tangentModuli, 6);}
\DoxyCodeLine{200   cls.def(\textcolor{stringliteral}{"{}asBeamMaterial"{}}, [](\mbox{\hyperlink{a00385_gga05ac785124262c1e323d2f937d520a1bad92a8333dd3ccb895cc65f7455b71206}{Material}}\& self) \{}
\DoxyCodeLine{201     \textcolor{keywordflow}{return} \mbox{\hyperlink{a00407_ab89e3a8a28d4e7241ab9dfd41fbbd153}{Materials::beamMaterial}}(self);}
...
\DoxyCodeLine{210 }
\DoxyCodeLine{211 \mbox{\hyperlink{a00414_ac81cd08ca4f7222df18c123d422c932d}{MAKE\_MATERIAL\_REGISTRY\_FUNCTION}}(\mbox{\hyperlink{a00407_a93b8b0e77767bbe61541863fcf4d054d}{LinearElasticity}}, 6);}
\DoxyCodeLine{212 \mbox{\hyperlink{a00414_ac81cd08ca4f7222df18c123d422c932d}{MAKE\_MATERIAL\_REGISTRY\_FUNCTION}}(\mbox{\hyperlink{a00407_a68ee2f9a7730fbcf6969940b0c5da418}{StVenantKirchhoff}}, 6);}
\DoxyCodeLine{213 \mbox{\hyperlink{a00414_ac81cd08ca4f7222df18c123d422c932d}{MAKE\_MATERIAL\_REGISTRY\_FUNCTION}}(\mbox{\hyperlink{a00407_a4bf1415fc81c6cacecd347ec4b928def}{NeoHooke}}, 6);}
