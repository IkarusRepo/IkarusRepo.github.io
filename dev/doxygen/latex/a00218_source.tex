\hypertarget{a00218_source}{}\doxysection{fe.\+hh}
\label{a00218_source}\index{fe.hh@{fe.hh}}
...
\DoxyCodeLine{17 }
\DoxyCodeLine{18 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00122}{ikarus/finiteelements/fefactory.hh}}>}}
\DoxyCodeLine{19 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00221}{ikarus/python/finiteelements/registerferequirements.hh}}>}}
\DoxyCodeLine{20 }
\DoxyCodeLine{21 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00375}{Ikarus::Python}} \{}
\DoxyCodeLine{22 }
\DoxyCodeLine{50 \textcolor{keyword}{template} <\textcolor{keyword}{class }FE, \textcolor{keyword}{class}... options>}
\DoxyCodeLine{51 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00375_a0c58c17676c73945cb11eff8a80309ae}{registerCalculateAt}}(pybind11::handle scope, pybind11::class\_<FE, options...> cls, \textcolor{keyword}{auto} resultTypesTuple) \{}
\DoxyCodeLine{52   \textcolor{keyword}{using }Traits         = \textcolor{keyword}{typename} \mbox{\hyperlink{a01312_a70c7907448f7e13ff55b8fb123f3ee0c}{FE::Traits}};}
\DoxyCodeLine{53   \textcolor{keyword}{using }\mbox{\hyperlink{a01344}{FERequirements}} = \textcolor{keyword}{typename} \mbox{\hyperlink{a01516_a86c0fea1b37e487f3c78cde6facca9c3}{FE::Requirement}};}
\DoxyCodeLine{54   cls.def(}
\DoxyCodeLine{55       \textcolor{stringliteral}{"{}calculateAt"{}},}
\DoxyCodeLine{56       [\&](\mbox{\hyperlink{a01312}{FE}}\& self, \textcolor{keyword}{const} \mbox{\hyperlink{a01344}{FERequirements}}\& req, \textcolor{keyword}{const} \mbox{\hyperlink{a01704}{Dune::FieldVector<double, Traits::mydim>}}\& local,}
...
\DoxyCodeLine{61           \textcolor{keywordflow}{if} (resType == \mbox{\hyperlink{a00363_aef80b6b5b45dcfbea4f722f51a84f53f}{toString}}(i)) \{}
...
\DoxyCodeLine{71 \}}
\DoxyCodeLine{72 }
\DoxyCodeLine{86 \textcolor{keyword}{template} <\textcolor{keyword}{class }\mbox{\hyperlink{a01312}{FE}}, \textcolor{keyword}{class}... options>}
\DoxyCodeLine{87 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00355_gac8bb4a818dee7342efbc5e174e35b840}{registerFE}}(pybind11::handle scope, pybind11::class\_<FE, options...> cls) \{}
\DoxyCodeLine{88   \textcolor{keyword}{using }BH          = \textcolor{keyword}{typename} \mbox{\hyperlink{a01312_a26398fefb73f4d51895e26152e368cf8}{FE::BasisHandler}};}
\DoxyCodeLine{89   \textcolor{keyword}{using }GridElement = \textcolor{keyword}{typename} \mbox{\hyperlink{a01312_ae329d665e853b0286679e97418d3acad}{FE::GridElement}};}
\DoxyCodeLine{90   \textcolor{keyword}{using }Requirement = \textcolor{keyword}{typename} \mbox{\hyperlink{a01516_a86c0fea1b37e487f3c78cde6facca9c3}{FE::Requirement}};}
\DoxyCodeLine{91   \textcolor{keyword}{using }FlatBasis   = \textcolor{keyword}{typename} \mbox{\hyperlink{a01384_a81feef959fedef62b2e1daabbd52b5f2}{FE::Traits::FlatBasis}};}
\DoxyCodeLine{92 }
\DoxyCodeLine{93   \textcolor{keywordtype}{int} index = 0;}
\DoxyCodeLine{94   cls.def(\mbox{\hyperlink{a00363_ac8243891c1b961e50a066140ab79a142}{pybind11::init}}([](\textcolor{keyword}{const} BH\& basisHandler, \textcolor{keyword}{typename} \mbox{\hyperlink{a01312_a327f5479545f9b5d615c07ce535b0007}{FE::PreTuple}} argsTuple) \{}
\DoxyCodeLine{95             \textcolor{keyword}{auto} unpackTuple = [\&]<\textcolor{keyword}{typename}... Arg>(Arg\&\&... args) \{}
\DoxyCodeLine{96               \textcolor{keywordflow}{return} \textcolor{keyword}{new} \mbox{\hyperlink{a01312}{FE}}(basisHandler, std::forward<Arg>(args)...);}
\DoxyCodeLine{97             \};}
\DoxyCodeLine{98             \textcolor{keywordflow}{return} std::apply(unpackTuple, argsTuple);}
\DoxyCodeLine{99           \}),}
\DoxyCodeLine{100           pybind11::keep\_alive<1, 2>());}
\DoxyCodeLine{101 }
\DoxyCodeLine{102   cls.def(\textcolor{stringliteral}{"{}bind"{}}, [](\mbox{\hyperlink{a01312}{FE}}\& self, \textcolor{keyword}{const} GridElement\& e) \{ self.\mbox{\hyperlink{a01312_a3a23d70495e802f44ba4b9923804dda0}{bind}}(e); \});}
\DoxyCodeLine{103   cls.def(\textcolor{stringliteral}{"{}calculateScalar"{}}, [](\mbox{\hyperlink{a01312}{FE}}\& self, \textcolor{keyword}{const} Requirement\& req, \mbox{\hyperlink{a00363_af6f894084edd9109762b86222995ef2a}{Ikarus::ScalarAffordance}} affordance) \{}
\DoxyCodeLine{104     \textcolor{keywordflow}{return} calculateScalar(self, req, affordance);}
\DoxyCodeLine{105   \});}
\DoxyCodeLine{106   cls.def(\textcolor{stringliteral}{"{}calculateVector"{}}, [](\mbox{\hyperlink{a01312}{FE}}\& self, \textcolor{keyword}{const} Requirement\& req, \mbox{\hyperlink{a00363_aab9e3e38507d1db7602bc750718c302a}{Ikarus::VectorAffordance}} affordance,}
...
\DoxyCodeLine{110       [](\mbox{\hyperlink{a01312}{FE}}\& self, \textcolor{keyword}{const} Requirement\& req, \mbox{\hyperlink{a00363_a390d5311179ec61d163a29c943b3d1a0}{Ikarus::MatrixAffordance}} affordance, Eigen::Ref<Eigen::MatrixXd> mat) \{}
...
\DoxyCodeLine{135       [](\mbox{\hyperlink{a01312}{FE}}\& self) -\/> LocalViewWrapper \{}
\DoxyCodeLine{136         \textcolor{keyword}{auto} lvWrapped = LocalViewWrapper(self.\mbox{\hyperlink{a01312_a1425316afd592244682b9ccc48cf59ef}{localView}}().globalBasis());}
...
\DoxyCodeLine{140         lvWrapped.base().bind(self.\mbox{\hyperlink{a01312_a1425316afd592244682b9ccc48cf59ef}{localView}}().element());}
\DoxyCodeLine{141         \textcolor{keywordflow}{return} lvWrapped;}
\DoxyCodeLine{142       \},}
\DoxyCodeLine{143       pybind11::keep\_alive<0, 1>());}
\DoxyCodeLine{144 }
\DoxyCodeLine{145   \mbox{\hyperlink{a00375_a0c58c17676c73945cb11eff8a80309ae}{registerCalculateAt}}(scope, cls, \textcolor{keyword}{typename} \mbox{\hyperlink{a01516_ada59c15363d83f6e635ecd6e1672d6a4}{FE::SupportedResultTypes}}());}
\DoxyCodeLine{146   \mbox{\hyperlink{a00375_a32c3989a8ef1dbc581313ef17a0c6f5b}{registerFERequirement}}(scope, cls);}
\DoxyCodeLine{147 \}}
\DoxyCodeLine{148 }
