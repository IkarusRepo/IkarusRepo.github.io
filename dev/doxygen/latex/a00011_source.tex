...
\DoxyCodeLine{17 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00374}{Ikarus::utils}} \{}
\DoxyCodeLine{18 }
\DoxyCodeLine{28 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00357_ga6e36d8f5163f232e3142ecbd0575e8b4}{makeUniqueAndSort}}(std::ranges::random\_access\_range \textcolor{keyword}{auto}\& r) \{}
\DoxyCodeLine{29   sort(r.begin(), r.end());}
\DoxyCodeLine{30   r.erase(\mbox{\hyperlink{a00357_ga12de8f77a63ef488a87a5aa8536146ee}{std::unique}}(r.begin(), r.end()), r.end());}
\DoxyCodeLine{31 \}}
\DoxyCodeLine{32 }
\DoxyCodeLine{43 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T>}
\DoxyCodeLine{44 \textcolor{keyword}{auto} \mbox{\hyperlink{a00357_ga0ccbb016e46741bd00c69436dc11e2d0}{appendUnique}}(std::ranges::random\_access\_range \textcolor{keyword}{auto}\& r, T\&\& v) \{}
...
\DoxyCodeLine{64 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00357_ga2b7954c72a2393ab7494fa0b66d828cd}{printContent}}(C\&\& c, std::ostream\& os = std::cout) \{}
...
\DoxyCodeLine{77 \textcolor{keyword}{auto} \mbox{\hyperlink{a00357_ga7f597d87c8f2bcbf4afc65ebc929b680}{transformValueRangeToPointerRange}}(C\& cont) \{}
...
\DoxyCodeLine{92 \textcolor{keyword}{auto} \mbox{\hyperlink{a00357_ga83bd9e4f59f0aa9fadd797efefa751d9}{transformPointerRangeToReferenceRange}}(C\& cont) \{}
...
\DoxyCodeLine{100 \textcolor{keyword}{auto} \mbox{\hyperlink{a00374_a4c617d2458cc6d792f5ba3e6c64a0c7f}{makeNestedTupleFlat}}(std::tuple<Types...> tup);}
...
\DoxyCodeLine{120   \textcolor{keyword}{struct }uniqueImpl<\mbox{\hyperlink{a00359}{std}}::tuple<Ts...>, U, Us...>}
...
\DoxyCodeLine{134         \textcolor{keywordflow}{return} std::tuple\_cat(\mbox{\hyperlink{a00374_a4c617d2458cc6d792f5ba3e6c64a0c7f}{makeNestedTupleFlat}}(T()), makeNestedTupleFlatImpl<Types...>());}
...
\DoxyCodeLine{139         \textcolor{keywordflow}{return} \mbox{\hyperlink{a00374_a4c617d2458cc6d792f5ba3e6c64a0c7f}{makeNestedTupleFlat}}(T());}
...
\DoxyCodeLine{220 \textcolor{keyword}{constexpr} \textcolor{keywordtype}{size\_t} \mbox{\hyperlink{a00357_gaf75511e781bb89056badd33413222010}{find\_if}}(Tuple\&\& tuple, Predicate pred) \{}
...
\DoxyCodeLine{248 \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00357_ga33284bcf99d7d3870e0aff06f6651aa2}{none\_of}}(Tuple\&\& tuple, Predicate pred) \{}
\DoxyCodeLine{249   \textcolor{keywordflow}{return} \mbox{\hyperlink{a00357_gaf75511e781bb89056badd33413222010}{find\_if}}(tuple, pred) == std::tuple\_size<std::decay\_t<Tuple>>::value;}
\DoxyCodeLine{250 \}}
\DoxyCodeLine{251 }
\DoxyCodeLine{264 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Tuple, \textcolor{keyword}{typename} Predicate>}
\DoxyCodeLine{265 \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00357_gab6d955a70ec9215ae9a8f3841582ab49}{any\_of}}(Tuple\&\& tuple, Predicate pred) \{}
\DoxyCodeLine{266   \textcolor{keywordflow}{return} !\mbox{\hyperlink{a00357_ga33284bcf99d7d3870e0aff06f6651aa2}{none\_of}}(tuple, pred);}
\DoxyCodeLine{267 \}}
\DoxyCodeLine{268 }
\DoxyCodeLine{283 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Tuple, \textcolor{keyword}{typename} Predicate>}
\DoxyCodeLine{284 \textcolor{keyword}{auto} \mbox{\hyperlink{a00357_gad9f30d486a3d9151d534ec1b0fad5341}{filter}}(Tuple\&\& tuple, Predicate pred) \{}
...
\DoxyCodeLine{304 \textcolor{keyword}{constexpr} \textcolor{keyword}{auto} \mbox{\hyperlink{a00357_ga12de8f77a63ef488a87a5aa8536146ee}{unique}}([[maybe\_unused]] std::tuple<Types...>\&\& tuple) \{}
...
\DoxyCodeLine{322 \textcolor{keyword}{constexpr} \textcolor{keywordtype}{size\_t} \mbox{\hyperlink{a00357_gae9a7254f583151ee431db537c9980865}{count\_if}}(Tuple\&\& tuple, Predicate pred) \{}
...
\DoxyCodeLine{344 \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a00357_ga62d8ab565d41e49db75f0641bcdf0740}{findTypeSpecialization}}() \{}
\DoxyCodeLine{345   \textcolor{keywordflow}{return} \mbox{\hyperlink{a00357_gaf75511e781bb89056badd33413222010}{find\_if}}(std::remove\_cvref\_t<Tuple>(),}
...
\DoxyCodeLine{362 \textcolor{keyword}{auto} \mbox{\hyperlink{a00357_ga05a5ccea0f87d41fc69956f55a2c1dbd}{getSpecialization}}(Tuple\&\& tuple) \{}
...
\DoxyCodeLine{383 \textcolor{keyword}{constexpr} \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00357_gaec2a5de0482441ef1e1c68fb7ff8a0bc}{hasTypeSpecialization}}() \{}
\DoxyCodeLine{384   \textcolor{keywordflow}{return} (\mbox{\hyperlink{a00357_gaf75511e781bb89056badd33413222010}{find\_if}}(std::remove\_cvref\_t<Tuple>(), []<\textcolor{keyword}{typename} T>(T\&\&) \{}
...
\DoxyCodeLine{401 \textcolor{keyword}{constexpr} \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00357_gadf919f3a9b0c1d50134f9d041a3ce9f7}{countTypeSpecialization}}() \{}
\DoxyCodeLine{402   \textcolor{keywordflow}{return} \mbox{\hyperlink{a00357_gae9a7254f583151ee431db537c9980865}{count\_if}}(}
...
\DoxyCodeLine{418 \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00357_ga62ee166e690831f40395df076e9cdddb}{countTypeSpecialization\_v}} = countTypeSpecialization<Type, Tuple>();}
\DoxyCodeLine{419 }
\DoxyCodeLine{432 \textcolor{keyword}{template} <\textcolor{keywordtype}{int} N, \textcolor{keyword}{class} Tuple>}
\DoxyCodeLine{433 \textcolor{keyword}{constexpr} \textcolor{keyword}{auto} \mbox{\hyperlink{a00357_ga32de94604b9d1a7423134f33f49d613f}{makeTupleSubset}}(Tuple\&\& t) \{}
...
\DoxyCodeLine{454 \textcolor{keyword}{constexpr} \textcolor{keyword}{auto} \mbox{\hyperlink{a00357_gaef801f15c9f18ae16e4241a497c33e96}{makeTupleFromTupleIndices}}(Tuple\&\& t) \{}
...
\DoxyCodeLine{466 \textcolor{keyword}{auto} \mbox{\hyperlink{a00374_a4c617d2458cc6d792f5ba3e6c64a0c7f}{makeNestedTupleFlat}}(std::tuple<Types...>) \{}
...
\DoxyCodeLine{480 \textcolor{keyword}{auto} \mbox{\hyperlink{a00374_a162c64656f5917b717a6b44ebf4c9ebf}{makeNestedTupleFlatAndStoreReferences}}(Tuple\&\& tup) \{}
...
\DoxyCodeLine{497 \textcolor{keyword}{requires} \mbox{\hyperlink{a01870}{traits::Pointer<T>}}}
\DoxyCodeLine{498 \textcolor{keyword}{auto}\& \mbox{\hyperlink{a00374_aa156028e47fc302b02a7e70dea888034}{returnReferenceOrNulloptIfObjectIsNullPtr}}(T v) \{}
