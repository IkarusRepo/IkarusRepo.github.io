\hypertarget{a00041_source}{}\doxysection{nonlinearoperator.\+hh}
\label{a00041_source}\index{nonlinearoperator.hh@{nonlinearoperator.hh}}
...
\DoxyCodeLine{115 \textcolor{keyword}{auto} \mbox{\hyperlink{a00325_ac00abda505aa8ccc73ce59afd165ce49}{parameter}}(Args\&\&... args) \{}
...
\DoxyCodeLine{127 \textcolor{keyword}{auto} \mbox{\hyperlink{a00325_ab787b670f0d338c870988f417cf85f76}{functions}}(Args\&\&... args) \{}
...
\DoxyCodeLine{141 \textcolor{keyword}{auto} \mbox{\hyperlink{a00325_a5357efca8ce4f70831d107f93f2cda1d}{initResults}}(\textcolor{keyword}{const} Impl::Functions<DerivativeArgs...>\& derivativesFunctions,}
\DoxyCodeLine{142                  \textcolor{keyword}{const} Impl::Parameter<ParameterArgs...>\& \mbox{\hyperlink{a00325_ac00abda505aa8ccc73ce59afd165ce49}{parameter}}) \{}
\DoxyCodeLine{143   \textcolor{keywordflow}{return} Impl::makeTupleOfValuesAndReferences(}
\DoxyCodeLine{144       derivativesFunctions.args, \mbox{\hyperlink{a00325_ac00abda505aa8ccc73ce59afd165ce49}{parameter}},}
...
\DoxyCodeLine{155 \textcolor{keyword}{class }\mbox{\hyperlink{a01542}{NonLinearOperator}}}
\DoxyCodeLine{156 \{}
\DoxyCodeLine{157 \textcolor{keyword}{public}:}
\DoxyCodeLine{158   \mbox{\hyperlink{a01542_a2308f86b14266d7b7049b0a12cf20cdc}{NonLinearOperator}}([[maybe\_unused]] \textcolor{keyword}{const} TypeListOne\& derivativesFunctions,}
...
\DoxyCodeLine{177       std::tuple<\mbox{\hyperlink{a00323_ga0ba1bf25ee478b1b1d9e96c1dcd831a0}{Ikarus::traits::ReturnType}}<DerivativeArgs, ParameterArgs\&...>...>; }
...
\DoxyCodeLine{200 }
\DoxyCodeLine{207   \textcolor{keyword}{explicit} \mbox{\hyperlink{a01542_a2308f86b14266d7b7049b0a12cf20cdc}{NonLinearOperator}}(\textcolor{keyword}{const} Impl::Functions<DerivativeArgs...>\& derivativesFunctions,}
...
\DoxyCodeLine{211         derivativesEvaluated\_(\mbox{\hyperlink{a00325_a5357efca8ce4f70831d107f93f2cda1d}{initResults}}(derivativesFunctions, parameterI)) \{\}}
\DoxyCodeLine{212 }
...
\DoxyCodeLine{337     \textcolor{keywordflow}{return} \mbox{\hyperlink{a01542}{Ikarus::NonLinearOperator}}(\mbox{\hyperlink{a00325_ab787b670f0d338c870988f417cf85f76}{functions}}(std::get<Derivatives>(derivatives\_)...),}
...
\DoxyCodeLine{343       std::is\_reference\_v<\mbox{\hyperlink{a00323_ga0ba1bf25ee478b1b1d9e96c1dcd831a0}{Ikarus::traits::ReturnType}}<DerivativeArgs, ParameterArgs\&...>>,}
\DoxyCodeLine{344       std::reference\_wrapper<std::remove\_reference\_t<\mbox{\hyperlink{a00323_ga0ba1bf25ee478b1b1d9e96c1dcd831a0}{Ikarus::traits::ReturnType}}<DerivativeArgs, ParameterArgs\&...>>>,}
\DoxyCodeLine{345       std::remove\_cvref\_t<\mbox{\hyperlink{a00323_ga0ba1bf25ee478b1b1d9e96c1dcd831a0}{Ikarus::traits::ReturnType}}<DerivativeArgs, ParameterArgs\&...>>>...>;}
