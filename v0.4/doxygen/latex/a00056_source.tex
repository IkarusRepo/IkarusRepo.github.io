...
\DoxyCodeLine{15 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00329}{Ikarus::traits}} \{}
\DoxyCodeLine{16 }
\DoxyCodeLine{22   \textcolor{keyword}{template} <\textcolor{keyword}{typename} T>}
\DoxyCodeLine{23   \textcolor{keyword}{concept }\mbox{\hyperlink{a01641}{Pointer}} = std::is\_pointer\_v<T> || std::is\_same\_v<T, std::nullptr\_t>;}
\DoxyCodeLine{24 }
...
\DoxyCodeLine{45   \textcolor{keyword}{requires} is\_tuple<Tuple>::value \textcolor{keyword}{consteval} \textcolor{keywordtype}{int} \mbox{\hyperlink{a00311_ga45ac3fa7e384aa760181de7a1377dc14}{countType}}() \{}
...
\DoxyCodeLine{63   \textcolor{keyword}{using }\mbox{\hyperlink{a00311_ga0ba1bf25ee478b1b1d9e96c1dcd831a0}{ReturnType}} = std::invoke\_result\_t<Fun, Args...>;}
\DoxyCodeLine{64 }
\DoxyCodeLine{73   \textcolor{keyword}{template} <\textcolor{keyword}{typename} T, \textcolor{keyword}{typename} Tuple>}
\DoxyCodeLine{74   \textcolor{keyword}{struct }\mbox{\hyperlink{a01577}{hasType}} : std::false\_type \{\};}
\DoxyCodeLine{75 }
...
\DoxyCodeLine{78   \textcolor{keyword}{struct }\mbox{\hyperlink{a01577}{hasType}}<T, std::tuple<>> : std::false\_type \{\};}
\DoxyCodeLine{79 }
...
\DoxyCodeLine{185   \textcolor{keyword}{struct }\mbox{\hyperlink{a01597}{Index}};}
\DoxyCodeLine{186 \textcolor{preprocessor}{\#ifndef DOXYGEN}}
\DoxyCodeLine{187   \textcolor{keyword}{template} <\textcolor{keyword}{class} T>}
\DoxyCodeLine{188   \textcolor{keyword}{struct }\mbox{\hyperlink{a01597}{Index}}<T, std::tuple<>> \{}
...
\DoxyCodeLine{193   \textcolor{keyword}{struct }\mbox{\hyperlink{a01597}{Index}}<T, std::tuple<T, Types...>> \{}
...
\DoxyCodeLine{221   \textcolor{keyword}{struct }\mbox{\hyperlink{a01601}{Rebind}};}
\DoxyCodeLine{222 }
...
\DoxyCodeLine{228   \textcolor{keyword}{struct }\mbox{\hyperlink{a01601}{Rebind}}<Container<OldType, Args...>, NewType> \{}
...
\DoxyCodeLine{236   \textcolor{keyword}{struct }\mbox{\hyperlink{a01601}{Rebind}}<Container<OldType, N>, NewType> \{}
...
\DoxyCodeLine{252   \textcolor{keyword}{struct }\mbox{\hyperlink{a01605}{FunctionTraits}};}
\DoxyCodeLine{253 }
...
\DoxyCodeLine{259   \textcolor{keyword}{struct }\mbox{\hyperlink{a01605}{FunctionTraits}}<R (*)(Args...)> \{}
...
\DoxyCodeLine{270   \textcolor{keyword}{struct }\mbox{\hyperlink{a01605}{FunctionTraits}}<R (C::*)(Args...) const> \{}
...
\DoxyCodeLine{293   \textcolor{keyword}{struct }FunctionTraits<T, \mbox{\hyperlink{a00318}{Dune}}::void\_t<decltype(\&T::operator())>> : \textcolor{keyword}{public} FunctionTraits<decltype(\&T::operator())> \{\};}
