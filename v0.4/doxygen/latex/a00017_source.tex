...
\DoxyCodeLine{32   Eigen::Tensor<typename Derived::Scalar, rank> \mbox{\hyperlink{a00309_ga5cfd9d098384fb067d897b3c0499b447}{tensorView}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01457}{Eigen::EigenBase<Derived>}}\& matrix,}
...
\DoxyCodeLine{37   \}}
\DoxyCodeLine{38 }
\DoxyCodeLine{47   \textcolor{keyword}{auto} \mbox{\hyperlink{a00309_gab2cea9ac847cc3635812467c9d96ceb4}{dyadic}}(\textcolor{keyword}{const} \textcolor{keyword}{auto}\& A\_ij, \textcolor{keyword}{const} \textcolor{keyword}{auto}\& B\_kl) \{}
...
\DoxyCodeLine{60   \textcolor{keyword}{auto} \mbox{\hyperlink{a00309_ga1c9618ef351cd986d4f64fde7f52e860}{symmetricIdentityFourthOrder}}() \{}
...
\DoxyCodeLine{82   \textcolor{keyword}{auto} \mbox{\hyperlink{a00309_ga2368a572348c410fd7e7deb6c6e3964a}{symmetricFourthOrder}}(\textcolor{keyword}{const} \textcolor{keyword}{auto}\& A, \textcolor{keyword}{const} \textcolor{keyword}{auto}\& B) \{}
...
\DoxyCodeLine{101   \textcolor{keyword}{auto} \mbox{\hyperlink{a00309_gadb08b6f9cc40847b70286dc314a23000}{identityFourthOrder}}() \{}
...
\DoxyCodeLine{122   \textcolor{keyword}{auto} \mbox{\hyperlink{a00309_ga8fa2b440586483c1ee0f9b90b9081da2}{fourthOrderIKJL}}(\textcolor{keyword}{const} Eigen::MatrixBase<AType>\& A, \textcolor{keyword}{const} Eigen::MatrixBase<BType>\& B) \{}
...
\DoxyCodeLine{146   \textcolor{keyword}{auto} \mbox{\hyperlink{a00309_gaea03dbfcd8f85ef7af004c7e09244aa9}{symTwoSlots}}(\textcolor{keyword}{const} Eigen::TensorFixedSize<ScalarType, Eigen::Sizes<dim, dim, dim, dim>>\& t,}
...
\DoxyCodeLine{152   \}}
\DoxyCodeLine{153 }
\DoxyCodeLine{167   \textcolor{keyword}{constexpr} Eigen::Index \mbox{\hyperlink{a00309_ga4304655095296ce9283e012587817a51}{toVoigt}}(Eigen::Index i, Eigen::Index j) \textcolor{keyword}{noexcept} \{}
...
\DoxyCodeLine{195   Eigen::Matrix<ScalarType, 6, 6> \mbox{\hyperlink{a00309_ga4304655095296ce9283e012587817a51}{toVoigt}}(\textcolor{keyword}{const} Eigen::TensorFixedSize<ScalarType, Eigen::Sizes<3, 3, 3, 3>>\& ft) \{}
...
\DoxyCodeLine{201             mat(\mbox{\hyperlink{a00309_ga4304655095296ce9283e012587817a51}{toVoigt}}(i, j), \mbox{\hyperlink{a00309_ga4304655095296ce9283e012587817a51}{toVoigt}}(k, l)) = ft(i, j, k, l);}
...
\DoxyCodeLine{224   \textcolor{keyword}{requires}(size > 0 and size <= 3) \textcolor{keyword}{auto} \mbox{\hyperlink{a00309_ga4304655095296ce9283e012587817a51}{toVoigt}}(\textcolor{keyword}{const} Eigen::Matrix<ST, size, size, Options, size, size>\& E,}
...
\DoxyCodeLine{256   \textcolor{keyword}{requires}(size == 1 or size == 3 or size == 6) \textcolor{keyword}{auto} \mbox{\hyperlink{a00309_ga106e11a950fe2545890e811d2e9545fd}{fromVoigt}}(\textcolor{keyword}{const} Eigen::Vector<ST, size>\& EVoigt,}
\DoxyCodeLine{257                                                                \textcolor{keywordtype}{bool} isStrain = \textcolor{keyword}{true}) \{}
\DoxyCodeLine{258     \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} matrixSize = (-\/1 + \mbox{\hyperlink{a00313_ae55d4d0c3478ab3ecf54ce905ddf223b}{ct\_sqrt}}(1 + 8 * size)) / 2;}
...
\DoxyCodeLine{271   \}}
\DoxyCodeLine{272 }
\DoxyCodeLine{286   \textcolor{keyword}{constexpr} std::array<size\_t, 2> \mbox{\hyperlink{a00309_ga106e11a950fe2545890e811d2e9545fd}{fromVoigt}}(\textcolor{keywordtype}{size\_t} i) \{}
...
\DoxyCodeLine{313   \textcolor{keyword}{auto} \mbox{\hyperlink{a00309_ga106e11a950fe2545890e811d2e9545fd}{fromVoigt}}(\textcolor{keyword}{const} Eigen::Matrix<ScalarType, 6, 6>\& CVoigt) \{}
...
\DoxyCodeLine{318         \textcolor{keyword}{auto} firstIndices                                                       = \mbox{\hyperlink{a00309_ga106e11a950fe2545890e811d2e9545fd}{fromVoigt}}(i);}
\DoxyCodeLine{319         \textcolor{keyword}{auto} secondIndices                                                      = \mbox{\hyperlink{a00309_ga106e11a950fe2545890e811d2e9545fd}{fromVoigt}}(j);}
