\hypertarget{a00197_source}{}\doxysection{registerelement.\+hh}
\label{a00197_source}\index{registerelement.hh@{registerelement.hh}}
...
\DoxyCodeLine{23 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a02490}{ikarus/finiteelements/mechanics/linearelastic.hh}}>}}
\DoxyCodeLine{24 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a02505}{ikarus/utils/basis.hh}}>}}
\DoxyCodeLine{25 }
\DoxyCodeLine{26 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00322}{Ikarus::Python}} \{}
\DoxyCodeLine{27 }
...
\DoxyCodeLine{45   \textcolor{keywordtype}{void} \mbox{\hyperlink{a00305_ga40f83e4d7b90006b1019add3b1b218b5}{registerElement}}(pybind11::handle scope, pybind11::class\_<FE, options...> cls) \{}
...
\DoxyCodeLine{53     \textcolor{keyword}{using }\mbox{\hyperlink{a01237}{FERequirements}}         = \textcolor{keyword}{typename} FE::FERequirementType;}
...
\DoxyCodeLine{57       cls.def(\mbox{\hyperlink{a00313_ac8243891c1b961e50a066140ab79a142}{pybind11::init}}([](\textcolor{keyword}{const} GlobalBasis\& \mbox{\hyperlink{a00332_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}, \textcolor{keyword}{const} Element\& element, \textcolor{keywordtype}{double} emod, \textcolor{keywordtype}{double} nu) \{}
...
\DoxyCodeLine{63         \mbox{\hyperlink{a01365}{Dune::FieldVector<double, Traits::worlddim>}}, \textcolor{keyword}{const} \textcolor{keywordtype}{double}\&)>;}
\DoxyCodeLine{64     \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (defaultInitializers)}
\DoxyCodeLine{65       cls.def(}
\DoxyCodeLine{66           \mbox{\hyperlink{a00313_ac8243891c1b961e50a066140ab79a142}{pybind11::init}}([](\textcolor{keyword}{const} GlobalBasis\& \mbox{\hyperlink{a00332_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}, \textcolor{keyword}{const} Element\& element, \textcolor{keywordtype}{double} emod, \textcolor{keywordtype}{double} nu,}
...
\DoxyCodeLine{70       cls.def(\mbox{\hyperlink{a00313_ac8243891c1b961e50a066140ab79a142}{pybind11::init}}([](\textcolor{keyword}{const} GlobalBasis\& \mbox{\hyperlink{a00332_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}, \textcolor{keyword}{const} Element\& element, \textcolor{keywordtype}{double} emod, \textcolor{keywordtype}{double} nu,}
...
\DoxyCodeLine{73                 \textcolor{keywordflow}{return} \textcolor{keyword}{new} FE(\mbox{\hyperlink{a00332_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}, element, emod, nu, volumeLoad, \&bp, neumannBoundaryLoad);}
\DoxyCodeLine{74               \}),}
...
\DoxyCodeLine{111     cls.def(\textcolor{stringliteral}{"{}calculateScalar"{}}, [](FE\& self, \textcolor{keyword}{const} \mbox{\hyperlink{a01237}{FERequirements}}\& req) \{ \textcolor{keywordflow}{return} self.calculateScalar(req); \});}
\DoxyCodeLine{112     cls.def(\textcolor{stringliteral}{"{}calculateVector"{}}, [](FE\& self, \textcolor{keyword}{const} \mbox{\hyperlink{a01237}{FERequirements}}\& req, Eigen::Ref<Eigen::VectorXd> vec) \{}
...
\DoxyCodeLine{117         [](FE\& self, \textcolor{keyword}{const} \mbox{\hyperlink{a01237}{FERequirements}}\& req, Eigen::Ref<Eigen::MatrixXd> mat) \{}
...
\DoxyCodeLine{127         [](FE\& self, \textcolor{keyword}{const} ResultRequirementsType\& req, \textcolor{keyword}{const} \mbox{\hyperlink{a01365}{Dune::FieldVector<double, Traits::mydim>}}\& local,}
\DoxyCodeLine{128            \mbox{\hyperlink{a00300_ga531be167e924b749eb8b4ccc7f1c18c9}{ResultType}} resType = \mbox{\hyperlink{a00300_gga531be167e924b749eb8b4ccc7f1c18c9ad2859ebb97e0012ad38b47dca4f85713}{ResultType::noType}}) \{}
\DoxyCodeLine{129           \mbox{\hyperlink{a01245}{ResultTypeMap<double>}} resultTypeMap;}
\DoxyCodeLine{130           self.calculateAt(req, local, resultTypeMap);}
\DoxyCodeLine{131           \textcolor{keywordflow}{if} (resType == \mbox{\hyperlink{a00300_gga531be167e924b749eb8b4ccc7f1c18c9ad2859ebb97e0012ad38b47dca4f85713}{ResultType::noType}})}
\DoxyCodeLine{132             \textcolor{keywordflow}{return} resultTypeMap.\mbox{\hyperlink{a01245_a6c2c52fc90ff0af02def08b0c8f5deb2}{getSingleResult}}().second;}
\DoxyCodeLine{133           \textcolor{keywordflow}{else}}
\DoxyCodeLine{134             \textcolor{keywordflow}{return} resultTypeMap.\mbox{\hyperlink{a01245_a7f9a61700e42a5507d7dfcfd059a4067}{getResult}}(resType);}
\DoxyCodeLine{135         \},}
\DoxyCodeLine{136         pybind11::arg(\textcolor{stringliteral}{"{}resultRequirements"{}}), pybind11::arg(\textcolor{stringliteral}{"{}local"{}}), pybind11::arg(\textcolor{stringliteral}{"{}resultType"{}}) = \mbox{\hyperlink{a00300_gga531be167e924b749eb8b4ccc7f1c18c9ad2859ebb97e0012ad38b47dca4f85713}{ResultType::noType}});}
\DoxyCodeLine{137   \}}
\DoxyCodeLine{138 }
