...
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{a00310_ga6e36d8f5163f232e3142ecbd0575e8b4}{make\+Unique\+And\+Sort}} (std\+::ranges\+::random\+\_\+access\+\_\+range auto \&r)
...
{\footnotesize template$<$typename Value $>$ }\\auto \mbox{\hyperlink{a00310_ga8f6d2c90383de63c518cefeaccee76f8}{append\+Unique}} (std\+::ranges\+::random\+\_\+access\+\_\+range auto \&r, Value \&\&v)
\begin{DoxyCompactList}\small\item\em Appends a value to the range if it is not already present. \end{DoxyCompactList}\item 
{\footnotesize template$<$class Container $>$ }\\void \mbox{\hyperlink{a00310_ga11bb80da2430170954d6b7519f9498a6}{print\+Content}} (Container \&\&c, std\+::ostream \&os=std\+::cout)
...
{\footnotesize template$<$class Container $>$ }\\auto \mbox{\hyperlink{a00310_ga5f3a9e195a06ac4419ccb479f8819d62}{transform\+Value\+Range\+To\+Pointer\+Range}} (Container \&cont)
\begin{DoxyCompactList}\small\item\em Transforms a value range to a pointer range. \end{DoxyCompactList}\item 
{\footnotesize template$<$class Container $>$ }\\auto \mbox{\hyperlink{a00310_gaabfee41eeb4843cb2fa37b5f381e9fef}{transform\+Pointer\+Range\+To\+Reference\+Range}} (Container \&cont)
\begin{DoxyCompactList}\small\item\em Transforms a pointer range to a reference range. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename Tuple , typename Predicate $>$ }\\constexpr size\+\_\+t \mbox{\hyperlink{a00310_gaf75511e781bb89056badd33413222010}{find\+\_\+if}} (Tuple \&\&tuple, Predicate pred)
...
{\footnotesize template$<$typename Tuple , typename Predicate $>$ }\\bool \mbox{\hyperlink{a00310_ga33284bcf99d7d3870e0aff06f6651aa2}{none\+\_\+of}} (Tuple \&\&tuple, Predicate pred)
...
{\footnotesize template$<$typename Tuple , typename Predicate $>$ }\\bool \mbox{\hyperlink{a00310_gab6d955a70ec9215ae9a8f3841582ab49}{any\+\_\+of}} (Tuple \&\&tuple, Predicate pred)
...
{\footnotesize template$<$typename Tuple , typename Predicate $>$ }\\auto \mbox{\hyperlink{a00310_gad9f30d486a3d9151d534ec1b0fad5341}{filter}} (Tuple \&\&tuple, Predicate pred)
\begin{DoxyCompactList}\small\item\em Filters the elements of a tuple based on a given predicate. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename... Types$>$ }\\constexpr auto \mbox{\hyperlink{a00310_ga12de8f77a63ef488a87a5aa8536146ee}{unique}} (std\+::tuple$<$ Types... $>$ \&\&tuple)
\begin{DoxyCompactList}\small\item\em Creates a tuple with unique types from the given tuple. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename Tuple , typename Predicate $>$ }\\constexpr size\+\_\+t \mbox{\hyperlink{a00310_gae9a7254f583151ee431db537c9980865}{count\+\_\+if}} (Tuple \&\&tuple, Predicate pred)
...
{\footnotesize template$<$template$<$ auto... $>$ class Type, typename Tuple $>$ }\\constexpr int \mbox{\hyperlink{a00310_ga62d8ab565d41e49db75f0641bcdf0740}{find\+Type\+Specialization}} ()
...
{\footnotesize template$<$template$<$ auto... $>$ class Type, typename Tuple $>$ }\\auto \mbox{\hyperlink{a00310_ga05a5ccea0f87d41fc69956f55a2c1dbd}{get\+Specialization}} (Tuple \&\&tuple)
...
{\footnotesize template$<$template$<$ auto... $>$ class Type, typename Tuple $>$ }\\constexpr bool \mbox{\hyperlink{a00310_gaec2a5de0482441ef1e1c68fb7ff8a0bc}{has\+Type\+Specialization}} ()
\begin{DoxyCompactList}\small\item\em Checks if a tuple has a specialization of a template type. \end{DoxyCompactList}\item 
{\footnotesize template$<$template$<$ auto... $>$ class Type, typename Tuple $>$ }\\constexpr bool \mbox{\hyperlink{a00310_gadf919f3a9b0c1d50134f9d041a3ce9f7}{count\+Type\+Specialization}} ()
...
{\footnotesize template$<$int N, class Tuple $>$ }\\constexpr auto \mbox{\hyperlink{a00310_ga32de94604b9d1a7423134f33f49d613f}{make\+Tuple\+Subset}} (Tuple \&\&t)
...
{\footnotesize template$<$class Tuple , std\+::size\+\_\+t... I$>$ }\\constexpr auto \mbox{\hyperlink{a00310_gaef801f15c9f18ae16e4241a497c33e96}{make\+Tuple\+From\+Tuple\+Indices}} (Tuple \&\&t)
\begin{DoxyCompactList}\small\item\em Creates a new tuple using indices from the original tuple. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename... Types$>$ }\\auto \mbox{\hyperlink{a00323_a4c617d2458cc6d792f5ba3e6c64a0c7f}{make\+Nested\+Tuple\+Flat}} (std\+::tuple$<$ Types... $>$)
\begin{DoxyCompactList}\small\item\em Creates a flattened nested tuple. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename Tuple $>$ }\\auto \mbox{\hyperlink{a00323_a162c64656f5917b717a6b44ebf4c9ebf}{make\+Nested\+Tuple\+Flat\+And\+Store\+References}} (Tuple \&\&tup)
...
requires traits\+::\+Pointer$<$T$>$}\\auto \& \mbox{\hyperlink{a00323_aa156028e47fc302b02a7e70dea888034}{return\+Reference\+Or\+Nullopt\+If\+Object\+Is\+Null\+Ptr}} (T v)
...
std\+::tuple$<$ Dune\+::\+Functions\+::\+Polynomial$<$ double $>$, decltype(Eigen\+::seq(0, 0))$>$ \mbox{\hyperlink{a00308_ga16e7d5f51cc42190c090e727495c1609}{find\+Line\+Segment}} (const Eigen\+::\+Vector\+Xd \&x, const Eigen\+::\+Vector\+Xd \&y, int segment\+Size)
\begin{DoxyCompactList}\small\item\em Find a linear segment in a set of data points. \end{DoxyCompactList}\item 
{\footnotesize template$<$int size, typename Local\+View $>$ }\\void \mbox{\hyperlink{a00308_ga276a9de351512c4cacf6e09cad649265}{obtain\+Lagrange\+Node\+Positions}} (const Local\+View \&local\+View, std\+::vector$<$ \mbox{\hyperlink{a01365}{Dune\+::\+Field\+Vector}}$<$ double, size $>$ $>$ \&lagrange\+Node\+Coords)
...
{\footnotesize template$<$typename Nonlinear\+Operator , typename Update\+Type  = typename Nonlinear\+Operator\+::template Parameter\+Value$<$0$>$$>$ }\\bool \mbox{\hyperlink{a00308_ga5d1a87964a3d6b6ddc994532e93b6798}{check\+Hessian}} (Nonlinear\+Operator \&non\+Lin\+Op, \mbox{\hyperlink{a01521}{Check\+Flags}} check\+Flags=\mbox{\hyperlink{a01521}{Check\+Flags}}(), std\+::function$<$ void(typename Nonlinear\+Operator\+::template Parameter\+Value$<$ 0 $>$ \&, const Update\+Type \&)$>$ p\+\_\+update\+Function=\mbox{[}$\,$\mbox{]}(typename Nonlinear\+Operator\+::template Parameter\+Value$<$ 0 $>$ \&a, const Update\+Type \&b) \{ a+=b;\})
\begin{DoxyCompactList}\small\item\em Checks the Hessian of a nonlinear operator. \end{DoxyCompactList}\item 
std\+::tuple$<$ Dune\+::\+Functions\+::\+Polynomial$<$ double $>$, double $>$ \mbox{\hyperlink{a00308_ga0d3a38551806e4de3ff44f311847ba51}{polyfit}} (const Eigen\+::\+Ref$<$ const Eigen\+::\+Vector\+Xd $>$ \&x, const Eigen\+::\+Ref$<$ const Eigen\+::\+Vector\+Xd $>$ \&y, int deg)
...
\begin{DoxyCompactItemize}
\item 
{\footnotesize template$<$template$<$ auto... $>$ class Type, typename Tuple $>$ }\\static constexpr bool \mbox{\hyperlink{a00310_ga62ee166e690831f40395df076e9cdddb}{count\+Type\+Specialization\+\_\+v}} = \mbox{\hyperlink{a00310_gadf919f3a9b0c1d50134f9d041a3ce9f7}{count\+Type\+Specialization}}$<$Type, Tuple$>$()
...
\mbox{\Hypertarget{a00323_a4c617d2458cc6d792f5ba3e6c64a0c7f}\label{a00323_a4c617d2458cc6d792f5ba3e6c64a0c7f}} 
...
\end{DoxyReturn}
\mbox{\Hypertarget{a00323_a162c64656f5917b717a6b44ebf4c9ebf}\label{a00323_a162c64656f5917b717a6b44ebf4c9ebf}} 
...
\end{DoxyReturn}
This function creates a flattened nested tuple and stores references. \mbox{\Hypertarget{a00323_aa156028e47fc302b02a7e70dea888034}\label{a00323_aa156028e47fc302b02a7e70dea888034}} 
