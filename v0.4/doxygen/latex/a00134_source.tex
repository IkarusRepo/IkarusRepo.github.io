\hypertarget{a00134_source}{}\doxysection{enhancedassumedstrains.\+hh}
\label{a00134_source}\index{enhancedassumedstrains.hh@{enhancedassumedstrains.hh}}
...
\DoxyCodeLine{15 }
\DoxyCodeLine{16 \textcolor{preprocessor}{\#  include <\mbox{\hyperlink{a00179}{ikarus/finiteelements/fehelper.hh}}>}}
...
\DoxyCodeLine{19 }
\DoxyCodeLine{20 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00313}{Ikarus}} \{}
\DoxyCodeLine{21 }
\DoxyCodeLine{31   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Geometry>}
\DoxyCodeLine{32   Eigen::Matrix3d \mbox{\hyperlink{a00313_a7a5b9f5e83f6918ca1726fb4316c3b86}{calcTransformationMatrix2D}}(\textcolor{keyword}{const} Geometry\& geometry) \{}
...
\DoxyCodeLine{64   Eigen::Matrix<double, 6, 6> \mbox{\hyperlink{a00313_a95234ab8588ced83708c6e5a30e2368e}{calcTransformationMatrix3D}}(\textcolor{keyword}{const} Geometry\& geometry) \{}
...
\DoxyCodeLine{105   \textcolor{keyword}{struct }\mbox{\hyperlink{a01257}{EASQ1E4}} \{}
\DoxyCodeLine{106     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01257_a091b2d7ab16564e0355e5078fae6eabd}{strainSize}}         = 3;}
\DoxyCodeLine{107     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01257_ad14763e1531d0b04751e51cc1ca0f23f}{enhancedStrainSize}} = 4;}
\DoxyCodeLine{108     \textcolor{keyword}{using }\mbox{\hyperlink{a01257_aa88f171600c9a12e1e56f0eac6184b20}{MType}}                             = Eigen::Matrix<double, strainSize, enhancedStrainSize>;}
\DoxyCodeLine{109 }
\DoxyCodeLine{110     \mbox{\hyperlink{a01257_ac30d67e782b291e459cad4eacdf16cf2}{EASQ1E4}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{111     \textcolor{keyword}{explicit} \mbox{\hyperlink{a01257_a322fdf68966e7fb0ee8165f0c966cc40}{EASQ1E4}}(\textcolor{keyword}{const} Geometry\& geometry\_)}
\DoxyCodeLine{112         : \mbox{\hyperlink{a01257_a98834915295f56b2eb15eae744202339}{geometry}}\{std::make\_shared<Geometry>(geometry\_)\},}
\DoxyCodeLine{113           \mbox{\hyperlink{a01257_a39592b62d7442344006f6c1f7254631f}{T0InverseTransformed}}\{\mbox{\hyperlink{a00313_a7a5b9f5e83f6918ca1726fb4316c3b86}{calcTransformationMatrix2D}}(geometry\_)\} \{\}}
\DoxyCodeLine{114 }
\DoxyCodeLine{115     \textcolor{keyword}{auto} \mbox{\hyperlink{a01257_a69fd71138345d01372e9434a1fa904fe}{calcM}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01365}{Dune::FieldVector<double, 2>}}\& quadPos)\textcolor{keyword}{ const }\{}
\DoxyCodeLine{116       \mbox{\hyperlink{a01257_aa88f171600c9a12e1e56f0eac6184b20}{MType}} M;}
\DoxyCodeLine{117       M.setZero(\mbox{\hyperlink{a01257_a091b2d7ab16564e0355e5078fae6eabd}{strainSize}}, \mbox{\hyperlink{a01257_ad14763e1531d0b04751e51cc1ca0f23f}{enhancedStrainSize}});}
...
\DoxyCodeLine{124       \textcolor{keyword}{const} \textcolor{keywordtype}{double} detJ = \mbox{\hyperlink{a01257_a98834915295f56b2eb15eae744202339}{geometry}}-\/>integrationElement(quadPos);}
\DoxyCodeLine{125       M                 = \mbox{\hyperlink{a01257_a39592b62d7442344006f6c1f7254631f}{T0InverseTransformed}} / detJ * M;}
\DoxyCodeLine{126       \textcolor{keywordflow}{return} M;}
\DoxyCodeLine{127     \}}
\DoxyCodeLine{128 }
\DoxyCodeLine{129     std::shared\_ptr<Geometry> \mbox{\hyperlink{a01257_a98834915295f56b2eb15eae744202339}{geometry}};}
\DoxyCodeLine{130     Eigen::Matrix3d \mbox{\hyperlink{a01257_a39592b62d7442344006f6c1f7254631f}{T0InverseTransformed}};}
\DoxyCodeLine{131   \};}
\DoxyCodeLine{132 }
\DoxyCodeLine{140   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Geometry>}
\DoxyCodeLine{141   \textcolor{keyword}{struct }\mbox{\hyperlink{a01261}{EASQ1E5}} \{}
\DoxyCodeLine{142     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01261_ac0cb21ead6bd716ddee697328ba429f7}{strainSize}}         = 3;}
\DoxyCodeLine{143     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01261_a295cad836cda5a090316e80d37107d97}{enhancedStrainSize}} = 5;}
\DoxyCodeLine{144     \textcolor{keyword}{using }\mbox{\hyperlink{a01261_a00ce3ccf82b2acbae524f52ea42de95a}{MType}}                             = Eigen::Matrix<double, strainSize, enhancedStrainSize>;}
\DoxyCodeLine{145 }
\DoxyCodeLine{146     \mbox{\hyperlink{a01261_a4f508bc3cac3ed9504183f1768eca6a1}{EASQ1E5}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{147     \textcolor{keyword}{explicit} \mbox{\hyperlink{a01261_a56469a9df101001a6aad3aab9e51b568}{EASQ1E5}}(\textcolor{keyword}{const} Geometry\& geometry\_)}
\DoxyCodeLine{148         : \mbox{\hyperlink{a01261_a933c1aed3dbfda6e87955129651ca3e2}{geometry}}\{std::make\_shared<Geometry>(geometry\_)\},}
\DoxyCodeLine{149           \mbox{\hyperlink{a01261_abc4ffe4eb222fc40c893f69b2aa96f25}{T0InverseTransformed}}\{\mbox{\hyperlink{a00313_a7a5b9f5e83f6918ca1726fb4316c3b86}{calcTransformationMatrix2D}}(geometry\_)\} \{\}}
\DoxyCodeLine{150 }
\DoxyCodeLine{151     \textcolor{keyword}{auto} \mbox{\hyperlink{a01261_a624d83c80aa923e821696c9cc2deef85}{calcM}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01365}{Dune::FieldVector<double, 2>}}\& quadPos)\textcolor{keyword}{ const }\{}
\DoxyCodeLine{152       \mbox{\hyperlink{a01261_a00ce3ccf82b2acbae524f52ea42de95a}{MType}} M;}
...
\DoxyCodeLine{161       \textcolor{keyword}{const} \textcolor{keywordtype}{double} detJ = \mbox{\hyperlink{a01261_a933c1aed3dbfda6e87955129651ca3e2}{geometry}}-\/>integrationElement(quadPos);}
\DoxyCodeLine{162       M                 = \mbox{\hyperlink{a01261_abc4ffe4eb222fc40c893f69b2aa96f25}{T0InverseTransformed}} / detJ * M;}
\DoxyCodeLine{163       \textcolor{keywordflow}{return} M;}
\DoxyCodeLine{164     \}}
\DoxyCodeLine{165 }
\DoxyCodeLine{166     std::shared\_ptr<Geometry> \mbox{\hyperlink{a01261_a933c1aed3dbfda6e87955129651ca3e2}{geometry}};}
\DoxyCodeLine{167     Eigen::Matrix3d \mbox{\hyperlink{a01261_abc4ffe4eb222fc40c893f69b2aa96f25}{T0InverseTransformed}};}
\DoxyCodeLine{168   \};}
\DoxyCodeLine{169 }
\DoxyCodeLine{177   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Geometry>}
\DoxyCodeLine{178   \textcolor{keyword}{struct }\mbox{\hyperlink{a01265}{EASQ1E7}} \{}
\DoxyCodeLine{179     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01265_a7b988c0a64a63311a1c6861a4a45ed4f}{strainSize}}         = 3;}
\DoxyCodeLine{180     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01265_ad0b8cacc2ddc15f583977858ee760077}{enhancedStrainSize}} = 7;}
\DoxyCodeLine{181     \textcolor{keyword}{using }\mbox{\hyperlink{a01265_a38aee3dda331f7f4071c6348ea511cca}{MType}}                             = Eigen::Matrix<double, strainSize, enhancedStrainSize>;}
\DoxyCodeLine{182 }
\DoxyCodeLine{183     \mbox{\hyperlink{a01265_a59966ec62660dc7eeb1f12400b3ad672}{EASQ1E7}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{184     \textcolor{keyword}{explicit} \mbox{\hyperlink{a01265_a8ac7ec46a513c44a892e48e297324abf}{EASQ1E7}}(\textcolor{keyword}{const} Geometry\& geometry\_)}
\DoxyCodeLine{185         : \mbox{\hyperlink{a01265_ac28ee04d63153dd9323a2926e2f9a8b9}{geometry}}\{std::make\_shared<Geometry>(geometry\_)\},}
\DoxyCodeLine{186           \mbox{\hyperlink{a01265_acd663cb202adf116ebab1d2cfbd708ea}{T0InverseTransformed}}\{\mbox{\hyperlink{a00313_a7a5b9f5e83f6918ca1726fb4316c3b86}{calcTransformationMatrix2D}}(geometry\_)\} \{\}}
\DoxyCodeLine{187 }
\DoxyCodeLine{188     \textcolor{keyword}{auto} \mbox{\hyperlink{a01265_a984954a677451b2f71a968c8e30d5658}{calcM}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01365}{Dune::FieldVector<double, 2>}}\& quadPos)\textcolor{keyword}{ const }\{}
\DoxyCodeLine{189       \mbox{\hyperlink{a01265_a38aee3dda331f7f4071c6348ea511cca}{MType}} M;}
...
\DoxyCodeLine{200       \textcolor{keyword}{const} \textcolor{keywordtype}{double} detJ = \mbox{\hyperlink{a01265_ac28ee04d63153dd9323a2926e2f9a8b9}{geometry}}-\/>integrationElement(quadPos);}
\DoxyCodeLine{201       M                 = \mbox{\hyperlink{a01265_acd663cb202adf116ebab1d2cfbd708ea}{T0InverseTransformed}} / detJ * M;}
\DoxyCodeLine{202       \textcolor{keywordflow}{return} M;}
\DoxyCodeLine{203     \}}
\DoxyCodeLine{204 }
\DoxyCodeLine{205     std::shared\_ptr<Geometry> \mbox{\hyperlink{a01265_ac28ee04d63153dd9323a2926e2f9a8b9}{geometry}};}
\DoxyCodeLine{206     Eigen::Matrix3d \mbox{\hyperlink{a01265_acd663cb202adf116ebab1d2cfbd708ea}{T0InverseTransformed}};}
\DoxyCodeLine{207   \};}
\DoxyCodeLine{208 }
\DoxyCodeLine{216   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Geometry>}
\DoxyCodeLine{217   \textcolor{keyword}{struct }\mbox{\hyperlink{a01269}{EASH1E9}} \{}
\DoxyCodeLine{218     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01269_a3a3b04261ab9c37d87211f79317b6c72}{strainSize}}         = 6;}
\DoxyCodeLine{219     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01269_acece1d0df4ecbe282f035d1961f632d8}{enhancedStrainSize}} = 9;}
\DoxyCodeLine{220     \textcolor{keyword}{using }\mbox{\hyperlink{a01269_a7212ed3754aa79af50a76848d95eb4d5}{MType}}                             = Eigen::Matrix<double, strainSize, enhancedStrainSize>;}
\DoxyCodeLine{221 }
\DoxyCodeLine{222     \mbox{\hyperlink{a01269_a5d74fc8ebfb04e85b70d8bd252624552}{EASH1E9}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{223     \textcolor{keyword}{explicit} \mbox{\hyperlink{a01269_a32418ed3d63b290057d27523e468873f}{EASH1E9}}(\textcolor{keyword}{const} Geometry\& geometry\_)}
\DoxyCodeLine{224         : \mbox{\hyperlink{a01269_a9348ce08ebf36d33aebade14c436a313}{geometry}}\{std::make\_shared<Geometry>(geometry\_)\},}
\DoxyCodeLine{225           \mbox{\hyperlink{a01269_a426a7f668cba849850916bdf61d3f72b}{T0InverseTransformed}}\{\mbox{\hyperlink{a00313_a95234ab8588ced83708c6e5a30e2368e}{calcTransformationMatrix3D}}(geometry\_)\} \{\}}
\DoxyCodeLine{226 }
\DoxyCodeLine{227     \textcolor{keyword}{auto} \mbox{\hyperlink{a01269_a00fa6978f126c09a3961b18e460155e7}{calcM}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01365}{Dune::FieldVector<double, 3>}}\& quadPos)\textcolor{keyword}{ const }\{}
\DoxyCodeLine{228       \mbox{\hyperlink{a01269_a7212ed3754aa79af50a76848d95eb4d5}{MType}} M;}
...
\DoxyCodeLine{242       \textcolor{keyword}{const} \textcolor{keywordtype}{double} detJ = \mbox{\hyperlink{a01269_a9348ce08ebf36d33aebade14c436a313}{geometry}}-\/>integrationElement(quadPos);}
\DoxyCodeLine{243       M                 = \mbox{\hyperlink{a01269_a426a7f668cba849850916bdf61d3f72b}{T0InverseTransformed}} / detJ * M;}
\DoxyCodeLine{244       \textcolor{keywordflow}{return} M;}
\DoxyCodeLine{245     \}}
\DoxyCodeLine{246     std::shared\_ptr<Geometry> \mbox{\hyperlink{a01269_a9348ce08ebf36d33aebade14c436a313}{geometry}};}
\DoxyCodeLine{247     Eigen::Matrix<double, 6, 6> \mbox{\hyperlink{a01269_a426a7f668cba849850916bdf61d3f72b}{T0InverseTransformed}};}
\DoxyCodeLine{248   \};}
\DoxyCodeLine{249 }
\DoxyCodeLine{257   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Geometry>}
\DoxyCodeLine{258   \textcolor{keyword}{struct }\mbox{\hyperlink{a01273}{EASH1E21}} \{}
\DoxyCodeLine{259     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01273_add6a1247960eb038a2cc4d129b0b79e5}{strainSize}}         = 6;}
\DoxyCodeLine{260     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} \mbox{\hyperlink{a01273_af2217d81619792495bb7ee6ea40205bd}{enhancedStrainSize}} = 21;}
\DoxyCodeLine{261     \textcolor{keyword}{using }\mbox{\hyperlink{a01273_ae4d88268d8bbccfa19801db35b60564f}{MType}}                             = Eigen::Matrix<double, strainSize, enhancedStrainSize>;}
\DoxyCodeLine{262 }
\DoxyCodeLine{263     \mbox{\hyperlink{a01273_a8c5b5847f3fec76168c02e05114b1df5}{EASH1E21}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{264     \textcolor{keyword}{explicit} \mbox{\hyperlink{a01273_a72cdd4c83d4373c7623f9a397eb6d520}{EASH1E21}}(\textcolor{keyword}{const} Geometry\& geometry\_)}
\DoxyCodeLine{265         : \mbox{\hyperlink{a01273_adde8fea3f6eb6e806044c5131a7bc919}{geometry}}\{std::make\_shared<Geometry>(geometry\_)\},}
\DoxyCodeLine{266           \mbox{\hyperlink{a01273_aff9381f83c01e85c46cce75c3bf9633b}{T0InverseTransformed}}\{\mbox{\hyperlink{a00313_a95234ab8588ced83708c6e5a30e2368e}{calcTransformationMatrix3D}}(geometry\_)\} \{\}}
\DoxyCodeLine{267 }
\DoxyCodeLine{268     \textcolor{keyword}{auto} \mbox{\hyperlink{a01273_a58741a35769a0b13c530e47ffd8dffcd}{calcM}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01365}{Dune::FieldVector<double, 3>}}\& quadPos)\textcolor{keyword}{ const }\{}
\DoxyCodeLine{269       \mbox{\hyperlink{a01273_ae4d88268d8bbccfa19801db35b60564f}{MType}} M;}
...
\DoxyCodeLine{297 }
\DoxyCodeLine{298       \textcolor{keyword}{const} \textcolor{keywordtype}{double} detJ = \mbox{\hyperlink{a01273_adde8fea3f6eb6e806044c5131a7bc919}{geometry}}-\/>integrationElement(quadPos);}
\DoxyCodeLine{299       M                 = \mbox{\hyperlink{a01273_aff9381f83c01e85c46cce75c3bf9633b}{T0InverseTransformed}} / detJ * M;}
\DoxyCodeLine{300       \textcolor{keywordflow}{return} M;}
\DoxyCodeLine{301     \}}
\DoxyCodeLine{302 }
\DoxyCodeLine{303     std::shared\_ptr<Geometry> \mbox{\hyperlink{a01273_adde8fea3f6eb6e806044c5131a7bc919}{geometry}};}
\DoxyCodeLine{304     Eigen::Matrix<double, 6, 6> \mbox{\hyperlink{a01273_aff9381f83c01e85c46cce75c3bf9633b}{T0InverseTransformed}};}
\DoxyCodeLine{305   \};}
\DoxyCodeLine{306 }
\DoxyCodeLine{314   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Geometry>}
\DoxyCodeLine{315   \textcolor{keyword}{using }\mbox{\hyperlink{a00313_a87e3feaaba5839ab7b515df24438c07f}{EAS2DVariant}} = std::variant<std::monostate, EASQ1E4<Geometry>, \mbox{\hyperlink{a01261}{EASQ1E5<Geometry>}}, \mbox{\hyperlink{a01265}{EASQ1E7<Geometry>}}>;}
\DoxyCodeLine{316 }
\DoxyCodeLine{324   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Geometry>}
\DoxyCodeLine{325   \textcolor{keyword}{using }\mbox{\hyperlink{a00313_a4e486ca9fc463568d5018e15b3d68b0d}{EAS3DVariant}} = std::variant<std::monostate, EASH1E9<Geometry>, \mbox{\hyperlink{a01273}{EASH1E21<Geometry>}}>;}
\DoxyCodeLine{326 }
\DoxyCodeLine{336   \textcolor{keyword}{template} <\textcolor{keyword}{typename} DisplacementBasedElement>}
\DoxyCodeLine{337   \textcolor{keyword}{class }\mbox{\hyperlink{a01277}{EnhancedAssumedStrains}} : \textcolor{keyword}{public} DisplacementBasedElement \{}
\DoxyCodeLine{338   \textcolor{keyword}{public}:}
\DoxyCodeLine{339     \textcolor{keyword}{using }\mbox{\hyperlink{a01277_a5a888bacae06491a7e890c9424518f25}{FERequirementType}}      = \textcolor{keyword}{typename} DisplacementBasedElement::FERequirementType;}
\DoxyCodeLine{340     \textcolor{keyword}{using }\mbox{\hyperlink{a01277_a5ed0cee3df4cbf8a9aed6a705dd8642e}{ResultRequirementsType}} = \textcolor{keyword}{typename} DisplacementBasedElement::ResultRequirementsType;}
\DoxyCodeLine{341     \textcolor{keyword}{using }\mbox{\hyperlink{a01277_a5699ce520159375f9737ec518130e50e}{LocalView}}              = \textcolor{keyword}{typename} DisplacementBasedElement::LocalView;}
\DoxyCodeLine{342     \textcolor{keyword}{using }\mbox{\hyperlink{a01277_aee26978267fb07c5c013a33bbc85f380}{GridView}}               = \textcolor{keyword}{typename} DisplacementBasedElement::GridView;}
\DoxyCodeLine{343     \textcolor{keyword}{using }\mbox{\hyperlink{a01277_a550c9fb8dcd8c64d21c9adaf4749c866}{Traits}}                 = \textcolor{keyword}{typename} DisplacementBasedElement::Traits;}
...
\DoxyCodeLine{356                                 \mbox{\hyperlink{a01277}{EnhancedAssumedStrains}}>) \textcolor{keyword}{explicit} \mbox{\hyperlink{a01277_a1f09e03a1efdba3ff76ad0f37acc0abc}{EnhancedAssumedStrains}}(Args\&\&... args)}
\DoxyCodeLine{357         : DisplacementBasedElement(std::forward<Args>(args)...) \{\}}
\DoxyCodeLine{358 }
\DoxyCodeLine{367     \textcolor{keywordtype}{double} \mbox{\hyperlink{a01277_aa455935bfd539dbd145450c9e8732bdc}{calculateScalar}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01277_a5a888bacae06491a7e890c9424518f25}{FERequirementType}}\& par)\textcolor{keyword}{ const }\{}
\DoxyCodeLine{368       \textcolor{keywordflow}{if} (\mbox{\hyperlink{a01277_a27a311be4e36cbb8d68d96e6d9046afd}{isDisplacementBased}}()) \textcolor{keywordflow}{return} DisplacementBasedElement::calculateScalar(par);}
...
\DoxyCodeLine{371     \}}
\DoxyCodeLine{372 }
\DoxyCodeLine{378     \textcolor{keywordtype}{bool} \mbox{\hyperlink{a01277_a27a311be4e36cbb8d68d96e6d9046afd}{isDisplacementBased}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} std::holds\_alternative<std::monostate>(easVariant\_); \}}
\DoxyCodeLine{379 }
\DoxyCodeLine{388     \textcolor{keyword}{inline} \textcolor{keywordtype}{void} \mbox{\hyperlink{a01277_a3a92d4669635a5ab22a10bc353111d95}{calculateVector}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01277_a5a888bacae06491a7e890c9424518f25}{FERequirementType}}\& par, \textcolor{keyword}{typename} Traits::template VectorType<> force)\textcolor{keyword}{ const }\{}
\DoxyCodeLine{389       calculateVectorImpl<double>(par, force);}
\DoxyCodeLine{390     \}}
\DoxyCodeLine{391 }
\DoxyCodeLine{397     \textcolor{keyword}{const} \textcolor{keyword}{auto}\& \mbox{\hyperlink{a01277_ab8c3ff043b0808de14656d79ec56de5f}{easVariant}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} easVariant\_; \}}
\DoxyCodeLine{398 }
\DoxyCodeLine{404     \textcolor{keyword}{auto} \mbox{\hyperlink{a01277_aa75e2ef6c92f084608e36d5aa6a1122e}{getNumberOfEASParameters}}()\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{413     \}}
\DoxyCodeLine{414 }
\DoxyCodeLine{423     \textcolor{keywordtype}{void} \mbox{\hyperlink{a01277_a7f2216c3b8f6b94145ae586324018376}{calculateMatrix}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01277_a5a888bacae06491a7e890c9424518f25}{FERequirementType}}\& par, \textcolor{keyword}{typename} Traits::template MatrixType<> K)\textcolor{keyword}{ const }\{}
\DoxyCodeLine{424       \textcolor{keyword}{using namespace }Dune::DerivativeDirections;}
\DoxyCodeLine{425       \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00318}{Dune}};}
\DoxyCodeLine{426 }
\DoxyCodeLine{430       DisplacementBasedElement::calculateMatrix(par, K);}
\DoxyCodeLine{431 }
\DoxyCodeLine{432       \textcolor{keywordflow}{if} (\mbox{\hyperlink{a01277_a27a311be4e36cbb8d68d96e6d9046afd}{isDisplacementBased}}()) \textcolor{keywordflow}{return};}
\DoxyCodeLine{433 }
...
\DoxyCodeLine{446     \}}
\DoxyCodeLine{447 }
\DoxyCodeLine{462     \textcolor{keywordtype}{void} \mbox{\hyperlink{a01277_a22e25753bb3cf0c5b296c3af10c443b6}{calculateAt}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01277_a5ed0cee3df4cbf8a9aed6a705dd8642e}{ResultRequirementsType}}\& req, \textcolor{keyword}{const} \mbox{\hyperlink{a01365}{Dune::FieldVector<double, Traits::mydim>}}\& local,}
\DoxyCodeLine{463                      \mbox{\hyperlink{a01245}{ResultTypeMap<double>}}\& result)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{466       \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00318}{Dune}};}
\DoxyCodeLine{467 }
\DoxyCodeLine{468       DisplacementBasedElement::calculateAt(req, local, result);}
\DoxyCodeLine{469 }
\DoxyCodeLine{470       \textcolor{keywordflow}{if} (\mbox{\hyperlink{a01277_a27a311be4e36cbb8d68d96e6d9046afd}{isDisplacementBased}}()) \textcolor{keywordflow}{return};}
\DoxyCodeLine{471 }
...
\DoxyCodeLine{476       \textcolor{keyword}{const} \textcolor{keyword}{auto} disp           = \mbox{\hyperlink{a00308_ga545d74839895f4576a3b8c97d72abefd}{Dune::viewAsFlatEigenVector}}(uFunction.coefficientsRef());}
\DoxyCodeLine{477 }
...
\DoxyCodeLine{488               \textcolor{keyword}{typename} \mbox{\hyperlink{a01245_a72132ad19ec7049750ba2c4f60cde93f}{ResultTypeMap<double>::ResultArray}} resultVector;}
\DoxyCodeLine{489               \textcolor{keywordflow}{if} (req.isResultRequested(\mbox{\hyperlink{a00300_gga531be167e924b749eb8b4ccc7f1c18c9ad8cbb8fe32024cc3f1376a24d27aeae7}{ResultType::linearStress}})) \{}
\DoxyCodeLine{490                 resultVector.resize(3, 1);}
\DoxyCodeLine{491                 resultVector = result.\mbox{\hyperlink{a01245_a7f9a61700e42a5507d7dfcfd059a4067}{getResult}}(\mbox{\hyperlink{a00300_gga531be167e924b749eb8b4ccc7f1c18c9ad8cbb8fe32024cc3f1376a24d27aeae7}{ResultType::linearStress}}) + easStress;}
\DoxyCodeLine{492                 result.\mbox{\hyperlink{a01245_aa399a96000daf40950e388eb0b23a7c0}{insertOrAssignResult}}(\mbox{\hyperlink{a00300_gga531be167e924b749eb8b4ccc7f1c18c9ad8cbb8fe32024cc3f1376a24d27aeae7}{ResultType::linearStress}}, resultVector);}
...
\DoxyCodeLine{498     \}}
\DoxyCodeLine{499 }
\DoxyCodeLine{505     \textcolor{keywordtype}{void} \mbox{\hyperlink{a01277_a3990ba9792f807ae9d0c2f5fd7fb7e85}{setEASType}}(\textcolor{keywordtype}{int} numberOfEASParameters\_) \{}
...
\DoxyCodeLine{508           and (not \mbox{\hyperlink{a01277_a27a311be4e36cbb8d68d96e6d9046afd}{isDisplacementBased}}()))}
...
\DoxyCodeLine{517             easVariant\_ = \mbox{\hyperlink{a01257}{EASQ1E4}}(localView().element().geometry());}
\DoxyCodeLine{518             \textcolor{keywordflow}{break};}
\DoxyCodeLine{519           \textcolor{keywordflow}{case} 5:}
\DoxyCodeLine{520             easVariant\_ = \mbox{\hyperlink{a01261}{EASQ1E5}}(localView().element().geometry());}
\DoxyCodeLine{521             \textcolor{keywordflow}{break};}
\DoxyCodeLine{522           \textcolor{keywordflow}{case} 7:}
\DoxyCodeLine{523             easVariant\_ = \mbox{\hyperlink{a01265}{EASQ1E7}}(localView().element().geometry());}
...
\DoxyCodeLine{535             easVariant\_ = \mbox{\hyperlink{a01269}{EASH1E9}}(localView().element().geometry());}
\DoxyCodeLine{536             \textcolor{keywordflow}{break};}
\DoxyCodeLine{537           \textcolor{keywordflow}{case} 21:}
\DoxyCodeLine{538             easVariant\_ = \mbox{\hyperlink{a01273}{EASH1E21}}(localView().element().geometry());}
...
\DoxyCodeLine{549     \textcolor{keyword}{inline} ScalarType \mbox{\hyperlink{a01277_afc5adc55bc187c5d033a90cbae91ae44}{calculateScalarImpl}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01277_a5a888bacae06491a7e890c9424518f25}{FERequirementType}}\& par,}
...
\DoxyCodeLine{552       \textcolor{keywordflow}{if} (\mbox{\hyperlink{a01277_a27a311be4e36cbb8d68d96e6d9046afd}{isDisplacementBased}}()) \textcolor{keywordflow}{return} DisplacementBasedElement::template calculateScalarImpl<ScalarType>(par, dx);}
...
\DoxyCodeLine{558     \textcolor{keywordtype}{void} \mbox{\hyperlink{a01277_afa32c429e6121e0573a0fedbe43d2f45}{calculateVectorImpl}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01277_a5a888bacae06491a7e890c9424518f25}{FERequirementType}}\& par, \textcolor{keyword}{typename} Traits::template VectorType<ScalarType> force,}
...
\DoxyCodeLine{561       \textcolor{keywordflow}{if} (\mbox{\hyperlink{a01277_a27a311be4e36cbb8d68d96e6d9046afd}{isDisplacementBased}}()) \textcolor{keywordflow}{return};}
\DoxyCodeLine{562       \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00318}{Dune}};}
...
\DoxyCodeLine{566       \textcolor{keyword}{const} \textcolor{keyword}{auto} disp           = \mbox{\hyperlink{a00308_ga545d74839895f4576a3b8c97d72abefd}{Dune::viewAsFlatEigenVector}}(uFunction.coefficientsRef());}
\DoxyCodeLine{567 }
...
\DoxyCodeLine{600     \textcolor{keyword}{using }EAS2DVariantImpl = \mbox{\hyperlink{a00313_a87e3feaaba5839ab7b515df24438c07f}{EAS2DVariant<typename LocalView::Element::Geometry>}};}
\DoxyCodeLine{601     \textcolor{keyword}{using }EAS3DVariantImpl = \mbox{\hyperlink{a00313_a4e486ca9fc463568d5018e15b3d68b0d}{EAS3DVariant<typename LocalView::Element::Geometry>}};}
...
\DoxyCodeLine{608       \textcolor{keyword}{using namespace }\mbox{\hyperlink{a00318}{Dune}};}
