...
\DoxyCodeLine{31   \textcolor{keyword}{class }\mbox{\hyperlink{a01197}{AutoDiffFE}} : \textcolor{keyword}{public} RealFE\_ \{}
\DoxyCodeLine{32   \textcolor{keyword}{public}:}
\DoxyCodeLine{33     \textcolor{keyword}{using }\mbox{\hyperlink{a01197_ae3eeda5463148aeab6bec5e774791384}{RealFE}}            = RealFE\_;                                      }
\DoxyCodeLine{34     \textcolor{keyword}{using }\mbox{\hyperlink{a01197_a89a700073503fa0567afbcb5f4638b7e}{Basis}}             = \textcolor{keyword}{typename} RealFE::Basis;                       }
\DoxyCodeLine{35     \textcolor{keyword}{using }\mbox{\hyperlink{a01197_a0890448ef4b8fd1605b861cb3ffd4e21}{LocalView}}         = \textcolor{keyword}{typename} Basis::FlatBasis::LocalView;         }
\DoxyCodeLine{36     \textcolor{keyword}{using }\mbox{\hyperlink{a01313}{Traits}}            = \mbox{\hyperlink{a01313}{TraitsFromLocalView<LocalView, useEigenRef>}};  }
\DoxyCodeLine{37     \textcolor{keyword}{using }\mbox{\hyperlink{a01197_a20d9d81fd33709e9e4dd1c7223a1ccaa}{Element}}           = \textcolor{keyword}{typename} LocalView::Element;                  }
\DoxyCodeLine{38     \textcolor{keyword}{using }\mbox{\hyperlink{a01197_a1fcac1d2f958ed25af80263406a5051d}{FERequirementType}} = FERequirementType\_;  }
\DoxyCodeLine{39 }
\DoxyCodeLine{46     \textcolor{keywordtype}{void} \mbox{\hyperlink{a01197_a2650fc875e359aab7e22e59ccbed53f8}{calculateMatrix}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01197_a1fcac1d2f958ed25af80263406a5051d}{FERequirementType}}\& req, \textcolor{keyword}{typename} Traits::template MatrixType<> h)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{80     \}}
\DoxyCodeLine{81 }
\DoxyCodeLine{88     \textcolor{keywordtype}{void} \mbox{\hyperlink{a01197_a70030068b3205be5d75548ce1f1c126f}{calculateVector}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01197_a1fcac1d2f958ed25af80263406a5051d}{FERequirementType}}\& req, \textcolor{keyword}{typename} Traits::template VectorType<> g)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{111     \}}
\DoxyCodeLine{112 }
\DoxyCodeLine{120     \textcolor{keywordtype}{void} \mbox{\hyperlink{a01197_aa35fb8992a69d3b8a4272722eea90c8a}{calculateLocalSystem}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01197_a1fcac1d2f958ed25af80263406a5051d}{FERequirementType}}\& req, \textcolor{keyword}{typename} Traits::template MatrixType<> h,}
...
\DoxyCodeLine{126     \}}
\DoxyCodeLine{127 }
\DoxyCodeLine{134     [[nodiscard]] \textcolor{keywordtype}{double} \mbox{\hyperlink{a01197_a1ceee52422b438e6c24386e7c17dc124}{calculateScalar}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01197_a1fcac1d2f958ed25af80263406a5051d}{FERequirementType}}\& par)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{146     \}}
\DoxyCodeLine{147 }
\DoxyCodeLine{153     \textcolor{keyword}{const} \mbox{\hyperlink{a01197_ae3eeda5463148aeab6bec5e774791384}{RealFE}}\& \mbox{\hyperlink{a01197_af1726c92c0d829e25de3bfede15c4291}{realFE}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} *\textcolor{keyword}{this}; \}}
\DoxyCodeLine{154 }
\DoxyCodeLine{162     \textcolor{keyword}{template} <\textcolor{keyword}{typename}... Args>}
\DoxyCodeLine{163     \textcolor{keyword}{explicit} \mbox{\hyperlink{a01197_a0945c8f2eb83323d6b8767b4ce47c919}{AutoDiffFE}}(Args\&\&... args) : \mbox{\hyperlink{a01197_ae3eeda5463148aeab6bec5e774791384}{RealFE}}\{std::forward<Args>(args)...\} \{\}}
\DoxyCodeLine{164   \};}
